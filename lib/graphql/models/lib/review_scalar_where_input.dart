...
class ReviewScalarWhereInput extends Equatable {
  final List<ReviewScalarWhereInput>? AND;
  final List<ReviewScalarWhereInput>? OR;
  final List<ReviewScalarWhereInput>? NOT;
  ...
  static ReviewScalarWhereInput fromJson(Map<dynamic, dynamic> json) {
    return ReviewScalarWhereInput(
      AND: json['AND'] != null
          ? List.generate(json['AND'].length,
              (index) => ReviewScalarWhereInput.fromJson(json['AND'][index]))
          : null,
      OR: json['OR'] != null
          ? List.generate(json['OR'].length,
              (index) => ReviewScalarWhereInput.fromJson(json['OR'][index]))
          : null,
      NOT: json['NOT'] != null
          ? List.generate(json['NOT'].length,
              (index) => ReviewScalarWhereInput.fromJson(json['NOT'][index]))
          : null,
  ...
  ReviewScalarWhereInput copyWith(
      {List<ReviewScalarWhereInput>? AND,
      List<ReviewScalarWhereInput>? OR,
      List<ReviewScalarWhereInput>? NOT,
      StringFilter? id,
