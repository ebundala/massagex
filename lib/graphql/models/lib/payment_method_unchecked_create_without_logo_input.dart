...
import 'transaction_unchecked_create_nested_many_without_payment_method_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class PaymentMethodUncheckedCreateWithoutLogoInput extends Equatable {
  final String? id;
  final String name;
  ...
  final TransactionUncheckedCreateNestedManyWithoutPaymentMethodInput?
      transactions;
  ...
  PaymentMethodUncheckedCreateWithoutLogoInput(
      {this.id,
      required this.name,
      this.description,
      required this.code,
  ...
  static PaymentMethodUncheckedCreateWithoutLogoInput fromJson(
      Map<dynamic, dynamic> json) {
    return PaymentMethodUncheckedCreateWithoutLogoInput(
      id: json['id'],
      name: json['name'],
  ...
  PaymentMethodUncheckedCreateWithoutLogoInput copyWith(
      {String? id,
      String? name,
      String? description,
