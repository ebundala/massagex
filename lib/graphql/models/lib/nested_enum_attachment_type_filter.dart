...
class NestedEnumAttachmentTypeFilter extends Equatable {
  ...
  NestedEnumAttachmentTypeFilter({this.equals, this.in$, this.notIn, this.not});

  static NestedEnumAttachmentTypeFilter fromJson(Map<dynamic, dynamic> json) {
    return NestedEnumAttachmentTypeFilter(
  ...
  NestedEnumAttachmentTypeFilter copyWith(
