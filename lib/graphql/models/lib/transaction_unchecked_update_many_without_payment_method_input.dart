...
import 'transaction_upsert_with_where_unique_without_payment_method_input.dart';
import 'transaction_create_many_payment_method_input_envelope.dart';
import 'transaction_where_unique_input.dart';
import 'transaction_update_with_where_unique_without_payment_method_input.dart';
import 'transaction_update_many_with_where_without_payment_method_input.dart';
import 'transaction_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class TransactionUncheckedUpdateManyWithoutPaymentMethodInput
    extends Equatable {
  ...
  final List<TransactionCreateOrConnectWithoutPaymentMethodInput>?
      connectOrCreate;
  final List<TransactionUpsertWithWhereUniqueWithoutPaymentMethodInput>? upsert;
  ...
  final List<TransactionUpdateWithWhereUniqueWithoutPaymentMethodInput>? update;
  final List<TransactionUpdateManyWithWhereWithoutPaymentMethodInput>?
      updateMany;
  ...
  TransactionUncheckedUpdateManyWithoutPaymentMethodInput(
      {this.create,
  ...
  static TransactionUncheckedUpdateManyWithoutPaymentMethodInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUncheckedUpdateManyWithoutPaymentMethodInput(
          ...
          ? List.generate(
              ...
              (index) =>
                  TransactionUpdateWithWhereUniqueWithoutPaymentMethodInput
                      .fromJson(json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              json['updateMany'].length,
              (index) => TransactionUpdateManyWithWhereWithoutPaymentMethodInput
                  .fromJson(json['updateMany'][index]))
          : null,
  ...
  TransactionUncheckedUpdateManyWithoutPaymentMethodInput copyWith(
      {List<TransactionCreateWithoutPaymentMethodInput>? create,
      List<TransactionCreateOrConnectWithoutPaymentMethodInput>?
          connectOrCreate,
      List<TransactionUpsertWithWhereUniqueWithoutPaymentMethodInput>? upsert,
      ...
      List<TransactionUpdateWithWhereUniqueWithoutPaymentMethodInput>? update,
      List<TransactionUpdateManyWithWhereWithoutPaymentMethodInput>? updateMany,
