...
class PaymentMethodCreateOrConnectWithoutTransactionsInput extends Equatable {
  ...
  PaymentMethodCreateOrConnectWithoutTransactionsInput(
      {required this.where, required this.create});

  static PaymentMethodCreateOrConnectWithoutTransactionsInput fromJson(
      Map<dynamic, dynamic> json) {
    return PaymentMethodCreateOrConnectWithoutTransactionsInput(
  ...
  PaymentMethodCreateOrConnectWithoutTransactionsInput copyWith(
