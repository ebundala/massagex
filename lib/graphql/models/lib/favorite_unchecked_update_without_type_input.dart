...
class FavoriteUncheckedUpdateWithoutTypeInput extends Equatable {
  ...
  FavoriteUncheckedUpdateWithoutTypeInput(
      {this.id,
      this.favId,
      this.authorId,
      this.recordStatus,
  ...
  static FavoriteUncheckedUpdateWithoutTypeInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedUpdateWithoutTypeInput(
      id: json['id'] != null
  ...
  FavoriteUncheckedUpdateWithoutTypeInput copyWith(
