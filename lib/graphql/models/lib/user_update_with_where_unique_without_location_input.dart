...
class UserUpdateWithWhereUniqueWithoutLocationInput extends Equatable {
  final UserWhereUniqueInput where;
  final UserUpdateWithoutLocationInput data;
  ...
  UserUpdateWithWhereUniqueWithoutLocationInput(
      {required this.where, required this.data});

  static UserUpdateWithWhereUniqueWithoutLocationInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUpdateWithWhereUniqueWithoutLocationInput(
      where: UserWhereUniqueInput.fromJson(json['where']),
      data: UserUpdateWithoutLocationInput.fromJson(json['data']),
    );
  }
  ...
  UserUpdateWithWhereUniqueWithoutLocationInput copyWith(
      {UserWhereUniqueInput? where, UserUpdateWithoutLocationInput? data}) {
    return UserUpdateWithWhereUniqueWithoutLocationInput(
