import 'comment_create_without_comments_input.dart';
import 'comment_create_or_connect_without_comments_input.dart';
import 'comment_upsert_without_comments_input.dart';
import 'comment_where_unique_input.dart';
import 'comment_update_without_comments_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class CommentUpdateOneWithoutCommentsInput extends Equatable {
  final CommentCreateWithoutCommentsInput? create;
  final CommentCreateOrConnectWithoutCommentsInput? connectOrCreate;
  final CommentUpsertWithoutCommentsInput? upsert;
  final CommentWhereUniqueInput? connect;
  final bool? disconnect;
  final bool? delete;
  final CommentUpdateWithoutCommentsInput? update;
  ...
  static CommentUpdateOneWithoutCommentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUpdateOneWithoutCommentsInput(
      create: json['create'] != null
          ? CommentCreateWithoutCommentsInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? CommentCreateOrConnectWithoutCommentsInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? CommentUpsertWithoutCommentsInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? CommentUpdateWithoutCommentsInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  CommentUpdateOneWithoutCommentsInput copyWith(
      {CommentCreateWithoutCommentsInput? create,
      CommentCreateOrConnectWithoutCommentsInput? connectOrCreate,
      CommentUpsertWithoutCommentsInput? upsert,
      CommentWhereUniqueInput? connect,
      bool? disconnect,
      bool? delete,
      CommentUpdateWithoutCommentsInput? update}) {
    return CommentUpdateOneWithoutCommentsInput(
