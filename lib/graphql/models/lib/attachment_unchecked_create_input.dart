...
class AttachmentUncheckedCreateInput extends Equatable {
  ...
  static AttachmentUncheckedCreateInput fromJson(Map<dynamic, dynamic> json) {
    return AttachmentUncheckedCreateInput(
      path: json['path'],
      id: json['id'],
  ...
  AttachmentUncheckedCreateInput copyWith(
      {MultipartFile? path,
      String? id,
      String? filename,
      String? mimetype,
