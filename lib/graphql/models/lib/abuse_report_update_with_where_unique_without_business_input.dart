...
class AbuseReportUpdateWithWhereUniqueWithoutBusinessInput extends Equatable {
  final AbuseReportWhereUniqueInput where;
  final AbuseReportUpdateWithoutBusinessInput data;
  ...
  AbuseReportUpdateWithWhereUniqueWithoutBusinessInput(
      {required this.where, required this.data});

  static AbuseReportUpdateWithWhereUniqueWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpdateWithWhereUniqueWithoutBusinessInput(
      where: AbuseReportWhereUniqueInput.fromJson(json['where']),
      data: AbuseReportUpdateWithoutBusinessInput.fromJson(json['data']),
    );
  }
  ...
  AbuseReportUpdateWithWhereUniqueWithoutBusinessInput copyWith(
      {AbuseReportWhereUniqueInput? where,
      AbuseReportUpdateWithoutBusinessInput? data}) {
    return AbuseReportUpdateWithWhereUniqueWithoutBusinessInput(
