...
import 'review_upsert_without_favorites_input.dart';
...
class ReviewUpdateOneWithoutFavoritesInput extends Equatable {
  ...
  ReviewUpdateOneWithoutFavoritesInput(
      {this.create,
  ...
  static ReviewUpdateOneWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewUpdateOneWithoutFavoritesInput(
      ...
      upsert: json['upsert'] != null
          ? ReviewUpsertWithoutFavoritesInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? ReviewUpdateWithoutFavoritesInput.fromJson(json['update'])
          : null,
    );
  }
