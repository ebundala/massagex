...
class FavoriteCreateManyBusinessInput extends Equatable {
  final String? id;
  final String favId;
  ...
  FavoriteCreateManyBusinessInput(
      {this.id,
      required this.favId,
  ...
  static FavoriteCreateManyBusinessInput fromJson(Map<dynamic, dynamic> json) {
    return FavoriteCreateManyBusinessInput(
      id: json['id'],
      favId: json['favId'],
  ...
  FavoriteCreateManyBusinessInput copyWith(
      {String? id,
      String? favId,
      String? authorId,
      String? typeId,
