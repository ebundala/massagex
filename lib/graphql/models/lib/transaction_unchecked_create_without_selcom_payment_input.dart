...
class TransactionUncheckedCreateWithoutSelcomPaymentInput extends Equatable {
  final String? id;
  ...
  TransactionUncheckedCreateWithoutSelcomPaymentInput(
      {this.id,
  ...
  static TransactionUncheckedCreateWithoutSelcomPaymentInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUncheckedCreateWithoutSelcomPaymentInput(
      id: json['id'],
  ...
  TransactionUncheckedCreateWithoutSelcomPaymentInput copyWith(
      {String? id,
