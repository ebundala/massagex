...
import 'abuse_report_unchecked_update_many_without_type_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class AbuseRecordTypeUncheckedUpdateInput extends Equatable {
  final StringFieldUpdateOperationsInput? id;
  final StringFieldUpdateOperationsInput? name;
  final AbuseReportUncheckedUpdateManyWithoutTypeInput? abuseReports;
  ...
  AbuseRecordTypeUncheckedUpdateInput({this.id, this.name, this.abuseReports});

  static AbuseRecordTypeUncheckedUpdateInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseRecordTypeUncheckedUpdateInput(
      id: json['id'] != null
      ...
      abuseReports: json['abuseReports'] != null
          ? AbuseReportUncheckedUpdateManyWithoutTypeInput.fromJson(
              json['abuseReports'])
          : null,
    );
  }
  ...
  AbuseRecordTypeUncheckedUpdateInput copyWith(
      {StringFieldUpdateOperationsInput? id,
      StringFieldUpdateOperationsInput? name,
      AbuseReportUncheckedUpdateManyWithoutTypeInput? abuseReports}) {
    return AbuseRecordTypeUncheckedUpdateInput(
        id: id ?? this.id,
        name: name ?? this.name,
