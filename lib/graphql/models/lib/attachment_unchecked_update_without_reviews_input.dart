...
class AttachmentUncheckedUpdateWithoutReviewsInput extends Equatable {
  ...
  AttachmentUncheckedUpdateWithoutReviewsInput(
      {this.id,
      this.path,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUncheckedUpdateWithoutReviewsInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedUpdateWithoutReviewsInput(
      id: json['id'] != null
  ...
  AttachmentUncheckedUpdateWithoutReviewsInput copyWith(
