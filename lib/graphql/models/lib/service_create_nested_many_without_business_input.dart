...
class ServiceCreateNestedManyWithoutBusinessInput extends Equatable {
  ...
  ServiceCreateNestedManyWithoutBusinessInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static ServiceCreateNestedManyWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceCreateNestedManyWithoutBusinessInput(
  ...
  ServiceCreateNestedManyWithoutBusinessInput copyWith(
