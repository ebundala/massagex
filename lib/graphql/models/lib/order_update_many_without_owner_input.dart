...
class OrderUpdateManyWithoutOwnerInput extends Equatable {
  ...
  static OrderUpdateManyWithoutOwnerInput fromJson(Map<dynamic, dynamic> json) {
    return OrderUpdateManyWithoutOwnerInput(
  ...
  OrderUpdateManyWithoutOwnerInput copyWith(
