...
class UserUpsertWithWhereUniqueWithoutAvatorInput extends Equatable {
  final UserWhereUniqueInput where;
  final UserUpdateWithoutAvatorInput update;
  final UserCreateWithoutAvatorInput create;
  ...
  UserUpsertWithWhereUniqueWithoutAvatorInput(
      {required this.where, required this.update, required this.create});

  static UserUpsertWithWhereUniqueWithoutAvatorInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUpsertWithWhereUniqueWithoutAvatorInput(
      where: UserWhereUniqueInput.fromJson(json['where']),
      update: UserUpdateWithoutAvatorInput.fromJson(json['update']),
      create: UserCreateWithoutAvatorInput.fromJson(json['create']),
    );
  }
  ...
  UserUpsertWithWhereUniqueWithoutAvatorInput copyWith(
      {UserWhereUniqueInput? where,
      UserUpdateWithoutAvatorInput? update,
      UserCreateWithoutAvatorInput? create}) {
    return UserUpsertWithWhereUniqueWithoutAvatorInput(
