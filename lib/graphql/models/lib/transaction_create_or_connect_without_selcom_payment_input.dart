...
class TransactionCreateOrConnectWithoutSelcomPaymentInput extends Equatable {
  ...
  TransactionCreateOrConnectWithoutSelcomPaymentInput(
      {required this.where, required this.create});

  static TransactionCreateOrConnectWithoutSelcomPaymentInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionCreateOrConnectWithoutSelcomPaymentInput(
  ...
  TransactionCreateOrConnectWithoutSelcomPaymentInput copyWith(
