...
import 'service_update_one_required_without_orders_input.dart';
...
class OrderUpdateWithoutFavoritesInput extends Equatable {
  ...
  final ServiceUpdateOneRequiredWithoutOrdersInput? service;
  ...
  OrderUpdateWithoutFavoritesInput(
      {this.id,
      this.quantity,
      this.recordStatus,
      this.orderStatus,
  ...
  static OrderUpdateWithoutFavoritesInput fromJson(Map<dynamic, dynamic> json) {
    return OrderUpdateWithoutFavoritesInput(
      id: json['id'] != null
      ...
      service: json['service'] != null
          ? ServiceUpdateOneRequiredWithoutOrdersInput.fromJson(json['service'])
          : null,
  ...
  OrderUpdateWithoutFavoritesInput copyWith(
      ...
      ServiceUpdateOneRequiredWithoutOrdersInput? service,
