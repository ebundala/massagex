...
class BusinessUncheckedUpdateWithoutOrdersInput extends Equatable {
  ...
  static BusinessUncheckedUpdateWithoutOrdersInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUncheckedUpdateWithoutOrdersInput(
      id: json['id'] != null
  ...
  BusinessUncheckedUpdateWithoutOrdersInput copyWith(
