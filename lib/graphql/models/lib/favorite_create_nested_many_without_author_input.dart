...
class FavoriteCreateNestedManyWithoutAuthorInput extends Equatable {
  ...
  FavoriteCreateNestedManyWithoutAuthorInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static FavoriteCreateNestedManyWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteCreateNestedManyWithoutAuthorInput(
  ...
  FavoriteCreateNestedManyWithoutAuthorInput copyWith(
