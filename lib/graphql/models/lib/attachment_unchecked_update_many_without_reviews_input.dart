...
import 'attachment_create_or_connect_without_reviews_input.dart';
import 'attachment_upsert_with_where_unique_without_reviews_input.dart';
import 'attachment_create_many_reviews_input_envelope.dart';
import 'attachment_where_unique_input.dart';
import 'attachment_update_with_where_unique_without_reviews_input.dart';
import 'attachment_update_many_with_where_without_reviews_input.dart';
import 'attachment_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class AttachmentUncheckedUpdateManyWithoutReviewsInput extends Equatable {
  final List<AttachmentCreateWithoutReviewsInput>? create;
  final List<AttachmentCreateOrConnectWithoutReviewsInput>? connectOrCreate;
  final List<AttachmentUpsertWithWhereUniqueWithoutReviewsInput>? upsert;
  final AttachmentCreateManyReviewsInputEnvelope? createMany;
  ...
  final List<AttachmentUpdateWithWhereUniqueWithoutReviewsInput>? update;
  final List<AttachmentUpdateManyWithWhereWithoutReviewsInput>? updateMany;
  ...
  AttachmentUncheckedUpdateManyWithoutReviewsInput(
      {this.create,
  ...
  static AttachmentUncheckedUpdateManyWithoutReviewsInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedUpdateManyWithoutReviewsInput(
      create: json['create'] != null
          ? List.generate(
              json['create'].length,
              (index) => AttachmentCreateWithoutReviewsInput.fromJson(
                  json['create'][index]))
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? List.generate(
              json['connectOrCreate'].length,
              (index) => AttachmentCreateOrConnectWithoutReviewsInput.fromJson(
      ...
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) =>
                  AttachmentUpsertWithWhereUniqueWithoutReviewsInput.fromJson(
                      json['upsert'][index]))
          : null,
      createMany: json['createMany'] != null
          ? AttachmentCreateManyReviewsInputEnvelope.fromJson(
              json['createMany'])
          : null,
      ...
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) =>
                  AttachmentUpdateWithWhereUniqueWithoutReviewsInput.fromJson(
                      json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              ...
              (index) =>
                  AttachmentUpdateManyWithWhereWithoutReviewsInput.fromJson(
  ...
  AttachmentUncheckedUpdateManyWithoutReviewsInput copyWith(
      {List<AttachmentCreateWithoutReviewsInput>? create,
      List<AttachmentCreateOrConnectWithoutReviewsInput>? connectOrCreate,
      List<AttachmentUpsertWithWhereUniqueWithoutReviewsInput>? upsert,
      AttachmentCreateManyReviewsInputEnvelope? createMany,
      ...
      List<AttachmentUpdateWithWhereUniqueWithoutReviewsInput>? update,
      List<AttachmentUpdateManyWithWhereWithoutReviewsInput>? updateMany,
