...
class AttachmentCreateOrConnectWithoutReviewsInput extends Equatable {
  ...
  AttachmentCreateOrConnectWithoutReviewsInput(
      {required this.where, required this.create});

  static AttachmentCreateOrConnectWithoutReviewsInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateOrConnectWithoutReviewsInput(
  ...
  AttachmentCreateOrConnectWithoutReviewsInput copyWith(
