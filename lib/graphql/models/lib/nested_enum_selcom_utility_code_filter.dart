...
class NestedEnumSelcomUtilityCodeFilter extends Equatable {
  ...
  NestedEnumSelcomUtilityCodeFilter(
      {this.equals, this.in$, this.notIn, this.not});

  static NestedEnumSelcomUtilityCodeFilter fromJson(
      Map<dynamic, dynamic> json) {
    return NestedEnumSelcomUtilityCodeFilter(
  ...
  NestedEnumSelcomUtilityCodeFilter copyWith(
