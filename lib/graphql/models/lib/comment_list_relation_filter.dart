import 'comment_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class CommentListRelationFilter extends Equatable {
  ...
  CommentListRelationFilter({this.every, this.some, this.none});

  static CommentListRelationFilter fromJson(Map<dynamic, dynamic> json) {
    return CommentListRelationFilter(
      every: json['every'] != null
          ? CommentWhereInput.fromJson(json['every'])
          : null,
      some: json['some'] != null
          ? CommentWhereInput.fromJson(json['some'])
          : null,
      none: json['none'] != null
          ? CommentWhereInput.fromJson(json['none'])
          : null,
    );
  }
  ...
  CommentListRelationFilter copyWith(
      {CommentWhereInput? every,
      CommentWhereInput? some,
      CommentWhereInput? none}) {
    return CommentListRelationFilter(
