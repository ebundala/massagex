...
class HelpStepUncheckedUpdateManyInput extends Equatable {
  ...
  HelpStepUncheckedUpdateManyInput(
      {this.id,
      this.stepNumber,
      this.title,
      this.description,
  ...
  static HelpStepUncheckedUpdateManyInput fromJson(Map<dynamic, dynamic> json) {
    return HelpStepUncheckedUpdateManyInput(
      id: json['id'] != null
  ...
  HelpStepUncheckedUpdateManyInput copyWith(
