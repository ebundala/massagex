import 'user_create_without_device_input.dart';
import 'user_create_or_connect_without_device_input.dart';
import 'user_upsert_without_device_input.dart';
import 'user_where_unique_input.dart';
import 'user_update_without_device_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class UserUpdateOneWithoutDeviceInput extends Equatable {
  final UserCreateWithoutDeviceInput? create;
  final UserCreateOrConnectWithoutDeviceInput? connectOrCreate;
  final UserUpsertWithoutDeviceInput? upsert;
  final UserWhereUniqueInput? connect;
  final bool? disconnect;
  final bool? delete;
  final UserUpdateWithoutDeviceInput? update;
  ...
  UserUpdateOneWithoutDeviceInput(
      {this.create,
  ...
  static UserUpdateOneWithoutDeviceInput fromJson(Map<dynamic, dynamic> json) {
    return UserUpdateOneWithoutDeviceInput(
      create: json['create'] != null
          ? UserCreateWithoutDeviceInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? UserCreateOrConnectWithoutDeviceInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? UserUpsertWithoutDeviceInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? UserUpdateWithoutDeviceInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  UserUpdateOneWithoutDeviceInput copyWith(
      {UserCreateWithoutDeviceInput? create,
      UserCreateOrConnectWithoutDeviceInput? connectOrCreate,
      UserUpsertWithoutDeviceInput? upsert,
      UserWhereUniqueInput? connect,
      bool? disconnect,
      bool? delete,
      UserUpdateWithoutDeviceInput? update}) {
    return UserUpdateOneWithoutDeviceInput(
