...
import 'abuse_record_type_relation_filter.dart';
...
class AbuseReportWhereInput extends Equatable {
  final List<AbuseReportWhereInput>? AND;
  final List<AbuseReportWhereInput>? OR;
  final List<AbuseReportWhereInput>? NOT;
  final StringFilter? id;
  final IntFilter? number;
  final StringNullableFilter? report;
  final UserRelationFilter? author;
  final StringFilter? authorId;
  final AbuseRecordTypeRelationFilter? type;
  ...
  static AbuseReportWhereInput fromJson(Map<dynamic, dynamic> json) {
    return AbuseReportWhereInput(
      AND: json['AND'] != null
          ? List.generate(json['AND'].length,
              (index) => AbuseReportWhereInput.fromJson(json['AND'][index]))
          : null,
      OR: json['OR'] != null
          ? List.generate(json['OR'].length,
              (index) => AbuseReportWhereInput.fromJson(json['OR'][index]))
          : null,
      NOT: json['NOT'] != null
          ? List.generate(json['NOT'].length,
              (index) => AbuseReportWhereInput.fromJson(json['NOT'][index]))
          : null,
      ...
      authorId: json['authorId'] != null
          ...
          : null,
      type: json['type'] != null
          ? AbuseRecordTypeRelationFilter.fromJson(json['type'])
          : null,
      typeId:
  ...
  AbuseReportWhereInput copyWith(
      {List<AbuseReportWhereInput>? AND,
      List<AbuseReportWhereInput>? OR,
      List<AbuseReportWhereInput>? NOT,
      StringFilter? id,
      IntFilter? number,
      StringNullableFilter? report,
      UserRelationFilter? author,
      StringFilter? authorId,
      AbuseRecordTypeRelationFilter? type,
      StringFilter? typeId,
