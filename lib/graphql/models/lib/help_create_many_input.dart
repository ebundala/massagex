...
class HelpCreateManyInput extends Equatable {
  final String? id;
  final String topic;
  ...
  static HelpCreateManyInput fromJson(Map<dynamic, dynamic> json) {
    return HelpCreateManyInput(
      id: json['id'],
      topic: json['topic'],
