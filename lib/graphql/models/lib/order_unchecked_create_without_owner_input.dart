...
class OrderUncheckedCreateWithoutOwnerInput extends Equatable {
  final String? id;
  final int quantity;
  ...
  OrderUncheckedCreateWithoutOwnerInput(
      {this.id,
  ...
  static OrderUncheckedCreateWithoutOwnerInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUncheckedCreateWithoutOwnerInput(
      id: json['id'],
  ...
  OrderUncheckedCreateWithoutOwnerInput copyWith(
      {String? id,
      int? quantity,
