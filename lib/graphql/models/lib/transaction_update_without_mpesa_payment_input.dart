...
class TransactionUpdateWithoutMpesaPaymentInput extends Equatable {
  ...
  TransactionUpdateWithoutMpesaPaymentInput(
      {this.id,
      this.type,
      this.status,
      this.recordStatus,
  ...
  static TransactionUpdateWithoutMpesaPaymentInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUpdateWithoutMpesaPaymentInput(
      id: json['id'] != null
  ...
  TransactionUpdateWithoutMpesaPaymentInput copyWith(
