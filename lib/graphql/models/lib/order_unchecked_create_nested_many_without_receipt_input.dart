...
class OrderUncheckedCreateNestedManyWithoutReceiptInput extends Equatable {
  ...
  OrderUncheckedCreateNestedManyWithoutReceiptInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static OrderUncheckedCreateNestedManyWithoutReceiptInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUncheckedCreateNestedManyWithoutReceiptInput(
  ...
  OrderUncheckedCreateNestedManyWithoutReceiptInput copyWith(
