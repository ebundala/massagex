...
import 'abuse_report_unchecked_create_nested_many_without_author_input.dart';
import 'favorite_unchecked_create_nested_many_without_author_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class UserUncheckedCreateWithoutBusinessProfileInput extends Equatable {
  final String? id;
  final String? email;
  ...
  final AbuseReportUncheckedCreateNestedManyWithoutAuthorInput? abuseReported;
  ...
  UserUncheckedCreateWithoutBusinessProfileInput(
      {this.id,
      this.email,
      this.displayName,
      this.phoneNumber,
  ...
  static UserUncheckedCreateWithoutBusinessProfileInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUncheckedCreateWithoutBusinessProfileInput(
      id: json['id'],
      email: json['email'],
      ...
      abuseReported: json['abuseReported'] != null
          ? AbuseReportUncheckedCreateNestedManyWithoutAuthorInput.fromJson(
              json['abuseReported'])
          : null,
  ...
  UserUncheckedCreateWithoutBusinessProfileInput copyWith(
      {String? id,
      String? email,
      String? displayName,
      String? phoneNumber,
      ...
      AbuseReportUncheckedCreateNestedManyWithoutAuthorInput? abuseReported,
