...
class BusinessCreateNestedOneWithoutServicesInput extends Equatable {
  ...
  BusinessCreateNestedOneWithoutServicesInput(
      {this.create, this.connectOrCreate, this.connect});

  static BusinessCreateNestedOneWithoutServicesInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessCreateNestedOneWithoutServicesInput(
  ...
  BusinessCreateNestedOneWithoutServicesInput copyWith(
