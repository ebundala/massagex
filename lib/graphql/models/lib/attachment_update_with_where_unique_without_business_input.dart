...
class AttachmentUpdateWithWhereUniqueWithoutBusinessInput extends Equatable {
  final AttachmentWhereUniqueInput where;
  final AttachmentUpdateWithoutBusinessInput data;
  ...
  AttachmentUpdateWithWhereUniqueWithoutBusinessInput(
      {required this.where, required this.data});

  static AttachmentUpdateWithWhereUniqueWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUpdateWithWhereUniqueWithoutBusinessInput(
      where: AttachmentWhereUniqueInput.fromJson(json['where']),
      data: AttachmentUpdateWithoutBusinessInput.fromJson(json['data']),
    );
  }
  ...
  AttachmentUpdateWithWhereUniqueWithoutBusinessInput copyWith(
      {AttachmentWhereUniqueInput? where,
      AttachmentUpdateWithoutBusinessInput? data}) {
    return AttachmentUpdateWithWhereUniqueWithoutBusinessInput(
