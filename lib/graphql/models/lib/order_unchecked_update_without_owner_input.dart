...
class OrderUncheckedUpdateWithoutOwnerInput extends Equatable {
  ...
  OrderUncheckedUpdateWithoutOwnerInput(
      {this.id,
      this.quantity,
      this.recordStatus,
      this.orderStatus,
  ...
  static OrderUncheckedUpdateWithoutOwnerInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUncheckedUpdateWithoutOwnerInput(
      id: json['id'] != null
  ...
  OrderUncheckedUpdateWithoutOwnerInput copyWith(
