...
class CommentUncheckedUpdateWithoutCommentsInput extends Equatable {
  ...
  CommentUncheckedUpdateWithoutCommentsInput(
      {this.id,
      this.authorId,
      this.reviewId,
  ...
  static CommentUncheckedUpdateWithoutCommentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUncheckedUpdateWithoutCommentsInput(
      id: json['id'] != null
  ...
  CommentUncheckedUpdateWithoutCommentsInput copyWith(
