import 'review_create_without_abuse_reports_input.dart';
import 'review_create_or_connect_without_abuse_reports_input.dart';
import 'review_upsert_without_abuse_reports_input.dart';
import 'review_where_unique_input.dart';
import 'review_update_without_abuse_reports_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class ReviewUpdateOneWithoutAbuseReportsInput extends Equatable {
  final ReviewCreateWithoutAbuseReportsInput? create;
  final ReviewCreateOrConnectWithoutAbuseReportsInput? connectOrCreate;
  final ReviewUpsertWithoutAbuseReportsInput? upsert;
  final ReviewWhereUniqueInput? connect;
  final bool? disconnect;
  final bool? delete;
  final ReviewUpdateWithoutAbuseReportsInput? update;
  ...
  ReviewUpdateOneWithoutAbuseReportsInput(
      {this.create,
  ...
  static ReviewUpdateOneWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewUpdateOneWithoutAbuseReportsInput(
      create: json['create'] != null
          ? ReviewCreateWithoutAbuseReportsInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? ReviewCreateOrConnectWithoutAbuseReportsInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? ReviewUpsertWithoutAbuseReportsInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? ReviewUpdateWithoutAbuseReportsInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  ReviewUpdateOneWithoutAbuseReportsInput copyWith(
      {ReviewCreateWithoutAbuseReportsInput? create,
      ReviewCreateOrConnectWithoutAbuseReportsInput? connectOrCreate,
      ReviewUpsertWithoutAbuseReportsInput? upsert,
      ReviewWhereUniqueInput? connect,
      bool? disconnect,
      bool? delete,
      ReviewUpdateWithoutAbuseReportsInput? update}) {
    return ReviewUpdateOneWithoutAbuseReportsInput(
