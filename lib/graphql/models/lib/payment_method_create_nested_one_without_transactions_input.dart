...
class PaymentMethodCreateNestedOneWithoutTransactionsInput extends Equatable {
  ...
  PaymentMethodCreateNestedOneWithoutTransactionsInput(
      {this.create, this.connectOrCreate, this.connect});

  static PaymentMethodCreateNestedOneWithoutTransactionsInput fromJson(
      Map<dynamic, dynamic> json) {
    return PaymentMethodCreateNestedOneWithoutTransactionsInput(
  ...
  PaymentMethodCreateNestedOneWithoutTransactionsInput copyWith(
