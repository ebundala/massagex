...
class PaymentMethodCreateWithoutLogoInput extends Equatable {
  final String? id;
  final String name;
  ...
  PaymentMethodCreateWithoutLogoInput(
      {this.id,
      required this.name,
      this.description,
      required this.code,
  ...
  static PaymentMethodCreateWithoutLogoInput fromJson(
      Map<dynamic, dynamic> json) {
    return PaymentMethodCreateWithoutLogoInput(
      id: json['id'],
      name: json['name'],
  ...
  PaymentMethodCreateWithoutLogoInput copyWith(
      {String? id,
      String? name,
      String? description,
