...
import 'abuse_report_update_without_business_input.dart';
import 'abuse_report_create_without_business_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class AbuseReportUpsertWithWhereUniqueWithoutBusinessInput extends Equatable {
  final AbuseReportWhereUniqueInput where;
  final AbuseReportUpdateWithoutBusinessInput update;
  final AbuseReportCreateWithoutBusinessInput create;
  ...
  AbuseReportUpsertWithWhereUniqueWithoutBusinessInput(
      {required this.where, required this.update, required this.create});

  static AbuseReportUpsertWithWhereUniqueWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpsertWithWhereUniqueWithoutBusinessInput(
      where: AbuseReportWhereUniqueInput.fromJson(json['where']),
      update: AbuseReportUpdateWithoutBusinessInput.fromJson(json['update']),
      create: AbuseReportCreateWithoutBusinessInput.fromJson(json['create']),
    );
  }
  ...
  AbuseReportUpsertWithWhereUniqueWithoutBusinessInput copyWith(
      {AbuseReportWhereUniqueInput? where,
      AbuseReportUpdateWithoutBusinessInput? update,
      AbuseReportCreateWithoutBusinessInput? create}) {
    return AbuseReportUpsertWithWhereUniqueWithoutBusinessInput(
