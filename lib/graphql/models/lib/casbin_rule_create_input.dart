...
class CasbinRuleCreateInput extends Equatable {
  final String ptype;
  final String? v0;
  final String? v1;
  final String? v2;
  ...
  static CasbinRuleCreateInput fromJson(Map<dynamic, dynamic> json) {
    return CasbinRuleCreateInput(
      ptype: json['ptype'],
      v0: json['v0'],
      v1: json['v1'],
      v2: json['v2'],
  ...
  CasbinRuleCreateInput copyWith(
      {String? ptype,
      String? v0,
      String? v1,
      String? v2,
