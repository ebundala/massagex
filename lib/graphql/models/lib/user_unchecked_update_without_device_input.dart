...
class UserUncheckedUpdateWithoutDeviceInput extends Equatable {
  ...
  UserUncheckedUpdateWithoutDeviceInput(
      {this.id,
      this.email,
      this.displayName,
      this.phoneNumber,
  ...
  static UserUncheckedUpdateWithoutDeviceInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUncheckedUpdateWithoutDeviceInput(
      id: json['id'] != null
  ...
  UserUncheckedUpdateWithoutDeviceInput copyWith(
