...
class CategoryUncheckedUpdateWithoutPictureInput extends Equatable {
  ...
  CategoryUncheckedUpdateWithoutPictureInput(
      {this.id,
      this.name,
      this.description,
      this.metadata,
  ...
  static CategoryUncheckedUpdateWithoutPictureInput fromJson(
      Map<dynamic, dynamic> json) {
    return CategoryUncheckedUpdateWithoutPictureInput(
      id: json['id'] != null
  ...
  CategoryUncheckedUpdateWithoutPictureInput copyWith(
