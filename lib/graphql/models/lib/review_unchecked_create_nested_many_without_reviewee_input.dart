...
class ReviewUncheckedCreateNestedManyWithoutRevieweeInput extends Equatable {
  ...
  ReviewUncheckedCreateNestedManyWithoutRevieweeInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static ReviewUncheckedCreateNestedManyWithoutRevieweeInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewUncheckedCreateNestedManyWithoutRevieweeInput(
  ...
  ReviewUncheckedCreateNestedManyWithoutRevieweeInput copyWith(
