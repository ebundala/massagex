...
class PaymentMethodUncheckedUpdateWithoutLogoInput extends Equatable {
  ...
  PaymentMethodUncheckedUpdateWithoutLogoInput(
      {this.id,
      this.name,
      this.description,
      this.code,
  ...
  static PaymentMethodUncheckedUpdateWithoutLogoInput fromJson(
      Map<dynamic, dynamic> json) {
    return PaymentMethodUncheckedUpdateWithoutLogoInput(
      id: json['id'] != null
  ...
  PaymentMethodUncheckedUpdateWithoutLogoInput copyWith(
