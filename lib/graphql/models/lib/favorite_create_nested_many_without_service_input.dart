...
class FavoriteCreateNestedManyWithoutServiceInput extends Equatable {
  ...
  FavoriteCreateNestedManyWithoutServiceInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static FavoriteCreateNestedManyWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteCreateNestedManyWithoutServiceInput(
  ...
  FavoriteCreateNestedManyWithoutServiceInput copyWith(
