...
class DeviceCreateManyInput extends Equatable {
  final String id;
  final String? fcm$id;
  final String? type;
  final String? userId;
  ...
  static DeviceCreateManyInput fromJson(Map<dynamic, dynamic> json) {
    return DeviceCreateManyInput(
      id: json['id'],
      fcm$id: json['fcm_id'],
      type: json['type'],
      userId: json['userId'],
  ...
  DeviceCreateManyInput copyWith(
      {String? id,
      String? fcm$id,
      String? type,
      String? userId,
