...
class OrderCreateNestedOneWithoutTransactionsInput extends Equatable {
  ...
  OrderCreateNestedOneWithoutTransactionsInput(
      {this.create, this.connectOrCreate, this.connect});

  static OrderCreateNestedOneWithoutTransactionsInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderCreateNestedOneWithoutTransactionsInput(
  ...
  OrderCreateNestedOneWithoutTransactionsInput copyWith(
