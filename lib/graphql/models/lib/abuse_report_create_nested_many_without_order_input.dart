...
class AbuseReportCreateNestedManyWithoutOrderInput extends Equatable {
  ...
  AbuseReportCreateNestedManyWithoutOrderInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static AbuseReportCreateNestedManyWithoutOrderInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportCreateNestedManyWithoutOrderInput(
  ...
  AbuseReportCreateNestedManyWithoutOrderInput copyWith(
