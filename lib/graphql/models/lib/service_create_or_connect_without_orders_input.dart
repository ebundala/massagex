...
class ServiceCreateOrConnectWithoutOrdersInput extends Equatable {
  ...
  ServiceCreateOrConnectWithoutOrdersInput(
      {required this.where, required this.create});

  static ServiceCreateOrConnectWithoutOrdersInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceCreateOrConnectWithoutOrdersInput(
  ...
  ServiceCreateOrConnectWithoutOrdersInput copyWith(
