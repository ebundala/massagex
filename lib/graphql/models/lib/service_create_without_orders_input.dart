...
class ServiceCreateWithoutOrdersInput extends Equatable {
  final String? id;
  final String name;
  ...
  ServiceCreateWithoutOrdersInput(
      {this.id,
      required this.name,
      this.description,
      required this.price,
  ...
  static ServiceCreateWithoutOrdersInput fromJson(Map<dynamic, dynamic> json) {
    return ServiceCreateWithoutOrdersInput(
      id: json['id'],
      name: json['name'],
  ...
  ServiceCreateWithoutOrdersInput copyWith(
      {String? id,
      String? name,
      String? description,
      double? price,
