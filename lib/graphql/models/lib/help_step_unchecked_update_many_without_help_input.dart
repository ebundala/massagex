...
class HelpStepUncheckedUpdateManyWithoutHelpInput extends Equatable {
  ...
  HelpStepUncheckedUpdateManyWithoutHelpInput(
      {this.create,
  ...
  static HelpStepUncheckedUpdateManyWithoutHelpInput fromJson(
      Map<dynamic, dynamic> json) {
    return HelpStepUncheckedUpdateManyWithoutHelpInput(
  ...
  HelpStepUncheckedUpdateManyWithoutHelpInput copyWith(
