...
class CommentCreateWithoutFavoritesInput extends Equatable {
  final String? id;
  ...
  CommentCreateWithoutFavoritesInput(
      {this.id,
  ...
  static CommentCreateWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentCreateWithoutFavoritesInput(
      id: json['id'],
  ...
  CommentCreateWithoutFavoritesInput copyWith(
      {String? id,
