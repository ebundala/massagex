...
import 'transaction_create_nested_one_without_selcom_payment_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class SelcomPaymentCreateInput extends Equatable {
  final String? id;
  ...
  final TransactionCreateNestedOneWithoutSelcomPaymentInput? transaction;
  ...
  static SelcomPaymentCreateInput fromJson(Map<dynamic, dynamic> json) {
    return SelcomPaymentCreateInput(
      id: json['id'],
      ...
      transaction: json['transaction'] != null
          ? TransactionCreateNestedOneWithoutSelcomPaymentInput.fromJson(
              json['transaction'])
          : null,
    );
  }
  ...
  SelcomPaymentCreateInput copyWith(
      {String? id,
      String? transId,
      int? amount,
      String? msisdn,
      ...
      DateTime? createdAt,
      DateTime? updatedAt,
      TransactionCreateNestedOneWithoutSelcomPaymentInput? transaction}) {
    return SelcomPaymentCreateInput(
        id: id ?? this.id,
