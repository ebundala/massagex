...
class AttachmentUncheckedUpdateManyWithoutAttachmentsInput extends Equatable {
  ...
  AttachmentUncheckedUpdateManyWithoutAttachmentsInput(
      {this.id,
      this.path,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUncheckedUpdateManyWithoutAttachmentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedUpdateManyWithoutAttachmentsInput(
      id: json['id'] != null
  ...
  AttachmentUncheckedUpdateManyWithoutAttachmentsInput copyWith(
