...
class OrderUncheckedUpdateWithoutTransactionsInput extends Equatable {
  ...
  static OrderUncheckedUpdateWithoutTransactionsInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUncheckedUpdateWithoutTransactionsInput(
      id: json['id'] != null
  ...
  OrderUncheckedUpdateWithoutTransactionsInput copyWith(
