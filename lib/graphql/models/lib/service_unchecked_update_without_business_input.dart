...
class ServiceUncheckedUpdateWithoutBusinessInput extends Equatable {
  ...
  ServiceUncheckedUpdateWithoutBusinessInput(
      {this.id,
      this.name,
      this.description,
      this.price,
  ...
  static ServiceUncheckedUpdateWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUncheckedUpdateWithoutBusinessInput(
      id: json['id'] != null
  ...
  ServiceUncheckedUpdateWithoutBusinessInput copyWith(
