...
class AttachmentCreateNestedOneWithoutBusinessesInput extends Equatable {
  ...
  static AttachmentCreateNestedOneWithoutBusinessesInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateNestedOneWithoutBusinessesInput(
  ...
  AttachmentCreateNestedOneWithoutBusinessesInput copyWith(
