...
class AbuseReportUpdateWithWhereUniqueWithoutCommentInput extends Equatable {
  final AbuseReportWhereUniqueInput where;
  final AbuseReportUpdateWithoutCommentInput data;
  ...
  AbuseReportUpdateWithWhereUniqueWithoutCommentInput(
      {required this.where, required this.data});

  static AbuseReportUpdateWithWhereUniqueWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpdateWithWhereUniqueWithoutCommentInput(
      where: AbuseReportWhereUniqueInput.fromJson(json['where']),
      data: AbuseReportUpdateWithoutCommentInput.fromJson(json['data']),
    );
  }
  ...
  AbuseReportUpdateWithWhereUniqueWithoutCommentInput copyWith(
      {AbuseReportWhereUniqueInput? where,
      AbuseReportUpdateWithoutCommentInput? data}) {
    return AbuseReportUpdateWithWhereUniqueWithoutCommentInput(
