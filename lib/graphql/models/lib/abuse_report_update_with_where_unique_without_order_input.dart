...
class AbuseReportUpdateWithWhereUniqueWithoutOrderInput extends Equatable {
  final AbuseReportWhereUniqueInput where;
  final AbuseReportUpdateWithoutOrderInput data;
  ...
  AbuseReportUpdateWithWhereUniqueWithoutOrderInput(
      {required this.where, required this.data});

  static AbuseReportUpdateWithWhereUniqueWithoutOrderInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpdateWithWhereUniqueWithoutOrderInput(
      where: AbuseReportWhereUniqueInput.fromJson(json['where']),
      data: AbuseReportUpdateWithoutOrderInput.fromJson(json['data']),
    );
  }
  ...
  AbuseReportUpdateWithWhereUniqueWithoutOrderInput copyWith(
      {AbuseReportWhereUniqueInput? where,
      AbuseReportUpdateWithoutOrderInput? data}) {
    return AbuseReportUpdateWithWhereUniqueWithoutOrderInput(
