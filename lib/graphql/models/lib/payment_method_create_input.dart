...
import 'attachment_create_nested_one_without_payment_methods_input.dart';
import 'transaction_create_nested_many_without_payment_method_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class PaymentMethodCreateInput extends Equatable {
  final String? id;
  final String name;
  ...
  final AttachmentCreateNestedOneWithoutPaymentMethodsInput logo;
  final TransactionCreateNestedManyWithoutPaymentMethodInput? transactions;
  ...
  static PaymentMethodCreateInput fromJson(Map<dynamic, dynamic> json) {
    return PaymentMethodCreateInput(
      ...
      logo: AttachmentCreateNestedOneWithoutPaymentMethodsInput.fromJson(
          json['logo']),
      transactions: json['transactions'] != null
          ? TransactionCreateNestedManyWithoutPaymentMethodInput.fromJson(
              json['transactions'])
          : null,
    );
  }
  ...
  PaymentMethodCreateInput copyWith(
      {String? id,
      String? name,
      String? description,
      ...
      DateTime? createdAt,
      DateTime? updatedAt,
      AttachmentCreateNestedOneWithoutPaymentMethodsInput? logo,
      TransactionCreateNestedManyWithoutPaymentMethodInput? transactions}) {
    return PaymentMethodCreateInput(
        id: id ?? this.id,
        name: name ?? this.name,
