...
class UserCreateNestedOneWithoutBusinessProfileInput extends Equatable {
  ...
  UserCreateNestedOneWithoutBusinessProfileInput(
      {this.create, this.connectOrCreate, this.connect});

  static UserCreateNestedOneWithoutBusinessProfileInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserCreateNestedOneWithoutBusinessProfileInput(
  ...
  UserCreateNestedOneWithoutBusinessProfileInput copyWith(
