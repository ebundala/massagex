...
class TransactionUncheckedUpdateManyInput extends Equatable {
  ...
  static TransactionUncheckedUpdateManyInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUncheckedUpdateManyInput(
      id: json['id'] != null
  ...
  TransactionUncheckedUpdateManyInput copyWith(
