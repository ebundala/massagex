...
class FavoriteUncheckedCreateWithoutAuthorInput extends Equatable {
  final String? id;
  final String favId;
  final String typeId;
  ...
  FavoriteUncheckedCreateWithoutAuthorInput(
      {this.id,
      required this.favId,
  ...
  static FavoriteUncheckedCreateWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedCreateWithoutAuthorInput(
      id: json['id'],
      favId: json['favId'],
      typeId: json['typeId'],
  ...
  FavoriteUncheckedCreateWithoutAuthorInput copyWith(
      {String? id,
      String? favId,
      String? typeId,
