...
class BusinessCreateWithoutOrdersInput extends Equatable {
  final String? id;
  ...
  static BusinessCreateWithoutOrdersInput fromJson(Map<dynamic, dynamic> json) {
    return BusinessCreateWithoutOrdersInput(
      id: json['id'],
      mode:
  ...
  BusinessCreateWithoutOrdersInput copyWith(
      {String? id,
      BusinessMode? mode,
      String? about,
      String? businessName,
