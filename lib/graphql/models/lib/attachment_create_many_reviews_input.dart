...
class AttachmentCreateManyReviewsInput extends Equatable {
  ...
  AttachmentCreateManyReviewsInput(
      {required this.path,
      this.id,
      this.filename,
      this.mimetype,
  ...
  static AttachmentCreateManyReviewsInput fromJson(Map<dynamic, dynamic> json) {
    return AttachmentCreateManyReviewsInput(
      path: json['path'],
      id: json['id'],
  ...
  AttachmentCreateManyReviewsInput copyWith(
      {MultipartFile? path,
      String? id,
      String? filename,
      String? mimetype,
