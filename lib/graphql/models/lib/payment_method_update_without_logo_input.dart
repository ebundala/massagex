...
class PaymentMethodUpdateWithoutLogoInput extends Equatable {
  ...
  PaymentMethodUpdateWithoutLogoInput(
      {this.id,
      this.name,
      this.description,
      this.code,
  ...
  static PaymentMethodUpdateWithoutLogoInput fromJson(
      Map<dynamic, dynamic> json) {
    return PaymentMethodUpdateWithoutLogoInput(
      id: json['id'] != null
  ...
  PaymentMethodUpdateWithoutLogoInput copyWith(
