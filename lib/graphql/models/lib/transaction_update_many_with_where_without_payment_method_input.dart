...
import 'transaction_update_many_mutation_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class TransactionUpdateManyWithWhereWithoutPaymentMethodInput
    extends Equatable {
  ...
  static TransactionUpdateManyWithWhereWithoutPaymentMethodInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUpdateManyWithWhereWithoutPaymentMethodInput(
      where: TransactionScalarWhereInput.fromJson(json['where']),
      data: TransactionUpdateManyMutationInput.fromJson(json['data']),
    );
  }
  ...
  TransactionUpdateManyWithWhereWithoutPaymentMethodInput copyWith(
      {TransactionScalarWhereInput? where,
      TransactionUpdateManyMutationInput? data}) {
    return TransactionUpdateManyWithWhereWithoutPaymentMethodInput(
