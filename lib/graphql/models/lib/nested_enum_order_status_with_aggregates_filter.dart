...
class NestedEnumOrderStatusWithAggregatesFilter extends Equatable {
  ...
  static NestedEnumOrderStatusWithAggregatesFilter fromJson(
      Map<dynamic, dynamic> json) {
    return NestedEnumOrderStatusWithAggregatesFilter(
  ...
  NestedEnumOrderStatusWithAggregatesFilter copyWith(
      {OrderStatus? equals,
      List<OrderStatus>? in$,
