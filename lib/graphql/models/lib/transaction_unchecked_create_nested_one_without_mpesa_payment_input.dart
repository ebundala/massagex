...
class TransactionUncheckedCreateNestedOneWithoutMpesaPaymentInput
    extends Equatable {
  ...
  static TransactionUncheckedCreateNestedOneWithoutMpesaPaymentInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUncheckedCreateNestedOneWithoutMpesaPaymentInput(
  ...
  TransactionUncheckedCreateNestedOneWithoutMpesaPaymentInput copyWith(
