import 'abuse_report_create_without_comment_input.dart';
import 'abuse_report_create_or_connect_without_comment_input.dart';
import 'abuse_report_upsert_with_where_unique_without_comment_input.dart';
import 'abuse_report_create_many_comment_input_envelope.dart';
import 'abuse_report_where_unique_input.dart';
import 'abuse_report_update_with_where_unique_without_comment_input.dart';
import 'abuse_report_update_many_with_where_without_comment_input.dart';
import 'abuse_report_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class AbuseReportUncheckedUpdateManyWithoutCommentInput extends Equatable {
  final List<AbuseReportCreateWithoutCommentInput>? create;
  final List<AbuseReportCreateOrConnectWithoutCommentInput>? connectOrCreate;
  final List<AbuseReportUpsertWithWhereUniqueWithoutCommentInput>? upsert;
  final AbuseReportCreateManyCommentInputEnvelope? createMany;
  ...
  final List<AbuseReportUpdateWithWhereUniqueWithoutCommentInput>? update;
  final List<AbuseReportUpdateManyWithWhereWithoutCommentInput>? updateMany;
  ...
  AbuseReportUncheckedUpdateManyWithoutCommentInput(
      {this.create,
  ...
  static AbuseReportUncheckedUpdateManyWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedUpdateManyWithoutCommentInput(
      create: json['create'] != null
          ? List.generate(
              json['create'].length,
              (index) => AbuseReportCreateWithoutCommentInput.fromJson(
                  json['create'][index]))
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? List.generate(
              json['connectOrCreate'].length,
              (index) => AbuseReportCreateOrConnectWithoutCommentInput.fromJson(
      ...
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) =>
                  AbuseReportUpsertWithWhereUniqueWithoutCommentInput.fromJson(
                      json['upsert'][index]))
          : null,
      createMany: json['createMany'] != null
          ? AbuseReportCreateManyCommentInputEnvelope.fromJson(
              json['createMany'])
          : null,
      ...
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) =>
                  AbuseReportUpdateWithWhereUniqueWithoutCommentInput.fromJson(
                      json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              ...
              (index) =>
                  AbuseReportUpdateManyWithWhereWithoutCommentInput.fromJson(
  ...
  AbuseReportUncheckedUpdateManyWithoutCommentInput copyWith(
      {List<AbuseReportCreateWithoutCommentInput>? create,
      List<AbuseReportCreateOrConnectWithoutCommentInput>? connectOrCreate,
      List<AbuseReportUpsertWithWhereUniqueWithoutCommentInput>? upsert,
      AbuseReportCreateManyCommentInputEnvelope? createMany,
      ...
      List<AbuseReportUpdateWithWhereUniqueWithoutCommentInput>? update,
      List<AbuseReportUpdateManyWithWhereWithoutCommentInput>? updateMany,
