...
class AttachmentCreateWithoutUsersInput extends Equatable {
  ...
  AttachmentCreateWithoutUsersInput(
      {required this.path,
      this.id,
      this.filename,
      this.mimetype,
  ...
  static AttachmentCreateWithoutUsersInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateWithoutUsersInput(
      path: json['path'],
      id: json['id'],
  ...
  AttachmentCreateWithoutUsersInput copyWith(
      {MultipartFile? path,
      String? id,
      String? filename,
      String? mimetype,
