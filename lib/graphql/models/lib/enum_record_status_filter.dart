...
class EnumRecordStatusFilter extends Equatable {
  ...
  EnumRecordStatusFilter({this.equals, this.in$, this.notIn, this.not});

  static EnumRecordStatusFilter fromJson(Map<dynamic, dynamic> json) {
    return EnumRecordStatusFilter(
  ...
  EnumRecordStatusFilter copyWith(
      {RecordStatus? equals,
