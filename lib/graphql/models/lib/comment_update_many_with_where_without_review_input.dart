...
import 'comment_update_many_mutation_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class CommentUpdateManyWithWhereWithoutReviewInput extends Equatable {
  ...
  CommentUpdateManyWithWhereWithoutReviewInput(
      {required this.where, required this.data});

  static CommentUpdateManyWithWhereWithoutReviewInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUpdateManyWithWhereWithoutReviewInput(
      where: CommentScalarWhereInput.fromJson(json['where']),
      data: CommentUpdateManyMutationInput.fromJson(json['data']),
    );
  }
  ...
  CommentUpdateManyWithWhereWithoutReviewInput copyWith(
      {CommentScalarWhereInput? where, CommentUpdateManyMutationInput? data}) {
    return CommentUpdateManyWithWhereWithoutReviewInput(
