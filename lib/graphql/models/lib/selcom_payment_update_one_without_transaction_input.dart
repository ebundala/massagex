...
import 'selcom_payment_create_or_connect_without_transaction_input.dart';
import 'selcom_payment_upsert_without_transaction_input.dart';
import 'selcom_payment_where_unique_input.dart';
import 'selcom_payment_update_without_transaction_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class SelcomPaymentUpdateOneWithoutTransactionInput extends Equatable {
  final SelcomPaymentCreateWithoutTransactionInput? create;
  final SelcomPaymentCreateOrConnectWithoutTransactionInput? connectOrCreate;
  final SelcomPaymentUpsertWithoutTransactionInput? upsert;
  final SelcomPaymentWhereUniqueInput? connect;
  final bool? disconnect;
  final bool? delete;
  final SelcomPaymentUpdateWithoutTransactionInput? update;
  ...
  SelcomPaymentUpdateOneWithoutTransactionInput(
      {this.create,
  ...
  static SelcomPaymentUpdateOneWithoutTransactionInput fromJson(
      Map<dynamic, dynamic> json) {
    return SelcomPaymentUpdateOneWithoutTransactionInput(
      create: json['create'] != null
          ? SelcomPaymentCreateWithoutTransactionInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? SelcomPaymentCreateOrConnectWithoutTransactionInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? SelcomPaymentUpsertWithoutTransactionInput.fromJson(json['upsert'])
          : null,
      connect: json['connect'] != null
          ? SelcomPaymentWhereUniqueInput.fromJson(json['connect'])
          : null,
      disconnect: json['disconnect'],
      delete: json['delete'],
      update: json['update'] != null
          ? SelcomPaymentUpdateWithoutTransactionInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  SelcomPaymentUpdateOneWithoutTransactionInput copyWith(
      {SelcomPaymentCreateWithoutTransactionInput? create,
      SelcomPaymentCreateOrConnectWithoutTransactionInput? connectOrCreate,
      SelcomPaymentUpsertWithoutTransactionInput? upsert,
      SelcomPaymentWhereUniqueInput? connect,
      bool? disconnect,
      bool? delete,
      SelcomPaymentUpdateWithoutTransactionInput? update}) {
    return SelcomPaymentUpdateOneWithoutTransactionInput(
