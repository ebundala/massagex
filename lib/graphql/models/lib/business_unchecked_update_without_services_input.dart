...
class BusinessUncheckedUpdateWithoutServicesInput extends Equatable {
  ...
  BusinessUncheckedUpdateWithoutServicesInput(
      {this.id,
      this.ownerId,
      this.mode,
      this.coverId,
  ...
  static BusinessUncheckedUpdateWithoutServicesInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUncheckedUpdateWithoutServicesInput(
      id: json['id'] != null
  ...
  BusinessUncheckedUpdateWithoutServicesInput copyWith(
