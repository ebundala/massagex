...
class LocationCreateNestedOneWithoutBusinessesInput extends Equatable {
  ...
  static LocationCreateNestedOneWithoutBusinessesInput fromJson(
      Map<dynamic, dynamic> json) {
    return LocationCreateNestedOneWithoutBusinessesInput(
  ...
  LocationCreateNestedOneWithoutBusinessesInput copyWith(
