...
class OrderUncheckedUpdateManyWithoutOrderedInput extends Equatable {
  ...
  OrderUncheckedUpdateManyWithoutOrderedInput(
      {this.id,
      this.quantity,
      this.recordStatus,
      this.orderStatus,
  ...
  static OrderUncheckedUpdateManyWithoutOrderedInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUncheckedUpdateManyWithoutOrderedInput(
      id: json['id'] != null
  ...
  OrderUncheckedUpdateManyWithoutOrderedInput copyWith(
