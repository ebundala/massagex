...
class AbuseRecordTypeUpdateManyMutationInput extends Equatable {
  ...
  AbuseRecordTypeUpdateManyMutationInput({this.id, this.name});

  static AbuseRecordTypeUpdateManyMutationInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseRecordTypeUpdateManyMutationInput(
      id: json['id'] != null
  ...
  AbuseRecordTypeUpdateManyMutationInput copyWith(
