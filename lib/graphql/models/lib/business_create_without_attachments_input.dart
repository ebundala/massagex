...
class BusinessCreateWithoutAttachmentsInput extends Equatable {
  final String? id;
  ...
  BusinessCreateWithoutAttachmentsInput(
      {this.id,
      this.mode,
      required this.about,
  ...
  static BusinessCreateWithoutAttachmentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessCreateWithoutAttachmentsInput(
      id: json['id'],
      mode:
  ...
  BusinessCreateWithoutAttachmentsInput copyWith(
      {String? id,
      BusinessMode? mode,
      String? about,
      String? businessName,
