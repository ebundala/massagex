...
class TransactionUpsertWithoutMpesaPaymentInput extends Equatable {
  ...
  TransactionUpsertWithoutMpesaPaymentInput(
      {required this.update, required this.create});

  static TransactionUpsertWithoutMpesaPaymentInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUpsertWithoutMpesaPaymentInput(
      update:
  ...
  TransactionUpsertWithoutMpesaPaymentInput copyWith(
