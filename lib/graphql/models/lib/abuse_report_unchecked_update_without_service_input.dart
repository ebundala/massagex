...
class AbuseReportUncheckedUpdateWithoutServiceInput extends Equatable {
  ...
  AbuseReportUncheckedUpdateWithoutServiceInput(
      {this.id,
      this.number,
      this.report,
      this.authorId,
  ...
  static AbuseReportUncheckedUpdateWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedUpdateWithoutServiceInput(
      id: json['id'] != null
  ...
  AbuseReportUncheckedUpdateWithoutServiceInput copyWith(
