...
import 'favorite_update_without_business_input.dart';
import 'favorite_create_without_business_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class FavoriteUpsertWithWhereUniqueWithoutBusinessInput extends Equatable {
  final FavoriteWhereUniqueInput where;
  final FavoriteUpdateWithoutBusinessInput update;
  final FavoriteCreateWithoutBusinessInput create;
  ...
  FavoriteUpsertWithWhereUniqueWithoutBusinessInput(
      {required this.where, required this.update, required this.create});

  static FavoriteUpsertWithWhereUniqueWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUpsertWithWhereUniqueWithoutBusinessInput(
      where: FavoriteWhereUniqueInput.fromJson(json['where']),
      update: FavoriteUpdateWithoutBusinessInput.fromJson(json['update']),
      create: FavoriteCreateWithoutBusinessInput.fromJson(json['create']),
    );
  }
  ...
  FavoriteUpsertWithWhereUniqueWithoutBusinessInput copyWith(
      {FavoriteWhereUniqueInput? where,
      FavoriteUpdateWithoutBusinessInput? update,
      FavoriteCreateWithoutBusinessInput? create}) {
    return FavoriteUpsertWithWhereUniqueWithoutBusinessInput(
