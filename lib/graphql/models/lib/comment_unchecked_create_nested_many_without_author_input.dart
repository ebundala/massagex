...
class CommentUncheckedCreateNestedManyWithoutAuthorInput extends Equatable {
  ...
  static CommentUncheckedCreateNestedManyWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUncheckedCreateNestedManyWithoutAuthorInput(
  ...
  CommentUncheckedCreateNestedManyWithoutAuthorInput copyWith(
