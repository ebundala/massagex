...
class ServiceUpdateWithoutCategoryInput extends Equatable {
  ...
  static ServiceUpdateWithoutCategoryInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUpdateWithoutCategoryInput(
      id: json['id'] != null
  ...
  ServiceUpdateWithoutCategoryInput copyWith(
