...
class EnumAttachmentTypeFilter extends Equatable {
  final AttachmentType? equals;
  final List<AttachmentType>? in$;
  final List<AttachmentType>? notIn;
  final NestedEnumAttachmentTypeFilter? not;
  ...
  EnumAttachmentTypeFilter({this.equals, this.in$, this.notIn, this.not});

  static EnumAttachmentTypeFilter fromJson(Map<dynamic, dynamic> json) {
    return EnumAttachmentTypeFilter(
      ...
      notIn: json['notIn'] != null
          ...
          : null,
      not: json['not'] != null
          ? NestedEnumAttachmentTypeFilter.fromJson(json['not'])
          : null,
    );
  }
