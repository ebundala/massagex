...
class FavoriteCreateNestedManyWithoutUserInput extends Equatable {
  ...
  FavoriteCreateNestedManyWithoutUserInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static FavoriteCreateNestedManyWithoutUserInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteCreateNestedManyWithoutUserInput(
  ...
  FavoriteCreateNestedManyWithoutUserInput copyWith(
