...
class NestedIntWithAggregatesFilter extends Equatable {
  final int? equals;
  final List<int>? in$;
  ...
  static NestedIntWithAggregatesFilter fromJson(Map<dynamic, dynamic> json) {
    return NestedIntWithAggregatesFilter(
      equals: json['equals'],
      in$: json['in'] != null
          ? List.generate(
  ...
  NestedIntWithAggregatesFilter copyWith(
      {int? equals,
      List<int>? in$,
      List<int>? notIn,
      int? lt,
