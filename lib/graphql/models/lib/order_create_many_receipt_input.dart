...
class OrderCreateManyReceiptInput extends Equatable {
  final String? id;
  final int quantity;
  ...
  static OrderCreateManyReceiptInput fromJson(Map<dynamic, dynamic> json) {
    return OrderCreateManyReceiptInput(
      id: json['id'],
  ...
  OrderCreateManyReceiptInput copyWith(
      {String? id,
      int? quantity,
