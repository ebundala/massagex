...
class TransactionBatchResponse extends Equatable {
  final bool? status;
  final BatchPayload? data;
  final String? message;
  TransactionBatchResponse({this.status, this.data, this.message});

  static TransactionBatchResponse fromJson(Map<dynamic, dynamic> json) {
  ...
  TransactionBatchResponse copyWith(
