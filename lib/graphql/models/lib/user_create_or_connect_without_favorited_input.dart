...
class UserCreateOrConnectWithoutFavoritedInput extends Equatable {
  ...
  UserCreateOrConnectWithoutFavoritedInput(
      {required this.where, required this.create});

  static UserCreateOrConnectWithoutFavoritedInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserCreateOrConnectWithoutFavoritedInput(
  ...
  UserCreateOrConnectWithoutFavoritedInput copyWith(
      {UserWhereUniqueInput? where, UserCreateWithoutFavoritedInput? create}) {
    return UserCreateOrConnectWithoutFavoritedInput(
