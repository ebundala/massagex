...
class FavoriteUpdateManyWithWhereWithoutReviewInput extends Equatable {
  ...
  FavoriteUpdateManyWithWhereWithoutReviewInput(
      {required this.where, required this.data});

  static FavoriteUpdateManyWithWhereWithoutReviewInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUpdateManyWithWhereWithoutReviewInput(
  ...
  FavoriteUpdateManyWithWhereWithoutReviewInput copyWith(
