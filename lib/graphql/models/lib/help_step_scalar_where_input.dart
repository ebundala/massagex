...
class HelpStepScalarWhereInput extends Equatable {
  final List<HelpStepScalarWhereInput>? AND;
  final List<HelpStepScalarWhereInput>? OR;
  final List<HelpStepScalarWhereInput>? NOT;
  ...
  static HelpStepScalarWhereInput fromJson(Map<dynamic, dynamic> json) {
    return HelpStepScalarWhereInput(
      AND: json['AND'] != null
          ? List.generate(json['AND'].length,
              (index) => HelpStepScalarWhereInput.fromJson(json['AND'][index]))
          : null,
      OR: json['OR'] != null
          ? List.generate(json['OR'].length,
              (index) => HelpStepScalarWhereInput.fromJson(json['OR'][index]))
          : null,
      NOT: json['NOT'] != null
          ? List.generate(json['NOT'].length,
              (index) => HelpStepScalarWhereInput.fromJson(json['NOT'][index]))
          : null,
  ...
  HelpStepScalarWhereInput copyWith(
      {List<HelpStepScalarWhereInput>? AND,
      List<HelpStepScalarWhereInput>? OR,
      List<HelpStepScalarWhereInput>? NOT,
      StringFilter? id,
