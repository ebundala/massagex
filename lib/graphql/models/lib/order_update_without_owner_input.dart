...
class OrderUpdateWithoutOwnerInput extends Equatable {
  ...
  static OrderUpdateWithoutOwnerInput fromJson(Map<dynamic, dynamic> json) {
    return OrderUpdateWithoutOwnerInput(
      id: json['id'] != null
  ...
  OrderUpdateWithoutOwnerInput copyWith(
