...
import 'user_upsert_with_where_unique_without_avator_input.dart';
import 'user_create_many_avator_input_envelope.dart';
import 'user_where_unique_input.dart';
import 'user_update_with_where_unique_without_avator_input.dart';
import 'user_update_many_with_where_without_avator_input.dart';
import 'user_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class UserUncheckedUpdateManyWithoutAvatorInput extends Equatable {
  final List<UserCreateWithoutAvatorInput>? create;
  final List<UserCreateOrConnectWithoutAvatorInput>? connectOrCreate;
  final List<UserUpsertWithWhereUniqueWithoutAvatorInput>? upsert;
  ...
  final List<UserUpdateWithWhereUniqueWithoutAvatorInput>? update;
  final List<UserUpdateManyWithWhereWithoutAvatorInput>? updateMany;
  ...
  UserUncheckedUpdateManyWithoutAvatorInput(
      {this.create,
  ...
  static UserUncheckedUpdateManyWithoutAvatorInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUncheckedUpdateManyWithoutAvatorInput(
      ...
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) => UserUpsertWithWhereUniqueWithoutAvatorInput.fromJson(
                  json['upsert'][index]))
          : null,
      ...
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) => UserUpdateWithWhereUniqueWithoutAvatorInput.fromJson(
                  json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              json['updateMany'].length,
              (index) => UserUpdateManyWithWhereWithoutAvatorInput.fromJson(
  ...
  UserUncheckedUpdateManyWithoutAvatorInput copyWith(
      {List<UserCreateWithoutAvatorInput>? create,
      List<UserCreateOrConnectWithoutAvatorInput>? connectOrCreate,
      List<UserUpsertWithWhereUniqueWithoutAvatorInput>? upsert,
      ...
      List<UserUpdateWithWhereUniqueWithoutAvatorInput>? update,
      List<UserUpdateManyWithWhereWithoutAvatorInput>? updateMany,
