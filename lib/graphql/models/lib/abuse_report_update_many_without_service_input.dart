...
class AbuseReportUpdateManyWithoutServiceInput extends Equatable {
  ...
  AbuseReportUpdateManyWithoutServiceInput(
      {this.create,
  ...
  static AbuseReportUpdateManyWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpdateManyWithoutServiceInput(
  ...
  AbuseReportUpdateManyWithoutServiceInput copyWith(
