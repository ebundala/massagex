...
class FavoriteCreateManyReviewInput extends Equatable {
  final String? id;
  final String favId;
  ...
  static FavoriteCreateManyReviewInput fromJson(Map<dynamic, dynamic> json) {
    return FavoriteCreateManyReviewInput(
      id: json['id'],
      favId: json['favId'],
  ...
  FavoriteCreateManyReviewInput copyWith(
      {String? id,
      String? favId,
      String? authorId,
      String? typeId,
