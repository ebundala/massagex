...
import 'favorite_create_or_connect_without_comment_input.dart';
import 'favorite_upsert_with_where_unique_without_comment_input.dart';
import 'favorite_create_many_comment_input_envelope.dart';
import 'favorite_where_unique_input.dart';
import 'favorite_update_with_where_unique_without_comment_input.dart';
import 'favorite_update_many_with_where_without_comment_input.dart';
import 'favorite_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class FavoriteUncheckedUpdateManyWithoutCommentInput extends Equatable {
  final List<FavoriteCreateWithoutCommentInput>? create;
  final List<FavoriteCreateOrConnectWithoutCommentInput>? connectOrCreate;
  final List<FavoriteUpsertWithWhereUniqueWithoutCommentInput>? upsert;
  final FavoriteCreateManyCommentInputEnvelope? createMany;
  ...
  final List<FavoriteUpdateWithWhereUniqueWithoutCommentInput>? update;
  final List<FavoriteUpdateManyWithWhereWithoutCommentInput>? updateMany;
  ...
  FavoriteUncheckedUpdateManyWithoutCommentInput(
      {this.create,
  ...
  static FavoriteUncheckedUpdateManyWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedUpdateManyWithoutCommentInput(
      create: json['create'] != null
          ? List.generate(
              json['create'].length,
              (index) => FavoriteCreateWithoutCommentInput.fromJson(
                  json['create'][index]))
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? List.generate(
              json['connectOrCreate'].length,
              (index) => FavoriteCreateOrConnectWithoutCommentInput.fromJson(
      ...
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) =>
                  FavoriteUpsertWithWhereUniqueWithoutCommentInput.fromJson(
                      json['upsert'][index]))
          : null,
      createMany: json['createMany'] != null
          ? FavoriteCreateManyCommentInputEnvelope.fromJson(json['createMany'])
          : null,
      ...
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) =>
                  FavoriteUpdateWithWhereUniqueWithoutCommentInput.fromJson(
                      json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              ...
              (index) =>
                  FavoriteUpdateManyWithWhereWithoutCommentInput.fromJson(
  ...
  FavoriteUncheckedUpdateManyWithoutCommentInput copyWith(
      {List<FavoriteCreateWithoutCommentInput>? create,
      List<FavoriteCreateOrConnectWithoutCommentInput>? connectOrCreate,
      List<FavoriteUpsertWithWhereUniqueWithoutCommentInput>? upsert,
      FavoriteCreateManyCommentInputEnvelope? createMany,
      ...
      List<FavoriteUpdateWithWhereUniqueWithoutCommentInput>? update,
      List<FavoriteUpdateManyWithWhereWithoutCommentInput>? updateMany,
