...
class BusinessUncheckedUpdateWithoutAttachmentsInput extends Equatable {
  ...
  BusinessUncheckedUpdateWithoutAttachmentsInput(
      {this.id,
      this.ownerId,
      this.mode,
      this.coverId,
  ...
  static BusinessUncheckedUpdateWithoutAttachmentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUncheckedUpdateWithoutAttachmentsInput(
      id: json['id'] != null
  ...
  BusinessUncheckedUpdateWithoutAttachmentsInput copyWith(
