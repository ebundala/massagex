...
class BusinessUpdateManyWithoutCoverInput extends Equatable {
  ...
  BusinessUpdateManyWithoutCoverInput(
      {this.create,
  ...
  static BusinessUpdateManyWithoutCoverInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUpdateManyWithoutCoverInput(
  ...
  BusinessUpdateManyWithoutCoverInput copyWith(
