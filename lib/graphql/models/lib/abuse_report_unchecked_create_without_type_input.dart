...
class AbuseReportUncheckedCreateWithoutTypeInput extends Equatable {
  final String? id;
  final int? number;
  final String? report;
  ...
  AbuseReportUncheckedCreateWithoutTypeInput(
      {this.id,
      this.number,
      this.report,
  ...
  static AbuseReportUncheckedCreateWithoutTypeInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedCreateWithoutTypeInput(
      id: json['id'],
      number: json['number'],
      report: json['report'],
  ...
  AbuseReportUncheckedCreateWithoutTypeInput copyWith(
      {String? id,
      int? number,
      String? report,
      String? authorId,
