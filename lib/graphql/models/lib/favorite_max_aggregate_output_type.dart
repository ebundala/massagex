...
class FavoriteMaxAggregateOutputType extends Equatable {
  final String? id;
  final String? favId;
  ...
  FavoriteMaxAggregateOutputType(
      {this.id,
      this.favId,
      this.authorId,
      this.typeId,
  ...
  static FavoriteMaxAggregateOutputType fromJson(Map<dynamic, dynamic> json) {
    return FavoriteMaxAggregateOutputType(
      id: json['id'],
      favId: json['favId'],
  ...
  FavoriteMaxAggregateOutputType copyWith(
      {String? id,
      String? favId,
      String? authorId,
      String? typeId,
...
extension FavoriteMaxAggregateOutputTypeExt on FavoriteMaxAggregateOutputType {
...
class FavoriteMaxAggregateOutputTypeController
    extends ValueNotifier<FavoriteMaxAggregateOutputType> {
  ...
  final FavoriteMaxAggregateOutputType initialValue;
  final SelectionSetNode selectionSet;
  final Map<String, SelectionNodeData> selections = {};
  FavoriteMaxAggregateOutputTypeController({
