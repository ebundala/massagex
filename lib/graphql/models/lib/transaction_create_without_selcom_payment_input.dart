...
class TransactionCreateWithoutSelcomPaymentInput extends Equatable {
  final String? id;
  ...
  TransactionCreateWithoutSelcomPaymentInput(
      {this.id,
      required this.type,
      this.status,
      this.recordStatus,
  ...
  static TransactionCreateWithoutSelcomPaymentInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionCreateWithoutSelcomPaymentInput(
      id: json['id'],
  ...
  TransactionCreateWithoutSelcomPaymentInput copyWith(
      {String? id,
