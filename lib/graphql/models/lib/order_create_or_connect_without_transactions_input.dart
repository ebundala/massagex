...
class OrderCreateOrConnectWithoutTransactionsInput extends Equatable {
  ...
  OrderCreateOrConnectWithoutTransactionsInput(
      {required this.where, required this.create});

  static OrderCreateOrConnectWithoutTransactionsInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderCreateOrConnectWithoutTransactionsInput(
  ...
  OrderCreateOrConnectWithoutTransactionsInput copyWith(
