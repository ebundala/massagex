...
class AbuseReportUncheckedUpdateInput extends Equatable {
  ...
  AbuseReportUncheckedUpdateInput(
      {this.id,
      this.number,
      this.report,
      this.authorId,
  ...
  static AbuseReportUncheckedUpdateInput fromJson(Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedUpdateInput(
      id: json['id'] != null
  ...
  AbuseReportUncheckedUpdateInput copyWith(
