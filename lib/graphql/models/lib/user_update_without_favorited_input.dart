...
class UserUpdateWithoutFavoritedInput extends Equatable {
  ...
  UserUpdateWithoutFavoritedInput(
      {this.id,
      this.email,
      this.displayName,
      this.phoneNumber,
  ...
  static UserUpdateWithoutFavoritedInput fromJson(Map<dynamic, dynamic> json) {
    return UserUpdateWithoutFavoritedInput(
      id: json['id'] != null
  ...
  UserUpdateWithoutFavoritedInput copyWith(
