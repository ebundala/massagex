...
class UserCreateOrConnectWithoutOrderedInput extends Equatable {
  ...
  UserCreateOrConnectWithoutOrderedInput(
      {required this.where, required this.create});

  static UserCreateOrConnectWithoutOrderedInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserCreateOrConnectWithoutOrderedInput(
  ...
  UserCreateOrConnectWithoutOrderedInput copyWith(
      {UserWhereUniqueInput? where, UserCreateWithoutOrderedInput? create}) {
    return UserCreateOrConnectWithoutOrderedInput(
