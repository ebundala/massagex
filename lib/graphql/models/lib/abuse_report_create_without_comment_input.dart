...
class AbuseReportCreateWithoutCommentInput extends Equatable {
  final String? id;
  final int? number;
  final String? report;
  ...
  AbuseReportCreateWithoutCommentInput(
      {this.id,
      this.number,
      this.report,
      this.recordStatus,
  ...
  static AbuseReportCreateWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportCreateWithoutCommentInput(
      id: json['id'],
      number: json['number'],
      report: json['report'],
  ...
  AbuseReportCreateWithoutCommentInput copyWith(
      {String? id,
      int? number,
      String? report,
