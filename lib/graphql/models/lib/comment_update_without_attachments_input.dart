...
class CommentUpdateWithoutAttachmentsInput extends Equatable {
  ...
  CommentUpdateWithoutAttachmentsInput(
      {this.id,
  ...
  static CommentUpdateWithoutAttachmentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUpdateWithoutAttachmentsInput(
      id: json['id'] != null
  ...
  CommentUpdateWithoutAttachmentsInput copyWith(
