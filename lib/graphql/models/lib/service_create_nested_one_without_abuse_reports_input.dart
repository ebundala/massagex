...
class ServiceCreateNestedOneWithoutAbuseReportsInput extends Equatable {
  ...
  ServiceCreateNestedOneWithoutAbuseReportsInput(
      {this.create, this.connectOrCreate, this.connect});

  static ServiceCreateNestedOneWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceCreateNestedOneWithoutAbuseReportsInput(
  ...
  ServiceCreateNestedOneWithoutAbuseReportsInput copyWith(
