...
class PaymentMethodUpsertWithoutTransactionsInput extends Equatable {
  ...
  PaymentMethodUpsertWithoutTransactionsInput(
      {required this.update, required this.create});

  static PaymentMethodUpsertWithoutTransactionsInput fromJson(
      Map<dynamic, dynamic> json) {
    return PaymentMethodUpsertWithoutTransactionsInput(
      update:
  ...
  PaymentMethodUpsertWithoutTransactionsInput copyWith(
