...
class UserUpdateWithoutCommentsInput extends Equatable {
  ...
  static UserUpdateWithoutCommentsInput fromJson(Map<dynamic, dynamic> json) {
    return UserUpdateWithoutCommentsInput(
      id: json['id'] != null
  ...
  UserUpdateWithoutCommentsInput copyWith(
