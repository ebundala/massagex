...
class OrderRelationFilter extends Equatable {
  final OrderWhereInput? is$;
  final OrderWhereInput? isNot;
  ...
  OrderRelationFilter({this.is$, this.isNot});

  static OrderRelationFilter fromJson(Map<dynamic, dynamic> json) {
    return OrderRelationFilter(
      is$: json['is'] != null ? OrderWhereInput.fromJson(json['is']) : null,
      isNot: json['isNot'] != null
          ? OrderWhereInput.fromJson(json['isNot'])
          : null,
    );
  }
  ...
  OrderRelationFilter copyWith({OrderWhereInput? is$, OrderWhereInput? isNot}) {
    return OrderRelationFilter(
