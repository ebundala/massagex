...
class BusinessUpdateManyWithoutLocationInput extends Equatable {
  ...
  BusinessUpdateManyWithoutLocationInput(
      {this.create,
  ...
  static BusinessUpdateManyWithoutLocationInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUpdateManyWithoutLocationInput(
  ...
  BusinessUpdateManyWithoutLocationInput copyWith(
