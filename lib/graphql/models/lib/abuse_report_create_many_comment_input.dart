...
class AbuseReportCreateManyCommentInput extends Equatable {
  final String? id;
  final int? number;
  final String? report;
  ...
  AbuseReportCreateManyCommentInput(
      {this.id,
      this.number,
      this.report,
  ...
  static AbuseReportCreateManyCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportCreateManyCommentInput(
      id: json['id'],
      number: json['number'],
      report: json['report'],
  ...
  AbuseReportCreateManyCommentInput copyWith(
      {String? id,
      int? number,
      String? report,
      String? authorId,
