...
class NestedDateTimeNullableFilter extends Equatable {
  ...
  static NestedDateTimeNullableFilter fromJson(Map<dynamic, dynamic> json) {
    return NestedDateTimeNullableFilter(
  ...
  NestedDateTimeNullableFilter copyWith(
      {DateTime? equals,
      List<DateTime>? in$,
      List<DateTime>? notIn,
      DateTime? lt,
