...
class FavoriteCreateOrConnectWithoutTypeInput extends Equatable {
  ...
  FavoriteCreateOrConnectWithoutTypeInput(
      {required this.where, required this.create});

  static FavoriteCreateOrConnectWithoutTypeInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteCreateOrConnectWithoutTypeInput(
  ...
  FavoriteCreateOrConnectWithoutTypeInput copyWith(
