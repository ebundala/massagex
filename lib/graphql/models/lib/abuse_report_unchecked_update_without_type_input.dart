...
class AbuseReportUncheckedUpdateWithoutTypeInput extends Equatable {
  ...
  AbuseReportUncheckedUpdateWithoutTypeInput(
      {this.id,
      this.number,
      this.report,
      this.authorId,
  ...
  static AbuseReportUncheckedUpdateWithoutTypeInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedUpdateWithoutTypeInput(
      id: json['id'] != null
  ...
  AbuseReportUncheckedUpdateWithoutTypeInput copyWith(
