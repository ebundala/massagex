...
class CommentUpdateManyWithoutAuthorInput extends Equatable {
  ...
  static CommentUpdateManyWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUpdateManyWithoutAuthorInput(
  ...
  CommentUpdateManyWithoutAuthorInput copyWith(
