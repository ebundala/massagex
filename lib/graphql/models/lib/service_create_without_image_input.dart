...
class ServiceCreateWithoutImageInput extends Equatable {
  final String? id;
  final String name;
  ...
  ServiceCreateWithoutImageInput(
      {this.id,
      required this.name,
      this.description,
      required this.price,
  ...
  static ServiceCreateWithoutImageInput fromJson(Map<dynamic, dynamic> json) {
    return ServiceCreateWithoutImageInput(
      id: json['id'],
      name: json['name'],
  ...
  ServiceCreateWithoutImageInput copyWith(
      {String? id,
      String? name,
      String? description,
      double? price,
