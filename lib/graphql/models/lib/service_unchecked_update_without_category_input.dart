...
class ServiceUncheckedUpdateWithoutCategoryInput extends Equatable {
  ...
  static ServiceUncheckedUpdateWithoutCategoryInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUncheckedUpdateWithoutCategoryInput(
      id: json['id'] != null
  ...
  ServiceUncheckedUpdateWithoutCategoryInput copyWith(
