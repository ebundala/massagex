...
class TransactionUpdateOneWithoutSelcomPaymentInput extends Equatable {
  ...
  TransactionUpdateOneWithoutSelcomPaymentInput(
      {this.create,
  ...
  static TransactionUpdateOneWithoutSelcomPaymentInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUpdateOneWithoutSelcomPaymentInput(
  ...
  TransactionUpdateOneWithoutSelcomPaymentInput copyWith(
