...
class HelpStepCreateManyInput extends Equatable {
  final String? id;
  ...
  static HelpStepCreateManyInput fromJson(Map<dynamic, dynamic> json) {
    return HelpStepCreateManyInput(
      id: json['id'],
  ...
  HelpStepCreateManyInput copyWith(
      {String? id,
      int? stepNumber,
      String? title,
      String? description,
