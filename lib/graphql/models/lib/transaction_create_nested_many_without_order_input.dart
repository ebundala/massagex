...
class TransactionCreateNestedManyWithoutOrderInput extends Equatable {
  ...
  TransactionCreateNestedManyWithoutOrderInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static TransactionCreateNestedManyWithoutOrderInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionCreateNestedManyWithoutOrderInput(
  ...
  TransactionCreateNestedManyWithoutOrderInput copyWith(
