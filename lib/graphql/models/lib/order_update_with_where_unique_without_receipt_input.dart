...
class OrderUpdateWithWhereUniqueWithoutReceiptInput extends Equatable {
  final OrderWhereUniqueInput where;
  final OrderUpdateWithoutReceiptInput data;
  ...
  OrderUpdateWithWhereUniqueWithoutReceiptInput(
      {required this.where, required this.data});

  static OrderUpdateWithWhereUniqueWithoutReceiptInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUpdateWithWhereUniqueWithoutReceiptInput(
      where: OrderWhereUniqueInput.fromJson(json['where']),
      data: OrderUpdateWithoutReceiptInput.fromJson(json['data']),
    );
  }
  ...
  OrderUpdateWithWhereUniqueWithoutReceiptInput copyWith(
      {OrderWhereUniqueInput? where, OrderUpdateWithoutReceiptInput? data}) {
    return OrderUpdateWithWhereUniqueWithoutReceiptInput(
