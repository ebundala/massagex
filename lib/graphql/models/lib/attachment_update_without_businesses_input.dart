...
class AttachmentUpdateWithoutBusinessesInput extends Equatable {
  ...
  AttachmentUpdateWithoutBusinessesInput(
      {this.id,
      this.path,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUpdateWithoutBusinessesInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUpdateWithoutBusinessesInput(
      id: json['id'] != null
  ...
  AttachmentUpdateWithoutBusinessesInput copyWith(
