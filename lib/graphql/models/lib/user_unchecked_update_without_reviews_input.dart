...
class UserUncheckedUpdateWithoutReviewsInput extends Equatable {
  ...
  static UserUncheckedUpdateWithoutReviewsInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUncheckedUpdateWithoutReviewsInput(
      id: json['id'] != null
  ...
  UserUncheckedUpdateWithoutReviewsInput copyWith(
