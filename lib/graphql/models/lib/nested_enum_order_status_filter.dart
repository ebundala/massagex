...
class NestedEnumOrderStatusFilter extends Equatable {
  ...
  NestedEnumOrderStatusFilter({this.equals, this.in$, this.notIn, this.not});

  static NestedEnumOrderStatusFilter fromJson(Map<dynamic, dynamic> json) {
    return NestedEnumOrderStatusFilter(
  ...
  NestedEnumOrderStatusFilter copyWith(
      {OrderStatus? equals,
      List<OrderStatus>? in$,
