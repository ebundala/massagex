...
class AttachmentCreateNestedManyWithoutCommentInput extends Equatable {
  ...
  AttachmentCreateNestedManyWithoutCommentInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static AttachmentCreateNestedManyWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateNestedManyWithoutCommentInput(
  ...
  AttachmentCreateNestedManyWithoutCommentInput copyWith(
