...
class BusinessUpdateWithoutFavoritesInput extends Equatable {
  ...
  BusinessUpdateWithoutFavoritesInput(
      {this.id,
      this.mode,
      this.about,
      this.businessName,
  ...
  static BusinessUpdateWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUpdateWithoutFavoritesInput(
      id: json['id'] != null
  ...
  BusinessUpdateWithoutFavoritesInput copyWith(
