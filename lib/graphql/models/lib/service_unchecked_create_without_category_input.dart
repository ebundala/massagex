...
class ServiceUncheckedCreateWithoutCategoryInput extends Equatable {
  final String? id;
  final String name;
  ...
  static ServiceUncheckedCreateWithoutCategoryInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUncheckedCreateWithoutCategoryInput(
      id: json['id'],
      name: json['name'],
  ...
  ServiceUncheckedCreateWithoutCategoryInput copyWith(
      {String? id,
      String? name,
      String? description,
      double? price,
