...
class ServiceUpdateManyWithWhereWithoutCategoryInput extends Equatable {
  ...
  static ServiceUpdateManyWithWhereWithoutCategoryInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUpdateManyWithWhereWithoutCategoryInput(
  ...
  ServiceUpdateManyWithWhereWithoutCategoryInput copyWith(
