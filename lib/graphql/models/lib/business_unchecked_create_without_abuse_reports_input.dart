...
import 'order_unchecked_create_nested_many_without_business_input.dart';
...
class BusinessUncheckedCreateWithoutAbuseReportsInput extends Equatable {
  final String? id;
  ...
  final OrderUncheckedCreateNestedManyWithoutBusinessInput? orders;
  ...
  BusinessUncheckedCreateWithoutAbuseReportsInput(
      {this.id,
  ...
  static BusinessUncheckedCreateWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUncheckedCreateWithoutAbuseReportsInput(
      id: json['id'],
      ...
      orders: json['orders'] != null
          ? OrderUncheckedCreateNestedManyWithoutBusinessInput.fromJson(
              json['orders'])
          : null,
  ...
  BusinessUncheckedCreateWithoutAbuseReportsInput copyWith(
      {String? id,
      String? ownerId,
      BusinessMode? mode,
      String? coverId,
      ...
      OrderUncheckedCreateNestedManyWithoutBusinessInput? orders,
