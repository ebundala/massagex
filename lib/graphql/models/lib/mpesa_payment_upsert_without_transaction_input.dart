...
class MpesaPaymentUpsertWithoutTransactionInput extends Equatable {
  ...
  MpesaPaymentUpsertWithoutTransactionInput(
      {required this.update, required this.create});

  static MpesaPaymentUpsertWithoutTransactionInput fromJson(
      Map<dynamic, dynamic> json) {
    return MpesaPaymentUpsertWithoutTransactionInput(
      update:
  ...
  MpesaPaymentUpsertWithoutTransactionInput copyWith(
