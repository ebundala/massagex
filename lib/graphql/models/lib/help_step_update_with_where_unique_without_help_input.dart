...
import 'help_step_update_without_help_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class HelpStepUpdateWithWhereUniqueWithoutHelpInput extends Equatable {
  final HelpStepWhereUniqueInput where;
  final HelpStepUpdateWithoutHelpInput data;
  ...
  HelpStepUpdateWithWhereUniqueWithoutHelpInput(
      {required this.where, required this.data});

  static HelpStepUpdateWithWhereUniqueWithoutHelpInput fromJson(
      Map<dynamic, dynamic> json) {
    return HelpStepUpdateWithWhereUniqueWithoutHelpInput(
      where: HelpStepWhereUniqueInput.fromJson(json['where']),
      data: HelpStepUpdateWithoutHelpInput.fromJson(json['data']),
    );
  }
  ...
  HelpStepUpdateWithWhereUniqueWithoutHelpInput copyWith(
      {HelpStepWhereUniqueInput? where, HelpStepUpdateWithoutHelpInput? data}) {
    return HelpStepUpdateWithWhereUniqueWithoutHelpInput(
