...
class AbuseReportUncheckedCreateNestedManyWithoutAuthorInput extends Equatable {
  ...
  AbuseReportUncheckedCreateNestedManyWithoutAuthorInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static AbuseReportUncheckedCreateNestedManyWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedCreateNestedManyWithoutAuthorInput(
  ...
  AbuseReportUncheckedCreateNestedManyWithoutAuthorInput copyWith(
