...
class NestedEnumRoleWithAggregatesFilter extends Equatable {
  final Role? equals;
  final List<Role>? in$;
  ...
  static NestedEnumRoleWithAggregatesFilter fromJson(
      Map<dynamic, dynamic> json) {
    return NestedEnumRoleWithAggregatesFilter(
  ...
  NestedEnumRoleWithAggregatesFilter copyWith(
      {Role? equals,
      List<Role>? in$,
      List<Role>? notIn,
