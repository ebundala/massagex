...
import 'location_create_or_connect_without_businesses_input.dart';
import 'location_upsert_without_businesses_input.dart';
import 'location_where_unique_input.dart';
import 'location_update_without_businesses_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class LocationUpdateOneWithoutBusinessesInput extends Equatable {
  final LocationCreateWithoutBusinessesInput? create;
  final LocationCreateOrConnectWithoutBusinessesInput? connectOrCreate;
  final LocationUpsertWithoutBusinessesInput? upsert;
  final LocationWhereUniqueInput? connect;
  final bool? disconnect;
  final bool? delete;
  final LocationUpdateWithoutBusinessesInput? update;
  ...
  static LocationUpdateOneWithoutBusinessesInput fromJson(
      Map<dynamic, dynamic> json) {
    return LocationUpdateOneWithoutBusinessesInput(
      create: json['create'] != null
          ? LocationCreateWithoutBusinessesInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? LocationCreateOrConnectWithoutBusinessesInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? LocationUpsertWithoutBusinessesInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? LocationUpdateWithoutBusinessesInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  LocationUpdateOneWithoutBusinessesInput copyWith(
      {LocationCreateWithoutBusinessesInput? create,
      LocationCreateOrConnectWithoutBusinessesInput? connectOrCreate,
      LocationUpsertWithoutBusinessesInput? upsert,
      LocationWhereUniqueInput? connect,
      bool? disconnect,
      bool? delete,
      LocationUpdateWithoutBusinessesInput? update}) {
    return LocationUpdateOneWithoutBusinessesInput(
