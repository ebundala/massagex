...
class OrderUpdateManyWithWhereWithoutBusinessInput extends Equatable {
  ...
  static OrderUpdateManyWithWhereWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUpdateManyWithWhereWithoutBusinessInput(
  ...
  OrderUpdateManyWithWhereWithoutBusinessInput copyWith(
