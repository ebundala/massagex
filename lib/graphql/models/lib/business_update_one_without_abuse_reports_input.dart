...
import 'business_create_or_connect_without_abuse_reports_input.dart';
import 'business_upsert_without_abuse_reports_input.dart';
...
class BusinessUpdateOneWithoutAbuseReportsInput extends Equatable {
  final BusinessCreateWithoutAbuseReportsInput? create;
  final BusinessCreateOrConnectWithoutAbuseReportsInput? connectOrCreate;
  final BusinessUpsertWithoutAbuseReportsInput? upsert;
  ...
  BusinessUpdateOneWithoutAbuseReportsInput(
      {this.create,
  ...
  static BusinessUpdateOneWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUpdateOneWithoutAbuseReportsInput(
      create: json['create'] != null
          ? BusinessCreateWithoutAbuseReportsInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? BusinessCreateOrConnectWithoutAbuseReportsInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? BusinessUpsertWithoutAbuseReportsInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? BusinessUpdateWithoutAbuseReportsInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  BusinessUpdateOneWithoutAbuseReportsInput copyWith(
      {BusinessCreateWithoutAbuseReportsInput? create,
      BusinessCreateOrConnectWithoutAbuseReportsInput? connectOrCreate,
      BusinessUpsertWithoutAbuseReportsInput? upsert,
