...
class ReviewUncheckedUpdateWithoutAbuseReportsInput extends Equatable {
  ...
  ReviewUncheckedUpdateWithoutAbuseReportsInput(
      {this.id,
      this.authorId,
      this.revieweeId,
      this.value,
  ...
  static ReviewUncheckedUpdateWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewUncheckedUpdateWithoutAbuseReportsInput(
      id: json['id'] != null
  ...
  ReviewUncheckedUpdateWithoutAbuseReportsInput copyWith(
