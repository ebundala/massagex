import 'attachment_create_without_businesses_input.dart';
import 'attachment_create_or_connect_without_businesses_input.dart';
import 'attachment_upsert_without_businesses_input.dart';
import 'attachment_where_unique_input.dart';
import 'attachment_update_without_businesses_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class AttachmentUpdateOneWithoutBusinessesInput extends Equatable {
  final AttachmentCreateWithoutBusinessesInput? create;
  final AttachmentCreateOrConnectWithoutBusinessesInput? connectOrCreate;
  final AttachmentUpsertWithoutBusinessesInput? upsert;
  final AttachmentWhereUniqueInput? connect;
  final bool? disconnect;
  final bool? delete;
  final AttachmentUpdateWithoutBusinessesInput? update;
  ...
  AttachmentUpdateOneWithoutBusinessesInput(
      {this.create,
  ...
  static AttachmentUpdateOneWithoutBusinessesInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUpdateOneWithoutBusinessesInput(
      create: json['create'] != null
          ? AttachmentCreateWithoutBusinessesInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? AttachmentCreateOrConnectWithoutBusinessesInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? AttachmentUpsertWithoutBusinessesInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? AttachmentUpdateWithoutBusinessesInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  AttachmentUpdateOneWithoutBusinessesInput copyWith(
      {AttachmentCreateWithoutBusinessesInput? create,
      AttachmentCreateOrConnectWithoutBusinessesInput? connectOrCreate,
      AttachmentUpsertWithoutBusinessesInput? upsert,
      AttachmentWhereUniqueInput? connect,
      bool? disconnect,
      bool? delete,
      AttachmentUpdateWithoutBusinessesInput? update}) {
    return AttachmentUpdateOneWithoutBusinessesInput(
