...
class UserCreateWithoutDeviceInput extends Equatable {
  final String? id;
  final String email;
  ...
  static UserCreateWithoutDeviceInput fromJson(Map<dynamic, dynamic> json) {
    return UserCreateWithoutDeviceInput(
      id: json['id'],
      email: json['email'],
  ...
  UserCreateWithoutDeviceInput copyWith(
      {String? id,
      String? email,
      String? displayName,
      String? phoneNumber,
