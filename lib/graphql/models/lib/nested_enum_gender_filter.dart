...
class NestedEnumGenderFilter extends Equatable {
  final Gender? equals;
  final List<Gender>? in$;
  final List<Gender>? notIn;
  final NestedEnumGenderFilter? not;
  ...
  NestedEnumGenderFilter({this.equals, this.in$, this.notIn, this.not});

  static NestedEnumGenderFilter fromJson(Map<dynamic, dynamic> json) {
    return NestedEnumGenderFilter(
      equals:
      ...
      notIn: json['notIn'] != null
          ...
          : null,
      not: json['not'] != null
          ? NestedEnumGenderFilter.fromJson(json['not'])
          : null,
    );
  }
  ...
  NestedEnumGenderFilter copyWith(
      {Gender? equals,
      List<Gender>? in$,
      List<Gender>? notIn,
      NestedEnumGenderFilter? not}) {
    return NestedEnumGenderFilter(
