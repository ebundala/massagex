...
class HelpStepUncheckedCreateWithoutHelpInput extends Equatable {
  final String? id;
  ...
  HelpStepUncheckedCreateWithoutHelpInput(
      {this.id,
  ...
  static HelpStepUncheckedCreateWithoutHelpInput fromJson(
      Map<dynamic, dynamic> json) {
    return HelpStepUncheckedCreateWithoutHelpInput(
      id: json['id'],
  ...
  HelpStepUncheckedCreateWithoutHelpInput copyWith(
      {String? id,
      int? stepNumber,
      String? title,
      String? description,
