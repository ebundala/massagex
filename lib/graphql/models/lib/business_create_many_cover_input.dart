...
class BusinessCreateManyCoverInput extends Equatable {
  final String? id;
  ...
  static BusinessCreateManyCoverInput fromJson(Map<dynamic, dynamic> json) {
    return BusinessCreateManyCoverInput(
      id: json['id'],
  ...
  BusinessCreateManyCoverInput copyWith(
      {String? id,
      String? ownerId,
      BusinessMode? mode,
      String? about,
