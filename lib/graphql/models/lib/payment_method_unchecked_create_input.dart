...
class PaymentMethodUncheckedCreateInput extends Equatable {
  final String? id;
  final String name;
  ...
  static PaymentMethodUncheckedCreateInput fromJson(
      Map<dynamic, dynamic> json) {
    return PaymentMethodUncheckedCreateInput(
      id: json['id'],
      name: json['name'],
  ...
  PaymentMethodUncheckedCreateInput copyWith(
      {String? id,
      String? name,
      String? description,
      String? attachmentId,
