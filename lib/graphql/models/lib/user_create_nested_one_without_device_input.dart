...
class UserCreateNestedOneWithoutDeviceInput extends Equatable {
  ...
  UserCreateNestedOneWithoutDeviceInput(
      {this.create, this.connectOrCreate, this.connect});

  static UserCreateNestedOneWithoutDeviceInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserCreateNestedOneWithoutDeviceInput(
  ...
  UserCreateNestedOneWithoutDeviceInput copyWith(
