...
class FavoriteCreateWithoutOrderInput extends Equatable {
  final String? id;
  final String favId;
  ...
  FavoriteCreateWithoutOrderInput(
      {this.id,
      required this.favId,
      this.recordStatus,
      this.createdAt,
  ...
  static FavoriteCreateWithoutOrderInput fromJson(Map<dynamic, dynamic> json) {
    return FavoriteCreateWithoutOrderInput(
      id: json['id'],
      favId: json['favId'],
  ...
  FavoriteCreateWithoutOrderInput copyWith(
      {String? id,
      String? favId,
