...
import 'abuse_record_type_create_or_connect_without_abuse_reports_input.dart';
import 'abuse_record_type_upsert_without_abuse_reports_input.dart';
import 'abuse_record_type_where_unique_input.dart';
import 'abuse_record_type_update_without_abuse_reports_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class AbuseRecordTypeUpdateOneRequiredWithoutAbuseReportsInput
    extends Equatable {
  final AbuseRecordTypeCreateWithoutAbuseReportsInput? create;
  final AbuseRecordTypeCreateOrConnectWithoutAbuseReportsInput? connectOrCreate;
  final AbuseRecordTypeUpsertWithoutAbuseReportsInput? upsert;
  final AbuseRecordTypeWhereUniqueInput? connect;
  ...
  AbuseRecordTypeUpdateOneRequiredWithoutAbuseReportsInput(
      {this.create,
  ...
  static AbuseRecordTypeUpdateOneRequiredWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseRecordTypeUpdateOneRequiredWithoutAbuseReportsInput(
      create: json['create'] != null
          ? AbuseRecordTypeCreateWithoutAbuseReportsInput.fromJson(
              json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? AbuseRecordTypeCreateOrConnectWithoutAbuseReportsInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? AbuseRecordTypeUpsertWithoutAbuseReportsInput.fromJson(
              json['upsert'])
          : null,
      connect: json['connect'] != null
          ? AbuseRecordTypeWhereUniqueInput.fromJson(json['connect'])
          : null,
      update: json['update'] != null
          ? AbuseRecordTypeUpdateWithoutAbuseReportsInput.fromJson(
              json['update'])
          : null,
    );
  }
  ...
  AbuseRecordTypeUpdateOneRequiredWithoutAbuseReportsInput copyWith(
      {AbuseRecordTypeCreateWithoutAbuseReportsInput? create,
      AbuseRecordTypeCreateOrConnectWithoutAbuseReportsInput? connectOrCreate,
      AbuseRecordTypeUpsertWithoutAbuseReportsInput? upsert,
      AbuseRecordTypeWhereUniqueInput? connect,
