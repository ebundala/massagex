...
class ServiceCreateInput extends Equatable {
  final String? id;
  final String name;
  ...
  static ServiceCreateInput fromJson(Map<dynamic, dynamic> json) {
    return ServiceCreateInput(
      id: json['id'],
      name: json['name'],
