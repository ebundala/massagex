...
import 'comment_create_or_connect_without_attachments_input.dart';
import 'comment_upsert_without_attachments_input.dart';
import 'comment_where_unique_input.dart';
import 'comment_update_without_attachments_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class CommentUpdateOneWithoutAttachmentsInput extends Equatable {
  final CommentCreateWithoutAttachmentsInput? create;
  final CommentCreateOrConnectWithoutAttachmentsInput? connectOrCreate;
  final CommentUpsertWithoutAttachmentsInput? upsert;
  final CommentWhereUniqueInput? connect;
  final bool? disconnect;
  final bool? delete;
  final CommentUpdateWithoutAttachmentsInput? update;
  ...
  CommentUpdateOneWithoutAttachmentsInput(
      {this.create,
  ...
  static CommentUpdateOneWithoutAttachmentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUpdateOneWithoutAttachmentsInput(
      create: json['create'] != null
          ? CommentCreateWithoutAttachmentsInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? CommentCreateOrConnectWithoutAttachmentsInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? CommentUpsertWithoutAttachmentsInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? CommentUpdateWithoutAttachmentsInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  CommentUpdateOneWithoutAttachmentsInput copyWith(
      {CommentCreateWithoutAttachmentsInput? create,
      CommentCreateOrConnectWithoutAttachmentsInput? connectOrCreate,
      CommentUpsertWithoutAttachmentsInput? upsert,
      CommentWhereUniqueInput? connect,
      bool? disconnect,
      bool? delete,
      CommentUpdateWithoutAttachmentsInput? update}) {
    return CommentUpdateOneWithoutAttachmentsInput(
