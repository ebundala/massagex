...
class FavoriteUpdateManyWithoutOrderInput extends Equatable {
  ...
  FavoriteUpdateManyWithoutOrderInput(
      {this.create,
  ...
  static FavoriteUpdateManyWithoutOrderInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUpdateManyWithoutOrderInput(
  ...
  FavoriteUpdateManyWithoutOrderInput copyWith(
