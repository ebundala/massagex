...
class NestedStringNullableWithAggregatesFilter extends Equatable {
  final String? equals;
  ...
  static NestedStringNullableWithAggregatesFilter fromJson(
  ...
  NestedStringNullableWithAggregatesFilter copyWith(
      {String? equals,
      List<String>? in$,
      List<String>? notIn,
      String? lt,
