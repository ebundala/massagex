...
class CommentUncheckedUpdateInput extends Equatable {
  ...
  static CommentUncheckedUpdateInput fromJson(Map<dynamic, dynamic> json) {
    return CommentUncheckedUpdateInput(
      id: json['id'] != null
  ...
  CommentUncheckedUpdateInput copyWith(
