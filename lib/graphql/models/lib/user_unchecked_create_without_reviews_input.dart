...
class UserUncheckedCreateWithoutReviewsInput extends Equatable {
  final String? id;
  final String? email;
  ...
  static UserUncheckedCreateWithoutReviewsInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUncheckedCreateWithoutReviewsInput(
      id: json['id'],
      email: json['email'],
  ...
  UserUncheckedCreateWithoutReviewsInput copyWith(
      {String? id,
      String? email,
      String? displayName,
      String? phoneNumber,
