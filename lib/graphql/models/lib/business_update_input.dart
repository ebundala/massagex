...
class BusinessUpdateInput extends Equatable {
  ...
  static BusinessUpdateInput fromJson(Map<dynamic, dynamic> json) {
    return BusinessUpdateInput(
      id: json['id'] != null
