...
class FavoriteUpdateManyWithWhereWithoutTypeInput extends Equatable {
  ...
  FavoriteUpdateManyWithWhereWithoutTypeInput(
      {required this.where, required this.data});

  static FavoriteUpdateManyWithWhereWithoutTypeInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUpdateManyWithWhereWithoutTypeInput(
  ...
  FavoriteUpdateManyWithWhereWithoutTypeInput copyWith(
