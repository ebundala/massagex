import 'abuse_report_create_without_author_input.dart';
import 'abuse_report_create_or_connect_without_author_input.dart';
import 'abuse_report_upsert_with_where_unique_without_author_input.dart';
import 'abuse_report_create_many_author_input_envelope.dart';
import 'abuse_report_where_unique_input.dart';
import 'abuse_report_update_with_where_unique_without_author_input.dart';
import 'abuse_report_update_many_with_where_without_author_input.dart';
import 'abuse_report_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class AbuseReportUncheckedUpdateManyWithoutAuthorInput extends Equatable {
  final List<AbuseReportCreateWithoutAuthorInput>? create;
  final List<AbuseReportCreateOrConnectWithoutAuthorInput>? connectOrCreate;
  final List<AbuseReportUpsertWithWhereUniqueWithoutAuthorInput>? upsert;
  final AbuseReportCreateManyAuthorInputEnvelope? createMany;
  ...
  final List<AbuseReportUpdateWithWhereUniqueWithoutAuthorInput>? update;
  final List<AbuseReportUpdateManyWithWhereWithoutAuthorInput>? updateMany;
  ...
  AbuseReportUncheckedUpdateManyWithoutAuthorInput(
      {this.create,
  ...
  static AbuseReportUncheckedUpdateManyWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedUpdateManyWithoutAuthorInput(
      create: json['create'] != null
          ? List.generate(
              json['create'].length,
              (index) => AbuseReportCreateWithoutAuthorInput.fromJson(
                  json['create'][index]))
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? List.generate(
              json['connectOrCreate'].length,
              (index) => AbuseReportCreateOrConnectWithoutAuthorInput.fromJson(
      ...
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) =>
                  AbuseReportUpsertWithWhereUniqueWithoutAuthorInput.fromJson(
                      json['upsert'][index]))
          : null,
      createMany: json['createMany'] != null
          ? AbuseReportCreateManyAuthorInputEnvelope.fromJson(
              json['createMany'])
          : null,
      ...
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) =>
                  AbuseReportUpdateWithWhereUniqueWithoutAuthorInput.fromJson(
                      json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              ...
              (index) =>
                  AbuseReportUpdateManyWithWhereWithoutAuthorInput.fromJson(
  ...
  AbuseReportUncheckedUpdateManyWithoutAuthorInput copyWith(
      {List<AbuseReportCreateWithoutAuthorInput>? create,
      List<AbuseReportCreateOrConnectWithoutAuthorInput>? connectOrCreate,
      List<AbuseReportUpsertWithWhereUniqueWithoutAuthorInput>? upsert,
      AbuseReportCreateManyAuthorInputEnvelope? createMany,
      ...
      List<AbuseReportUpdateWithWhereUniqueWithoutAuthorInput>? update,
      List<AbuseReportUpdateManyWithWhereWithoutAuthorInput>? updateMany,
