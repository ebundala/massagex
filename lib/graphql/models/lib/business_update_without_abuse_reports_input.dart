...
import 'service_update_many_without_business_input.dart';
...
class BusinessUpdateWithoutAbuseReportsInput extends Equatable {
  ...
  final ServiceUpdateManyWithoutBusinessInput? services;
  ...
  BusinessUpdateWithoutAbuseReportsInput(
      {this.id,
      this.mode,
      this.about,
      this.businessName,
  ...
  static BusinessUpdateWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUpdateWithoutAbuseReportsInput(
      id: json['id'] != null
      ...
      services: json['services'] != null
          ? ServiceUpdateManyWithoutBusinessInput.fromJson(json['services'])
          : null,
  ...
  BusinessUpdateWithoutAbuseReportsInput copyWith(
      ...
      ServiceUpdateManyWithoutBusinessInput? services,
