...
class FavoriteUncheckedCreateNestedManyWithoutServiceInput extends Equatable {
  ...
  FavoriteUncheckedCreateNestedManyWithoutServiceInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static FavoriteUncheckedCreateNestedManyWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedCreateNestedManyWithoutServiceInput(
  ...
  FavoriteUncheckedCreateNestedManyWithoutServiceInput copyWith(
