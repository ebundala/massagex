...
import 'order_upsert_without_favorites_input.dart';
import 'order_where_unique_input.dart';
import 'order_update_without_favorites_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class OrderUpdateOneWithoutFavoritesInput extends Equatable {
  final OrderCreateWithoutFavoritesInput? create;
  final OrderCreateOrConnectWithoutFavoritesInput? connectOrCreate;
  final OrderUpsertWithoutFavoritesInput? upsert;
  final OrderWhereUniqueInput? connect;
  final bool? disconnect;
  final bool? delete;
  final OrderUpdateWithoutFavoritesInput? update;
  ...
  OrderUpdateOneWithoutFavoritesInput(
      {this.create,
  ...
  static OrderUpdateOneWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUpdateOneWithoutFavoritesInput(
      ...
      upsert: json['upsert'] != null
          ? OrderUpsertWithoutFavoritesInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? OrderUpdateWithoutFavoritesInput.fromJson(json['update'])
          : null,
    );
  }
