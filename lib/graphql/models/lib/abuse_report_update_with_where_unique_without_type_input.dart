...
class AbuseReportUpdateWithWhereUniqueWithoutTypeInput extends Equatable {
  final AbuseReportWhereUniqueInput where;
  final AbuseReportUpdateWithoutTypeInput data;
  ...
  AbuseReportUpdateWithWhereUniqueWithoutTypeInput(
      {required this.where, required this.data});

  static AbuseReportUpdateWithWhereUniqueWithoutTypeInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpdateWithWhereUniqueWithoutTypeInput(
      where: AbuseReportWhereUniqueInput.fromJson(json['where']),
      data: AbuseReportUpdateWithoutTypeInput.fromJson(json['data']),
    );
  }
  ...
  AbuseReportUpdateWithWhereUniqueWithoutTypeInput copyWith(
      {AbuseReportWhereUniqueInput? where,
      AbuseReportUpdateWithoutTypeInput? data}) {
    return AbuseReportUpdateWithWhereUniqueWithoutTypeInput(
