...
class AbuseReportUncheckedUpdateManyWithoutUserInput extends Equatable {
  ...
  AbuseReportUncheckedUpdateManyWithoutUserInput(
      {this.create,
  ...
  static AbuseReportUncheckedUpdateManyWithoutUserInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedUpdateManyWithoutUserInput(
  ...
  AbuseReportUncheckedUpdateManyWithoutUserInput copyWith(
