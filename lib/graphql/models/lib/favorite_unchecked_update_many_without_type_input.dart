...
import 'favorite_create_or_connect_without_type_input.dart';
import 'favorite_upsert_with_where_unique_without_type_input.dart';
import 'favorite_create_many_type_input_envelope.dart';
import 'favorite_where_unique_input.dart';
import 'favorite_update_with_where_unique_without_type_input.dart';
import 'favorite_update_many_with_where_without_type_input.dart';
import 'favorite_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class FavoriteUncheckedUpdateManyWithoutTypeInput extends Equatable {
  final List<FavoriteCreateWithoutTypeInput>? create;
  final List<FavoriteCreateOrConnectWithoutTypeInput>? connectOrCreate;
  final List<FavoriteUpsertWithWhereUniqueWithoutTypeInput>? upsert;
  final FavoriteCreateManyTypeInputEnvelope? createMany;
  ...
  final List<FavoriteUpdateWithWhereUniqueWithoutTypeInput>? update;
  final List<FavoriteUpdateManyWithWhereWithoutTypeInput>? updateMany;
  ...
  FavoriteUncheckedUpdateManyWithoutTypeInput(
      {this.create,
  ...
  static FavoriteUncheckedUpdateManyWithoutTypeInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedUpdateManyWithoutTypeInput(
      create: json['create'] != null
          ? List.generate(
              json['create'].length,
              (index) => FavoriteCreateWithoutTypeInput.fromJson(
                  json['create'][index]))
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? List.generate(
              json['connectOrCreate'].length,
              (index) => FavoriteCreateOrConnectWithoutTypeInput.fromJson(
                  json['connectOrCreate'][index]))
          : null,
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) => FavoriteUpsertWithWhereUniqueWithoutTypeInput.fromJson(
                  json['upsert'][index]))
          : null,
      createMany: json['createMany'] != null
          ? FavoriteCreateManyTypeInputEnvelope.fromJson(json['createMany'])
          : null,
      ...
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) => FavoriteUpdateWithWhereUniqueWithoutTypeInput.fromJson(
                  json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              json['updateMany'].length,
              (index) => FavoriteUpdateManyWithWhereWithoutTypeInput.fromJson(
  ...
  FavoriteUncheckedUpdateManyWithoutTypeInput copyWith(
      {List<FavoriteCreateWithoutTypeInput>? create,
      List<FavoriteCreateOrConnectWithoutTypeInput>? connectOrCreate,
      List<FavoriteUpsertWithWhereUniqueWithoutTypeInput>? upsert,
      FavoriteCreateManyTypeInputEnvelope? createMany,
      ...
      List<FavoriteUpdateWithWhereUniqueWithoutTypeInput>? update,
      List<FavoriteUpdateManyWithWhereWithoutTypeInput>? updateMany,
