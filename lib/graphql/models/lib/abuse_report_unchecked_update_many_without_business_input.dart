...
import 'abuse_report_upsert_with_where_unique_without_business_input.dart';
import 'abuse_report_create_many_business_input_envelope.dart';
import 'abuse_report_where_unique_input.dart';
import 'abuse_report_update_with_where_unique_without_business_input.dart';
import 'abuse_report_update_many_with_where_without_business_input.dart';
import 'abuse_report_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class AbuseReportUncheckedUpdateManyWithoutBusinessInput extends Equatable {
  ...
  final List<AbuseReportUpsertWithWhereUniqueWithoutBusinessInput>? upsert;
  ...
  final List<AbuseReportUpdateWithWhereUniqueWithoutBusinessInput>? update;
  final List<AbuseReportUpdateManyWithWhereWithoutBusinessInput>? updateMany;
  ...
  AbuseReportUncheckedUpdateManyWithoutBusinessInput(
      {this.create,
  ...
  static AbuseReportUncheckedUpdateManyWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedUpdateManyWithoutBusinessInput(
      ...
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) =>
                  AbuseReportUpsertWithWhereUniqueWithoutBusinessInput.fromJson(
                      json['upsert'][index]))
          : null,
      ...
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) =>
                  AbuseReportUpdateWithWhereUniqueWithoutBusinessInput.fromJson(
                      json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              ...
              (index) =>
                  AbuseReportUpdateManyWithWhereWithoutBusinessInput.fromJson(
  ...
  AbuseReportUncheckedUpdateManyWithoutBusinessInput copyWith(
      {List<AbuseReportCreateWithoutBusinessInput>? create,
      List<AbuseReportCreateOrConnectWithoutBusinessInput>? connectOrCreate,
      List<AbuseReportUpsertWithWhereUniqueWithoutBusinessInput>? upsert,
      ...
      List<AbuseReportUpdateWithWhereUniqueWithoutBusinessInput>? update,
      List<AbuseReportUpdateManyWithWhereWithoutBusinessInput>? updateMany,
