...
import 'category_create_nested_one_without_services_input.dart';
...
class ServiceCreateWithoutAbuseReportsInput extends Equatable {
  final String? id;
  final String name;
  ...
  final CategoryCreateNestedOneWithoutServicesInput? category;
  ...
  ServiceCreateWithoutAbuseReportsInput(
      {this.id,
      required this.name,
      this.description,
      required this.price,
  ...
  static ServiceCreateWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceCreateWithoutAbuseReportsInput(
      id: json['id'],
      name: json['name'],
      ...
      category: json['category'] != null
          ? CategoryCreateNestedOneWithoutServicesInput.fromJson(
              json['category'])
          : null,
  ...
  ServiceCreateWithoutAbuseReportsInput copyWith(
      {String? id,
      String? name,
      String? description,
      double? price,
      ...
      DateTime? createdAt,
      DateTime? updatedAt,
      CategoryCreateNestedOneWithoutServicesInput? category,
