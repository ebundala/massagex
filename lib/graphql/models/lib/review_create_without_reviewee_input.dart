...
class ReviewCreateWithoutRevieweeInput extends Equatable {
  final String? id;
  final int? value;
  ...
  ReviewCreateWithoutRevieweeInput(
      {this.id,
      this.value,
      this.content,
      this.recordStatus,
  ...
  static ReviewCreateWithoutRevieweeInput fromJson(Map<dynamic, dynamic> json) {
    return ReviewCreateWithoutRevieweeInput(
      id: json['id'],
      value: json['value'],
  ...
  ReviewCreateWithoutRevieweeInput copyWith(
      {String? id,
      int? value,
      String? content,
