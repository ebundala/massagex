...
class BusinessUncheckedUpdateWithoutAbuseReportsInput extends Equatable {
  ...
  BusinessUncheckedUpdateWithoutAbuseReportsInput(
      {this.id,
      this.ownerId,
      this.mode,
      this.coverId,
  ...
  static BusinessUncheckedUpdateWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUncheckedUpdateWithoutAbuseReportsInput(
      id: json['id'] != null
  ...
  BusinessUncheckedUpdateWithoutAbuseReportsInput copyWith(
