...
class AttachmentCreateWithoutCategoryInput extends Equatable {
  ...
  AttachmentCreateWithoutCategoryInput(
      {required this.path,
      this.id,
      this.filename,
      this.mimetype,
  ...
  static AttachmentCreateWithoutCategoryInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateWithoutCategoryInput(
      path: json['path'],
      id: json['id'],
  ...
  AttachmentCreateWithoutCategoryInput copyWith(
      {MultipartFile? path,
      String? id,
      String? filename,
      String? mimetype,
