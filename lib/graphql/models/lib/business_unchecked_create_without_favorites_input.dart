...
class BusinessUncheckedCreateWithoutFavoritesInput extends Equatable {
  final String? id;
  ...
  BusinessUncheckedCreateWithoutFavoritesInput(
      {this.id,
  ...
  static BusinessUncheckedCreateWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUncheckedCreateWithoutFavoritesInput(
      id: json['id'],
  ...
  BusinessUncheckedCreateWithoutFavoritesInput copyWith(
      {String? id,
      String? ownerId,
      BusinessMode? mode,
      String? coverId,
