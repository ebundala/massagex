...
class DeviceUncheckedCreateNestedOneWithoutUserInput extends Equatable {
  ...
  DeviceUncheckedCreateNestedOneWithoutUserInput(
      {this.create, this.connectOrCreate, this.connect});

  static DeviceUncheckedCreateNestedOneWithoutUserInput fromJson(
      Map<dynamic, dynamic> json) {
    return DeviceUncheckedCreateNestedOneWithoutUserInput(
  ...
  DeviceUncheckedCreateNestedOneWithoutUserInput copyWith(
