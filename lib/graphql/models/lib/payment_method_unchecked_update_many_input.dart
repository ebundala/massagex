...
class PaymentMethodUncheckedUpdateManyInput extends Equatable {
  ...
  static PaymentMethodUncheckedUpdateManyInput fromJson(
      Map<dynamic, dynamic> json) {
    return PaymentMethodUncheckedUpdateManyInput(
      id: json['id'] != null
  ...
  PaymentMethodUncheckedUpdateManyInput copyWith(
