import 'abuse_report_create_without_service_input.dart';
import 'abuse_report_create_or_connect_without_service_input.dart';
import 'abuse_report_upsert_with_where_unique_without_service_input.dart';
import 'abuse_report_create_many_service_input_envelope.dart';
import 'abuse_report_where_unique_input.dart';
import 'abuse_report_update_with_where_unique_without_service_input.dart';
import 'abuse_report_update_many_with_where_without_service_input.dart';
import 'abuse_report_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class AbuseReportUncheckedUpdateManyWithoutServiceInput extends Equatable {
  final List<AbuseReportCreateWithoutServiceInput>? create;
  final List<AbuseReportCreateOrConnectWithoutServiceInput>? connectOrCreate;
  final List<AbuseReportUpsertWithWhereUniqueWithoutServiceInput>? upsert;
  final AbuseReportCreateManyServiceInputEnvelope? createMany;
  ...
  final List<AbuseReportUpdateWithWhereUniqueWithoutServiceInput>? update;
  final List<AbuseReportUpdateManyWithWhereWithoutServiceInput>? updateMany;
  ...
  AbuseReportUncheckedUpdateManyWithoutServiceInput(
      {this.create,
  ...
  static AbuseReportUncheckedUpdateManyWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedUpdateManyWithoutServiceInput(
      create: json['create'] != null
          ? List.generate(
              json['create'].length,
              (index) => AbuseReportCreateWithoutServiceInput.fromJson(
                  json['create'][index]))
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? List.generate(
              json['connectOrCreate'].length,
              (index) => AbuseReportCreateOrConnectWithoutServiceInput.fromJson(
      ...
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) =>
                  AbuseReportUpsertWithWhereUniqueWithoutServiceInput.fromJson(
                      json['upsert'][index]))
          : null,
      createMany: json['createMany'] != null
          ? AbuseReportCreateManyServiceInputEnvelope.fromJson(
              json['createMany'])
          : null,
      ...
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) =>
                  AbuseReportUpdateWithWhereUniqueWithoutServiceInput.fromJson(
                      json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              ...
              (index) =>
                  AbuseReportUpdateManyWithWhereWithoutServiceInput.fromJson(
  ...
  AbuseReportUncheckedUpdateManyWithoutServiceInput copyWith(
      {List<AbuseReportCreateWithoutServiceInput>? create,
      List<AbuseReportCreateOrConnectWithoutServiceInput>? connectOrCreate,
      List<AbuseReportUpsertWithWhereUniqueWithoutServiceInput>? upsert,
      AbuseReportCreateManyServiceInputEnvelope? createMany,
      ...
      List<AbuseReportUpdateWithWhereUniqueWithoutServiceInput>? update,
      List<AbuseReportUpdateManyWithWhereWithoutServiceInput>? updateMany,
