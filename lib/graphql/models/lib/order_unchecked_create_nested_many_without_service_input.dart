...
class OrderUncheckedCreateNestedManyWithoutServiceInput extends Equatable {
  ...
  OrderUncheckedCreateNestedManyWithoutServiceInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static OrderUncheckedCreateNestedManyWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUncheckedCreateNestedManyWithoutServiceInput(
  ...
  OrderUncheckedCreateNestedManyWithoutServiceInput copyWith(
