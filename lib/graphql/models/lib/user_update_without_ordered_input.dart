...
class UserUpdateWithoutOrderedInput extends Equatable {
  ...
  static UserUpdateWithoutOrderedInput fromJson(Map<dynamic, dynamic> json) {
    return UserUpdateWithoutOrderedInput(
      id: json['id'] != null
  ...
  UserUpdateWithoutOrderedInput copyWith(
