...
class AbuseReportUpdateManyWithWhereWithoutBusinessInput extends Equatable {
  ...
  AbuseReportUpdateManyWithWhereWithoutBusinessInput(
      {required this.where, required this.data});

  static AbuseReportUpdateManyWithWhereWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpdateManyWithWhereWithoutBusinessInput(
  ...
  AbuseReportUpdateManyWithWhereWithoutBusinessInput copyWith(
