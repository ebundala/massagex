...
class SelcomDisbursementUncheckedUpdateManyInput extends Equatable {
  ...
  SelcomDisbursementUncheckedUpdateManyInput(
      {this.id,
      this.amount,
      this.reference,
      this.resultCode,
  ...
  static SelcomDisbursementUncheckedUpdateManyInput fromJson(
      Map<dynamic, dynamic> json) {
    return SelcomDisbursementUncheckedUpdateManyInput(
      id: json['id'] != null
  ...
  SelcomDisbursementUncheckedUpdateManyInput copyWith(
