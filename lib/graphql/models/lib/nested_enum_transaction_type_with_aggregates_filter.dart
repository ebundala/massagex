...
class NestedEnumTransactionTypeWithAggregatesFilter extends Equatable {
  ...
  static NestedEnumTransactionTypeWithAggregatesFilter fromJson(
      Map<dynamic, dynamic> json) {
    return NestedEnumTransactionTypeWithAggregatesFilter(
  ...
  NestedEnumTransactionTypeWithAggregatesFilter copyWith(
