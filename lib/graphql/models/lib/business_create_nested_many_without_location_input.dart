...
class BusinessCreateNestedManyWithoutLocationInput extends Equatable {
  ...
  BusinessCreateNestedManyWithoutLocationInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static BusinessCreateNestedManyWithoutLocationInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessCreateNestedManyWithoutLocationInput(
  ...
  BusinessCreateNestedManyWithoutLocationInput copyWith(
