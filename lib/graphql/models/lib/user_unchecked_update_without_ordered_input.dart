...
class UserUncheckedUpdateWithoutOrderedInput extends Equatable {
  ...
  UserUncheckedUpdateWithoutOrderedInput(
      {this.id,
      this.email,
      this.displayName,
      this.phoneNumber,
  ...
  static UserUncheckedUpdateWithoutOrderedInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUncheckedUpdateWithoutOrderedInput(
      id: json['id'] != null
  ...
  UserUncheckedUpdateWithoutOrderedInput copyWith(
