...
class AttachmentCreateWithoutReviewsInput extends Equatable {
  ...
  AttachmentCreateWithoutReviewsInput(
      {required this.path,
      this.id,
      this.filename,
      this.mimetype,
  ...
  static AttachmentCreateWithoutReviewsInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateWithoutReviewsInput(
      path: json['path'],
      id: json['id'],
  ...
  AttachmentCreateWithoutReviewsInput copyWith(
      {MultipartFile? path,
      String? id,
      String? filename,
      String? mimetype,
