...
class BusinessUpdateManyMutationInput extends Equatable {
  ...
  static BusinessUpdateManyMutationInput fromJson(Map<dynamic, dynamic> json) {
    return BusinessUpdateManyMutationInput(
      id: json['id'] != null
  ...
  BusinessUpdateManyMutationInput copyWith(
