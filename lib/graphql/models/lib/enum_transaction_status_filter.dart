...
class EnumTransactionStatusFilter extends Equatable {
  ...
  EnumTransactionStatusFilter({this.equals, this.in$, this.notIn, this.not});

  static EnumTransactionStatusFilter fromJson(Map<dynamic, dynamic> json) {
    return EnumTransactionStatusFilter(
  ...
  EnumTransactionStatusFilter copyWith(
