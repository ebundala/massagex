...
class CategoryUpdateWithoutPictureInput extends Equatable {
  ...
  CategoryUpdateWithoutPictureInput(
      {this.id,
      this.name,
      this.description,
      this.metadata,
  ...
  static CategoryUpdateWithoutPictureInput fromJson(
      Map<dynamic, dynamic> json) {
    return CategoryUpdateWithoutPictureInput(
      id: json['id'] != null
  ...
  CategoryUpdateWithoutPictureInput copyWith(
