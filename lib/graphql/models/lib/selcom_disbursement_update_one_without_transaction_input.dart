...
import 'selcom_disbursement_upsert_without_transaction_input.dart';
import 'selcom_disbursement_where_unique_input.dart';
import 'selcom_disbursement_update_without_transaction_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class SelcomDisbursementUpdateOneWithoutTransactionInput extends Equatable {
  ...
  final SelcomDisbursementCreateOrConnectWithoutTransactionInput?
      connectOrCreate;
  final SelcomDisbursementUpsertWithoutTransactionInput? upsert;
  final SelcomDisbursementWhereUniqueInput? connect;
  final bool? disconnect;
  final bool? delete;
  final SelcomDisbursementUpdateWithoutTransactionInput? update;
  ...
  SelcomDisbursementUpdateOneWithoutTransactionInput(
      {this.create,
  ...
  static SelcomDisbursementUpdateOneWithoutTransactionInput fromJson(
      Map<dynamic, dynamic> json) {
    return SelcomDisbursementUpdateOneWithoutTransactionInput(
      ...
      upsert: json['upsert'] != null
          ? SelcomDisbursementUpsertWithoutTransactionInput.fromJson(
              json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? SelcomDisbursementUpdateWithoutTransactionInput.fromJson(
              json['update'])
          : null,
    );
  }
  ...
  SelcomDisbursementUpdateOneWithoutTransactionInput copyWith(
      ...
      SelcomDisbursementUpsertWithoutTransactionInput? upsert,
      SelcomDisbursementWhereUniqueInput? connect,
      bool? disconnect,
      bool? delete,
      SelcomDisbursementUpdateWithoutTransactionInput? update}) {
    return SelcomDisbursementUpdateOneWithoutTransactionInput(
