...
import 'nested_enum_selcom_utility_code_with_aggregates_filter.dart';
...
class EnumSelcomUtilityCodeWithAggregatesFilter extends Equatable {
  final SelcomUtilityCode? equals;
  final List<SelcomUtilityCode>? in$;
  final List<SelcomUtilityCode>? notIn;
  final NestedEnumSelcomUtilityCodeWithAggregatesFilter? not;
  final NestedIntFilter? $count;
  final NestedIntFilter? count;
  final NestedEnumSelcomUtilityCodeFilter? $min;
  final NestedEnumSelcomUtilityCodeFilter? min;
  final NestedEnumSelcomUtilityCodeFilter? $max;
  final NestedEnumSelcomUtilityCodeFilter? max;
  ...
  EnumSelcomUtilityCodeWithAggregatesFilter(
      {this.equals,
      this.in$,
      this.notIn,
      this.not,
  ...
  static EnumSelcomUtilityCodeWithAggregatesFilter fromJson(
      Map<dynamic, dynamic> json) {
    return EnumSelcomUtilityCodeWithAggregatesFilter(
      ...
      notIn: json['notIn'] != null
          ...
          : null,
      not: json['not'] != null
          ? NestedEnumSelcomUtilityCodeWithAggregatesFilter.fromJson(
              json['not'])
          : null,
      ...
      count: json['count'] != null
          ...
          : null,
      $min: json['_min'] != null
          ? NestedEnumSelcomUtilityCodeFilter.fromJson(json['_min'])
          : null,
      min: json['min'] != null
          ? NestedEnumSelcomUtilityCodeFilter.fromJson(json['min'])
          : null,
      $max: json['_max'] != null
          ? NestedEnumSelcomUtilityCodeFilter.fromJson(json['_max'])
          : null,
      max: json['max'] != null
          ? NestedEnumSelcomUtilityCodeFilter.fromJson(json['max'])
          : null,
    );
  }
  ...
  EnumSelcomUtilityCodeWithAggregatesFilter copyWith(
      {SelcomUtilityCode? equals,
      List<SelcomUtilityCode>? in$,
      List<SelcomUtilityCode>? notIn,
      NestedEnumSelcomUtilityCodeWithAggregatesFilter? not,
      NestedIntFilter? $count,
      NestedIntFilter? count,
      NestedEnumSelcomUtilityCodeFilter? $min,
      NestedEnumSelcomUtilityCodeFilter? min,
      NestedEnumSelcomUtilityCodeFilter? $max,
      NestedEnumSelcomUtilityCodeFilter? max}) {
    return EnumSelcomUtilityCodeWithAggregatesFilter(
