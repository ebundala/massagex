...
class ServiceUpdateManyWithoutBusinessInput extends Equatable {
  ...
  ServiceUpdateManyWithoutBusinessInput(
      {this.create,
  ...
  static ServiceUpdateManyWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUpdateManyWithoutBusinessInput(
  ...
  ServiceUpdateManyWithoutBusinessInput copyWith(
