import 'favorite_create_without_order_input.dart';
import 'favorite_create_or_connect_without_order_input.dart';
import 'favorite_upsert_with_where_unique_without_order_input.dart';
import 'favorite_create_many_order_input_envelope.dart';
import 'favorite_where_unique_input.dart';
import 'favorite_update_with_where_unique_without_order_input.dart';
import 'favorite_update_many_with_where_without_order_input.dart';
import 'favorite_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class FavoriteUncheckedUpdateManyWithoutOrderInput extends Equatable {
  final List<FavoriteCreateWithoutOrderInput>? create;
  final List<FavoriteCreateOrConnectWithoutOrderInput>? connectOrCreate;
  final List<FavoriteUpsertWithWhereUniqueWithoutOrderInput>? upsert;
  final FavoriteCreateManyOrderInputEnvelope? createMany;
  ...
  final List<FavoriteUpdateWithWhereUniqueWithoutOrderInput>? update;
  final List<FavoriteUpdateManyWithWhereWithoutOrderInput>? updateMany;
  ...
  FavoriteUncheckedUpdateManyWithoutOrderInput(
      {this.create,
  ...
  static FavoriteUncheckedUpdateManyWithoutOrderInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedUpdateManyWithoutOrderInput(
      create: json['create'] != null
          ? List.generate(
              json['create'].length,
              (index) => FavoriteCreateWithoutOrderInput.fromJson(
                  json['create'][index]))
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? List.generate(
              json['connectOrCreate'].length,
              (index) => FavoriteCreateOrConnectWithoutOrderInput.fromJson(
      ...
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) =>
                  FavoriteUpsertWithWhereUniqueWithoutOrderInput.fromJson(
                      json['upsert'][index]))
          : null,
      createMany: json['createMany'] != null
          ? FavoriteCreateManyOrderInputEnvelope.fromJson(json['createMany'])
          : null,
      ...
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) =>
                  FavoriteUpdateWithWhereUniqueWithoutOrderInput.fromJson(
                      json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              json['updateMany'].length,
              (index) => FavoriteUpdateManyWithWhereWithoutOrderInput.fromJson(
  ...
  FavoriteUncheckedUpdateManyWithoutOrderInput copyWith(
      {List<FavoriteCreateWithoutOrderInput>? create,
      List<FavoriteCreateOrConnectWithoutOrderInput>? connectOrCreate,
      List<FavoriteUpsertWithWhereUniqueWithoutOrderInput>? upsert,
      FavoriteCreateManyOrderInputEnvelope? createMany,
      ...
      List<FavoriteUpdateWithWhereUniqueWithoutOrderInput>? update,
      List<FavoriteUpdateManyWithWhereWithoutOrderInput>? updateMany,
