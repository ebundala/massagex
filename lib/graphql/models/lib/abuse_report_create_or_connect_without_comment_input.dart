...
class AbuseReportCreateOrConnectWithoutCommentInput extends Equatable {
  ...
  AbuseReportCreateOrConnectWithoutCommentInput(
      {required this.where, required this.create});

  static AbuseReportCreateOrConnectWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportCreateOrConnectWithoutCommentInput(
  ...
  AbuseReportCreateOrConnectWithoutCommentInput copyWith(
