...
import 'abuse_report_upsert_with_where_unique_without_type_input.dart';
import 'abuse_report_create_many_type_input_envelope.dart';
import 'abuse_report_where_unique_input.dart';
import 'abuse_report_update_with_where_unique_without_type_input.dart';
import 'abuse_report_update_many_with_where_without_type_input.dart';
import 'abuse_report_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class AbuseReportUncheckedUpdateManyWithoutTypeInput extends Equatable {
  final List<AbuseReportCreateWithoutTypeInput>? create;
  final List<AbuseReportCreateOrConnectWithoutTypeInput>? connectOrCreate;
  final List<AbuseReportUpsertWithWhereUniqueWithoutTypeInput>? upsert;
  ...
  final List<AbuseReportUpdateWithWhereUniqueWithoutTypeInput>? update;
  final List<AbuseReportUpdateManyWithWhereWithoutTypeInput>? updateMany;
  ...
  AbuseReportUncheckedUpdateManyWithoutTypeInput(
      {this.create,
  ...
  static AbuseReportUncheckedUpdateManyWithoutTypeInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedUpdateManyWithoutTypeInput(
      ...
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) =>
                  AbuseReportUpsertWithWhereUniqueWithoutTypeInput.fromJson(
                      json['upsert'][index]))
          : null,
      ...
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) =>
                  AbuseReportUpdateWithWhereUniqueWithoutTypeInput.fromJson(
                      json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              ...
              (index) =>
                  AbuseReportUpdateManyWithWhereWithoutTypeInput.fromJson(
  ...
  AbuseReportUncheckedUpdateManyWithoutTypeInput copyWith(
      {List<AbuseReportCreateWithoutTypeInput>? create,
      List<AbuseReportCreateOrConnectWithoutTypeInput>? connectOrCreate,
      List<AbuseReportUpsertWithWhereUniqueWithoutTypeInput>? upsert,
      ...
      List<AbuseReportUpdateWithWhereUniqueWithoutTypeInput>? update,
      List<AbuseReportUpdateManyWithWhereWithoutTypeInput>? updateMany,
