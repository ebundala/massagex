...
class AbuseReportUncheckedCreateInput extends Equatable {
  final String? id;
  final int? number;
  final String? report;
  ...
  AbuseReportUncheckedCreateInput(
      {this.id,
      this.number,
      this.report,
  ...
  static AbuseReportUncheckedCreateInput fromJson(Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedCreateInput(
      id: json['id'],
      number: json['number'],
      report: json['report'],
  ...
  AbuseReportUncheckedCreateInput copyWith(
      {String? id,
      int? number,
      String? report,
      String? authorId,
