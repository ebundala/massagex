...
class AttachmentCreateNestedOneWithoutOrdersInput extends Equatable {
  ...
  AttachmentCreateNestedOneWithoutOrdersInput(
      {this.create, this.connectOrCreate, this.connect});

  static AttachmentCreateNestedOneWithoutOrdersInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateNestedOneWithoutOrdersInput(
  ...
  AttachmentCreateNestedOneWithoutOrdersInput copyWith(
