...
class OrderUncheckedUpdateWithoutAbuseReportsInput extends Equatable {
  ...
  OrderUncheckedUpdateWithoutAbuseReportsInput(
      {this.id,
      this.quantity,
      this.recordStatus,
      this.orderStatus,
  ...
  static OrderUncheckedUpdateWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUncheckedUpdateWithoutAbuseReportsInput(
      id: json['id'] != null
  ...
  OrderUncheckedUpdateWithoutAbuseReportsInput copyWith(
