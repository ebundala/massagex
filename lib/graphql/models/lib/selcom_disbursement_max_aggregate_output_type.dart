...
class SelcomDisbursementMaxAggregateOutputType extends Equatable {
  final String? id;
  final int? amount;
  ...
  SelcomDisbursementMaxAggregateOutputType(
      {this.id,
      this.amount,
      this.reference,
      this.resultCode,
  ...
  static SelcomDisbursementMaxAggregateOutputType fromJson(
      Map<dynamic, dynamic> json) {
    return SelcomDisbursementMaxAggregateOutputType(
      id: json['id'],
      amount: json['amount'],
  ...
  SelcomDisbursementMaxAggregateOutputType copyWith(
      {String? id,
      int? amount,
      String? reference,
      String? resultCode,
...
extension SelcomDisbursementMaxAggregateOutputTypeExt
    on SelcomDisbursementMaxAggregateOutputType {
...
class SelcomDisbursementMaxAggregateOutputTypeController
    extends ValueNotifier<SelcomDisbursementMaxAggregateOutputType> {
  ...
  final SelcomDisbursementMaxAggregateOutputType initialValue;
  final SelectionSetNode selectionSet;
  final Map<String, SelectionNodeData> selections = {};
  SelcomDisbursementMaxAggregateOutputTypeController({
