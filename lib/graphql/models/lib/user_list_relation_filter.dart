import 'user_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class UserListRelationFilter extends Equatable {
  ...
  UserListRelationFilter({this.every, this.some, this.none});

  static UserListRelationFilter fromJson(Map<dynamic, dynamic> json) {
    return UserListRelationFilter(
      every:
          json['every'] != null ? UserWhereInput.fromJson(json['every']) : null,
      some: json['some'] != null ? UserWhereInput.fromJson(json['some']) : null,
      none: json['none'] != null ? UserWhereInput.fromJson(json['none']) : null,
    );
  }
  ...
  UserListRelationFilter copyWith(
      {UserWhereInput? every, UserWhereInput? some, UserWhereInput? none}) {
    return UserListRelationFilter(
