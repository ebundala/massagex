...
class FavoriteUpdateWithoutCommentInput extends Equatable {
  ...
  FavoriteUpdateWithoutCommentInput(
      {this.id,
      this.favId,
      this.recordStatus,
      this.createdAt,
  ...
  static FavoriteUpdateWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUpdateWithoutCommentInput(
      id: json['id'] != null
  ...
  FavoriteUpdateWithoutCommentInput copyWith(
