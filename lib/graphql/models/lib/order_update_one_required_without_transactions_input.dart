...
import 'order_create_or_connect_without_transactions_input.dart';
import 'order_upsert_without_transactions_input.dart';
...
class OrderUpdateOneRequiredWithoutTransactionsInput extends Equatable {
  final OrderCreateWithoutTransactionsInput? create;
  final OrderCreateOrConnectWithoutTransactionsInput? connectOrCreate;
  final OrderUpsertWithoutTransactionsInput? upsert;
  ...
  OrderUpdateOneRequiredWithoutTransactionsInput(
      {this.create,
  ...
  static OrderUpdateOneRequiredWithoutTransactionsInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUpdateOneRequiredWithoutTransactionsInput(
      create: json['create'] != null
          ? OrderCreateWithoutTransactionsInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? OrderCreateOrConnectWithoutTransactionsInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? OrderUpsertWithoutTransactionsInput.fromJson(json['upsert'])
          : null,
      connect: json['connect'] != null
          ? OrderWhereUniqueInput.fromJson(json['connect'])
          : null,
      update: json['update'] != null
          ? OrderUpdateWithoutTransactionsInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  OrderUpdateOneRequiredWithoutTransactionsInput copyWith(
      {OrderCreateWithoutTransactionsInput? create,
      OrderCreateOrConnectWithoutTransactionsInput? connectOrCreate,
      OrderUpsertWithoutTransactionsInput? upsert,
