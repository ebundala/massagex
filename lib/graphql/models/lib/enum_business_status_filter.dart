...
class EnumBusinessStatusFilter extends Equatable {
  ...
  EnumBusinessStatusFilter({this.equals, this.in$, this.notIn, this.not});

  static EnumBusinessStatusFilter fromJson(Map<dynamic, dynamic> json) {
    return EnumBusinessStatusFilter(
  ...
  EnumBusinessStatusFilter copyWith(
