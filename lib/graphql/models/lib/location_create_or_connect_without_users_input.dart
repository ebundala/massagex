...
class LocationCreateOrConnectWithoutUsersInput extends Equatable {
  ...
  LocationCreateOrConnectWithoutUsersInput(
      {required this.where, required this.create});

  static LocationCreateOrConnectWithoutUsersInput fromJson(
      Map<dynamic, dynamic> json) {
    return LocationCreateOrConnectWithoutUsersInput(
  ...
  LocationCreateOrConnectWithoutUsersInput copyWith(
