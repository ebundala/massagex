...
class OrderCreateWithoutAbuseReportsInput extends Equatable {
  final String? id;
  final int quantity;
  ...
  OrderCreateWithoutAbuseReportsInput(
      {this.id,
  ...
  static OrderCreateWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderCreateWithoutAbuseReportsInput(
      id: json['id'],
  ...
  OrderCreateWithoutAbuseReportsInput copyWith(
      {String? id,
      int? quantity,
