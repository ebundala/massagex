...
class BusinessUpdateWithoutLocationInput extends Equatable {
  ...
  BusinessUpdateWithoutLocationInput(
      {this.id,
      this.mode,
      this.about,
      this.businessName,
  ...
  static BusinessUpdateWithoutLocationInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUpdateWithoutLocationInput(
      id: json['id'] != null
  ...
  BusinessUpdateWithoutLocationInput copyWith(
