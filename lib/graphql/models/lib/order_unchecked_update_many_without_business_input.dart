...
import 'order_create_or_connect_without_business_input.dart';
import 'order_upsert_with_where_unique_without_business_input.dart';
import 'order_create_many_business_input_envelope.dart';
import 'order_where_unique_input.dart';
import 'order_update_with_where_unique_without_business_input.dart';
import 'order_update_many_with_where_without_business_input.dart';
import 'order_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class OrderUncheckedUpdateManyWithoutBusinessInput extends Equatable {
  final List<OrderCreateWithoutBusinessInput>? create;
  final List<OrderCreateOrConnectWithoutBusinessInput>? connectOrCreate;
  final List<OrderUpsertWithWhereUniqueWithoutBusinessInput>? upsert;
  final OrderCreateManyBusinessInputEnvelope? createMany;
  ...
  final List<OrderUpdateWithWhereUniqueWithoutBusinessInput>? update;
  final List<OrderUpdateManyWithWhereWithoutBusinessInput>? updateMany;
  ...
  static OrderUncheckedUpdateManyWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUncheckedUpdateManyWithoutBusinessInput(
      create: json['create'] != null
          ? List.generate(
              json['create'].length,
              (index) => OrderCreateWithoutBusinessInput.fromJson(
                  json['create'][index]))
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? List.generate(
              json['connectOrCreate'].length,
              (index) => OrderCreateOrConnectWithoutBusinessInput.fromJson(
      ...
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) =>
                  OrderUpsertWithWhereUniqueWithoutBusinessInput.fromJson(
                      json['upsert'][index]))
          : null,
      createMany: json['createMany'] != null
          ? OrderCreateManyBusinessInputEnvelope.fromJson(json['createMany'])
          : null,
      ...
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) =>
                  OrderUpdateWithWhereUniqueWithoutBusinessInput.fromJson(
                      json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              json['updateMany'].length,
              (index) => OrderUpdateManyWithWhereWithoutBusinessInput.fromJson(
  ...
  OrderUncheckedUpdateManyWithoutBusinessInput copyWith(
      {List<OrderCreateWithoutBusinessInput>? create,
      List<OrderCreateOrConnectWithoutBusinessInput>? connectOrCreate,
      List<OrderUpsertWithWhereUniqueWithoutBusinessInput>? upsert,
      OrderCreateManyBusinessInputEnvelope? createMany,
      ...
      List<OrderUpdateWithWhereUniqueWithoutBusinessInput>? update,
      List<OrderUpdateManyWithWhereWithoutBusinessInput>? updateMany,
