...
class ServiceUncheckedCreateWithoutAbuseReportsInput extends Equatable {
  final String? id;
  final String name;
  ...
  ServiceUncheckedCreateWithoutAbuseReportsInput(
      {this.id,
      required this.name,
      this.description,
      required this.price,
  ...
  static ServiceUncheckedCreateWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUncheckedCreateWithoutAbuseReportsInput(
      id: json['id'],
      name: json['name'],
  ...
  ServiceUncheckedCreateWithoutAbuseReportsInput copyWith(
      {String? id,
      String? name,
      String? description,
      double? price,
