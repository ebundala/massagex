...
class ServiceCreateNestedOneWithoutOrdersInput extends Equatable {
  ...
  static ServiceCreateNestedOneWithoutOrdersInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceCreateNestedOneWithoutOrdersInput(
  ...
  ServiceCreateNestedOneWithoutOrdersInput copyWith(
