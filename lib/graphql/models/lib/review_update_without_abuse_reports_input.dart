...
class ReviewUpdateWithoutAbuseReportsInput extends Equatable {
  ...
  ReviewUpdateWithoutAbuseReportsInput(
      {this.id,
      this.value,
      this.content,
      this.recordStatus,
  ...
  static ReviewUpdateWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewUpdateWithoutAbuseReportsInput(
      id: json['id'] != null
  ...
  ReviewUpdateWithoutAbuseReportsInput copyWith(
