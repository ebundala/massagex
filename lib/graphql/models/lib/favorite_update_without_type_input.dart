...
class FavoriteUpdateWithoutTypeInput extends Equatable {
  ...
  FavoriteUpdateWithoutTypeInput(
      {this.id,
      this.favId,
      this.recordStatus,
      this.createdAt,
  ...
  static FavoriteUpdateWithoutTypeInput fromJson(Map<dynamic, dynamic> json) {
    return FavoriteUpdateWithoutTypeInput(
      id: json['id'] != null
  ...
  FavoriteUpdateWithoutTypeInput copyWith(
