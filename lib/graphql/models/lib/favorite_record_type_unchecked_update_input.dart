...
import 'favorite_unchecked_update_many_without_type_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class FavoriteRecordTypeUncheckedUpdateInput extends Equatable {
  final StringFieldUpdateOperationsInput? id;
  final StringFieldUpdateOperationsInput? name;
  final FavoriteUncheckedUpdateManyWithoutTypeInput? favorites;
  ...
  FavoriteRecordTypeUncheckedUpdateInput({this.id, this.name, this.favorites});

  static FavoriteRecordTypeUncheckedUpdateInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteRecordTypeUncheckedUpdateInput(
      id: json['id'] != null
      ...
      favorites: json['favorites'] != null
          ? FavoriteUncheckedUpdateManyWithoutTypeInput.fromJson(
              json['favorites'])
          : null,
    );
  }
  ...
  FavoriteRecordTypeUncheckedUpdateInput copyWith(
      {StringFieldUpdateOperationsInput? id,
      StringFieldUpdateOperationsInput? name,
      FavoriteUncheckedUpdateManyWithoutTypeInput? favorites}) {
    return FavoriteRecordTypeUncheckedUpdateInput(
        id: id ?? this.id,
        name: name ?? this.name,
