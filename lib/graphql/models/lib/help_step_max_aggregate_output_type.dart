...
class HelpStepMaxAggregateOutputType extends Equatable {
  final String? id;
  ...
  HelpStepMaxAggregateOutputType(
      {this.id,
      this.stepNumber,
      this.title,
      this.description,
  ...
  static HelpStepMaxAggregateOutputType fromJson(Map<dynamic, dynamic> json) {
    return HelpStepMaxAggregateOutputType(
      id: json['id'],
  ...
  HelpStepMaxAggregateOutputType copyWith(
      {String? id,
      int? stepNumber,
      String? title,
      String? description,
...
extension HelpStepMaxAggregateOutputTypeExt on HelpStepMaxAggregateOutputType {
...
class HelpStepMaxAggregateOutputTypeController
    extends ValueNotifier<HelpStepMaxAggregateOutputType> {
  ...
  final HelpStepMaxAggregateOutputType initialValue;
  final SelectionSetNode selectionSet;
  final Map<String, SelectionNodeData> selections = {};
  HelpStepMaxAggregateOutputTypeController({
