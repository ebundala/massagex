...
class OrderUpdateWithoutTransactionsInput extends Equatable {
  ...
  OrderUpdateWithoutTransactionsInput(
      {this.id,
      this.quantity,
      this.recordStatus,
      this.orderStatus,
  ...
  static OrderUpdateWithoutTransactionsInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUpdateWithoutTransactionsInput(
      id: json['id'] != null
  ...
  OrderUpdateWithoutTransactionsInput copyWith(
