...
class EnumBusinessModeFilter extends Equatable {
  final BusinessMode? equals;
  final List<BusinessMode>? in$;
  final List<BusinessMode>? notIn;
  final NestedEnumBusinessModeFilter? not;
  ...
  EnumBusinessModeFilter({this.equals, this.in$, this.notIn, this.not});

  static EnumBusinessModeFilter fromJson(Map<dynamic, dynamic> json) {
    return EnumBusinessModeFilter(
      ...
      notIn: json['notIn'] != null
          ...
          : null,
      not: json['not'] != null
          ? NestedEnumBusinessModeFilter.fromJson(json['not'])
          : null,
    );
  }
  ...
  EnumBusinessModeFilter copyWith(
      {BusinessMode? equals,
      List<BusinessMode>? in$,
      List<BusinessMode>? notIn,
      NestedEnumBusinessModeFilter? not}) {
    return EnumBusinessModeFilter(
