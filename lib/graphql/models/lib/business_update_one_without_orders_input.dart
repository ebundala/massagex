import 'business_create_without_orders_input.dart';
import 'business_create_or_connect_without_orders_input.dart';
import 'business_upsert_without_orders_input.dart';
import 'business_where_unique_input.dart';
import 'business_update_without_orders_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class BusinessUpdateOneWithoutOrdersInput extends Equatable {
  final BusinessCreateWithoutOrdersInput? create;
  final BusinessCreateOrConnectWithoutOrdersInput? connectOrCreate;
  final BusinessUpsertWithoutOrdersInput? upsert;
  final BusinessWhereUniqueInput? connect;
  final bool? disconnect;
  final bool? delete;
  final BusinessUpdateWithoutOrdersInput? update;
  ...
  BusinessUpdateOneWithoutOrdersInput(
      {this.create,
  ...
  static BusinessUpdateOneWithoutOrdersInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUpdateOneWithoutOrdersInput(
      create: json['create'] != null
          ? BusinessCreateWithoutOrdersInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? BusinessCreateOrConnectWithoutOrdersInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? BusinessUpsertWithoutOrdersInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? BusinessUpdateWithoutOrdersInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  BusinessUpdateOneWithoutOrdersInput copyWith(
      {BusinessCreateWithoutOrdersInput? create,
      BusinessCreateOrConnectWithoutOrdersInput? connectOrCreate,
      BusinessUpsertWithoutOrdersInput? upsert,
      BusinessWhereUniqueInput? connect,
      bool? disconnect,
      bool? delete,
      BusinessUpdateWithoutOrdersInput? update}) {
    return BusinessUpdateOneWithoutOrdersInput(
