...
class EnumPaymentStatusFilter extends Equatable {
  ...
  EnumPaymentStatusFilter({this.equals, this.in$, this.notIn, this.not});

  static EnumPaymentStatusFilter fromJson(Map<dynamic, dynamic> json) {
    return EnumPaymentStatusFilter(
  ...
  EnumPaymentStatusFilter copyWith(
