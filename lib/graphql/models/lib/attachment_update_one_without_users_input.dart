...
import 'attachment_create_or_connect_without_users_input.dart';
import 'attachment_upsert_without_users_input.dart';
...
class AttachmentUpdateOneWithoutUsersInput extends Equatable {
  final AttachmentCreateWithoutUsersInput? create;
  final AttachmentCreateOrConnectWithoutUsersInput? connectOrCreate;
  final AttachmentUpsertWithoutUsersInput? upsert;
  ...
  AttachmentUpdateOneWithoutUsersInput(
      {this.create,
  ...
  static AttachmentUpdateOneWithoutUsersInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUpdateOneWithoutUsersInput(
      create: json['create'] != null
          ? AttachmentCreateWithoutUsersInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? AttachmentCreateOrConnectWithoutUsersInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? AttachmentUpsertWithoutUsersInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? AttachmentUpdateWithoutUsersInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  AttachmentUpdateOneWithoutUsersInput copyWith(
      {AttachmentCreateWithoutUsersInput? create,
      AttachmentCreateOrConnectWithoutUsersInput? connectOrCreate,
      AttachmentUpsertWithoutUsersInput? upsert,
