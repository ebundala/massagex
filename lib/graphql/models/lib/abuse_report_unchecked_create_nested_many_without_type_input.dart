...
class AbuseReportUncheckedCreateNestedManyWithoutTypeInput extends Equatable {
  ...
  AbuseReportUncheckedCreateNestedManyWithoutTypeInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static AbuseReportUncheckedCreateNestedManyWithoutTypeInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedCreateNestedManyWithoutTypeInput(
  ...
  AbuseReportUncheckedCreateNestedManyWithoutTypeInput copyWith(
