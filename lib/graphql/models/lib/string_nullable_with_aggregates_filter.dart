...
import 'nested_string_nullable_with_aggregates_filter.dart';
import 'nested_int_nullable_filter.dart';
import 'nested_string_nullable_filter.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class StringNullableWithAggregatesFilter extends Equatable {
  final String? equals;
  ...
  static StringNullableWithAggregatesFilter fromJson(
    ...
    return StringNullableWithAggregatesFilter(
      ...
      not: json['not'] != null
          ? NestedStringNullableWithAggregatesFilter.fromJson(json['not'])
          : null,
      ...
      count: json['count'] != null
          ...
          : null,
      $min: json['_min'] != null
          ? NestedStringNullableFilter.fromJson(json['_min'])
          : null,
      min: json['min'] != null
          ? NestedStringNullableFilter.fromJson(json['min'])
          : null,
      $max: json['_max'] != null
          ? NestedStringNullableFilter.fromJson(json['_max'])
          : null,
      max: json['max'] != null
          ? NestedStringNullableFilter.fromJson(json['max'])
          : null,
    );
  }
  ...
  StringNullableWithAggregatesFilter copyWith(
      {String? equals,
      List<String>? in$,
      List<String>? notIn,
      String? lt,
      ...
      String? endsWith,
      QueryMode? mode,
      NestedStringNullableWithAggregatesFilter? not,
      NestedIntNullableFilter? $count,
      NestedIntNullableFilter? count,
      NestedStringNullableFilter? $min,
      NestedStringNullableFilter? min,
      NestedStringNullableFilter? $max,
      NestedStringNullableFilter? max}) {
    return StringNullableWithAggregatesFilter(
