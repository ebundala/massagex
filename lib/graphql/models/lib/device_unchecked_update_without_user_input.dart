...
class DeviceUncheckedUpdateWithoutUserInput extends Equatable {
  ...
  static DeviceUncheckedUpdateWithoutUserInput fromJson(
      Map<dynamic, dynamic> json) {
    return DeviceUncheckedUpdateWithoutUserInput(
      id: json['id'] != null
  ...
  DeviceUncheckedUpdateWithoutUserInput copyWith(
