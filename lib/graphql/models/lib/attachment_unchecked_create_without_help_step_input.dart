...
class AttachmentUncheckedCreateWithoutHelpStepInput extends Equatable {
  ...
  AttachmentUncheckedCreateWithoutHelpStepInput(
      {required this.path,
      this.id,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUncheckedCreateWithoutHelpStepInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedCreateWithoutHelpStepInput(
      path: json['path'],
      id: json['id'],
  ...
  AttachmentUncheckedCreateWithoutHelpStepInput copyWith(
      {MultipartFile? path,
      String? id,
      String? filename,
      String? mimetype,
