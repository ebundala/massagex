...
import 'user_create_or_connect_without_comments_input.dart';
import 'user_upsert_without_comments_input.dart';
import 'user_where_unique_input.dart';
import 'user_update_without_comments_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class UserUpdateOneRequiredWithoutCommentsInput extends Equatable {
  ...
  static UserUpdateOneRequiredWithoutCommentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUpdateOneRequiredWithoutCommentsInput(
      create: json['create'] != null
          ? UserCreateWithoutCommentsInput.fromJson(json['create'])
          : null,
      ...
      upsert: json['upsert'] != null
          ? UserUpsertWithoutCommentsInput.fromJson(json['upsert'])
          : null,
      connect: json['connect'] != null
          ? UserWhereUniqueInput.fromJson(json['connect'])
          : null,
      update: json['update'] != null
          ? UserUpdateWithoutCommentsInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  UserUpdateOneRequiredWithoutCommentsInput copyWith(
      {UserCreateWithoutCommentsInput? create,
      UserCreateOrConnectWithoutCommentsInput? connectOrCreate,
      UserUpsertWithoutCommentsInput? upsert,
      UserWhereUniqueInput? connect,
      UserUpdateWithoutCommentsInput? update}) {
    return UserUpdateOneRequiredWithoutCommentsInput(
