import 'favorite_create_many_user_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class FavoriteCreateManyUserInputEnvelope extends Equatable {
  final List<FavoriteCreateManyUserInput>? data;
  ...
  FavoriteCreateManyUserInputEnvelope({this.data, this.skipDuplicates});

  static FavoriteCreateManyUserInputEnvelope fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteCreateManyUserInputEnvelope(
      data: json['data'] != null
          ? List.generate(
              json['data'].length,
              (index) =>
                  FavoriteCreateManyUserInput.fromJson(json['data'][index]))
          : null,
  ...
  FavoriteCreateManyUserInputEnvelope copyWith(
      {List<FavoriteCreateManyUserInput>? data, bool? skipDuplicates}) {
    return FavoriteCreateManyUserInputEnvelope(
        data: data ?? this.data,
