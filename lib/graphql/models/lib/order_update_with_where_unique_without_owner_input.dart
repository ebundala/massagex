...
class OrderUpdateWithWhereUniqueWithoutOwnerInput extends Equatable {
  final OrderWhereUniqueInput where;
  final OrderUpdateWithoutOwnerInput data;
  ...
  static OrderUpdateWithWhereUniqueWithoutOwnerInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUpdateWithWhereUniqueWithoutOwnerInput(
      where: OrderWhereUniqueInput.fromJson(json['where']),
      data: OrderUpdateWithoutOwnerInput.fromJson(json['data']),
    );
  }
  ...
  OrderUpdateWithWhereUniqueWithoutOwnerInput copyWith(
      {OrderWhereUniqueInput? where, OrderUpdateWithoutOwnerInput? data}) {
    return OrderUpdateWithWhereUniqueWithoutOwnerInput(
