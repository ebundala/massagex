...
class NestedDateTimeNullableWithAggregatesFilter extends Equatable {
  ...
  static NestedDateTimeNullableWithAggregatesFilter fromJson(
      Map<dynamic, dynamic> json) {
    return NestedDateTimeNullableWithAggregatesFilter(
  ...
  NestedDateTimeNullableWithAggregatesFilter copyWith(
      {DateTime? equals,
      List<DateTime>? in$,
      List<DateTime>? notIn,
      DateTime? lt,
