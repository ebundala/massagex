...
class HelpStepUpdateWithoutHelpInput extends Equatable {
  ...
  HelpStepUpdateWithoutHelpInput(
      {this.id,
      this.stepNumber,
      this.title,
      this.description,
  ...
  static HelpStepUpdateWithoutHelpInput fromJson(Map<dynamic, dynamic> json) {
    return HelpStepUpdateWithoutHelpInput(
      id: json['id'] != null
  ...
  HelpStepUpdateWithoutHelpInput copyWith(
