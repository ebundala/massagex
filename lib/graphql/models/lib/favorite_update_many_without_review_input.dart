...
class FavoriteUpdateManyWithoutReviewInput extends Equatable {
  ...
  FavoriteUpdateManyWithoutReviewInput(
      {this.create,
  ...
  static FavoriteUpdateManyWithoutReviewInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUpdateManyWithoutReviewInput(
  ...
  FavoriteUpdateManyWithoutReviewInput copyWith(
