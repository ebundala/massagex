...
class AttachmentUncheckedCreateWithoutBusinessesInput extends Equatable {
  ...
  AttachmentUncheckedCreateWithoutBusinessesInput(
      {required this.path,
      this.id,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUncheckedCreateWithoutBusinessesInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedCreateWithoutBusinessesInput(
      path: json['path'],
      id: json['id'],
  ...
  AttachmentUncheckedCreateWithoutBusinessesInput copyWith(
      {MultipartFile? path,
      String? id,
      String? filename,
      String? mimetype,
