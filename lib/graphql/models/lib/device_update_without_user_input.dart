...
class DeviceUpdateWithoutUserInput extends Equatable {
  ...
  static DeviceUpdateWithoutUserInput fromJson(Map<dynamic, dynamic> json) {
    return DeviceUpdateWithoutUserInput(
      id: json['id'] != null
  ...
  DeviceUpdateWithoutUserInput copyWith(
