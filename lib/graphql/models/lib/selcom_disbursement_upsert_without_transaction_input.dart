...
class SelcomDisbursementUpsertWithoutTransactionInput extends Equatable {
  ...
  SelcomDisbursementUpsertWithoutTransactionInput(
      {required this.update, required this.create});

  static SelcomDisbursementUpsertWithoutTransactionInput fromJson(
      Map<dynamic, dynamic> json) {
    return SelcomDisbursementUpsertWithoutTransactionInput(
      update: SelcomDisbursementUpdateWithoutTransactionInput.fromJson(
          json['update']),
  ...
  SelcomDisbursementUpsertWithoutTransactionInput copyWith(
