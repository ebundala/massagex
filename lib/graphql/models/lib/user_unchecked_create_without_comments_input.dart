...
class UserUncheckedCreateWithoutCommentsInput extends Equatable {
  final String? id;
  final String email;
  ...
  static UserUncheckedCreateWithoutCommentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUncheckedCreateWithoutCommentsInput(
      id: json['id'],
      email: json['email'],
  ...
  UserUncheckedCreateWithoutCommentsInput copyWith(
      {String? id,
      String? email,
      String? displayName,
      String? phoneNumber,
