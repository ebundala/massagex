...
class AttachmentUncheckedUpdateWithoutCategoriesInput extends Equatable {
  ...
  AttachmentUncheckedUpdateWithoutCategoriesInput(
      {this.id,
      this.path,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUncheckedUpdateWithoutCategoriesInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedUpdateWithoutCategoriesInput(
      id: json['id'] != null
  ...
  AttachmentUncheckedUpdateWithoutCategoriesInput copyWith(
