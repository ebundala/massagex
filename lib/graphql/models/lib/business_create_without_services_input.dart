...
class BusinessCreateWithoutServicesInput extends Equatable {
  final String? id;
  ...
  BusinessCreateWithoutServicesInput(
      {this.id,
      this.mode,
      required this.about,
  ...
  static BusinessCreateWithoutServicesInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessCreateWithoutServicesInput(
      id: json['id'],
      mode:
  ...
  BusinessCreateWithoutServicesInput copyWith(
      {String? id,
      BusinessMode? mode,
      String? about,
      String? businessName,
