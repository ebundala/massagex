...
import 'transaction_unchecked_create_nested_one_without_mpesa_payment_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class MpesaPaymentUncheckedCreateInput extends Equatable {
  final String? id;
  ...
  final TransactionUncheckedCreateNestedOneWithoutMpesaPaymentInput?
      transaction;
  ...
  MpesaPaymentUncheckedCreateInput(
      {this.id,
  ...
  static MpesaPaymentUncheckedCreateInput fromJson(Map<dynamic, dynamic> json) {
    return MpesaPaymentUncheckedCreateInput(
      id: json['id'],
      ...
      transaction: json['transaction'] != null
          ? TransactionUncheckedCreateNestedOneWithoutMpesaPaymentInput
  ...
  MpesaPaymentUncheckedCreateInput copyWith(
      {String? id,
      String? input$Amount,
