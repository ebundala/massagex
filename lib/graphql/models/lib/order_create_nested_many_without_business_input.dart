...
class OrderCreateNestedManyWithoutBusinessInput extends Equatable {
  ...
  OrderCreateNestedManyWithoutBusinessInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static OrderCreateNestedManyWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderCreateNestedManyWithoutBusinessInput(
  ...
  OrderCreateNestedManyWithoutBusinessInput copyWith(
