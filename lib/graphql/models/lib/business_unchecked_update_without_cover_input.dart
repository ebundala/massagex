...
class BusinessUncheckedUpdateWithoutCoverInput extends Equatable {
  ...
  BusinessUncheckedUpdateWithoutCoverInput(
      {this.id,
      this.ownerId,
      this.mode,
      this.about,
  ...
  static BusinessUncheckedUpdateWithoutCoverInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUncheckedUpdateWithoutCoverInput(
      id: json['id'] != null
  ...
  BusinessUncheckedUpdateWithoutCoverInput copyWith(
