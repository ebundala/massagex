...
class BusinessUncheckedCreateWithoutOwnerInput extends Equatable {
  final String? id;
  ...
  static BusinessUncheckedCreateWithoutOwnerInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUncheckedCreateWithoutOwnerInput(
      id: json['id'],
      mode:
  ...
  BusinessUncheckedCreateWithoutOwnerInput copyWith(
      {String? id,
      BusinessMode? mode,
      String? coverId,
      String? about,
