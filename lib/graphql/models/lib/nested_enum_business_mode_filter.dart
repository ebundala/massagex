...
class NestedEnumBusinessModeFilter extends Equatable {
  ...
  NestedEnumBusinessModeFilter({this.equals, this.in$, this.notIn, this.not});

  static NestedEnumBusinessModeFilter fromJson(Map<dynamic, dynamic> json) {
    return NestedEnumBusinessModeFilter(
  ...
  NestedEnumBusinessModeFilter copyWith(
      {BusinessMode? equals,
