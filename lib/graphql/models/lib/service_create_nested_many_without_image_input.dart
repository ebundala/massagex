...
class ServiceCreateNestedManyWithoutImageInput extends Equatable {
  ...
  ServiceCreateNestedManyWithoutImageInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static ServiceCreateNestedManyWithoutImageInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceCreateNestedManyWithoutImageInput(
  ...
  ServiceCreateNestedManyWithoutImageInput copyWith(
