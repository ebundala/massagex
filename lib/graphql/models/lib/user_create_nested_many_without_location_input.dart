...
class UserCreateNestedManyWithoutLocationInput extends Equatable {
  ...
  UserCreateNestedManyWithoutLocationInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static UserCreateNestedManyWithoutLocationInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserCreateNestedManyWithoutLocationInput(
  ...
  UserCreateNestedManyWithoutLocationInput copyWith(
