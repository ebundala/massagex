...
import 'transaction_unchecked_update_one_without_mpesa_payment_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class MpesaPaymentUncheckedUpdateInput extends Equatable {
  ...
  final TransactionUncheckedUpdateOneWithoutMpesaPaymentInput? transaction;
  ...
  MpesaPaymentUncheckedUpdateInput(
      {this.id,
      this.input$Amount,
      this.input$Country,
      this.input$Currency,
  ...
  static MpesaPaymentUncheckedUpdateInput fromJson(Map<dynamic, dynamic> json) {
    return MpesaPaymentUncheckedUpdateInput(
      id: json['id'] != null
      ...
      transaction: json['transaction'] != null
          ? TransactionUncheckedUpdateOneWithoutMpesaPaymentInput.fromJson(
              json['transaction'])
          : null,
    );
  }
  ...
  MpesaPaymentUncheckedUpdateInput copyWith(
      ...
      TransactionUncheckedUpdateOneWithoutMpesaPaymentInput? transaction}) {
    return MpesaPaymentUncheckedUpdateInput(
        id: id ?? this.id,
