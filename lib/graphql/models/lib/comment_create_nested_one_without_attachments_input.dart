...
class CommentCreateNestedOneWithoutAttachmentsInput extends Equatable {
  ...
  static CommentCreateNestedOneWithoutAttachmentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentCreateNestedOneWithoutAttachmentsInput(
  ...
  CommentCreateNestedOneWithoutAttachmentsInput copyWith(
