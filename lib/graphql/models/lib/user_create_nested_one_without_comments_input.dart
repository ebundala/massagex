...
class UserCreateNestedOneWithoutCommentsInput extends Equatable {
  ...
  static UserCreateNestedOneWithoutCommentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserCreateNestedOneWithoutCommentsInput(
  ...
  UserCreateNestedOneWithoutCommentsInput copyWith(
