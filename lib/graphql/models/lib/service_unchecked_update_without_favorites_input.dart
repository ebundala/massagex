...
class ServiceUncheckedUpdateWithoutFavoritesInput extends Equatable {
  ...
  ServiceUncheckedUpdateWithoutFavoritesInput(
      {this.id,
      this.name,
      this.description,
      this.price,
  ...
  static ServiceUncheckedUpdateWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUncheckedUpdateWithoutFavoritesInput(
      id: json['id'] != null
  ...
  ServiceUncheckedUpdateWithoutFavoritesInput copyWith(
