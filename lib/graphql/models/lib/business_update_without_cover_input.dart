...
class BusinessUpdateWithoutCoverInput extends Equatable {
  ...
  BusinessUpdateWithoutCoverInput(
      {this.id,
      this.mode,
      this.about,
      this.businessName,
  ...
  static BusinessUpdateWithoutCoverInput fromJson(Map<dynamic, dynamic> json) {
    return BusinessUpdateWithoutCoverInput(
      id: json['id'] != null
  ...
  BusinessUpdateWithoutCoverInput copyWith(
