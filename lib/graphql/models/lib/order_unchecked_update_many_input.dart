...
class OrderUncheckedUpdateManyInput extends Equatable {
  ...
  static OrderUncheckedUpdateManyInput fromJson(Map<dynamic, dynamic> json) {
    return OrderUncheckedUpdateManyInput(
      id: json['id'] != null
  ...
  OrderUncheckedUpdateManyInput copyWith(
