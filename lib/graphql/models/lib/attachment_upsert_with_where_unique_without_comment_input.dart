...
class AttachmentUpsertWithWhereUniqueWithoutCommentInput extends Equatable {
  final AttachmentWhereUniqueInput where;
  final AttachmentUpdateWithoutCommentInput update;
  final AttachmentCreateWithoutCommentInput create;
  ...
  AttachmentUpsertWithWhereUniqueWithoutCommentInput(
      {required this.where, required this.update, required this.create});

  static AttachmentUpsertWithWhereUniqueWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUpsertWithWhereUniqueWithoutCommentInput(
      where: AttachmentWhereUniqueInput.fromJson(json['where']),
      update: AttachmentUpdateWithoutCommentInput.fromJson(json['update']),
      create: AttachmentCreateWithoutCommentInput.fromJson(json['create']),
    );
  }
  ...
  AttachmentUpsertWithWhereUniqueWithoutCommentInput copyWith(
      {AttachmentWhereUniqueInput? where,
      AttachmentUpdateWithoutCommentInput? update,
      AttachmentCreateWithoutCommentInput? create}) {
    return AttachmentUpsertWithWhereUniqueWithoutCommentInput(
