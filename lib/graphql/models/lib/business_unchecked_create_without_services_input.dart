...
class BusinessUncheckedCreateWithoutServicesInput extends Equatable {
  final String? id;
  ...
  BusinessUncheckedCreateWithoutServicesInput(
      {this.id,
  ...
  static BusinessUncheckedCreateWithoutServicesInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUncheckedCreateWithoutServicesInput(
      id: json['id'],
  ...
  BusinessUncheckedCreateWithoutServicesInput copyWith(
      {String? id,
      String? ownerId,
      BusinessMode? mode,
      String? coverId,
