import 'transaction_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class TransactionListRelationFilter extends Equatable {
  ...
  TransactionListRelationFilter({this.every, this.some, this.none});

  static TransactionListRelationFilter fromJson(Map<dynamic, dynamic> json) {
    return TransactionListRelationFilter(
      every: json['every'] != null
          ? TransactionWhereInput.fromJson(json['every'])
          : null,
      some: json['some'] != null
          ? TransactionWhereInput.fromJson(json['some'])
          : null,
      none: json['none'] != null
          ? TransactionWhereInput.fromJson(json['none'])
          : null,
    );
  }
  ...
  TransactionListRelationFilter copyWith(
      {TransactionWhereInput? every,
      TransactionWhereInput? some,
      TransactionWhereInput? none}) {
    return TransactionListRelationFilter(
