...
class AttachmentCreateInput extends Equatable {
  ...
  static AttachmentCreateInput fromJson(Map<dynamic, dynamic> json) {
    return AttachmentCreateInput(
      path: json['path'],
      id: json['id'],
  ...
  AttachmentCreateInput copyWith(
      {MultipartFile? path,
      String? id,
      String? filename,
      String? mimetype,
