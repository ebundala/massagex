import 'comment_create_many_author_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class CommentCreateManyAuthorInputEnvelope extends Equatable {
  final List<CommentCreateManyAuthorInput>? data;
  ...
  CommentCreateManyAuthorInputEnvelope({this.data, this.skipDuplicates});

  static CommentCreateManyAuthorInputEnvelope fromJson(
      Map<dynamic, dynamic> json) {
    return CommentCreateManyAuthorInputEnvelope(
      data: json['data'] != null
          ? List.generate(
              json['data'].length,
              (index) =>
                  CommentCreateManyAuthorInput.fromJson(json['data'][index]))
          : null,
  ...
  CommentCreateManyAuthorInputEnvelope copyWith(
      {List<CommentCreateManyAuthorInput>? data, bool? skipDuplicates}) {
    return CommentCreateManyAuthorInputEnvelope(
        data: data ?? this.data,
