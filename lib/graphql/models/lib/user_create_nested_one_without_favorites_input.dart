...
class UserCreateNestedOneWithoutFavoritesInput extends Equatable {
  ...
  UserCreateNestedOneWithoutFavoritesInput(
      {this.create, this.connectOrCreate, this.connect});

  static UserCreateNestedOneWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserCreateNestedOneWithoutFavoritesInput(
  ...
  UserCreateNestedOneWithoutFavoritesInput copyWith(
