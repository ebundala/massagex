...
class CommentUpdateWithoutCommentsInput extends Equatable {
  ...
  static CommentUpdateWithoutCommentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUpdateWithoutCommentsInput(
      id: json['id'] != null
  ...
  CommentUpdateWithoutCommentsInput copyWith(
