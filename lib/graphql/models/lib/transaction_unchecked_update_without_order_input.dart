...
class TransactionUncheckedUpdateWithoutOrderInput extends Equatable {
  ...
  TransactionUncheckedUpdateWithoutOrderInput(
      {this.id,
  ...
  static TransactionUncheckedUpdateWithoutOrderInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUncheckedUpdateWithoutOrderInput(
      id: json['id'] != null
  ...
  TransactionUncheckedUpdateWithoutOrderInput copyWith(
