...
class ReviewUncheckedUpdateManyWithoutReviewsInput extends Equatable {
  ...
  ReviewUncheckedUpdateManyWithoutReviewsInput(
      {this.id,
      this.authorId,
      this.value,
      this.content,
  ...
  static ReviewUncheckedUpdateManyWithoutReviewsInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewUncheckedUpdateManyWithoutReviewsInput(
      id: json['id'] != null
  ...
  ReviewUncheckedUpdateManyWithoutReviewsInput copyWith(
  ...
  List<Object?> get props =>
      [id, authorId, value, content, recordStatus, createdAt, updatedAt];
}
