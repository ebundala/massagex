...
import 'order_create_or_connect_without_abuse_reports_input.dart';
import 'order_upsert_without_abuse_reports_input.dart';
...
class OrderUpdateOneWithoutAbuseReportsInput extends Equatable {
  final OrderCreateWithoutAbuseReportsInput? create;
  final OrderCreateOrConnectWithoutAbuseReportsInput? connectOrCreate;
  final OrderUpsertWithoutAbuseReportsInput? upsert;
  ...
  OrderUpdateOneWithoutAbuseReportsInput(
      {this.create,
  ...
  static OrderUpdateOneWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUpdateOneWithoutAbuseReportsInput(
      create: json['create'] != null
          ? OrderCreateWithoutAbuseReportsInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? OrderCreateOrConnectWithoutAbuseReportsInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? OrderUpsertWithoutAbuseReportsInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? OrderUpdateWithoutAbuseReportsInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  OrderUpdateOneWithoutAbuseReportsInput copyWith(
      {OrderCreateWithoutAbuseReportsInput? create,
      OrderCreateOrConnectWithoutAbuseReportsInput? connectOrCreate,
      OrderUpsertWithoutAbuseReportsInput? upsert,
