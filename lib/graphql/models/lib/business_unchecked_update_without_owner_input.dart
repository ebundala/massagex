...
class BusinessUncheckedUpdateWithoutOwnerInput extends Equatable {
  ...
  static BusinessUncheckedUpdateWithoutOwnerInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUncheckedUpdateWithoutOwnerInput(
      id: json['id'] != null
  ...
  BusinessUncheckedUpdateWithoutOwnerInput copyWith(
