...
class ServiceUpdateWithoutFavoritesInput extends Equatable {
  ...
  ServiceUpdateWithoutFavoritesInput(
      {this.id,
      this.name,
      this.description,
      this.price,
  ...
  static ServiceUpdateWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUpdateWithoutFavoritesInput(
      id: json['id'] != null
  ...
  ServiceUpdateWithoutFavoritesInput copyWith(
