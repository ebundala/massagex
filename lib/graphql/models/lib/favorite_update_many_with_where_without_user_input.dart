...
class FavoriteUpdateManyWithWhereWithoutUserInput extends Equatable {
  ...
  static FavoriteUpdateManyWithWhereWithoutUserInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUpdateManyWithWhereWithoutUserInput(
  ...
  FavoriteUpdateManyWithWhereWithoutUserInput copyWith(
