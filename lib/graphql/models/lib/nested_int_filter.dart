...
class NestedIntFilter extends Equatable {
  final int? equals;
  final List<int>? in$;
  ...
  static NestedIntFilter fromJson(Map<dynamic, dynamic> json) {
    return NestedIntFilter(
      ...
      gt: json['gt'],
      gte: json['gte'],
      not: json['not'] != null ? NestedIntFilter.fromJson(json['not']) : null,
    );
  }
