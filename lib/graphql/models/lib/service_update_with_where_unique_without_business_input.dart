...
class ServiceUpdateWithWhereUniqueWithoutBusinessInput extends Equatable {
  final ServiceWhereUniqueInput where;
  final ServiceUpdateWithoutBusinessInput data;
  ...
  ServiceUpdateWithWhereUniqueWithoutBusinessInput(
      {required this.where, required this.data});

  static ServiceUpdateWithWhereUniqueWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUpdateWithWhereUniqueWithoutBusinessInput(
      where: ServiceWhereUniqueInput.fromJson(json['where']),
      data: ServiceUpdateWithoutBusinessInput.fromJson(json['data']),
    );
  }
  ...
  ServiceUpdateWithWhereUniqueWithoutBusinessInput copyWith(
      {ServiceWhereUniqueInput? where,
      ServiceUpdateWithoutBusinessInput? data}) {
    return ServiceUpdateWithWhereUniqueWithoutBusinessInput(
