...
class MpesaPaymentUncheckedUpdateWithoutTransactionInput extends Equatable {
  ...
  MpesaPaymentUncheckedUpdateWithoutTransactionInput(
      {this.id,
      this.input$Amount,
      this.input$Country,
      this.input$Currency,
  ...
  static MpesaPaymentUncheckedUpdateWithoutTransactionInput fromJson(
      Map<dynamic, dynamic> json) {
    return MpesaPaymentUncheckedUpdateWithoutTransactionInput(
      id: json['id'] != null
  ...
  MpesaPaymentUncheckedUpdateWithoutTransactionInput copyWith(
