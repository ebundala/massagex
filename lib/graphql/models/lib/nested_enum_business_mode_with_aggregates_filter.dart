...
class NestedEnumBusinessModeWithAggregatesFilter extends Equatable {
  ...
  NestedEnumBusinessModeWithAggregatesFilter(
      {this.equals,
      this.in$,
      this.notIn,
      this.not,
  ...
  static NestedEnumBusinessModeWithAggregatesFilter fromJson(
      Map<dynamic, dynamic> json) {
    return NestedEnumBusinessModeWithAggregatesFilter(
  ...
  NestedEnumBusinessModeWithAggregatesFilter copyWith(
      {BusinessMode? equals,
