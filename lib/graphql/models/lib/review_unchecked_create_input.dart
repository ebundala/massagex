...
class ReviewUncheckedCreateInput extends Equatable {
  final String? id;
  ...
  static ReviewUncheckedCreateInput fromJson(Map<dynamic, dynamic> json) {
    return ReviewUncheckedCreateInput(
      id: json['id'],
  ...
  ReviewUncheckedCreateInput copyWith(
      {String? id,
      String? authorId,
      String? revieweeId,
      int? value,
