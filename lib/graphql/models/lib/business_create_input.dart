...
class BusinessCreateInput extends Equatable {
  final String? id;
  ...
  static BusinessCreateInput fromJson(Map<dynamic, dynamic> json) {
    return BusinessCreateInput(
      id: json['id'],
      mode:
