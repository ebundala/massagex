...
class FavoriteUpdateManyWithoutTypeInput extends Equatable {
  ...
  FavoriteUpdateManyWithoutTypeInput(
      {this.create,
  ...
  static FavoriteUpdateManyWithoutTypeInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUpdateManyWithoutTypeInput(
  ...
  FavoriteUpdateManyWithoutTypeInput copyWith(
