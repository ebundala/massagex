...
class ServiceUpdateManyWithWhereWithoutBusinessInput extends Equatable {
  ...
  ServiceUpdateManyWithWhereWithoutBusinessInput(
      {required this.where, required this.data});

  static ServiceUpdateManyWithWhereWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUpdateManyWithWhereWithoutBusinessInput(
  ...
  ServiceUpdateManyWithWhereWithoutBusinessInput copyWith(
