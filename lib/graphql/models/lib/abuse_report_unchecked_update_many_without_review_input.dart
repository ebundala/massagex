import 'abuse_report_create_without_review_input.dart';
import 'abuse_report_create_or_connect_without_review_input.dart';
import 'abuse_report_upsert_with_where_unique_without_review_input.dart';
import 'abuse_report_create_many_review_input_envelope.dart';
import 'abuse_report_where_unique_input.dart';
import 'abuse_report_update_with_where_unique_without_review_input.dart';
import 'abuse_report_update_many_with_where_without_review_input.dart';
import 'abuse_report_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class AbuseReportUncheckedUpdateManyWithoutReviewInput extends Equatable {
  final List<AbuseReportCreateWithoutReviewInput>? create;
  final List<AbuseReportCreateOrConnectWithoutReviewInput>? connectOrCreate;
  final List<AbuseReportUpsertWithWhereUniqueWithoutReviewInput>? upsert;
  final AbuseReportCreateManyReviewInputEnvelope? createMany;
  ...
  final List<AbuseReportUpdateWithWhereUniqueWithoutReviewInput>? update;
  final List<AbuseReportUpdateManyWithWhereWithoutReviewInput>? updateMany;
  ...
  AbuseReportUncheckedUpdateManyWithoutReviewInput(
      {this.create,
  ...
  static AbuseReportUncheckedUpdateManyWithoutReviewInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedUpdateManyWithoutReviewInput(
      create: json['create'] != null
          ? List.generate(
              json['create'].length,
              (index) => AbuseReportCreateWithoutReviewInput.fromJson(
                  json['create'][index]))
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? List.generate(
              json['connectOrCreate'].length,
              (index) => AbuseReportCreateOrConnectWithoutReviewInput.fromJson(
      ...
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) =>
                  AbuseReportUpsertWithWhereUniqueWithoutReviewInput.fromJson(
                      json['upsert'][index]))
          : null,
      createMany: json['createMany'] != null
          ? AbuseReportCreateManyReviewInputEnvelope.fromJson(
              json['createMany'])
          : null,
      ...
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) =>
                  AbuseReportUpdateWithWhereUniqueWithoutReviewInput.fromJson(
                      json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              ...
              (index) =>
                  AbuseReportUpdateManyWithWhereWithoutReviewInput.fromJson(
  ...
  AbuseReportUncheckedUpdateManyWithoutReviewInput copyWith(
      {List<AbuseReportCreateWithoutReviewInput>? create,
      List<AbuseReportCreateOrConnectWithoutReviewInput>? connectOrCreate,
      List<AbuseReportUpsertWithWhereUniqueWithoutReviewInput>? upsert,
      AbuseReportCreateManyReviewInputEnvelope? createMany,
      ...
      List<AbuseReportUpdateWithWhereUniqueWithoutReviewInput>? update,
      List<AbuseReportUpdateManyWithWhereWithoutReviewInput>? updateMany,
