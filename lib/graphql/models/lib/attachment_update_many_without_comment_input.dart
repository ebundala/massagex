import 'attachment_create_without_comment_input.dart';
import 'attachment_create_or_connect_without_comment_input.dart';
import 'attachment_upsert_with_where_unique_without_comment_input.dart';
import 'attachment_create_many_comment_input_envelope.dart';
import 'attachment_where_unique_input.dart';
import 'attachment_update_with_where_unique_without_comment_input.dart';
import 'attachment_update_many_with_where_without_comment_input.dart';
import 'attachment_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class AttachmentUpdateManyWithoutCommentInput extends Equatable {
  final List<AttachmentCreateWithoutCommentInput>? create;
  final List<AttachmentCreateOrConnectWithoutCommentInput>? connectOrCreate;
  final List<AttachmentUpsertWithWhereUniqueWithoutCommentInput>? upsert;
  final AttachmentCreateManyCommentInputEnvelope? createMany;
  ...
  final List<AttachmentUpdateWithWhereUniqueWithoutCommentInput>? update;
  final List<AttachmentUpdateManyWithWhereWithoutCommentInput>? updateMany;
  ...
  AttachmentUpdateManyWithoutCommentInput(
      {this.create,
  ...
  static AttachmentUpdateManyWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUpdateManyWithoutCommentInput(
      create: json['create'] != null
          ? List.generate(
              json['create'].length,
              (index) => AttachmentCreateWithoutCommentInput.fromJson(
                  json['create'][index]))
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? List.generate(
              json['connectOrCreate'].length,
              (index) => AttachmentCreateOrConnectWithoutCommentInput.fromJson(
      ...
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) =>
                  AttachmentUpsertWithWhereUniqueWithoutCommentInput.fromJson(
                      json['upsert'][index]))
          : null,
      createMany: json['createMany'] != null
          ? AttachmentCreateManyCommentInputEnvelope.fromJson(
              json['createMany'])
          : null,
      ...
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) =>
                  AttachmentUpdateWithWhereUniqueWithoutCommentInput.fromJson(
                      json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              ...
              (index) =>
                  AttachmentUpdateManyWithWhereWithoutCommentInput.fromJson(
  ...
  AttachmentUpdateManyWithoutCommentInput copyWith(
      {List<AttachmentCreateWithoutCommentInput>? create,
      List<AttachmentCreateOrConnectWithoutCommentInput>? connectOrCreate,
      List<AttachmentUpsertWithWhereUniqueWithoutCommentInput>? upsert,
      AttachmentCreateManyCommentInputEnvelope? createMany,
      ...
      List<AttachmentUpdateWithWhereUniqueWithoutCommentInput>? update,
      List<AttachmentUpdateManyWithWhereWithoutCommentInput>? updateMany,
