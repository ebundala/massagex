...
class NestedEnumPaymentMethodStatusWithAggregatesFilter extends Equatable {
  ...
  NestedEnumPaymentMethodStatusWithAggregatesFilter(
      {this.equals,
      this.in$,
      this.notIn,
      this.not,
  ...
  static NestedEnumPaymentMethodStatusWithAggregatesFilter fromJson(
      Map<dynamic, dynamic> json) {
    return NestedEnumPaymentMethodStatusWithAggregatesFilter(
  ...
  NestedEnumPaymentMethodStatusWithAggregatesFilter copyWith(
