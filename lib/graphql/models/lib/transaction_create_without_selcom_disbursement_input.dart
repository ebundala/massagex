...
class TransactionCreateWithoutSelcomDisbursementInput extends Equatable {
  final String? id;
  ...
  TransactionCreateWithoutSelcomDisbursementInput(
      {this.id,
      required this.type,
      this.status,
      this.recordStatus,
  ...
  static TransactionCreateWithoutSelcomDisbursementInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionCreateWithoutSelcomDisbursementInput(
      id: json['id'],
  ...
  TransactionCreateWithoutSelcomDisbursementInput copyWith(
      {String? id,
