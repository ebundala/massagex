...
class AbuseReportUncheckedUpdateManyWithoutAbuseReportedInput
    extends Equatable {
  ...
  AbuseReportUncheckedUpdateManyWithoutAbuseReportedInput(
      {this.id,
      this.number,
      this.report,
      this.typeId,
  ...
  static AbuseReportUncheckedUpdateManyWithoutAbuseReportedInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedUpdateManyWithoutAbuseReportedInput(
      id: json['id'] != null
  ...
  AbuseReportUncheckedUpdateManyWithoutAbuseReportedInput copyWith(
