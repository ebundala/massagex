...
class ReviewUpdateManyWithWhereWithoutRevieweeInput extends Equatable {
  ...
  ReviewUpdateManyWithWhereWithoutRevieweeInput(
      {required this.where, required this.data});

  static ReviewUpdateManyWithWhereWithoutRevieweeInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewUpdateManyWithWhereWithoutRevieweeInput(
  ...
  ReviewUpdateManyWithWhereWithoutRevieweeInput copyWith(
