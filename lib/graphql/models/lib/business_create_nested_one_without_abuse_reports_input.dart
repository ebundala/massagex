...
class BusinessCreateNestedOneWithoutAbuseReportsInput extends Equatable {
  ...
  BusinessCreateNestedOneWithoutAbuseReportsInput(
      {this.create, this.connectOrCreate, this.connect});

  static BusinessCreateNestedOneWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessCreateNestedOneWithoutAbuseReportsInput(
  ...
  BusinessCreateNestedOneWithoutAbuseReportsInput copyWith(
