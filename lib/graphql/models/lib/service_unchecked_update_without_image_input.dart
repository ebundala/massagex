...
class ServiceUncheckedUpdateWithoutImageInput extends Equatable {
  ...
  ServiceUncheckedUpdateWithoutImageInput(
      {this.id,
      this.name,
      this.description,
      this.price,
  ...
  static ServiceUncheckedUpdateWithoutImageInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUncheckedUpdateWithoutImageInput(
      id: json['id'] != null
  ...
  ServiceUncheckedUpdateWithoutImageInput copyWith(
