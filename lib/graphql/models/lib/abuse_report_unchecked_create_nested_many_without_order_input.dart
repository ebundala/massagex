...
class AbuseReportUncheckedCreateNestedManyWithoutOrderInput extends Equatable {
  ...
  AbuseReportUncheckedCreateNestedManyWithoutOrderInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static AbuseReportUncheckedCreateNestedManyWithoutOrderInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedCreateNestedManyWithoutOrderInput(
  ...
  AbuseReportUncheckedCreateNestedManyWithoutOrderInput copyWith(
