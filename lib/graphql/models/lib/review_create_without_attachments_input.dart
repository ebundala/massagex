...
class ReviewCreateWithoutAttachmentsInput extends Equatable {
  final String? id;
  final int? value;
  ...
  ReviewCreateWithoutAttachmentsInput(
      {this.id,
      this.value,
      this.content,
      this.recordStatus,
  ...
  static ReviewCreateWithoutAttachmentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewCreateWithoutAttachmentsInput(
      id: json['id'],
      value: json['value'],
  ...
  ReviewCreateWithoutAttachmentsInput copyWith(
      {String? id,
      int? value,
      String? content,
