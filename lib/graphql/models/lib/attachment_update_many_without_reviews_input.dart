...
class AttachmentUpdateManyWithoutReviewsInput extends Equatable {
  ...
  AttachmentUpdateManyWithoutReviewsInput(
      {this.create,
  ...
  static AttachmentUpdateManyWithoutReviewsInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUpdateManyWithoutReviewsInput(
  ...
  AttachmentUpdateManyWithoutReviewsInput copyWith(
