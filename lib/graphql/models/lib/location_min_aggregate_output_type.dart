...
class LocationMinAggregateOutputType extends Equatable {
  final String? id;
  final String? name;
  final double? lat;
  final double? lon;
  ...
  static LocationMinAggregateOutputType fromJson(Map<dynamic, dynamic> json) {
    return LocationMinAggregateOutputType(
      id: json['id'],
      name: json['name'],
  ...
  LocationMinAggregateOutputType copyWith(
      {String? id,
      String? name,
      double? lat,
      double? lon,
...
extension LocationMinAggregateOutputTypeExt on LocationMinAggregateOutputType {
...
class LocationMinAggregateOutputTypeController
    extends ValueNotifier<LocationMinAggregateOutputType> {
  ...
  final LocationMinAggregateOutputType initialValue;
  final SelectionSetNode selectionSet;
  final Map<String, SelectionNodeData> selections = {};
  LocationMinAggregateOutputTypeController({
