...
class HelpStepUncheckedUpdateWithoutAttachmentsInput extends Equatable {
  ...
  HelpStepUncheckedUpdateWithoutAttachmentsInput(
      {this.id,
      this.stepNumber,
      this.title,
      this.description,
  ...
  static HelpStepUncheckedUpdateWithoutAttachmentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return HelpStepUncheckedUpdateWithoutAttachmentsInput(
      id: json['id'] != null
  ...
  HelpStepUncheckedUpdateWithoutAttachmentsInput copyWith(
