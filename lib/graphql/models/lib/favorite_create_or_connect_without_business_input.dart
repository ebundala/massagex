...
class FavoriteCreateOrConnectWithoutBusinessInput extends Equatable {
  ...
  FavoriteCreateOrConnectWithoutBusinessInput(
      {required this.where, required this.create});

  static FavoriteCreateOrConnectWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteCreateOrConnectWithoutBusinessInput(
  ...
  FavoriteCreateOrConnectWithoutBusinessInput copyWith(
