...
class AttachmentCreateWithoutOrdersInput extends Equatable {
  ...
  AttachmentCreateWithoutOrdersInput(
      {required this.path,
      this.id,
      this.filename,
      this.mimetype,
  ...
  static AttachmentCreateWithoutOrdersInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateWithoutOrdersInput(
      path: json['path'],
      id: json['id'],
  ...
  AttachmentCreateWithoutOrdersInput copyWith(
      {MultipartFile? path,
      String? id,
      String? filename,
      String? mimetype,
