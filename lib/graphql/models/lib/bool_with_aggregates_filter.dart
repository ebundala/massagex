import 'nested_bool_with_aggregates_filter.dart';
...
class BoolWithAggregatesFilter extends Equatable {
  final bool? equals;
  ...
  static BoolWithAggregatesFilter fromJson(Map<dynamic, dynamic> json) {
    return BoolWithAggregatesFilter(
      equals: json['equals'],
      not: json['not'] != null
  ...
  BoolWithAggregatesFilter copyWith(
      {bool? equals,
