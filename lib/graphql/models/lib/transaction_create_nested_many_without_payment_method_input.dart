...
class TransactionCreateNestedManyWithoutPaymentMethodInput extends Equatable {
  ...
  TransactionCreateNestedManyWithoutPaymentMethodInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static TransactionCreateNestedManyWithoutPaymentMethodInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionCreateNestedManyWithoutPaymentMethodInput(
  ...
  TransactionCreateNestedManyWithoutPaymentMethodInput copyWith(
