...
class AttachmentCreateWithoutBusinessInput extends Equatable {
  ...
  AttachmentCreateWithoutBusinessInput(
      {required this.path,
      this.id,
      this.filename,
      this.mimetype,
  ...
  static AttachmentCreateWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateWithoutBusinessInput(
      path: json['path'],
      id: json['id'],
  ...
  AttachmentCreateWithoutBusinessInput copyWith(
      {MultipartFile? path,
      String? id,
      String? filename,
      String? mimetype,
