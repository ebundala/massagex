...
class TransactionUpsertWithoutSelcomPaymentInput extends Equatable {
  ...
  TransactionUpsertWithoutSelcomPaymentInput(
      {required this.update, required this.create});

  static TransactionUpsertWithoutSelcomPaymentInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUpsertWithoutSelcomPaymentInput(
      update:
  ...
  TransactionUpsertWithoutSelcomPaymentInput copyWith(
