...
class AbuseRecordTypeCreateNestedOneWithoutAbuseReportsInput extends Equatable {
  ...
  AbuseRecordTypeCreateNestedOneWithoutAbuseReportsInput(
      {this.create, this.connectOrCreate, this.connect});

  static AbuseRecordTypeCreateNestedOneWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseRecordTypeCreateNestedOneWithoutAbuseReportsInput(
  ...
  AbuseRecordTypeCreateNestedOneWithoutAbuseReportsInput copyWith(
