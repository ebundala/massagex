...
class CommentUncheckedUpdateWithoutCommentInput extends Equatable {
  ...
  CommentUncheckedUpdateWithoutCommentInput(
      {this.id,
      this.authorId,
      this.reviewId,
  ...
  static CommentUncheckedUpdateWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUncheckedUpdateWithoutCommentInput(
      id: json['id'] != null
  ...
  CommentUncheckedUpdateWithoutCommentInput copyWith(
