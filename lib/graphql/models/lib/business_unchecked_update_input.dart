...
class BusinessUncheckedUpdateInput extends Equatable {
  ...
  static BusinessUncheckedUpdateInput fromJson(Map<dynamic, dynamic> json) {
    return BusinessUncheckedUpdateInput(
      id: json['id'] != null
  ...
  BusinessUncheckedUpdateInput copyWith(
