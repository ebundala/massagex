...
class AttachmentUpdateManyWithoutHelpStepInput extends Equatable {
  ...
  AttachmentUpdateManyWithoutHelpStepInput(
      {this.create,
  ...
  static AttachmentUpdateManyWithoutHelpStepInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUpdateManyWithoutHelpStepInput(
  ...
  AttachmentUpdateManyWithoutHelpStepInput copyWith(
