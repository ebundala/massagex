...
import 'transaction_unchecked_update_one_without_selcom_payment_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class SelcomPaymentUncheckedUpdateInput extends Equatable {
  ...
  final TransactionUncheckedUpdateOneWithoutSelcomPaymentInput? transaction;
  ...
  SelcomPaymentUncheckedUpdateInput(
      {this.id,
      this.transId,
      this.amount,
      this.msisdn,
  ...
  static SelcomPaymentUncheckedUpdateInput fromJson(
      Map<dynamic, dynamic> json) {
    return SelcomPaymentUncheckedUpdateInput(
      id: json['id'] != null
      ...
      transaction: json['transaction'] != null
          ? TransactionUncheckedUpdateOneWithoutSelcomPaymentInput.fromJson(
              json['transaction'])
          : null,
    );
  }
  ...
  SelcomPaymentUncheckedUpdateInput copyWith(
      ...
      TransactionUncheckedUpdateOneWithoutSelcomPaymentInput? transaction}) {
    return SelcomPaymentUncheckedUpdateInput(
        id: id ?? this.id,
