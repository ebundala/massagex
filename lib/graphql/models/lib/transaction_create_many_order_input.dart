...
class TransactionCreateManyOrderInput extends Equatable {
  final String? id;
  ...
  TransactionCreateManyOrderInput(
      {this.id,
  ...
  static TransactionCreateManyOrderInput fromJson(Map<dynamic, dynamic> json) {
    return TransactionCreateManyOrderInput(
      id: json['id'],
  ...
  TransactionCreateManyOrderInput copyWith(
      {String? id,
