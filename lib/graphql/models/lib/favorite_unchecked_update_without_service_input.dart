...
class FavoriteUncheckedUpdateWithoutServiceInput extends Equatable {
  ...
  FavoriteUncheckedUpdateWithoutServiceInput(
      {this.id,
      this.favId,
      this.authorId,
      this.typeId,
  ...
  static FavoriteUncheckedUpdateWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedUpdateWithoutServiceInput(
      id: json['id'] != null
  ...
  FavoriteUncheckedUpdateWithoutServiceInput copyWith(
