...
class FavoriteUpdateManyWithoutAuthorInput extends Equatable {
  ...
  FavoriteUpdateManyWithoutAuthorInput(
      {this.create,
  ...
  static FavoriteUpdateManyWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUpdateManyWithoutAuthorInput(
  ...
  FavoriteUpdateManyWithoutAuthorInput copyWith(
