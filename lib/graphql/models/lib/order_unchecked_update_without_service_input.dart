...
class OrderUncheckedUpdateWithoutServiceInput extends Equatable {
  ...
  OrderUncheckedUpdateWithoutServiceInput(
      {this.id,
      this.quantity,
      this.recordStatus,
      this.orderStatus,
  ...
  static OrderUncheckedUpdateWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUncheckedUpdateWithoutServiceInput(
      id: json['id'] != null
  ...
  OrderUncheckedUpdateWithoutServiceInput copyWith(
