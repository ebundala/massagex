...
class ServiceUncheckedUpdateWithoutAbuseReportsInput extends Equatable {
  ...
  ServiceUncheckedUpdateWithoutAbuseReportsInput(
      {this.id,
      this.name,
      this.description,
      this.price,
  ...
  static ServiceUncheckedUpdateWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUncheckedUpdateWithoutAbuseReportsInput(
      id: json['id'] != null
  ...
  ServiceUncheckedUpdateWithoutAbuseReportsInput copyWith(
