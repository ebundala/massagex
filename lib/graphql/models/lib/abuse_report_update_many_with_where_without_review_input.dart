...
class AbuseReportUpdateManyWithWhereWithoutReviewInput extends Equatable {
  ...
  AbuseReportUpdateManyWithWhereWithoutReviewInput(
      {required this.where, required this.data});

  static AbuseReportUpdateManyWithWhereWithoutReviewInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpdateManyWithWhereWithoutReviewInput(
  ...
  AbuseReportUpdateManyWithWhereWithoutReviewInput copyWith(
