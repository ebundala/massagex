...
class AbuseReportUpdateWithoutTypeInput extends Equatable {
  ...
  AbuseReportUpdateWithoutTypeInput(
      {this.id,
      this.number,
      this.report,
      this.recordStatus,
  ...
  static AbuseReportUpdateWithoutTypeInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpdateWithoutTypeInput(
      id: json['id'] != null
  ...
  AbuseReportUpdateWithoutTypeInput copyWith(
