...
class MpesaPaymentMaxAggregateOutputType extends Equatable {
  final String? id;
  ...
  MpesaPaymentMaxAggregateOutputType(
      {this.id,
      this.input$Amount,
      this.input$Country,
      this.input$Currency,
  ...
  static MpesaPaymentMaxAggregateOutputType fromJson(
      Map<dynamic, dynamic> json) {
    return MpesaPaymentMaxAggregateOutputType(
      id: json['id'],
  ...
  MpesaPaymentMaxAggregateOutputType copyWith(
      {String? id,
      String? input$Amount,
...
extension MpesaPaymentMaxAggregateOutputTypeExt
    on MpesaPaymentMaxAggregateOutputType {
...
class MpesaPaymentMaxAggregateOutputTypeController
    extends ValueNotifier<MpesaPaymentMaxAggregateOutputType> {
  ...
  final MpesaPaymentMaxAggregateOutputType initialValue;
  final SelectionSetNode selectionSet;
  final Map<String, SelectionNodeData> selections = {};
  MpesaPaymentMaxAggregateOutputTypeController({
