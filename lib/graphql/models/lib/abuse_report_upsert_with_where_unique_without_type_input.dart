...
import 'abuse_report_update_without_type_input.dart';
import 'abuse_report_create_without_type_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class AbuseReportUpsertWithWhereUniqueWithoutTypeInput extends Equatable {
  final AbuseReportWhereUniqueInput where;
  final AbuseReportUpdateWithoutTypeInput update;
  final AbuseReportCreateWithoutTypeInput create;
  ...
  AbuseReportUpsertWithWhereUniqueWithoutTypeInput(
      {required this.where, required this.update, required this.create});

  static AbuseReportUpsertWithWhereUniqueWithoutTypeInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpsertWithWhereUniqueWithoutTypeInput(
      where: AbuseReportWhereUniqueInput.fromJson(json['where']),
      update: AbuseReportUpdateWithoutTypeInput.fromJson(json['update']),
      create: AbuseReportCreateWithoutTypeInput.fromJson(json['create']),
    );
  }
  ...
  AbuseReportUpsertWithWhereUniqueWithoutTypeInput copyWith(
      {AbuseReportWhereUniqueInput? where,
      AbuseReportUpdateWithoutTypeInput? update,
      AbuseReportCreateWithoutTypeInput? create}) {
    return AbuseReportUpsertWithWhereUniqueWithoutTypeInput(
