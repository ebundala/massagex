...
class AbuseReportUpdateManyWithWhereWithoutUserInput extends Equatable {
  ...
  AbuseReportUpdateManyWithWhereWithoutUserInput(
      {required this.where, required this.data});

  static AbuseReportUpdateManyWithWhereWithoutUserInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpdateManyWithWhereWithoutUserInput(
  ...
  AbuseReportUpdateManyWithWhereWithoutUserInput copyWith(
