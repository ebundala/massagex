...
class PaymentMethodUncheckedUpdateManyWithoutPaymentMethodsInput
    extends Equatable {
  ...
  PaymentMethodUncheckedUpdateManyWithoutPaymentMethodsInput(
      {this.id,
      this.name,
      this.description,
      this.code,
  ...
  static PaymentMethodUncheckedUpdateManyWithoutPaymentMethodsInput fromJson(
      Map<dynamic, dynamic> json) {
    return PaymentMethodUncheckedUpdateManyWithoutPaymentMethodsInput(
      id: json['id'] != null
  ...
  PaymentMethodUncheckedUpdateManyWithoutPaymentMethodsInput copyWith(
