...
import 'business_create_or_connect_without_attachments_input.dart';
import 'business_upsert_without_attachments_input.dart';
...
class BusinessUpdateOneWithoutAttachmentsInput extends Equatable {
  final BusinessCreateWithoutAttachmentsInput? create;
  final BusinessCreateOrConnectWithoutAttachmentsInput? connectOrCreate;
  final BusinessUpsertWithoutAttachmentsInput? upsert;
  ...
  BusinessUpdateOneWithoutAttachmentsInput(
      {this.create,
  ...
  static BusinessUpdateOneWithoutAttachmentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUpdateOneWithoutAttachmentsInput(
      create: json['create'] != null
          ? BusinessCreateWithoutAttachmentsInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? BusinessCreateOrConnectWithoutAttachmentsInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? BusinessUpsertWithoutAttachmentsInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? BusinessUpdateWithoutAttachmentsInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  BusinessUpdateOneWithoutAttachmentsInput copyWith(
      {BusinessCreateWithoutAttachmentsInput? create,
      BusinessCreateOrConnectWithoutAttachmentsInput? connectOrCreate,
      BusinessUpsertWithoutAttachmentsInput? upsert,
