...
import 'nested_enum_business_mode_with_aggregates_filter.dart';
import 'nested_int_filter.dart';
import 'nested_enum_business_mode_filter.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class EnumBusinessModeWithAggregatesFilter extends Equatable {
  final BusinessMode? equals;
  final List<BusinessMode>? in$;
  final List<BusinessMode>? notIn;
  final NestedEnumBusinessModeWithAggregatesFilter? not;
  final NestedIntFilter? $count;
  final NestedIntFilter? count;
  final NestedEnumBusinessModeFilter? $min;
  final NestedEnumBusinessModeFilter? min;
  final NestedEnumBusinessModeFilter? $max;
  final NestedEnumBusinessModeFilter? max;
  ...
  EnumBusinessModeWithAggregatesFilter(
      {this.equals,
      this.in$,
      this.notIn,
      this.not,
  ...
  static EnumBusinessModeWithAggregatesFilter fromJson(
      Map<dynamic, dynamic> json) {
    return EnumBusinessModeWithAggregatesFilter(
      equals: json['equals'] != null
          ? BusinessModeExt.fromJson(json['equals'])
          : null,
      in$: json['in'] != null
          ? List.generate(json['in'].length,
              (index) => BusinessModeExt.fromJson(json['in'][index]))
          : null,
      notIn: json['notIn'] != null
          ? List.generate(json['notIn'].length,
              (index) => BusinessModeExt.fromJson(json['notIn'][index]))
          : null,
      not: json['not'] != null
          ? NestedEnumBusinessModeWithAggregatesFilter.fromJson(json['not'])
          : null,
      ...
      count: json['count'] != null
          ...
          : null,
      $min: json['_min'] != null
          ? NestedEnumBusinessModeFilter.fromJson(json['_min'])
          : null,
      min: json['min'] != null
          ? NestedEnumBusinessModeFilter.fromJson(json['min'])
          : null,
      $max: json['_max'] != null
          ? NestedEnumBusinessModeFilter.fromJson(json['_max'])
          : null,
      max: json['max'] != null
          ? NestedEnumBusinessModeFilter.fromJson(json['max'])
          : null,
    );
  }
  ...
  EnumBusinessModeWithAggregatesFilter copyWith(
      {BusinessMode? equals,
      List<BusinessMode>? in$,
      List<BusinessMode>? notIn,
      NestedEnumBusinessModeWithAggregatesFilter? not,
      NestedIntFilter? $count,
      NestedIntFilter? count,
      NestedEnumBusinessModeFilter? $min,
      NestedEnumBusinessModeFilter? min,
      NestedEnumBusinessModeFilter? $max,
      NestedEnumBusinessModeFilter? max}) {
    return EnumBusinessModeWithAggregatesFilter(
