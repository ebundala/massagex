...
class ServiceUncheckedCreateNestedManyWithoutCategoryInput extends Equatable {
  ...
  ServiceUncheckedCreateNestedManyWithoutCategoryInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static ServiceUncheckedCreateNestedManyWithoutCategoryInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUncheckedCreateNestedManyWithoutCategoryInput(
  ...
  ServiceUncheckedCreateNestedManyWithoutCategoryInput copyWith(
