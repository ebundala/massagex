...
class BusinessCreateOrConnectWithoutOwnerInput extends Equatable {
  ...
  static BusinessCreateOrConnectWithoutOwnerInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessCreateOrConnectWithoutOwnerInput(
  ...
  BusinessCreateOrConnectWithoutOwnerInput copyWith(
