...
class FavoriteUncheckedUpdateWithoutBusinessInput extends Equatable {
  ...
  FavoriteUncheckedUpdateWithoutBusinessInput(
      {this.id,
      this.favId,
      this.authorId,
      this.typeId,
  ...
  static FavoriteUncheckedUpdateWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedUpdateWithoutBusinessInput(
      id: json['id'] != null
  ...
  FavoriteUncheckedUpdateWithoutBusinessInput copyWith(
