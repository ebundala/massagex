import 'favorite_create_without_service_input.dart';
import 'favorite_create_or_connect_without_service_input.dart';
import 'favorite_upsert_with_where_unique_without_service_input.dart';
import 'favorite_create_many_service_input_envelope.dart';
import 'favorite_where_unique_input.dart';
import 'favorite_update_with_where_unique_without_service_input.dart';
import 'favorite_update_many_with_where_without_service_input.dart';
import 'favorite_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class FavoriteUncheckedUpdateManyWithoutServiceInput extends Equatable {
  final List<FavoriteCreateWithoutServiceInput>? create;
  final List<FavoriteCreateOrConnectWithoutServiceInput>? connectOrCreate;
  final List<FavoriteUpsertWithWhereUniqueWithoutServiceInput>? upsert;
  final FavoriteCreateManyServiceInputEnvelope? createMany;
  ...
  final List<FavoriteUpdateWithWhereUniqueWithoutServiceInput>? update;
  final List<FavoriteUpdateManyWithWhereWithoutServiceInput>? updateMany;
  ...
  FavoriteUncheckedUpdateManyWithoutServiceInput(
      {this.create,
  ...
  static FavoriteUncheckedUpdateManyWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedUpdateManyWithoutServiceInput(
      create: json['create'] != null
          ? List.generate(
              json['create'].length,
              (index) => FavoriteCreateWithoutServiceInput.fromJson(
                  json['create'][index]))
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? List.generate(
              json['connectOrCreate'].length,
              (index) => FavoriteCreateOrConnectWithoutServiceInput.fromJson(
      ...
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) =>
                  FavoriteUpsertWithWhereUniqueWithoutServiceInput.fromJson(
                      json['upsert'][index]))
          : null,
      createMany: json['createMany'] != null
          ? FavoriteCreateManyServiceInputEnvelope.fromJson(json['createMany'])
          : null,
      ...
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) =>
                  FavoriteUpdateWithWhereUniqueWithoutServiceInput.fromJson(
                      json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              ...
              (index) =>
                  FavoriteUpdateManyWithWhereWithoutServiceInput.fromJson(
  ...
  FavoriteUncheckedUpdateManyWithoutServiceInput copyWith(
      {List<FavoriteCreateWithoutServiceInput>? create,
      List<FavoriteCreateOrConnectWithoutServiceInput>? connectOrCreate,
      List<FavoriteUpsertWithWhereUniqueWithoutServiceInput>? upsert,
      FavoriteCreateManyServiceInputEnvelope? createMany,
      ...
      List<FavoriteUpdateWithWhereUniqueWithoutServiceInput>? update,
      List<FavoriteUpdateManyWithWhereWithoutServiceInput>? updateMany,
