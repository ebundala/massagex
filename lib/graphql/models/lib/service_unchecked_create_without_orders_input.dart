...
class ServiceUncheckedCreateWithoutOrdersInput extends Equatable {
  final String? id;
  final String name;
  ...
  ServiceUncheckedCreateWithoutOrdersInput(
      {this.id,
      required this.name,
      this.description,
      required this.price,
  ...
  static ServiceUncheckedCreateWithoutOrdersInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUncheckedCreateWithoutOrdersInput(
      id: json['id'],
      name: json['name'],
  ...
  ServiceUncheckedCreateWithoutOrdersInput copyWith(
      {String? id,
      String? name,
      String? description,
      double? price,
