...
class HelpCreateWithoutStepsInput extends Equatable {
  final String? id;
  final String topic;
  ...
  static HelpCreateWithoutStepsInput fromJson(Map<dynamic, dynamic> json) {
    return HelpCreateWithoutStepsInput(
      id: json['id'],
      topic: json['topic'],
  ...
  HelpCreateWithoutStepsInput copyWith(
      {String? id,
      String? topic,
      String? description,
