...
import 'user_create_or_connect_without_business_profile_input.dart';
import 'user_upsert_without_business_profile_input.dart';
...
class UserUpdateOneRequiredWithoutBusinessProfileInput extends Equatable {
  final UserCreateWithoutBusinessProfileInput? create;
  final UserCreateOrConnectWithoutBusinessProfileInput? connectOrCreate;
  final UserUpsertWithoutBusinessProfileInput? upsert;
  ...
  UserUpdateOneRequiredWithoutBusinessProfileInput(
      {this.create,
  ...
  static UserUpdateOneRequiredWithoutBusinessProfileInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUpdateOneRequiredWithoutBusinessProfileInput(
      create: json['create'] != null
          ? UserCreateWithoutBusinessProfileInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? UserCreateOrConnectWithoutBusinessProfileInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? UserUpsertWithoutBusinessProfileInput.fromJson(json['upsert'])
          : null,
      connect: json['connect'] != null
          ? UserWhereUniqueInput.fromJson(json['connect'])
          : null,
      update: json['update'] != null
          ? UserUpdateWithoutBusinessProfileInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  UserUpdateOneRequiredWithoutBusinessProfileInput copyWith(
      {UserCreateWithoutBusinessProfileInput? create,
      UserCreateOrConnectWithoutBusinessProfileInput? connectOrCreate,
      UserUpsertWithoutBusinessProfileInput? upsert,
