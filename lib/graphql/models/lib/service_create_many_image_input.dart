...
class ServiceCreateManyImageInput extends Equatable {
  final String? id;
  final String name;
  ...
  static ServiceCreateManyImageInput fromJson(Map<dynamic, dynamic> json) {
    return ServiceCreateManyImageInput(
      id: json['id'],
      name: json['name'],
  ...
  ServiceCreateManyImageInput copyWith(
      {String? id,
      String? name,
      String? description,
      double? price,
