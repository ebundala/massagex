...
class PaymentMethodCreateWithoutTransactionsInput extends Equatable {
  final String? id;
  final String name;
  ...
  PaymentMethodCreateWithoutTransactionsInput(
      {this.id,
      required this.name,
      this.description,
      required this.code,
  ...
  static PaymentMethodCreateWithoutTransactionsInput fromJson(
      Map<dynamic, dynamic> json) {
    return PaymentMethodCreateWithoutTransactionsInput(
      id: json['id'],
      name: json['name'],
  ...
  PaymentMethodCreateWithoutTransactionsInput copyWith(
      {String? id,
      String? name,
      String? description,
