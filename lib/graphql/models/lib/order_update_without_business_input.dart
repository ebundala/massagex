...
class OrderUpdateWithoutBusinessInput extends Equatable {
  ...
  static OrderUpdateWithoutBusinessInput fromJson(Map<dynamic, dynamic> json) {
    return OrderUpdateWithoutBusinessInput(
      id: json['id'] != null
  ...
  OrderUpdateWithoutBusinessInput copyWith(
