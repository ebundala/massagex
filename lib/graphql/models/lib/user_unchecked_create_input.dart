...
class UserUncheckedCreateInput extends Equatable {
  final String? id;
  final String? email;
  ...
  static UserUncheckedCreateInput fromJson(Map<dynamic, dynamic> json) {
    return UserUncheckedCreateInput(
      id: json['id'],
      email: json['email'],
  ...
  UserUncheckedCreateInput copyWith(
      {String? id,
      String? email,
      String? displayName,
      String? phoneNumber,
