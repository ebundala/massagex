...
class CategoryUncheckedUpdateManyWithoutCategoryInput extends Equatable {
    ...
    return ast.ObjectValueNode(fields: [
      ...
      if (metadata != null)
        ast.ObjectFieldNode(
          ...
          value: ast.StringValueNode(value: metadata!, isBlock: false),
        ),
      if (createdAt != null)
        ast.ObjectFieldNode(
  ...
  static CategoryUncheckedUpdateManyWithoutCategoryInput fromJson(
      Map<dynamic, dynamic> json) {
    return CategoryUncheckedUpdateManyWithoutCategoryInput(
      id: json['id'] != null
  ...
  CategoryUncheckedUpdateManyWithoutCategoryInput copyWith(
