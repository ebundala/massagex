...
import 'category_upsert_without_services_input.dart';
...
class CategoryUpdateOneWithoutServicesInput extends Equatable {
  ...
  CategoryUpdateOneWithoutServicesInput(
      {this.create,
  ...
  static CategoryUpdateOneWithoutServicesInput fromJson(
      Map<dynamic, dynamic> json) {
    return CategoryUpdateOneWithoutServicesInput(
      ...
      upsert: json['upsert'] != null
          ? CategoryUpsertWithoutServicesInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? CategoryUpdateWithoutServicesInput.fromJson(json['update'])
          : null,
    );
  }
