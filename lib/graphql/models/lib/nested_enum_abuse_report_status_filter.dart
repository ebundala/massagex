...
class NestedEnumAbuseReportStatusFilter extends Equatable {
  ...
  NestedEnumAbuseReportStatusFilter(
      {this.equals, this.in$, this.notIn, this.not});

  static NestedEnumAbuseReportStatusFilter fromJson(
      Map<dynamic, dynamic> json) {
    return NestedEnumAbuseReportStatusFilter(
  ...
  NestedEnumAbuseReportStatusFilter copyWith(
