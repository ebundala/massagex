...
class NestedEnumGenderWithAggregatesFilter extends Equatable {
  final Gender? equals;
  ...
  static NestedEnumGenderWithAggregatesFilter fromJson(
      Map<dynamic, dynamic> json) {
    return NestedEnumGenderWithAggregatesFilter(
      equals:
  ...
  NestedEnumGenderWithAggregatesFilter copyWith(
      {Gender? equals,
      List<Gender>? in$,
      List<Gender>? notIn,
