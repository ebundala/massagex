...
class FavoriteUpdateWithWhereUniqueWithoutBusinessInput extends Equatable {
  final FavoriteWhereUniqueInput where;
  final FavoriteUpdateWithoutBusinessInput data;
  ...
  FavoriteUpdateWithWhereUniqueWithoutBusinessInput(
      {required this.where, required this.data});

  static FavoriteUpdateWithWhereUniqueWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUpdateWithWhereUniqueWithoutBusinessInput(
      where: FavoriteWhereUniqueInput.fromJson(json['where']),
      data: FavoriteUpdateWithoutBusinessInput.fromJson(json['data']),
    );
  }
  ...
  FavoriteUpdateWithWhereUniqueWithoutBusinessInput copyWith(
      {FavoriteWhereUniqueInput? where,
      FavoriteUpdateWithoutBusinessInput? data}) {
    return FavoriteUpdateWithWhereUniqueWithoutBusinessInput(
