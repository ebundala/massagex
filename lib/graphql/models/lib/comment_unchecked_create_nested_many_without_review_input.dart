...
class CommentUncheckedCreateNestedManyWithoutReviewInput extends Equatable {
  ...
  CommentUncheckedCreateNestedManyWithoutReviewInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static CommentUncheckedCreateNestedManyWithoutReviewInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUncheckedCreateNestedManyWithoutReviewInput(
  ...
  CommentUncheckedCreateNestedManyWithoutReviewInput copyWith(
