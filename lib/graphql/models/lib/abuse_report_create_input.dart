...
class AbuseReportCreateInput extends Equatable {
  final String? id;
  final int? number;
  final String? report;
  ...
  static AbuseReportCreateInput fromJson(Map<dynamic, dynamic> json) {
    return AbuseReportCreateInput(
      id: json['id'],
      number: json['number'],
      report: json['report'],
  ...
  AbuseReportCreateInput copyWith(
      {String? id,
      int? number,
      String? report,
