...
class OrderUncheckedCreateWithoutAbuseReportsInput extends Equatable {
  final String? id;
  final int quantity;
  ...
  OrderUncheckedCreateWithoutAbuseReportsInput(
      {this.id,
  ...
  static OrderUncheckedCreateWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUncheckedCreateWithoutAbuseReportsInput(
      id: json['id'],
  ...
  OrderUncheckedCreateWithoutAbuseReportsInput copyWith(
      {String? id,
      int? quantity,
