...
import 'review_upsert_with_where_unique_without_reviewee_input.dart';
import 'review_create_many_reviewee_input_envelope.dart';
import 'review_where_unique_input.dart';
import 'review_update_with_where_unique_without_reviewee_input.dart';
import 'review_update_many_with_where_without_reviewee_input.dart';
import 'review_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class ReviewUncheckedUpdateManyWithoutRevieweeInput extends Equatable {
  final List<ReviewCreateWithoutRevieweeInput>? create;
  final List<ReviewCreateOrConnectWithoutRevieweeInput>? connectOrCreate;
  final List<ReviewUpsertWithWhereUniqueWithoutRevieweeInput>? upsert;
  ...
  final List<ReviewUpdateWithWhereUniqueWithoutRevieweeInput>? update;
  final List<ReviewUpdateManyWithWhereWithoutRevieweeInput>? updateMany;
  ...
  ReviewUncheckedUpdateManyWithoutRevieweeInput(
      {this.create,
  ...
  static ReviewUncheckedUpdateManyWithoutRevieweeInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewUncheckedUpdateManyWithoutRevieweeInput(
      ...
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) =>
                  ReviewUpsertWithWhereUniqueWithoutRevieweeInput.fromJson(
                      json['upsert'][index]))
          : null,
      ...
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) =>
                  ReviewUpdateWithWhereUniqueWithoutRevieweeInput.fromJson(
                      json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              json['updateMany'].length,
              (index) => ReviewUpdateManyWithWhereWithoutRevieweeInput.fromJson(
  ...
  ReviewUncheckedUpdateManyWithoutRevieweeInput copyWith(
      {List<ReviewCreateWithoutRevieweeInput>? create,
      List<ReviewCreateOrConnectWithoutRevieweeInput>? connectOrCreate,
      List<ReviewUpsertWithWhereUniqueWithoutRevieweeInput>? upsert,
      ...
      List<ReviewUpdateWithWhereUniqueWithoutRevieweeInput>? update,
      List<ReviewUpdateManyWithWhereWithoutRevieweeInput>? updateMany,
