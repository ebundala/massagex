...
class AbuseReportUncheckedCreateNestedManyWithoutUserInput extends Equatable {
  ...
  AbuseReportUncheckedCreateNestedManyWithoutUserInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static AbuseReportUncheckedCreateNestedManyWithoutUserInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedCreateNestedManyWithoutUserInput(
  ...
  AbuseReportUncheckedCreateNestedManyWithoutUserInput copyWith(
