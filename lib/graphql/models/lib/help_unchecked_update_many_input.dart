...
class HelpUncheckedUpdateManyInput extends Equatable {
  ...
  static HelpUncheckedUpdateManyInput fromJson(Map<dynamic, dynamic> json) {
    return HelpUncheckedUpdateManyInput(
      id: json['id'] != null
  ...
  HelpUncheckedUpdateManyInput copyWith(
