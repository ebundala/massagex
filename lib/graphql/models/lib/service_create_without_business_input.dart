...
class ServiceCreateWithoutBusinessInput extends Equatable {
  final String? id;
  final String name;
  ...
  ServiceCreateWithoutBusinessInput(
      {this.id,
      required this.name,
      this.description,
      required this.price,
  ...
  static ServiceCreateWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceCreateWithoutBusinessInput(
      id: json['id'],
      name: json['name'],
  ...
  ServiceCreateWithoutBusinessInput copyWith(
      {String? id,
      String? name,
      String? description,
      double? price,
