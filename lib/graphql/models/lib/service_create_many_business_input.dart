...
class ServiceCreateManyBusinessInput extends Equatable {
  final String? id;
  final String name;
  ...
  ServiceCreateManyBusinessInput(
      {this.id,
      required this.name,
      this.description,
      required this.price,
  ...
  static ServiceCreateManyBusinessInput fromJson(Map<dynamic, dynamic> json) {
    return ServiceCreateManyBusinessInput(
      id: json['id'],
      name: json['name'],
  ...
  ServiceCreateManyBusinessInput copyWith(
      {String? id,
      String? name,
      String? description,
      double? price,
