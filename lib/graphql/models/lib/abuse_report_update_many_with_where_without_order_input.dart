...
class AbuseReportUpdateManyWithWhereWithoutOrderInput extends Equatable {
  ...
  AbuseReportUpdateManyWithWhereWithoutOrderInput(
      {required this.where, required this.data});

  static AbuseReportUpdateManyWithWhereWithoutOrderInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpdateManyWithWhereWithoutOrderInput(
  ...
  AbuseReportUpdateManyWithWhereWithoutOrderInput copyWith(
