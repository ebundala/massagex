...
class LocationUncheckedUpdateInput extends Equatable {
  ...
  static LocationUncheckedUpdateInput fromJson(Map<dynamic, dynamic> json) {
    return LocationUncheckedUpdateInput(
      id: json['id'] != null
  ...
  LocationUncheckedUpdateInput copyWith(
