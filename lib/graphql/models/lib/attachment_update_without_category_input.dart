...
class AttachmentUpdateWithoutCategoryInput extends Equatable {
  ...
  AttachmentUpdateWithoutCategoryInput(
      {this.id,
      this.path,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUpdateWithoutCategoryInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUpdateWithoutCategoryInput(
      id: json['id'] != null
  ...
  AttachmentUpdateWithoutCategoryInput copyWith(
