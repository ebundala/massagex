...
import 'attachment_create_or_connect_without_payment_methods_input.dart';
import 'attachment_upsert_without_payment_methods_input.dart';
...
class AttachmentUpdateOneRequiredWithoutPaymentMethodsInput extends Equatable {
  final AttachmentCreateWithoutPaymentMethodsInput? create;
  final AttachmentCreateOrConnectWithoutPaymentMethodsInput? connectOrCreate;
  final AttachmentUpsertWithoutPaymentMethodsInput? upsert;
  ...
  AttachmentUpdateOneRequiredWithoutPaymentMethodsInput(
      {this.create,
  ...
  static AttachmentUpdateOneRequiredWithoutPaymentMethodsInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUpdateOneRequiredWithoutPaymentMethodsInput(
      create: json['create'] != null
          ? AttachmentCreateWithoutPaymentMethodsInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? AttachmentCreateOrConnectWithoutPaymentMethodsInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? AttachmentUpsertWithoutPaymentMethodsInput.fromJson(json['upsert'])
          : null,
  ...
  AttachmentUpdateOneRequiredWithoutPaymentMethodsInput copyWith(
      {AttachmentCreateWithoutPaymentMethodsInput? create,
      AttachmentCreateOrConnectWithoutPaymentMethodsInput? connectOrCreate,
      AttachmentUpsertWithoutPaymentMethodsInput? upsert,
