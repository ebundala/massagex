...
class UserUncheckedUpdateWithoutFavoritedInput extends Equatable {
  ...
  UserUncheckedUpdateWithoutFavoritedInput(
      {this.id,
      this.email,
      this.displayName,
      this.phoneNumber,
  ...
  static UserUncheckedUpdateWithoutFavoritedInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUncheckedUpdateWithoutFavoritedInput(
      id: json['id'] != null
  ...
  UserUncheckedUpdateWithoutFavoritedInput copyWith(
