...
class AbuseReportUpdateWithWhereUniqueWithoutUserInput extends Equatable {
  final AbuseReportWhereUniqueInput where;
  final AbuseReportUpdateWithoutUserInput data;
  ...
  AbuseReportUpdateWithWhereUniqueWithoutUserInput(
      {required this.where, required this.data});

  static AbuseReportUpdateWithWhereUniqueWithoutUserInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpdateWithWhereUniqueWithoutUserInput(
      where: AbuseReportWhereUniqueInput.fromJson(json['where']),
      data: AbuseReportUpdateWithoutUserInput.fromJson(json['data']),
    );
  }
  ...
  AbuseReportUpdateWithWhereUniqueWithoutUserInput copyWith(
      {AbuseReportWhereUniqueInput? where,
      AbuseReportUpdateWithoutUserInput? data}) {
    return AbuseReportUpdateWithWhereUniqueWithoutUserInput(
