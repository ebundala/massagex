...
class AttachmentCreateOrConnectWithoutOrdersInput extends Equatable {
  ...
  AttachmentCreateOrConnectWithoutOrdersInput(
      {required this.where, required this.create});

  static AttachmentCreateOrConnectWithoutOrdersInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateOrConnectWithoutOrdersInput(
  ...
  AttachmentCreateOrConnectWithoutOrdersInput copyWith(
