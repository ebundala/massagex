...
import 'transaction_create_or_connect_without_selcom_disbursement_input.dart';
import 'transaction_upsert_without_selcom_disbursement_input.dart';
...
class TransactionUncheckedUpdateOneWithoutSelcomDisbursementInput
    extends Equatable {
  final TransactionCreateWithoutSelcomDisbursementInput? create;
  final TransactionCreateOrConnectWithoutSelcomDisbursementInput?
      connectOrCreate;
  final TransactionUpsertWithoutSelcomDisbursementInput? upsert;
  ...
  TransactionUncheckedUpdateOneWithoutSelcomDisbursementInput(
      {this.create,
  ...
  static TransactionUncheckedUpdateOneWithoutSelcomDisbursementInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUncheckedUpdateOneWithoutSelcomDisbursementInput(
      create: json['create'] != null
          ? TransactionCreateWithoutSelcomDisbursementInput.fromJson(
              json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? TransactionCreateOrConnectWithoutSelcomDisbursementInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? TransactionUpsertWithoutSelcomDisbursementInput.fromJson(
              json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? TransactionUpdateWithoutSelcomDisbursementInput.fromJson(
              json['update'])
          : null,
    );
  }
  ...
  TransactionUncheckedUpdateOneWithoutSelcomDisbursementInput copyWith(
      {TransactionCreateWithoutSelcomDisbursementInput? create,
      TransactionCreateOrConnectWithoutSelcomDisbursementInput? connectOrCreate,
      TransactionUpsertWithoutSelcomDisbursementInput? upsert,
