...
class ReviewUpdateWithoutRevieweeInput extends Equatable {
  ...
  ReviewUpdateWithoutRevieweeInput(
      {this.id,
      this.value,
      this.content,
      this.recordStatus,
  ...
  static ReviewUpdateWithoutRevieweeInput fromJson(Map<dynamic, dynamic> json) {
    return ReviewUpdateWithoutRevieweeInput(
      id: json['id'] != null
  ...
  ReviewUpdateWithoutRevieweeInput copyWith(
