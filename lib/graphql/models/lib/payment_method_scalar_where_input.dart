...
class PaymentMethodScalarWhereInput extends Equatable {
  final List<PaymentMethodScalarWhereInput>? AND;
  final List<PaymentMethodScalarWhereInput>? OR;
  final List<PaymentMethodScalarWhereInput>? NOT;
  ...
  static PaymentMethodScalarWhereInput fromJson(Map<dynamic, dynamic> json) {
    return PaymentMethodScalarWhereInput(
      AND: json['AND'] != null
          ? List.generate(
              json['AND'].length,
              (index) =>
                  PaymentMethodScalarWhereInput.fromJson(json['AND'][index]))
          : null,
      OR: json['OR'] != null
          ? List.generate(
              json['OR'].length,
              (index) =>
                  PaymentMethodScalarWhereInput.fromJson(json['OR'][index]))
          : null,
      NOT: json['NOT'] != null
          ? List.generate(
              json['NOT'].length,
              (index) =>
                  PaymentMethodScalarWhereInput.fromJson(json['NOT'][index]))
          : null,
  ...
  PaymentMethodScalarWhereInput copyWith(
      {List<PaymentMethodScalarWhereInput>? AND,
      List<PaymentMethodScalarWhereInput>? OR,
      List<PaymentMethodScalarWhereInput>? NOT,
      StringFilter? id,
      StringFilter? name,
