...
class CasbinRuleUncheckedUpdateInput extends Equatable {
  ...
  CasbinRuleUncheckedUpdateInput(
      {this.id,
      this.ptype,
      this.v0,
      this.v1,
  ...
  static CasbinRuleUncheckedUpdateInput fromJson(Map<dynamic, dynamic> json) {
    return CasbinRuleUncheckedUpdateInput(
      id: json['id'] != null
  ...
  CasbinRuleUncheckedUpdateInput copyWith(
