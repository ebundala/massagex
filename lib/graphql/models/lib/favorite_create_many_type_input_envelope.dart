import 'favorite_create_many_type_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class FavoriteCreateManyTypeInputEnvelope extends Equatable {
  final List<FavoriteCreateManyTypeInput>? data;
  ...
  FavoriteCreateManyTypeInputEnvelope({this.data, this.skipDuplicates});

  static FavoriteCreateManyTypeInputEnvelope fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteCreateManyTypeInputEnvelope(
      data: json['data'] != null
          ? List.generate(
              json['data'].length,
              (index) =>
                  FavoriteCreateManyTypeInput.fromJson(json['data'][index]))
          : null,
  ...
  FavoriteCreateManyTypeInputEnvelope copyWith(
      {List<FavoriteCreateManyTypeInput>? data, bool? skipDuplicates}) {
    return FavoriteCreateManyTypeInputEnvelope(
        data: data ?? this.data,
