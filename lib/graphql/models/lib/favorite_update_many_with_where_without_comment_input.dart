...
class FavoriteUpdateManyWithWhereWithoutCommentInput extends Equatable {
  ...
  FavoriteUpdateManyWithWhereWithoutCommentInput(
      {required this.where, required this.data});

  static FavoriteUpdateManyWithWhereWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUpdateManyWithWhereWithoutCommentInput(
  ...
  FavoriteUpdateManyWithWhereWithoutCommentInput copyWith(
