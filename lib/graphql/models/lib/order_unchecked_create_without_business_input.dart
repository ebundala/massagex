...
class OrderUncheckedCreateWithoutBusinessInput extends Equatable {
  final String? id;
  final int quantity;
  ...
  static OrderUncheckedCreateWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUncheckedCreateWithoutBusinessInput(
      id: json['id'],
  ...
  OrderUncheckedCreateWithoutBusinessInput copyWith(
      {String? id,
      int? quantity,
