...
class UserCreateWithoutReviewedInput extends Equatable {
  final String? id;
  final String email;
  ...
  UserCreateWithoutReviewedInput(
      {this.id,
      required this.email,
  ...
  static UserCreateWithoutReviewedInput fromJson(Map<dynamic, dynamic> json) {
    return UserCreateWithoutReviewedInput(
      id: json['id'],
      email: json['email'],
  ...
  UserCreateWithoutReviewedInput copyWith(
      {String? id,
      String? email,
      String? displayName,
      String? phoneNumber,
