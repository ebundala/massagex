...
class BusinessCreateManyLocationInput extends Equatable {
  final String? id;
  ...
  BusinessCreateManyLocationInput(
      {this.id,
  ...
  static BusinessCreateManyLocationInput fromJson(Map<dynamic, dynamic> json) {
    return BusinessCreateManyLocationInput(
      id: json['id'],
  ...
  BusinessCreateManyLocationInput copyWith(
      {String? id,
      String? ownerId,
      BusinessMode? mode,
      String? coverId,
