...
class CommentCreateWithoutCommentInput extends Equatable {
  final String? id;
  ...
  static CommentCreateWithoutCommentInput fromJson(Map<dynamic, dynamic> json) {
    return CommentCreateWithoutCommentInput(
      id: json['id'],
  ...
  CommentCreateWithoutCommentInput copyWith(
      {String? id,
