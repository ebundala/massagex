...
class FavoriteCreateManyUserInput extends Equatable {
  final String? id;
  final String favId;
  ...
  static FavoriteCreateManyUserInput fromJson(Map<dynamic, dynamic> json) {
    return FavoriteCreateManyUserInput(
      id: json['id'],
      favId: json['favId'],
  ...
  FavoriteCreateManyUserInput copyWith(
      {String? id,
      String? favId,
      String? authorId,
      String? typeId,
