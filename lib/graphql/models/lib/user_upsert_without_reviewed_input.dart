...
class UserUpsertWithoutReviewedInput extends Equatable {
  ...
  UserUpsertWithoutReviewedInput({required this.update, required this.create});

  static UserUpsertWithoutReviewedInput fromJson(Map<dynamic, dynamic> json) {
    return UserUpsertWithoutReviewedInput(
      update: UserUpdateWithoutReviewedInput.fromJson(json['update']),
      create: UserCreateWithoutReviewedInput.fromJson(json['create']),
    );
  }
  ...
  UserUpsertWithoutReviewedInput copyWith(
