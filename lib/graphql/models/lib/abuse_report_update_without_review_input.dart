...
class AbuseReportUpdateWithoutReviewInput extends Equatable {
  ...
  AbuseReportUpdateWithoutReviewInput(
      {this.id,
      this.number,
      this.report,
      this.recordStatus,
  ...
  static AbuseReportUpdateWithoutReviewInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpdateWithoutReviewInput(
      id: json['id'] != null
  ...
  AbuseReportUpdateWithoutReviewInput copyWith(
