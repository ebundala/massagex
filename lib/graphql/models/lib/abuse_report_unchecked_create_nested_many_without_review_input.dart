...
class AbuseReportUncheckedCreateNestedManyWithoutReviewInput extends Equatable {
  ...
  AbuseReportUncheckedCreateNestedManyWithoutReviewInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static AbuseReportUncheckedCreateNestedManyWithoutReviewInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedCreateNestedManyWithoutReviewInput(
  ...
  AbuseReportUncheckedCreateNestedManyWithoutReviewInput copyWith(
