...
class UserUpdateWithoutReviewedInput extends Equatable {
  ...
  UserUpdateWithoutReviewedInput(
      {this.id,
      this.email,
      this.displayName,
      this.phoneNumber,
  ...
  static UserUpdateWithoutReviewedInput fromJson(Map<dynamic, dynamic> json) {
    return UserUpdateWithoutReviewedInput(
      id: json['id'] != null
  ...
  UserUpdateWithoutReviewedInput copyWith(
