...
class AttachmentUncheckedCreateWithoutCategoryInput extends Equatable {
  ...
  AttachmentUncheckedCreateWithoutCategoryInput(
      {required this.path,
      this.id,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUncheckedCreateWithoutCategoryInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedCreateWithoutCategoryInput(
      path: json['path'],
      id: json['id'],
  ...
  AttachmentUncheckedCreateWithoutCategoryInput copyWith(
      {MultipartFile? path,
      String? id,
      String? filename,
      String? mimetype,
