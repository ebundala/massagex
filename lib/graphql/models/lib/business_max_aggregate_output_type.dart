...
class BusinessMaxAggregateOutputType extends Equatable {
  final String? id;
  ...
  BusinessMaxAggregateOutputType(
      {this.id,
      this.ownerId,
      this.mode,
      this.coverId,
  ...
  static BusinessMaxAggregateOutputType fromJson(Map<dynamic, dynamic> json) {
    return BusinessMaxAggregateOutputType(
      id: json['id'],
  ...
  BusinessMaxAggregateOutputType copyWith(
      {String? id,
      String? ownerId,
      BusinessMode? mode,
      String? coverId,
...
extension BusinessMaxAggregateOutputTypeExt on BusinessMaxAggregateOutputType {
...
class BusinessMaxAggregateOutputTypeController
    extends ValueNotifier<BusinessMaxAggregateOutputType> {
  ...
  final BusinessMaxAggregateOutputType initialValue;
  final SelectionSetNode selectionSet;
  final Map<String, SelectionNodeData> selections = {};
  BusinessMaxAggregateOutputTypeController({
