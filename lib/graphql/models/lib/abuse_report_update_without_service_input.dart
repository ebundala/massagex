...
class AbuseReportUpdateWithoutServiceInput extends Equatable {
  ...
  AbuseReportUpdateWithoutServiceInput(
      {this.id,
      this.number,
      this.report,
      this.recordStatus,
  ...
  static AbuseReportUpdateWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpdateWithoutServiceInput(
      id: json['id'] != null
  ...
  AbuseReportUpdateWithoutServiceInput copyWith(
