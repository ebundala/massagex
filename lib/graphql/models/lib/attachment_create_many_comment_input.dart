...
class AttachmentCreateManyCommentInput extends Equatable {
  ...
  static AttachmentCreateManyCommentInput fromJson(Map<dynamic, dynamic> json) {
    return AttachmentCreateManyCommentInput(
      path: json['path'],
      id: json['id'],
  ...
  AttachmentCreateManyCommentInput copyWith(
      {MultipartFile? path,
      String? id,
      String? filename,
      String? mimetype,
