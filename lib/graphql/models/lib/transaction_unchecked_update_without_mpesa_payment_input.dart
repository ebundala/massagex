...
class TransactionUncheckedUpdateWithoutMpesaPaymentInput extends Equatable {
  ...
  TransactionUncheckedUpdateWithoutMpesaPaymentInput(
      {this.id,
  ...
  static TransactionUncheckedUpdateWithoutMpesaPaymentInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUncheckedUpdateWithoutMpesaPaymentInput(
      id: json['id'] != null
  ...
  TransactionUncheckedUpdateWithoutMpesaPaymentInput copyWith(
