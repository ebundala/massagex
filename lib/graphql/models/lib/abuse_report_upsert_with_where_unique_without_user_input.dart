...
import 'abuse_report_update_without_user_input.dart';
import 'abuse_report_create_without_user_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class AbuseReportUpsertWithWhereUniqueWithoutUserInput extends Equatable {
  final AbuseReportWhereUniqueInput where;
  final AbuseReportUpdateWithoutUserInput update;
  ...
  AbuseReportUpsertWithWhereUniqueWithoutUserInput(
      {required this.where, required this.update, required this.create});

  static AbuseReportUpsertWithWhereUniqueWithoutUserInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpsertWithWhereUniqueWithoutUserInput(
      where: AbuseReportWhereUniqueInput.fromJson(json['where']),
      update: AbuseReportUpdateWithoutUserInput.fromJson(json['update']),
  ...
  AbuseReportUpsertWithWhereUniqueWithoutUserInput copyWith(
      {AbuseReportWhereUniqueInput? where,
      AbuseReportUpdateWithoutUserInput? update,
