...
class TransactionUpdateOneWithoutSelcomDisbursementInput extends Equatable {
  ...
  TransactionUpdateOneWithoutSelcomDisbursementInput(
      {this.create,
  ...
  static TransactionUpdateOneWithoutSelcomDisbursementInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUpdateOneWithoutSelcomDisbursementInput(
  ...
  TransactionUpdateOneWithoutSelcomDisbursementInput copyWith(
