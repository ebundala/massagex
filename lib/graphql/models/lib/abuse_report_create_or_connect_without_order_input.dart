...
class AbuseReportCreateOrConnectWithoutOrderInput extends Equatable {
  ...
  AbuseReportCreateOrConnectWithoutOrderInput(
      {required this.where, required this.create});

  static AbuseReportCreateOrConnectWithoutOrderInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportCreateOrConnectWithoutOrderInput(
  ...
  AbuseReportCreateOrConnectWithoutOrderInput copyWith(
