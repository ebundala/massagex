...
class FavoriteUncheckedCreateNestedManyWithoutTypeInput extends Equatable {
  ...
  FavoriteUncheckedCreateNestedManyWithoutTypeInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static FavoriteUncheckedCreateNestedManyWithoutTypeInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedCreateNestedManyWithoutTypeInput(
  ...
  FavoriteUncheckedCreateNestedManyWithoutTypeInput copyWith(
