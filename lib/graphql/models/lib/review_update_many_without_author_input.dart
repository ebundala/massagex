...
class ReviewUpdateManyWithoutAuthorInput extends Equatable {
  ...
  ReviewUpdateManyWithoutAuthorInput(
      {this.create,
  ...
  static ReviewUpdateManyWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewUpdateManyWithoutAuthorInput(
  ...
  ReviewUpdateManyWithoutAuthorInput copyWith(
