...
import 'favorite_upsert_with_where_unique_without_business_input.dart';
import 'favorite_create_many_business_input_envelope.dart';
import 'favorite_where_unique_input.dart';
import 'favorite_update_with_where_unique_without_business_input.dart';
import 'favorite_update_many_with_where_without_business_input.dart';
import 'favorite_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class FavoriteUncheckedUpdateManyWithoutBusinessInput extends Equatable {
  ...
  final List<FavoriteUpsertWithWhereUniqueWithoutBusinessInput>? upsert;
  ...
  final List<FavoriteUpdateWithWhereUniqueWithoutBusinessInput>? update;
  final List<FavoriteUpdateManyWithWhereWithoutBusinessInput>? updateMany;
  ...
  FavoriteUncheckedUpdateManyWithoutBusinessInput(
      {this.create,
  ...
  static FavoriteUncheckedUpdateManyWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedUpdateManyWithoutBusinessInput(
      ...
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) =>
                  FavoriteUpsertWithWhereUniqueWithoutBusinessInput.fromJson(
                      json['upsert'][index]))
          : null,
      ...
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) =>
                  FavoriteUpdateWithWhereUniqueWithoutBusinessInput.fromJson(
                      json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              ...
              (index) =>
                  FavoriteUpdateManyWithWhereWithoutBusinessInput.fromJson(
  ...
  FavoriteUncheckedUpdateManyWithoutBusinessInput copyWith(
      {List<FavoriteCreateWithoutBusinessInput>? create,
      List<FavoriteCreateOrConnectWithoutBusinessInput>? connectOrCreate,
      List<FavoriteUpsertWithWhereUniqueWithoutBusinessInput>? upsert,
      ...
      List<FavoriteUpdateWithWhereUniqueWithoutBusinessInput>? update,
      List<FavoriteUpdateManyWithWhereWithoutBusinessInput>? updateMany,
