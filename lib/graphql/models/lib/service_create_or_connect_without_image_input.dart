...
class ServiceCreateOrConnectWithoutImageInput extends Equatable {
  ...
  ServiceCreateOrConnectWithoutImageInput(
      {required this.where, required this.create});

  static ServiceCreateOrConnectWithoutImageInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceCreateOrConnectWithoutImageInput(
  ...
  ServiceCreateOrConnectWithoutImageInput copyWith(
