...
class SelcomPaymentCreateManyInput extends Equatable {
  final String? id;
  ...
  static SelcomPaymentCreateManyInput fromJson(Map<dynamic, dynamic> json) {
    return SelcomPaymentCreateManyInput(
      id: json['id'],
  ...
  SelcomPaymentCreateManyInput copyWith(
      {String? id,
      String? transId,
      int? amount,
      String? msisdn,
