...
class HelpStepCreateNestedOneWithoutAttachmentsInput extends Equatable {
  ...
  HelpStepCreateNestedOneWithoutAttachmentsInput(
      {this.create, this.connectOrCreate, this.connect});

  static HelpStepCreateNestedOneWithoutAttachmentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return HelpStepCreateNestedOneWithoutAttachmentsInput(
  ...
  HelpStepCreateNestedOneWithoutAttachmentsInput copyWith(
