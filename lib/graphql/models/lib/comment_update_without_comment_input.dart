...
class CommentUpdateWithoutCommentInput extends Equatable {
  ...
  static CommentUpdateWithoutCommentInput fromJson(Map<dynamic, dynamic> json) {
    return CommentUpdateWithoutCommentInput(
      id: json['id'] != null
  ...
  CommentUpdateWithoutCommentInput copyWith(
