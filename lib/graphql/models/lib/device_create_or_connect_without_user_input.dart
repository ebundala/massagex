...
class DeviceCreateOrConnectWithoutUserInput extends Equatable {
  ...
  static DeviceCreateOrConnectWithoutUserInput fromJson(
      Map<dynamic, dynamic> json) {
    return DeviceCreateOrConnectWithoutUserInput(
      where: DeviceWhereUniqueInput.fromJson(json['where']),
  ...
  DeviceCreateOrConnectWithoutUserInput copyWith(
      {DeviceWhereUniqueInput? where, DeviceCreateWithoutUserInput? create}) {
    return DeviceCreateOrConnectWithoutUserInput(
