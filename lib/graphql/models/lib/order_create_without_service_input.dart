...
class OrderCreateWithoutServiceInput extends Equatable {
  final String? id;
  final int quantity;
  ...
  static OrderCreateWithoutServiceInput fromJson(Map<dynamic, dynamic> json) {
    return OrderCreateWithoutServiceInput(
      id: json['id'],
  ...
  OrderCreateWithoutServiceInput copyWith(
      {String? id,
      int? quantity,
