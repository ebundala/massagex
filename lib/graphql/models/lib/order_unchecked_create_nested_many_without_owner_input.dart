...
class OrderUncheckedCreateNestedManyWithoutOwnerInput extends Equatable {
  ...
  OrderUncheckedCreateNestedManyWithoutOwnerInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static OrderUncheckedCreateNestedManyWithoutOwnerInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUncheckedCreateNestedManyWithoutOwnerInput(
  ...
  OrderUncheckedCreateNestedManyWithoutOwnerInput copyWith(
