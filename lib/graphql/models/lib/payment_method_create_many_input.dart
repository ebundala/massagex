...
class PaymentMethodCreateManyInput extends Equatable {
  final String? id;
  final String name;
  ...
  static PaymentMethodCreateManyInput fromJson(Map<dynamic, dynamic> json) {
    return PaymentMethodCreateManyInput(
      id: json['id'],
      name: json['name'],
  ...
  PaymentMethodCreateManyInput copyWith(
      {String? id,
      String? name,
      String? description,
      String? attachmentId,
