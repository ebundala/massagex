...
class AbuseReportCreateManyTypeInput extends Equatable {
  final String? id;
  final int? number;
  final String? report;
  ...
  AbuseReportCreateManyTypeInput(
      {this.id,
      this.number,
      this.report,
  ...
  static AbuseReportCreateManyTypeInput fromJson(Map<dynamic, dynamic> json) {
    return AbuseReportCreateManyTypeInput(
      id: json['id'],
      number: json['number'],
      report: json['report'],
  ...
  AbuseReportCreateManyTypeInput copyWith(
      {String? id,
      int? number,
      String? report,
      String? authorId,
