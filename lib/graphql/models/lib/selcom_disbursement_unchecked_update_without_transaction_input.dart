...
class SelcomDisbursementUncheckedUpdateWithoutTransactionInput
    extends Equatable {
  ...
  SelcomDisbursementUncheckedUpdateWithoutTransactionInput(
      {this.id,
      this.amount,
      this.reference,
      this.resultCode,
  ...
  static SelcomDisbursementUncheckedUpdateWithoutTransactionInput fromJson(
      Map<dynamic, dynamic> json) {
    return SelcomDisbursementUncheckedUpdateWithoutTransactionInput(
      id: json['id'] != null
  ...
  SelcomDisbursementUncheckedUpdateWithoutTransactionInput copyWith(
