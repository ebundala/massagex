...
class AttachmentCreateNestedOneWithoutServicesInput extends Equatable {
  ...
  AttachmentCreateNestedOneWithoutServicesInput(
      {this.create, this.connectOrCreate, this.connect});

  static AttachmentCreateNestedOneWithoutServicesInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateNestedOneWithoutServicesInput(
  ...
  AttachmentCreateNestedOneWithoutServicesInput copyWith(
