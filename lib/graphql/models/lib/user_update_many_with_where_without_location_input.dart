...
class UserUpdateManyWithWhereWithoutLocationInput extends Equatable {
  ...
  UserUpdateManyWithWhereWithoutLocationInput(
      {required this.where, required this.data});

  static UserUpdateManyWithWhereWithoutLocationInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUpdateManyWithWhereWithoutLocationInput(
  ...
  UserUpdateManyWithWhereWithoutLocationInput copyWith(
