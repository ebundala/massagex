...
import 'order_update_many_without_receipt_input.dart';
...
class AttachmentUpdateWithoutPaymentMethodsInput extends Equatable {
  ...
  final OrderUpdateManyWithoutReceiptInput? orders;
  ...
  AttachmentUpdateWithoutPaymentMethodsInput(
      {this.id,
      this.path,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUpdateWithoutPaymentMethodsInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUpdateWithoutPaymentMethodsInput(
      id: json['id'] != null
      ...
      orders: json['orders'] != null
          ? OrderUpdateManyWithoutReceiptInput.fromJson(json['orders'])
          : null,
  ...
  AttachmentUpdateWithoutPaymentMethodsInput copyWith(
      ...
      OrderUpdateManyWithoutReceiptInput? orders,
