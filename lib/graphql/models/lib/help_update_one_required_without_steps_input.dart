import 'help_create_without_steps_input.dart';
import 'help_create_or_connect_without_steps_input.dart';
import 'help_upsert_without_steps_input.dart';
import 'help_where_unique_input.dart';
import 'help_update_without_steps_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class HelpUpdateOneRequiredWithoutStepsInput extends Equatable {
  final HelpCreateWithoutStepsInput? create;
  final HelpCreateOrConnectWithoutStepsInput? connectOrCreate;
  final HelpUpsertWithoutStepsInput? upsert;
  final HelpWhereUniqueInput? connect;
  final HelpUpdateWithoutStepsInput? update;
  ...
  HelpUpdateOneRequiredWithoutStepsInput(
      {this.create,
  ...
  static HelpUpdateOneRequiredWithoutStepsInput fromJson(
      Map<dynamic, dynamic> json) {
    return HelpUpdateOneRequiredWithoutStepsInput(
      create: json['create'] != null
          ? HelpCreateWithoutStepsInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? HelpCreateOrConnectWithoutStepsInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? HelpUpsertWithoutStepsInput.fromJson(json['upsert'])
          : null,
      connect: json['connect'] != null
          ? HelpWhereUniqueInput.fromJson(json['connect'])
          : null,
      update: json['update'] != null
          ? HelpUpdateWithoutStepsInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  HelpUpdateOneRequiredWithoutStepsInput copyWith(
      {HelpCreateWithoutStepsInput? create,
      HelpCreateOrConnectWithoutStepsInput? connectOrCreate,
      HelpUpsertWithoutStepsInput? upsert,
      HelpWhereUniqueInput? connect,
      HelpUpdateWithoutStepsInput? update}) {
    return HelpUpdateOneRequiredWithoutStepsInput(
