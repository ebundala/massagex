...
class AttachmentCreateNestedOneWithoutUsersInput extends Equatable {
  ...
  AttachmentCreateNestedOneWithoutUsersInput(
      {this.create, this.connectOrCreate, this.connect});

  static AttachmentCreateNestedOneWithoutUsersInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateNestedOneWithoutUsersInput(
  ...
  AttachmentCreateNestedOneWithoutUsersInput copyWith(
