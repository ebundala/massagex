...
class ReviewUncheckedUpdateManyInput extends Equatable {
  ...
  static ReviewUncheckedUpdateManyInput fromJson(Map<dynamic, dynamic> json) {
    return ReviewUncheckedUpdateManyInput(
      id: json['id'] != null
  ...
  ReviewUncheckedUpdateManyInput copyWith(
