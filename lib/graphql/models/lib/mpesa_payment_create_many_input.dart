...
class MpesaPaymentCreateManyInput extends Equatable {
  final String? id;
  ...
  static MpesaPaymentCreateManyInput fromJson(Map<dynamic, dynamic> json) {
    return MpesaPaymentCreateManyInput(
      id: json['id'],
  ...
  MpesaPaymentCreateManyInput copyWith(
      {String? id,
      String? input$Amount,
