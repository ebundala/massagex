...
class PaymentMethodListRelationFilter extends Equatable {
  final PaymentMethodWhereInput? every;
  final PaymentMethodWhereInput? some;
  final PaymentMethodWhereInput? none;
  ...
  PaymentMethodListRelationFilter({this.every, this.some, this.none});

  static PaymentMethodListRelationFilter fromJson(Map<dynamic, dynamic> json) {
    return PaymentMethodListRelationFilter(
      every: json['every'] != null
          ? PaymentMethodWhereInput.fromJson(json['every'])
          : null,
      some: json['some'] != null
          ? PaymentMethodWhereInput.fromJson(json['some'])
          : null,
      none: json['none'] != null
          ? PaymentMethodWhereInput.fromJson(json['none'])
          : null,
    );
  }
  ...
  PaymentMethodListRelationFilter copyWith(
      {PaymentMethodWhereInput? every,
      PaymentMethodWhereInput? some,
      PaymentMethodWhereInput? none}) {
    return PaymentMethodListRelationFilter(
