...
import 'nested_enum_order_status_with_aggregates_filter.dart';
...
class EnumOrderStatusWithAggregatesFilter extends Equatable {
  final OrderStatus? equals;
  final List<OrderStatus>? in$;
  final List<OrderStatus>? notIn;
  final NestedEnumOrderStatusWithAggregatesFilter? not;
  final NestedIntFilter? $count;
  final NestedIntFilter? count;
  final NestedEnumOrderStatusFilter? $min;
  final NestedEnumOrderStatusFilter? min;
  final NestedEnumOrderStatusFilter? $max;
  final NestedEnumOrderStatusFilter? max;
  ...
  static EnumOrderStatusWithAggregatesFilter fromJson(
      Map<dynamic, dynamic> json) {
    return EnumOrderStatusWithAggregatesFilter(
      ...
      notIn: json['notIn'] != null
          ...
          : null,
      not: json['not'] != null
          ? NestedEnumOrderStatusWithAggregatesFilter.fromJson(json['not'])
          : null,
      ...
      count: json['count'] != null
          ...
          : null,
      $min: json['_min'] != null
          ? NestedEnumOrderStatusFilter.fromJson(json['_min'])
          : null,
      min: json['min'] != null
          ? NestedEnumOrderStatusFilter.fromJson(json['min'])
          : null,
      $max: json['_max'] != null
          ? NestedEnumOrderStatusFilter.fromJson(json['_max'])
          : null,
      max: json['max'] != null
          ? NestedEnumOrderStatusFilter.fromJson(json['max'])
          : null,
    );
  }
  ...
  EnumOrderStatusWithAggregatesFilter copyWith(
      {OrderStatus? equals,
      List<OrderStatus>? in$,
      List<OrderStatus>? notIn,
      NestedEnumOrderStatusWithAggregatesFilter? not,
      NestedIntFilter? $count,
      NestedIntFilter? count,
      NestedEnumOrderStatusFilter? $min,
      NestedEnumOrderStatusFilter? min,
      NestedEnumOrderStatusFilter? $max,
      NestedEnumOrderStatusFilter? max}) {
    return EnumOrderStatusWithAggregatesFilter(
