...
class ReviewCreateNestedManyWithoutAuthorInput extends Equatable {
  ...
  static ReviewCreateNestedManyWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewCreateNestedManyWithoutAuthorInput(
  ...
  ReviewCreateNestedManyWithoutAuthorInput copyWith(
