...
class AttachmentCreateNestedOneWithoutCategoryInput extends Equatable {
  ...
  AttachmentCreateNestedOneWithoutCategoryInput(
      {this.create, this.connectOrCreate, this.connect});

  static AttachmentCreateNestedOneWithoutCategoryInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateNestedOneWithoutCategoryInput(
  ...
  AttachmentCreateNestedOneWithoutCategoryInput copyWith(
