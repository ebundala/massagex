...
class AbuseReportUpdateWithoutUserInput extends Equatable {
  ...
  AbuseReportUpdateWithoutUserInput(
      {this.id,
      this.number,
      this.report,
      this.recordStatus,
  ...
  static AbuseReportUpdateWithoutUserInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpdateWithoutUserInput(
      id: json['id'] != null
  ...
  AbuseReportUpdateWithoutUserInput copyWith(
