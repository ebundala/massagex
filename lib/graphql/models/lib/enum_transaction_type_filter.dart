...
class EnumTransactionTypeFilter extends Equatable {
  final TransactionType? equals;
  final List<TransactionType>? in$;
  final List<TransactionType>? notIn;
  final NestedEnumTransactionTypeFilter? not;
  ...
  EnumTransactionTypeFilter({this.equals, this.in$, this.notIn, this.not});

  static EnumTransactionTypeFilter fromJson(Map<dynamic, dynamic> json) {
    return EnumTransactionTypeFilter(
      ...
      notIn: json['notIn'] != null
          ...
          : null,
      not: json['not'] != null
          ? NestedEnumTransactionTypeFilter.fromJson(json['not'])
          : null,
    );
  }
