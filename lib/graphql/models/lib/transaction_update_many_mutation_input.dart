...
class TransactionUpdateManyMutationInput extends Equatable {
  ...
  static TransactionUpdateManyMutationInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUpdateManyMutationInput(
      id: json['id'] != null
  ...
  TransactionUpdateManyMutationInput copyWith(
  ...
  List<Object?> get props =>
      [id, type, status, recordStatus, metadata, createdAt, updatedAt];
}
