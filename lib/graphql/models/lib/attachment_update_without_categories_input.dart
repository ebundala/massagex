...
class AttachmentUpdateWithoutCategoriesInput extends Equatable {
  ...
  AttachmentUpdateWithoutCategoriesInput(
      {this.id,
      this.path,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUpdateWithoutCategoriesInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUpdateWithoutCategoriesInput(
      id: json['id'] != null
  ...
  AttachmentUpdateWithoutCategoriesInput copyWith(
