...
class TransactionUncheckedUpdateInput extends Equatable {
  ...
  static TransactionUncheckedUpdateInput fromJson(Map<dynamic, dynamic> json) {
    return TransactionUncheckedUpdateInput(
      id: json['id'] != null
  ...
  TransactionUncheckedUpdateInput copyWith(
