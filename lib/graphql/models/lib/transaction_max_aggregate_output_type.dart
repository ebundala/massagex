...
class TransactionMaxAggregateOutputType extends Equatable {
  final String? id;
  ...
  static TransactionMaxAggregateOutputType fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionMaxAggregateOutputType(
      id: json['id'],
  ...
  TransactionMaxAggregateOutputType copyWith(
      {String? id,
...
extension TransactionMaxAggregateOutputTypeExt
    on TransactionMaxAggregateOutputType {
...
class TransactionMaxAggregateOutputTypeController
    extends ValueNotifier<TransactionMaxAggregateOutputType> {
  ...
  final TransactionMaxAggregateOutputType initialValue;
  final SelectionSetNode selectionSet;
  final Map<String, SelectionNodeData> selections = {};
  TransactionMaxAggregateOutputTypeController({
