...
class TransactionCreateOrConnectWithoutSelcomDisbursementInput
    extends Equatable {
  ...
  TransactionCreateOrConnectWithoutSelcomDisbursementInput(
      {required this.where, required this.create});

  static TransactionCreateOrConnectWithoutSelcomDisbursementInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionCreateOrConnectWithoutSelcomDisbursementInput(
  ...
  TransactionCreateOrConnectWithoutSelcomDisbursementInput copyWith(
