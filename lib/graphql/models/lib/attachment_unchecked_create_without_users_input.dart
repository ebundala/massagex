...
class AttachmentUncheckedCreateWithoutUsersInput extends Equatable {
  ...
  AttachmentUncheckedCreateWithoutUsersInput(
      {required this.path,
      this.id,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUncheckedCreateWithoutUsersInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedCreateWithoutUsersInput(
      path: json['path'],
      id: json['id'],
  ...
  AttachmentUncheckedCreateWithoutUsersInput copyWith(
      {MultipartFile? path,
      String? id,
      String? filename,
      String? mimetype,
