...
class CommentUpdateWithoutAuthorInput extends Equatable {
  ...
  static CommentUpdateWithoutAuthorInput fromJson(Map<dynamic, dynamic> json) {
    return CommentUpdateWithoutAuthorInput(
      id: json['id'] != null
  ...
  CommentUpdateWithoutAuthorInput copyWith(
