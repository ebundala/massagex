...
class CategoryMaxAggregateOutputType extends Equatable {
  final String? id;
  final String? name;
  ...
  static CategoryMaxAggregateOutputType fromJson(Map<dynamic, dynamic> json) {
    return CategoryMaxAggregateOutputType(
      id: json['id'],
      name: json['name'],
  ...
  CategoryMaxAggregateOutputType copyWith(
      {String? id,
      String? name,
      String? description,
      String? pictureId,
...
extension CategoryMaxAggregateOutputTypeExt on CategoryMaxAggregateOutputType {
...
class CategoryMaxAggregateOutputTypeController
    extends ValueNotifier<CategoryMaxAggregateOutputType> {
  ...
  final CategoryMaxAggregateOutputType initialValue;
  final SelectionSetNode selectionSet;
  final Map<String, SelectionNodeData> selections = {};
  CategoryMaxAggregateOutputTypeController({
