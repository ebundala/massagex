...
class CasbinRuleMinAggregateOutputType extends Equatable {
  final int? id;
  final String? ptype;
  final String? v0;
  final String? v1;
  ...
  static CasbinRuleMinAggregateOutputType fromJson(Map<dynamic, dynamic> json) {
    return CasbinRuleMinAggregateOutputType(
      id: json['id'],
      ptype: json['ptype'],
      v0: json['v0'],
      v1: json['v1'],
  ...
  CasbinRuleMinAggregateOutputType copyWith(
      {int? id,
      String? ptype,
      String? v0,
      String? v1,
