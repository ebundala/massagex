...
class FavoriteCreateManyOrderInput extends Equatable {
  final String? id;
  final String favId;
  ...
  static FavoriteCreateManyOrderInput fromJson(Map<dynamic, dynamic> json) {
    return FavoriteCreateManyOrderInput(
      id: json['id'],
      favId: json['favId'],
  ...
  FavoriteCreateManyOrderInput copyWith(
      {String? id,
      String? favId,
      String? authorId,
      String? typeId,
