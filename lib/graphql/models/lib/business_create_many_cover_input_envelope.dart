import 'business_create_many_cover_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class BusinessCreateManyCoverInputEnvelope extends Equatable {
  final List<BusinessCreateManyCoverInput>? data;
  ...
  BusinessCreateManyCoverInputEnvelope({this.data, this.skipDuplicates});

  static BusinessCreateManyCoverInputEnvelope fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessCreateManyCoverInputEnvelope(
      data: json['data'] != null
          ? List.generate(
              json['data'].length,
              (index) =>
                  BusinessCreateManyCoverInput.fromJson(json['data'][index]))
          : null,
  ...
  BusinessCreateManyCoverInputEnvelope copyWith(
      {List<BusinessCreateManyCoverInput>? data, bool? skipDuplicates}) {
    return BusinessCreateManyCoverInputEnvelope(
        data: data ?? this.data,
