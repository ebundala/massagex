...
class AbuseReportUpdateInput extends Equatable {
  ...
  static AbuseReportUpdateInput fromJson(Map<dynamic, dynamic> json) {
    return AbuseReportUpdateInput(
      id: json['id'] != null
  ...
  AbuseReportUpdateInput copyWith(
