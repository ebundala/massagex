...
class AttachmentCreateNestedManyWithoutBusinessInput extends Equatable {
  ...
  AttachmentCreateNestedManyWithoutBusinessInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static AttachmentCreateNestedManyWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateNestedManyWithoutBusinessInput(
  ...
  AttachmentCreateNestedManyWithoutBusinessInput copyWith(
