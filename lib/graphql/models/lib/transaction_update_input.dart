...
class TransactionUpdateInput extends Equatable {
  ...
  static TransactionUpdateInput fromJson(Map<dynamic, dynamic> json) {
    return TransactionUpdateInput(
      id: json['id'] != null
  ...
  TransactionUpdateInput copyWith(
