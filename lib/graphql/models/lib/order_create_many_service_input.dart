...
class OrderCreateManyServiceInput extends Equatable {
  final String? id;
  final int quantity;
  ...
  static OrderCreateManyServiceInput fromJson(Map<dynamic, dynamic> json) {
    return OrderCreateManyServiceInput(
      id: json['id'],
  ...
  OrderCreateManyServiceInput copyWith(
      {String? id,
      int? quantity,
