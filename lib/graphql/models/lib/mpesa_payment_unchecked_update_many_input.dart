...
class MpesaPaymentUncheckedUpdateManyInput extends Equatable {
  ...
  MpesaPaymentUncheckedUpdateManyInput(
      {this.id,
      this.input$Amount,
      this.input$Country,
      this.input$Currency,
  ...
  static MpesaPaymentUncheckedUpdateManyInput fromJson(
      Map<dynamic, dynamic> json) {
    return MpesaPaymentUncheckedUpdateManyInput(
      id: json['id'] != null
  ...
  MpesaPaymentUncheckedUpdateManyInput copyWith(
