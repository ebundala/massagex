import 'service_create_many_image_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class ServiceCreateManyImageInputEnvelope extends Equatable {
  final List<ServiceCreateManyImageInput>? data;
  ...
  ServiceCreateManyImageInputEnvelope({this.data, this.skipDuplicates});

  static ServiceCreateManyImageInputEnvelope fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceCreateManyImageInputEnvelope(
      data: json['data'] != null
          ? List.generate(
              json['data'].length,
              (index) =>
                  ServiceCreateManyImageInput.fromJson(json['data'][index]))
          : null,
  ...
  ServiceCreateManyImageInputEnvelope copyWith(
      {List<ServiceCreateManyImageInput>? data, bool? skipDuplicates}) {
    return ServiceCreateManyImageInputEnvelope(
        data: data ?? this.data,
