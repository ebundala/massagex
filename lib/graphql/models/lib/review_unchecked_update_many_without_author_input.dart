...
import 'review_create_or_connect_without_author_input.dart';
import 'review_upsert_with_where_unique_without_author_input.dart';
import 'review_create_many_author_input_envelope.dart';
import 'review_where_unique_input.dart';
import 'review_update_with_where_unique_without_author_input.dart';
import 'review_update_many_with_where_without_author_input.dart';
import 'review_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class ReviewUncheckedUpdateManyWithoutAuthorInput extends Equatable {
  final List<ReviewCreateWithoutAuthorInput>? create;
  final List<ReviewCreateOrConnectWithoutAuthorInput>? connectOrCreate;
  final List<ReviewUpsertWithWhereUniqueWithoutAuthorInput>? upsert;
  final ReviewCreateManyAuthorInputEnvelope? createMany;
  final List<ReviewWhereUniqueInput>? connect;
  final List<ReviewWhereUniqueInput>? set$;
  final List<ReviewWhereUniqueInput>? disconnect;
  final List<ReviewWhereUniqueInput>? delete;
  final List<ReviewUpdateWithWhereUniqueWithoutAuthorInput>? update;
  final List<ReviewUpdateManyWithWhereWithoutAuthorInput>? updateMany;
  final List<ReviewScalarWhereInput>? deleteMany;
  ...
  static ReviewUncheckedUpdateManyWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewUncheckedUpdateManyWithoutAuthorInput(
      create: json['create'] != null
          ? List.generate(
              json['create'].length,
              (index) => ReviewCreateWithoutAuthorInput.fromJson(
                  json['create'][index]))
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? List.generate(
              json['connectOrCreate'].length,
              (index) => ReviewCreateOrConnectWithoutAuthorInput.fromJson(
                  json['connectOrCreate'][index]))
          : null,
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) => ReviewUpsertWithWhereUniqueWithoutAuthorInput.fromJson(
                  json['upsert'][index]))
          : null,
      createMany: json['createMany'] != null
          ? ReviewCreateManyAuthorInputEnvelope.fromJson(json['createMany'])
          : null,
      ...
      set$: json['set'] != null
          ? List.generate(json['set'].length,
              (index) => ReviewWhereUniqueInput.fromJson(json['set'][index]))
          : null,
      disconnect: json['disconnect'] != null
          ? List.generate(
              json['disconnect'].length,
              (index) =>
                  ReviewWhereUniqueInput.fromJson(json['disconnect'][index]))
          : null,
      delete: json['delete'] != null
          ? List.generate(json['delete'].length,
              (index) => ReviewWhereUniqueInput.fromJson(json['delete'][index]))
          : null,
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) => ReviewUpdateWithWhereUniqueWithoutAuthorInput.fromJson(
                  json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              json['updateMany'].length,
              (index) => ReviewUpdateManyWithWhereWithoutAuthorInput.fromJson(
      ...
      deleteMany: json['deleteMany'] != null
          ? List.generate(
              ...
              (index) =>
                  ReviewScalarWhereInput.fromJson(json['deleteMany'][index]))
          : null,
    );
  }
  ...
  ReviewUncheckedUpdateManyWithoutAuthorInput copyWith(
      {List<ReviewCreateWithoutAuthorInput>? create,
      List<ReviewCreateOrConnectWithoutAuthorInput>? connectOrCreate,
      List<ReviewUpsertWithWhereUniqueWithoutAuthorInput>? upsert,
      ReviewCreateManyAuthorInputEnvelope? createMany,
      List<ReviewWhereUniqueInput>? connect,
      List<ReviewWhereUniqueInput>? set$,
      List<ReviewWhereUniqueInput>? disconnect,
      List<ReviewWhereUniqueInput>? delete,
      List<ReviewUpdateWithWhereUniqueWithoutAuthorInput>? update,
      List<ReviewUpdateManyWithWhereWithoutAuthorInput>? updateMany,
      List<ReviewScalarWhereInput>? deleteMany}) {
    return ReviewUncheckedUpdateManyWithoutAuthorInput(
