...
class AttachmentCreateManyHelpStepInput extends Equatable {
  ...
  AttachmentCreateManyHelpStepInput(
      {required this.path,
      this.id,
      this.filename,
      this.mimetype,
  ...
  static AttachmentCreateManyHelpStepInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateManyHelpStepInput(
      path: json['path'],
      id: json['id'],
  ...
  AttachmentCreateManyHelpStepInput copyWith(
      {MultipartFile? path,
      String? id,
      String? filename,
      String? mimetype,
