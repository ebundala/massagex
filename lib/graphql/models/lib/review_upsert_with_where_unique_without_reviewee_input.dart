...
import 'review_update_without_reviewee_input.dart';
import 'review_create_without_reviewee_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class ReviewUpsertWithWhereUniqueWithoutRevieweeInput extends Equatable {
  final ReviewWhereUniqueInput where;
  final ReviewUpdateWithoutRevieweeInput update;
  final ReviewCreateWithoutRevieweeInput create;
  ...
  ReviewUpsertWithWhereUniqueWithoutRevieweeInput(
      {required this.where, required this.update, required this.create});

  static ReviewUpsertWithWhereUniqueWithoutRevieweeInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewUpsertWithWhereUniqueWithoutRevieweeInput(
      where: ReviewWhereUniqueInput.fromJson(json['where']),
      update: ReviewUpdateWithoutRevieweeInput.fromJson(json['update']),
      create: ReviewCreateWithoutRevieweeInput.fromJson(json['create']),
    );
  }
  ...
  ReviewUpsertWithWhereUniqueWithoutRevieweeInput copyWith(
      {ReviewWhereUniqueInput? where,
      ReviewUpdateWithoutRevieweeInput? update,
      ReviewCreateWithoutRevieweeInput? create}) {
    return ReviewUpsertWithWhereUniqueWithoutRevieweeInput(
