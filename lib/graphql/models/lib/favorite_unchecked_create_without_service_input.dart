...
class FavoriteUncheckedCreateWithoutServiceInput extends Equatable {
  final String? id;
  final String favId;
  ...
  FavoriteUncheckedCreateWithoutServiceInput(
      {this.id,
      required this.favId,
  ...
  static FavoriteUncheckedCreateWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedCreateWithoutServiceInput(
      id: json['id'],
      favId: json['favId'],
  ...
  FavoriteUncheckedCreateWithoutServiceInput copyWith(
      {String? id,
      String? favId,
      String? authorId,
      String? typeId,
