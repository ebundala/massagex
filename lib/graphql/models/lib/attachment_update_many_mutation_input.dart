...
class AttachmentUpdateManyMutationInput extends Equatable {
  ...
  static AttachmentUpdateManyMutationInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUpdateManyMutationInput(
      id: json['id'] != null
  ...
  AttachmentUpdateManyMutationInput copyWith(
