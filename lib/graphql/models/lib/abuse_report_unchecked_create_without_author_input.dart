...
class AbuseReportUncheckedCreateWithoutAuthorInput extends Equatable {
  final String? id;
  final int? number;
  final String? report;
  final String typeId;
  ...
  AbuseReportUncheckedCreateWithoutAuthorInput(
      {this.id,
      this.number,
      this.report,
  ...
  static AbuseReportUncheckedCreateWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedCreateWithoutAuthorInput(
      id: json['id'],
      number: json['number'],
      report: json['report'],
      typeId: json['typeId'],
  ...
  AbuseReportUncheckedCreateWithoutAuthorInput copyWith(
      {String? id,
      int? number,
      String? report,
      String? typeId,
