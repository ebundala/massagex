...
class FavoriteCreateOrConnectWithoutOrderInput extends Equatable {
  ...
  FavoriteCreateOrConnectWithoutOrderInput(
      {required this.where, required this.create});

  static FavoriteCreateOrConnectWithoutOrderInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteCreateOrConnectWithoutOrderInput(
  ...
  FavoriteCreateOrConnectWithoutOrderInput copyWith(
