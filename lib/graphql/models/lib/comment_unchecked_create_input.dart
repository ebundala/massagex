...
class CommentUncheckedCreateInput extends Equatable {
  final String? id;
  ...
  static CommentUncheckedCreateInput fromJson(Map<dynamic, dynamic> json) {
    return CommentUncheckedCreateInput(
      id: json['id'],
  ...
  CommentUncheckedCreateInput copyWith(
      {String? id,
      String? authorId,
      String? reviewId,
