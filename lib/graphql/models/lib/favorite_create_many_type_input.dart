...
class FavoriteCreateManyTypeInput extends Equatable {
  final String? id;
  final String favId;
  ...
  static FavoriteCreateManyTypeInput fromJson(Map<dynamic, dynamic> json) {
    return FavoriteCreateManyTypeInput(
      id: json['id'],
      favId: json['favId'],
  ...
  FavoriteCreateManyTypeInput copyWith(
      {String? id,
      String? favId,
      String? authorId,
