...
class AbuseReportCreateNestedManyWithoutBusinessInput extends Equatable {
  ...
  AbuseReportCreateNestedManyWithoutBusinessInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static AbuseReportCreateNestedManyWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportCreateNestedManyWithoutBusinessInput(
  ...
  AbuseReportCreateNestedManyWithoutBusinessInput copyWith(
