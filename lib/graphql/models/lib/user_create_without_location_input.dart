...
class UserCreateWithoutLocationInput extends Equatable {
  final String? id;
  final String? email;
  ...
  UserCreateWithoutLocationInput(
      {this.id,
      this.email,
      this.displayName,
      this.phoneNumber,
  ...
  static UserCreateWithoutLocationInput fromJson(Map<dynamic, dynamic> json) {
    return UserCreateWithoutLocationInput(
      id: json['id'],
      email: json['email'],
  ...
  UserCreateWithoutLocationInput copyWith(
      {String? id,
      String? email,
      String? displayName,
      String? phoneNumber,
