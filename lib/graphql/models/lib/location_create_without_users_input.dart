...
import 'business_create_nested_many_without_location_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class LocationCreateWithoutUsersInput extends Equatable {
  final String? id;
  final String? name;
  final double lat;
  final double lon;
  ...
  final BusinessCreateNestedManyWithoutLocationInput? businesses;
  ...
  LocationCreateWithoutUsersInput(
      {this.id,
      this.name,
      required this.lat,
      required this.lon,
  ...
  static LocationCreateWithoutUsersInput fromJson(Map<dynamic, dynamic> json) {
    return LocationCreateWithoutUsersInput(
      id: json['id'],
      name: json['name'],
      ...
      businesses: json['businesses'] != null
          ? BusinessCreateNestedManyWithoutLocationInput.fromJson(
              json['businesses'])
          : null,
    );
  }
  ...
  LocationCreateWithoutUsersInput copyWith(
      {String? id,
      String? name,
      double? lat,
      double? lon,
      ...
      DateTime? createdAt,
      DateTime? updatedAt,
      BusinessCreateNestedManyWithoutLocationInput? businesses}) {
    return LocationCreateWithoutUsersInput(
        id: id ?? this.id,
        name: name ?? this.name,
        lat: lat ?? this.lat,
