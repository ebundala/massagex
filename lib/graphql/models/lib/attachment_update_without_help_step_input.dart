...
class AttachmentUpdateWithoutHelpStepInput extends Equatable {
  ...
  AttachmentUpdateWithoutHelpStepInput(
      {this.id,
      this.path,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUpdateWithoutHelpStepInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUpdateWithoutHelpStepInput(
      id: json['id'] != null
  ...
  AttachmentUpdateWithoutHelpStepInput copyWith(
