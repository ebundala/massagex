import 'comment_create_many_review_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class CommentCreateManyReviewInputEnvelope extends Equatable {
  final List<CommentCreateManyReviewInput>? data;
  ...
  CommentCreateManyReviewInputEnvelope({this.data, this.skipDuplicates});

  static CommentCreateManyReviewInputEnvelope fromJson(
      Map<dynamic, dynamic> json) {
    return CommentCreateManyReviewInputEnvelope(
      data: json['data'] != null
          ? List.generate(
              json['data'].length,
              (index) =>
                  CommentCreateManyReviewInput.fromJson(json['data'][index]))
          : null,
  ...
  CommentCreateManyReviewInputEnvelope copyWith(
      {List<CommentCreateManyReviewInput>? data, bool? skipDuplicates}) {
    return CommentCreateManyReviewInputEnvelope(
        data: data ?? this.data,
