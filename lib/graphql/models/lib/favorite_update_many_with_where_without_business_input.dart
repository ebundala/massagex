...
class FavoriteUpdateManyWithWhereWithoutBusinessInput extends Equatable {
  ...
  FavoriteUpdateManyWithWhereWithoutBusinessInput(
      {required this.where, required this.data});

  static FavoriteUpdateManyWithWhereWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUpdateManyWithWhereWithoutBusinessInput(
  ...
  FavoriteUpdateManyWithWhereWithoutBusinessInput copyWith(
