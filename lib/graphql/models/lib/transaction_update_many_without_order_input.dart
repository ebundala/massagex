...
class TransactionUpdateManyWithoutOrderInput extends Equatable {
  ...
  TransactionUpdateManyWithoutOrderInput(
      {this.create,
  ...
  static TransactionUpdateManyWithoutOrderInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUpdateManyWithoutOrderInput(
  ...
  TransactionUpdateManyWithoutOrderInput copyWith(
