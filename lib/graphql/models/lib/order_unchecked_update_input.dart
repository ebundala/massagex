...
class OrderUncheckedUpdateInput extends Equatable {
  ...
  static OrderUncheckedUpdateInput fromJson(Map<dynamic, dynamic> json) {
    return OrderUncheckedUpdateInput(
      id: json['id'] != null
  ...
  OrderUncheckedUpdateInput copyWith(
