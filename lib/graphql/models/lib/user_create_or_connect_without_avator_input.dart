...
class UserCreateOrConnectWithoutAvatorInput extends Equatable {
  ...
  UserCreateOrConnectWithoutAvatorInput(
      {required this.where, required this.create});

  static UserCreateOrConnectWithoutAvatorInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserCreateOrConnectWithoutAvatorInput(
  ...
  UserCreateOrConnectWithoutAvatorInput copyWith(
      {UserWhereUniqueInput? where, UserCreateWithoutAvatorInput? create}) {
    return UserCreateOrConnectWithoutAvatorInput(
