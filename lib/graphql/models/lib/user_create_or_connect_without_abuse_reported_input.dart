...
class UserCreateOrConnectWithoutAbuseReportedInput extends Equatable {
  ...
  UserCreateOrConnectWithoutAbuseReportedInput(
      {required this.where, required this.create});

  static UserCreateOrConnectWithoutAbuseReportedInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserCreateOrConnectWithoutAbuseReportedInput(
  ...
  UserCreateOrConnectWithoutAbuseReportedInput copyWith(
