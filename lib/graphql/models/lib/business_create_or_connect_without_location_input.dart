...
class BusinessCreateOrConnectWithoutLocationInput extends Equatable {
  ...
  BusinessCreateOrConnectWithoutLocationInput(
      {required this.where, required this.create});

  static BusinessCreateOrConnectWithoutLocationInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessCreateOrConnectWithoutLocationInput(
  ...
  BusinessCreateOrConnectWithoutLocationInput copyWith(
