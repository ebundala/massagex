...
class OrderUpdateManyWithoutServiceInput extends Equatable {
  ...
  OrderUpdateManyWithoutServiceInput(
      {this.create,
  ...
  static OrderUpdateManyWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUpdateManyWithoutServiceInput(
  ...
  OrderUpdateManyWithoutServiceInput copyWith(
