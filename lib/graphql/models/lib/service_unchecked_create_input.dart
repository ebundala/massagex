...
class ServiceUncheckedCreateInput extends Equatable {
  final String? id;
  final String name;
  ...
  static ServiceUncheckedCreateInput fromJson(Map<dynamic, dynamic> json) {
    return ServiceUncheckedCreateInput(
      id: json['id'],
      name: json['name'],
  ...
  ServiceUncheckedCreateInput copyWith(
      {String? id,
      String? name,
      String? description,
      double? price,
