...
class AttachmentCreateWithoutServicesInput extends Equatable {
  ...
  AttachmentCreateWithoutServicesInput(
      {required this.path,
      this.id,
      this.filename,
      this.mimetype,
  ...
  static AttachmentCreateWithoutServicesInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateWithoutServicesInput(
      path: json['path'],
      id: json['id'],
  ...
  AttachmentCreateWithoutServicesInput copyWith(
      {MultipartFile? path,
      String? id,
      String? filename,
      String? mimetype,
