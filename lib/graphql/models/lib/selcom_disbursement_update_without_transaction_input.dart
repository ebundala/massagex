...
class SelcomDisbursementUpdateWithoutTransactionInput extends Equatable {
  ...
  SelcomDisbursementUpdateWithoutTransactionInput(
      {this.id,
      this.amount,
      this.reference,
      this.resultCode,
  ...
  static SelcomDisbursementUpdateWithoutTransactionInput fromJson(
      Map<dynamic, dynamic> json) {
    return SelcomDisbursementUpdateWithoutTransactionInput(
      id: json['id'] != null
  ...
  SelcomDisbursementUpdateWithoutTransactionInput copyWith(
