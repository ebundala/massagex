...
import 'favorite_upsert_with_where_unique_without_review_input.dart';
import 'favorite_create_many_review_input_envelope.dart';
import 'favorite_where_unique_input.dart';
import 'favorite_update_with_where_unique_without_review_input.dart';
import 'favorite_update_many_with_where_without_review_input.dart';
import 'favorite_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class FavoriteUncheckedUpdateManyWithoutReviewInput extends Equatable {
  final List<FavoriteCreateWithoutReviewInput>? create;
  final List<FavoriteCreateOrConnectWithoutReviewInput>? connectOrCreate;
  final List<FavoriteUpsertWithWhereUniqueWithoutReviewInput>? upsert;
  ...
  final List<FavoriteUpdateWithWhereUniqueWithoutReviewInput>? update;
  final List<FavoriteUpdateManyWithWhereWithoutReviewInput>? updateMany;
  ...
  FavoriteUncheckedUpdateManyWithoutReviewInput(
      {this.create,
  ...
  static FavoriteUncheckedUpdateManyWithoutReviewInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedUpdateManyWithoutReviewInput(
      ...
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) =>
                  FavoriteUpsertWithWhereUniqueWithoutReviewInput.fromJson(
                      json['upsert'][index]))
          : null,
      ...
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) =>
                  FavoriteUpdateWithWhereUniqueWithoutReviewInput.fromJson(
                      json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              json['updateMany'].length,
              (index) => FavoriteUpdateManyWithWhereWithoutReviewInput.fromJson(
  ...
  FavoriteUncheckedUpdateManyWithoutReviewInput copyWith(
      {List<FavoriteCreateWithoutReviewInput>? create,
      List<FavoriteCreateOrConnectWithoutReviewInput>? connectOrCreate,
      List<FavoriteUpsertWithWhereUniqueWithoutReviewInput>? upsert,
      ...
      List<FavoriteUpdateWithWhereUniqueWithoutReviewInput>? update,
      List<FavoriteUpdateManyWithWhereWithoutReviewInput>? updateMany,
