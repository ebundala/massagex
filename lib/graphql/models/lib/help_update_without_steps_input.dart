...
class HelpUpdateWithoutStepsInput extends Equatable {
  ...
  static HelpUpdateWithoutStepsInput fromJson(Map<dynamic, dynamic> json) {
    return HelpUpdateWithoutStepsInput(
      id: json['id'] != null
  ...
  HelpUpdateWithoutStepsInput copyWith(
