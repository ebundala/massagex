...
class HelpStepUncheckedUpdateManyWithoutStepsInput extends Equatable {
  ...
  HelpStepUncheckedUpdateManyWithoutStepsInput(
      {this.id,
      this.stepNumber,
      this.title,
      this.description,
  ...
  static HelpStepUncheckedUpdateManyWithoutStepsInput fromJson(
      Map<dynamic, dynamic> json) {
    return HelpStepUncheckedUpdateManyWithoutStepsInput(
      id: json['id'] != null
  ...
  HelpStepUncheckedUpdateManyWithoutStepsInput copyWith(
