...
class FavoriteCreateManyCommentInput extends Equatable {
  final String? id;
  final String favId;
  ...
  FavoriteCreateManyCommentInput(
      {this.id,
      required this.favId,
  ...
  static FavoriteCreateManyCommentInput fromJson(Map<dynamic, dynamic> json) {
    return FavoriteCreateManyCommentInput(
      id: json['id'],
      favId: json['favId'],
  ...
  FavoriteCreateManyCommentInput copyWith(
      {String? id,
      String? favId,
      String? authorId,
      String? typeId,
