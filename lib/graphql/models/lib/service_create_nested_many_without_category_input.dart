...
class ServiceCreateNestedManyWithoutCategoryInput extends Equatable {
  ...
  ServiceCreateNestedManyWithoutCategoryInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static ServiceCreateNestedManyWithoutCategoryInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceCreateNestedManyWithoutCategoryInput(
  ...
  ServiceCreateNestedManyWithoutCategoryInput copyWith(
