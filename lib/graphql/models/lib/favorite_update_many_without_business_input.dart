...
class FavoriteUpdateManyWithoutBusinessInput extends Equatable {
  ...
  FavoriteUpdateManyWithoutBusinessInput(
      {this.create,
  ...
  static FavoriteUpdateManyWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUpdateManyWithoutBusinessInput(
  ...
  FavoriteUpdateManyWithoutBusinessInput copyWith(
