...
class TransactionCreateWithoutOrderInput extends Equatable {
  final String? id;
  ...
  static TransactionCreateWithoutOrderInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionCreateWithoutOrderInput(
      id: json['id'],
  ...
  TransactionCreateWithoutOrderInput copyWith(
      {String? id,
