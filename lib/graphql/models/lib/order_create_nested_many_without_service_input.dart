...
class OrderCreateNestedManyWithoutServiceInput extends Equatable {
  ...
  OrderCreateNestedManyWithoutServiceInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static OrderCreateNestedManyWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderCreateNestedManyWithoutServiceInput(
  ...
  OrderCreateNestedManyWithoutServiceInput copyWith(
