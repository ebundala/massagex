...
class AbuseReportUpdateManyWithoutTypeInput extends Equatable {
  ...
  AbuseReportUpdateManyWithoutTypeInput(
      {this.create,
  ...
  static AbuseReportUpdateManyWithoutTypeInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpdateManyWithoutTypeInput(
  ...
  AbuseReportUpdateManyWithoutTypeInput copyWith(
