...
class NestedDateTimeWithAggregatesFilter extends Equatable {
  ...
  static NestedDateTimeWithAggregatesFilter fromJson(
      Map<dynamic, dynamic> json) {
    return NestedDateTimeWithAggregatesFilter(
  ...
  NestedDateTimeWithAggregatesFilter copyWith(
      {DateTime? equals,
      List<DateTime>? in$,
      List<DateTime>? notIn,
      DateTime? lt,
