...
class AbuseReportUncheckedCreateNestedManyWithoutCommentInput
    extends Equatable {
  ...
  AbuseReportUncheckedCreateNestedManyWithoutCommentInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static AbuseReportUncheckedCreateNestedManyWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedCreateNestedManyWithoutCommentInput(
  ...
  AbuseReportUncheckedCreateNestedManyWithoutCommentInput copyWith(
