import 'attachment_create_without_orders_input.dart';
import 'attachment_create_or_connect_without_orders_input.dart';
import 'attachment_upsert_without_orders_input.dart';
import 'attachment_where_unique_input.dart';
import 'attachment_update_without_orders_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class AttachmentUpdateOneWithoutOrdersInput extends Equatable {
  final AttachmentCreateWithoutOrdersInput? create;
  final AttachmentCreateOrConnectWithoutOrdersInput? connectOrCreate;
  final AttachmentUpsertWithoutOrdersInput? upsert;
  final AttachmentWhereUniqueInput? connect;
  final bool? disconnect;
  final bool? delete;
  final AttachmentUpdateWithoutOrdersInput? update;
  ...
  AttachmentUpdateOneWithoutOrdersInput(
      {this.create,
  ...
  static AttachmentUpdateOneWithoutOrdersInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUpdateOneWithoutOrdersInput(
      create: json['create'] != null
          ? AttachmentCreateWithoutOrdersInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? AttachmentCreateOrConnectWithoutOrdersInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? AttachmentUpsertWithoutOrdersInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? AttachmentUpdateWithoutOrdersInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  AttachmentUpdateOneWithoutOrdersInput copyWith(
      {AttachmentCreateWithoutOrdersInput? create,
      AttachmentCreateOrConnectWithoutOrdersInput? connectOrCreate,
      AttachmentUpsertWithoutOrdersInput? upsert,
      AttachmentWhereUniqueInput? connect,
      bool? disconnect,
      bool? delete,
      AttachmentUpdateWithoutOrdersInput? update}) {
    return AttachmentUpdateOneWithoutOrdersInput(
