...
class FavoriteRecordTypeUpsertWithoutFavoritesInput extends Equatable {
  ...
  FavoriteRecordTypeUpsertWithoutFavoritesInput(
      {required this.update, required this.create});

  static FavoriteRecordTypeUpsertWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteRecordTypeUpsertWithoutFavoritesInput(
      update: FavoriteRecordTypeUpdateWithoutFavoritesInput.fromJson(
          json['update']),
  ...
  FavoriteRecordTypeUpsertWithoutFavoritesInput copyWith(
