...
import 'comment_update_without_review_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class CommentUpdateWithWhereUniqueWithoutReviewInput extends Equatable {
  final CommentWhereUniqueInput where;
  final CommentUpdateWithoutReviewInput data;
  ...
  static CommentUpdateWithWhereUniqueWithoutReviewInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUpdateWithWhereUniqueWithoutReviewInput(
      where: CommentWhereUniqueInput.fromJson(json['where']),
      data: CommentUpdateWithoutReviewInput.fromJson(json['data']),
    );
  }
  ...
  CommentUpdateWithWhereUniqueWithoutReviewInput copyWith(
      {CommentWhereUniqueInput? where, CommentUpdateWithoutReviewInput? data}) {
    return CommentUpdateWithWhereUniqueWithoutReviewInput(
