...
class ServiceCreateOrConnectWithoutFavoritesInput extends Equatable {
  ...
  ServiceCreateOrConnectWithoutFavoritesInput(
      {required this.where, required this.create});

  static ServiceCreateOrConnectWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceCreateOrConnectWithoutFavoritesInput(
  ...
  ServiceCreateOrConnectWithoutFavoritesInput copyWith(
