...
class BusinessCreateOrConnectWithoutServicesInput extends Equatable {
  ...
  BusinessCreateOrConnectWithoutServicesInput(
      {required this.where, required this.create});

  static BusinessCreateOrConnectWithoutServicesInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessCreateOrConnectWithoutServicesInput(
  ...
  BusinessCreateOrConnectWithoutServicesInput copyWith(
