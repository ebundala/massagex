...
class CommentCreateWithoutAuthorInput extends Equatable {
  final String? id;
  ...
  static CommentCreateWithoutAuthorInput fromJson(Map<dynamic, dynamic> json) {
    return CommentCreateWithoutAuthorInput(
      id: json['id'],
  ...
  CommentCreateWithoutAuthorInput copyWith(
      {String? id,
