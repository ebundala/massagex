...
class FavoriteUncheckedUpdateManyWithoutFavoritesInput extends Equatable {
  ...
  FavoriteUncheckedUpdateManyWithoutFavoritesInput(
      {this.id,
      this.favId,
      this.authorId,
      this.typeId,
  ...
  static FavoriteUncheckedUpdateManyWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedUpdateManyWithoutFavoritesInput(
      id: json['id'] != null
  ...
  FavoriteUncheckedUpdateManyWithoutFavoritesInput copyWith(
