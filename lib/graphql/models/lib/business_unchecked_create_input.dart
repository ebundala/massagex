...
class BusinessUncheckedCreateInput extends Equatable {
  final String? id;
  ...
  static BusinessUncheckedCreateInput fromJson(Map<dynamic, dynamic> json) {
    return BusinessUncheckedCreateInput(
      id: json['id'],
  ...
  BusinessUncheckedCreateInput copyWith(
      {String? id,
      String? ownerId,
      BusinessMode? mode,
      String? coverId,
