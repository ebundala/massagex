...
class TransactionCreateWithoutPaymentMethodInput extends Equatable {
  final String? id;
  ...
  TransactionCreateWithoutPaymentMethodInput(
      {this.id,
      required this.type,
      this.status,
      this.recordStatus,
  ...
  static TransactionCreateWithoutPaymentMethodInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionCreateWithoutPaymentMethodInput(
      id: json['id'],
  ...
  TransactionCreateWithoutPaymentMethodInput copyWith(
      {String? id,
