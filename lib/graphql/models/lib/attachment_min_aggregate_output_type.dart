...
class AttachmentMinAggregateOutputType extends Equatable {
  final String? id;
  final String? path;
  ...
  static AttachmentMinAggregateOutputType fromJson(Map<dynamic, dynamic> json) {
    return AttachmentMinAggregateOutputType(
      id: json['id'],
      path: json['path'],
  ...
  AttachmentMinAggregateOutputType copyWith(
      {String? id,
      String? path,
      String? filename,
      String? mimetype,
...
extension AttachmentMinAggregateOutputTypeExt
    on AttachmentMinAggregateOutputType {
...
class AttachmentMinAggregateOutputTypeController
    extends ValueNotifier<AttachmentMinAggregateOutputType> {
  ...
  final AttachmentMinAggregateOutputType initialValue;
  final SelectionSetNode selectionSet;
  final Map<String, SelectionNodeData> selections = {};
  AttachmentMinAggregateOutputTypeController({
