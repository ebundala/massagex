...
class UserUpdateWithoutAbuseReportedInput extends Equatable {
  ...
  UserUpdateWithoutAbuseReportedInput(
      {this.id,
      this.email,
      this.displayName,
      this.phoneNumber,
  ...
  static UserUpdateWithoutAbuseReportedInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUpdateWithoutAbuseReportedInput(
      id: json['id'] != null
  ...
  UserUpdateWithoutAbuseReportedInput copyWith(
