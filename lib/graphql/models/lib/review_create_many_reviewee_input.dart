...
class ReviewCreateManyRevieweeInput extends Equatable {
  final String? id;
  ...
  static ReviewCreateManyRevieweeInput fromJson(Map<dynamic, dynamic> json) {
    return ReviewCreateManyRevieweeInput(
      id: json['id'],
  ...
  ReviewCreateManyRevieweeInput copyWith(
      {String? id,
      String? authorId,
      int? value,
      String? content,
