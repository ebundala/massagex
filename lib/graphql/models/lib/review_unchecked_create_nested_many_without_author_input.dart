...
class ReviewUncheckedCreateNestedManyWithoutAuthorInput extends Equatable {
  ...
  static ReviewUncheckedCreateNestedManyWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewUncheckedCreateNestedManyWithoutAuthorInput(
  ...
  ReviewUncheckedCreateNestedManyWithoutAuthorInput copyWith(
