...
class NestedEnumPaymentStatusWithAggregatesFilter extends Equatable {
  ...
  static NestedEnumPaymentStatusWithAggregatesFilter fromJson(
      Map<dynamic, dynamic> json) {
    return NestedEnumPaymentStatusWithAggregatesFilter(
  ...
  NestedEnumPaymentStatusWithAggregatesFilter copyWith(
