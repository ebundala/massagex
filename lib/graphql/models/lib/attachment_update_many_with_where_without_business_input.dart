...
class AttachmentUpdateManyWithWhereWithoutBusinessInput extends Equatable {
  ...
  AttachmentUpdateManyWithWhereWithoutBusinessInput(
      {required this.where, required this.data});

  static AttachmentUpdateManyWithWhereWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUpdateManyWithWhereWithoutBusinessInput(
  ...
  AttachmentUpdateManyWithWhereWithoutBusinessInput copyWith(
