...
class NestedStringFilter extends Equatable {
  final String? equals;
  ...
  static NestedStringFilter fromJson(Map<dynamic, dynamic> json) {
    return NestedStringFilter(
      ...
      not:
          json['not'] != null ? NestedStringFilter.fromJson(json['not']) : null,
    );
  }
