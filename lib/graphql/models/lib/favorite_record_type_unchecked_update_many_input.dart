...
class FavoriteRecordTypeUncheckedUpdateManyInput extends Equatable {
  ...
  FavoriteRecordTypeUncheckedUpdateManyInput({this.id, this.name});

  static FavoriteRecordTypeUncheckedUpdateManyInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteRecordTypeUncheckedUpdateManyInput(
      id: json['id'] != null
  ...
  FavoriteRecordTypeUncheckedUpdateManyInput copyWith(
