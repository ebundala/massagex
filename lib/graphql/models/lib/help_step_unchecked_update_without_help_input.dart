...
class HelpStepUncheckedUpdateWithoutHelpInput extends Equatable {
  ...
  HelpStepUncheckedUpdateWithoutHelpInput(
      {this.id,
      this.stepNumber,
      this.title,
      this.description,
  ...
  static HelpStepUncheckedUpdateWithoutHelpInput fromJson(
      Map<dynamic, dynamic> json) {
    return HelpStepUncheckedUpdateWithoutHelpInput(
      id: json['id'] != null
  ...
  HelpStepUncheckedUpdateWithoutHelpInput copyWith(
