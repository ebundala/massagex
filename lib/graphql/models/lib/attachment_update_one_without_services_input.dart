import 'attachment_create_without_services_input.dart';
import 'attachment_create_or_connect_without_services_input.dart';
import 'attachment_upsert_without_services_input.dart';
import 'attachment_where_unique_input.dart';
import 'attachment_update_without_services_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class AttachmentUpdateOneWithoutServicesInput extends Equatable {
  final AttachmentCreateWithoutServicesInput? create;
  final AttachmentCreateOrConnectWithoutServicesInput? connectOrCreate;
  final AttachmentUpsertWithoutServicesInput? upsert;
  final AttachmentWhereUniqueInput? connect;
  final bool? disconnect;
  final bool? delete;
  final AttachmentUpdateWithoutServicesInput? update;
  ...
  AttachmentUpdateOneWithoutServicesInput(
      {this.create,
  ...
  static AttachmentUpdateOneWithoutServicesInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUpdateOneWithoutServicesInput(
      create: json['create'] != null
          ? AttachmentCreateWithoutServicesInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? AttachmentCreateOrConnectWithoutServicesInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? AttachmentUpsertWithoutServicesInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? AttachmentUpdateWithoutServicesInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  AttachmentUpdateOneWithoutServicesInput copyWith(
      {AttachmentCreateWithoutServicesInput? create,
      AttachmentCreateOrConnectWithoutServicesInput? connectOrCreate,
      AttachmentUpsertWithoutServicesInput? upsert,
      AttachmentWhereUniqueInput? connect,
      bool? disconnect,
      bool? delete,
      AttachmentUpdateWithoutServicesInput? update}) {
    return AttachmentUpdateOneWithoutServicesInput(
