...
class FavoriteCreateNestedManyWithoutOrderInput extends Equatable {
  ...
  FavoriteCreateNestedManyWithoutOrderInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static FavoriteCreateNestedManyWithoutOrderInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteCreateNestedManyWithoutOrderInput(
  ...
  FavoriteCreateNestedManyWithoutOrderInput copyWith(
