...
class ReviewMinAggregateOutputType extends Equatable {
  final String? id;
  ...
  static ReviewMinAggregateOutputType fromJson(Map<dynamic, dynamic> json) {
    return ReviewMinAggregateOutputType(
      id: json['id'],
  ...
  ReviewMinAggregateOutputType copyWith(
      {String? id,
      String? authorId,
      String? revieweeId,
      int? value,
...
extension ReviewMinAggregateOutputTypeExt on ReviewMinAggregateOutputType {
...
class ReviewMinAggregateOutputTypeController
    extends ValueNotifier<ReviewMinAggregateOutputType> {
  ...
  final ReviewMinAggregateOutputType initialValue;
  final SelectionSetNode selectionSet;
  final Map<String, SelectionNodeData> selections = {};
  ReviewMinAggregateOutputTypeController({
