...
class CommentUpdateWithWhereUniqueWithoutCommentInput extends Equatable {
  final CommentWhereUniqueInput where;
  final CommentUpdateWithoutCommentInput data;
  ...
  static CommentUpdateWithWhereUniqueWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUpdateWithWhereUniqueWithoutCommentInput(
      where: CommentWhereUniqueInput.fromJson(json['where']),
      data: CommentUpdateWithoutCommentInput.fromJson(json['data']),
    );
  }
  ...
  CommentUpdateWithWhereUniqueWithoutCommentInput copyWith(
      {CommentWhereUniqueInput? where,
      CommentUpdateWithoutCommentInput? data}) {
    return CommentUpdateWithWhereUniqueWithoutCommentInput(
