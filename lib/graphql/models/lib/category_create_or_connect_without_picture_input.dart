...
class CategoryCreateOrConnectWithoutPictureInput extends Equatable {
  ...
  CategoryCreateOrConnectWithoutPictureInput(
      {required this.where, required this.create});

  static CategoryCreateOrConnectWithoutPictureInput fromJson(
      Map<dynamic, dynamic> json) {
    return CategoryCreateOrConnectWithoutPictureInput(
  ...
  CategoryCreateOrConnectWithoutPictureInput copyWith(
