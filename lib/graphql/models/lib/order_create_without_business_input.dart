...
class OrderCreateWithoutBusinessInput extends Equatable {
  final String? id;
  final int quantity;
  ...
  static OrderCreateWithoutBusinessInput fromJson(Map<dynamic, dynamic> json) {
    return OrderCreateWithoutBusinessInput(
      id: json['id'],
  ...
  OrderCreateWithoutBusinessInput copyWith(
      {String? id,
      int? quantity,
