...
import 'business_update_one_required_without_services_input.dart';
...
class ServiceUpdateWithoutAbuseReportsInput extends Equatable {
  ...
  final BusinessUpdateOneRequiredWithoutServicesInput? business;
  ...
  ServiceUpdateWithoutAbuseReportsInput(
      {this.id,
      this.name,
      this.description,
      this.price,
  ...
  static ServiceUpdateWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUpdateWithoutAbuseReportsInput(
      id: json['id'] != null
      ...
      business: json['business'] != null
          ? BusinessUpdateOneRequiredWithoutServicesInput.fromJson(
              json['business'])
          : null,
  ...
  ServiceUpdateWithoutAbuseReportsInput copyWith(
      ...
      BusinessUpdateOneRequiredWithoutServicesInput? business,
