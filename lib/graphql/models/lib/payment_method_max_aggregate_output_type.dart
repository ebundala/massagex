...
class PaymentMethodMaxAggregateOutputType extends Equatable {
  final String? id;
  final String? name;
  ...
  static PaymentMethodMaxAggregateOutputType fromJson(
      Map<dynamic, dynamic> json) {
    return PaymentMethodMaxAggregateOutputType(
      id: json['id'],
      name: json['name'],
  ...
  PaymentMethodMaxAggregateOutputType copyWith(
      {String? id,
      String? name,
      String? description,
      String? attachmentId,
...
extension PaymentMethodMaxAggregateOutputTypeExt
    on PaymentMethodMaxAggregateOutputType {
...
class PaymentMethodMaxAggregateOutputTypeController
    extends ValueNotifier<PaymentMethodMaxAggregateOutputType> {
  ...
  final PaymentMethodMaxAggregateOutputType initialValue;
  final SelectionSetNode selectionSet;
  final Map<String, SelectionNodeData> selections = {};
  PaymentMethodMaxAggregateOutputTypeController({
