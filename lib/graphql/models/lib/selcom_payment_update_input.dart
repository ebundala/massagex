...
import 'transaction_update_one_without_selcom_payment_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class SelcomPaymentUpdateInput extends Equatable {
  ...
  final TransactionUpdateOneWithoutSelcomPaymentInput? transaction;
  ...
  static SelcomPaymentUpdateInput fromJson(Map<dynamic, dynamic> json) {
    return SelcomPaymentUpdateInput(
      id: json['id'] != null
      ...
      transaction: json['transaction'] != null
          ? TransactionUpdateOneWithoutSelcomPaymentInput.fromJson(
              json['transaction'])
          : null,
    );
  }
  ...
  SelcomPaymentUpdateInput copyWith(
      ...
      TransactionUpdateOneWithoutSelcomPaymentInput? transaction}) {
    return SelcomPaymentUpdateInput(
        id: id ?? this.id,
