...
class OrderCreateOrConnectWithoutServiceInput extends Equatable {
  ...
  static OrderCreateOrConnectWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderCreateOrConnectWithoutServiceInput(
  ...
  OrderCreateOrConnectWithoutServiceInput copyWith(
      {OrderWhereUniqueInput? where, OrderCreateWithoutServiceInput? create}) {
    return OrderCreateOrConnectWithoutServiceInput(
