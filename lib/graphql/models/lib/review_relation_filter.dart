...
class ReviewRelationFilter extends Equatable {
  final ReviewWhereInput? is$;
  final ReviewWhereInput? isNot;
  ...
  ReviewRelationFilter({this.is$, this.isNot});

  static ReviewRelationFilter fromJson(Map<dynamic, dynamic> json) {
    return ReviewRelationFilter(
      is$: json['is'] != null ? ReviewWhereInput.fromJson(json['is']) : null,
      isNot: json['isNot'] != null
          ? ReviewWhereInput.fromJson(json['isNot'])
          : null,
    );
  }
  ...
  ReviewRelationFilter copyWith(
      {ReviewWhereInput? is$, ReviewWhereInput? isNot}) {
    return ReviewRelationFilter(
