...
class UserUncheckedCreateWithoutFavoritesInput extends Equatable {
  final String? id;
  final String? email;
  ...
  static UserUncheckedCreateWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUncheckedCreateWithoutFavoritesInput(
      id: json['id'],
      email: json['email'],
  ...
  UserUncheckedCreateWithoutFavoritesInput copyWith(
      {String? id,
      String? email,
      String? displayName,
      String? phoneNumber,
