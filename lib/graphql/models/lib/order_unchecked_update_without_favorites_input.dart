...
class OrderUncheckedUpdateWithoutFavoritesInput extends Equatable {
  ...
  OrderUncheckedUpdateWithoutFavoritesInput(
      {this.id,
      this.quantity,
      this.recordStatus,
      this.orderStatus,
  ...
  static OrderUncheckedUpdateWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUncheckedUpdateWithoutFavoritesInput(
      id: json['id'] != null
  ...
  OrderUncheckedUpdateWithoutFavoritesInput copyWith(
