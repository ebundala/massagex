import 'help_step_create_many_help_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class HelpStepCreateManyHelpInputEnvelope extends Equatable {
  final List<HelpStepCreateManyHelpInput>? data;
  ...
  HelpStepCreateManyHelpInputEnvelope({this.data, this.skipDuplicates});

  static HelpStepCreateManyHelpInputEnvelope fromJson(
      Map<dynamic, dynamic> json) {
    return HelpStepCreateManyHelpInputEnvelope(
      data: json['data'] != null
          ? List.generate(
              json['data'].length,
              (index) =>
                  HelpStepCreateManyHelpInput.fromJson(json['data'][index]))
          : null,
  ...
  HelpStepCreateManyHelpInputEnvelope copyWith(
      {List<HelpStepCreateManyHelpInput>? data, bool? skipDuplicates}) {
    return HelpStepCreateManyHelpInputEnvelope(
        data: data ?? this.data,
