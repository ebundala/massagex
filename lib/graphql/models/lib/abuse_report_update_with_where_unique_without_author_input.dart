...
class AbuseReportUpdateWithWhereUniqueWithoutAuthorInput extends Equatable {
  final AbuseReportWhereUniqueInput where;
  final AbuseReportUpdateWithoutAuthorInput data;
  ...
  AbuseReportUpdateWithWhereUniqueWithoutAuthorInput(
      {required this.where, required this.data});

  static AbuseReportUpdateWithWhereUniqueWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpdateWithWhereUniqueWithoutAuthorInput(
      where: AbuseReportWhereUniqueInput.fromJson(json['where']),
      data: AbuseReportUpdateWithoutAuthorInput.fromJson(json['data']),
    );
  }
  ...
  AbuseReportUpdateWithWhereUniqueWithoutAuthorInput copyWith(
      {AbuseReportWhereUniqueInput? where,
      AbuseReportUpdateWithoutAuthorInput? data}) {
    return AbuseReportUpdateWithWhereUniqueWithoutAuthorInput(
