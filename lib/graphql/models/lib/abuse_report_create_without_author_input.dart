...
class AbuseReportCreateWithoutAuthorInput extends Equatable {
  final String? id;
  final int? number;
  final String? report;
  ...
  AbuseReportCreateWithoutAuthorInput(
      {this.id,
      this.number,
      this.report,
      this.recordStatus,
  ...
  static AbuseReportCreateWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportCreateWithoutAuthorInput(
      id: json['id'],
      number: json['number'],
      report: json['report'],
  ...
  AbuseReportCreateWithoutAuthorInput copyWith(
      {String? id,
      int? number,
      String? report,
