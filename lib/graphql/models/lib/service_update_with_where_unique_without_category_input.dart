...
class ServiceUpdateWithWhereUniqueWithoutCategoryInput extends Equatable {
  final ServiceWhereUniqueInput where;
  final ServiceUpdateWithoutCategoryInput data;
  ...
  static ServiceUpdateWithWhereUniqueWithoutCategoryInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUpdateWithWhereUniqueWithoutCategoryInput(
      where: ServiceWhereUniqueInput.fromJson(json['where']),
      data: ServiceUpdateWithoutCategoryInput.fromJson(json['data']),
    );
  }
  ...
  ServiceUpdateWithWhereUniqueWithoutCategoryInput copyWith(
      {ServiceWhereUniqueInput? where,
      ServiceUpdateWithoutCategoryInput? data}) {
    return ServiceUpdateWithWhereUniqueWithoutCategoryInput(
