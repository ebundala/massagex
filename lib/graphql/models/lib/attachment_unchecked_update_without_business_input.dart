...
class AttachmentUncheckedUpdateWithoutBusinessInput extends Equatable {
  ...
  AttachmentUncheckedUpdateWithoutBusinessInput(
      {this.id,
      this.path,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUncheckedUpdateWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedUpdateWithoutBusinessInput(
      id: json['id'] != null
  ...
  AttachmentUncheckedUpdateWithoutBusinessInput copyWith(
