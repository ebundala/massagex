...
class UserUncheckedUpdateInput extends Equatable {
  ...
  static UserUncheckedUpdateInput fromJson(Map<dynamic, dynamic> json) {
    return UserUncheckedUpdateInput(
      id: json['id'] != null
  ...
  UserUncheckedUpdateInput copyWith(
