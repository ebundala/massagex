...
import 'enum_payment_method_status_with_aggregates_filter.dart';
...
class PaymentMethodScalarWhereWithAggregatesInput extends Equatable {
  final List<PaymentMethodScalarWhereWithAggregatesInput>? AND;
  final List<PaymentMethodScalarWhereWithAggregatesInput>? OR;
  final List<PaymentMethodScalarWhereWithAggregatesInput>? NOT;
  ...
  final StringWithAggregatesFilter? attachmentId;
  final EnumSelcomUtilityCodeWithAggregatesFilter? code;
  final EnumRecordStatusWithAggregatesFilter? recordStatus;
  final EnumPaymentMethodStatusWithAggregatesFilter? status;
  ...
  static PaymentMethodScalarWhereWithAggregatesInput fromJson(
      Map<dynamic, dynamic> json) {
    return PaymentMethodScalarWhereWithAggregatesInput(
      AND: json['AND'] != null
          ? List.generate(
              json['AND'].length,
              (index) => PaymentMethodScalarWhereWithAggregatesInput.fromJson(
                  json['AND'][index]))
          : null,
      OR: json['OR'] != null
          ? List.generate(
      ...
      attachmentId: json['attachmentId'] != null
          ? StringWithAggregatesFilter.fromJson(json['attachmentId'])
          : null,
      code: json['code'] != null
          ? EnumSelcomUtilityCodeWithAggregatesFilter.fromJson(json['code'])
          : null,
      recordStatus: json['recordStatus'] != null
          ? EnumRecordStatusWithAggregatesFilter.fromJson(json['recordStatus'])
          : null,
      status: json['status'] != null
          ? EnumPaymentMethodStatusWithAggregatesFilter.fromJson(json['status'])
          : null,
  ...
  PaymentMethodScalarWhereWithAggregatesInput copyWith(
      {List<PaymentMethodScalarWhereWithAggregatesInput>? AND,
      List<PaymentMethodScalarWhereWithAggregatesInput>? OR,
      List<PaymentMethodScalarWhereWithAggregatesInput>? NOT,
      StringWithAggregatesFilter? id,
      StringWithAggregatesFilter? name,
      StringNullableWithAggregatesFilter? description,
      StringWithAggregatesFilter? attachmentId,
      EnumSelcomUtilityCodeWithAggregatesFilter? code,
      EnumRecordStatusWithAggregatesFilter? recordStatus,
      EnumPaymentMethodStatusWithAggregatesFilter? status,
