...
class OrderUpdateWithoutReceiptInput extends Equatable {
  ...
  OrderUpdateWithoutReceiptInput(
      {this.id,
      this.quantity,
      this.recordStatus,
      this.orderStatus,
  ...
  static OrderUpdateWithoutReceiptInput fromJson(Map<dynamic, dynamic> json) {
    return OrderUpdateWithoutReceiptInput(
      id: json['id'] != null
  ...
  OrderUpdateWithoutReceiptInput copyWith(
