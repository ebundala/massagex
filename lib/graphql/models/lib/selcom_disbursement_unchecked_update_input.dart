...
import 'transaction_unchecked_update_one_without_selcom_disbursement_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class SelcomDisbursementUncheckedUpdateInput extends Equatable {
  ...
  final TransactionUncheckedUpdateOneWithoutSelcomDisbursementInput?
      transaction;
  ...
  SelcomDisbursementUncheckedUpdateInput(
      {this.id,
      this.amount,
      this.reference,
      this.resultCode,
  ...
  static SelcomDisbursementUncheckedUpdateInput fromJson(
      Map<dynamic, dynamic> json) {
    return SelcomDisbursementUncheckedUpdateInput(
      id: json['id'] != null
  ...
  SelcomDisbursementUncheckedUpdateInput copyWith(
