...
class DeviceUpdateOneWithoutUserInput extends Equatable {
  ...
  DeviceUpdateOneWithoutUserInput(
      {this.create,
  ...
  static DeviceUpdateOneWithoutUserInput fromJson(Map<dynamic, dynamic> json) {
    return DeviceUpdateOneWithoutUserInput(
  ...
  DeviceUpdateOneWithoutUserInput copyWith(
