...
class UserUncheckedUpdateWithoutFavoritesInput extends Equatable {
  ...
  static UserUncheckedUpdateWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUncheckedUpdateWithoutFavoritesInput(
      id: json['id'] != null
  ...
  UserUncheckedUpdateWithoutFavoritesInput copyWith(
