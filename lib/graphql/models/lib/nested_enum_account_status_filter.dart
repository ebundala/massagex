...
class NestedEnumAccountStatusFilter extends Equatable {
  ...
  NestedEnumAccountStatusFilter({this.equals, this.in$, this.notIn, this.not});

  static NestedEnumAccountStatusFilter fromJson(Map<dynamic, dynamic> json) {
    return NestedEnumAccountStatusFilter(
  ...
  NestedEnumAccountStatusFilter copyWith(
