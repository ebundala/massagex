...
class FavoriteRecordTypeMaxAggregateOutputType extends Equatable {
  final String? id;
  final String? name;
  FavoriteRecordTypeMaxAggregateOutputType({this.id, this.name});

  static FavoriteRecordTypeMaxAggregateOutputType fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteRecordTypeMaxAggregateOutputType(
      id: json['id'],
      name: json['name'],
    );
  }
  ...
  FavoriteRecordTypeMaxAggregateOutputType copyWith(
...
extension FavoriteRecordTypeMaxAggregateOutputTypeExt
    on FavoriteRecordTypeMaxAggregateOutputType {
...
class FavoriteRecordTypeMaxAggregateOutputTypeController
    extends ValueNotifier<FavoriteRecordTypeMaxAggregateOutputType> {
  TextEditingController? idController;

  TextEditingController? nameController;

  final FavoriteRecordTypeMaxAggregateOutputType initialValue;
  final SelectionSetNode selectionSet;
  final Map<String, SelectionNodeData> selections = {};
  FavoriteRecordTypeMaxAggregateOutputTypeController({
