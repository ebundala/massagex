...
class NestedStringWithAggregatesFilter extends Equatable {
  final String? equals;
  ...
  static NestedStringWithAggregatesFilter fromJson(Map<dynamic, dynamic> json) {
  ...
  NestedStringWithAggregatesFilter copyWith(
      {String? equals,
      List<String>? in$,
      List<String>? notIn,
      String? lt,
