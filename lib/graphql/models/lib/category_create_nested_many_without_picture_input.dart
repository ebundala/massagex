...
class CategoryCreateNestedManyWithoutPictureInput extends Equatable {
  ...
  CategoryCreateNestedManyWithoutPictureInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static CategoryCreateNestedManyWithoutPictureInput fromJson(
      Map<dynamic, dynamic> json) {
    return CategoryCreateNestedManyWithoutPictureInput(
  ...
  CategoryCreateNestedManyWithoutPictureInput copyWith(
