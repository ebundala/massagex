...
import 'transaction_unchecked_create_nested_one_without_selcom_disbursement_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class SelcomDisbursementUncheckedCreateInput extends Equatable {
  final String? id;
  final int amount;
  ...
  final TransactionUncheckedCreateNestedOneWithoutSelcomDisbursementInput?
      transaction;
  ...
  SelcomDisbursementUncheckedCreateInput(
      {this.id,
  ...
  static SelcomDisbursementUncheckedCreateInput fromJson(
      Map<dynamic, dynamic> json) {
    return SelcomDisbursementUncheckedCreateInput(
      id: json['id'],
      amount: json['amount'],
  ...
  SelcomDisbursementUncheckedCreateInput copyWith(
      {String? id,
      int? amount,
      String? reference,
      String? resultCode,
