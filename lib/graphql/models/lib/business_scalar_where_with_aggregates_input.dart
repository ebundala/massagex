...
import 'enum_business_mode_with_aggregates_filter.dart';
import 'string_nullable_with_aggregates_filter.dart';
import 'json_nullable_with_aggregates_filter.dart';
import 'enum_business_status_with_aggregates_filter.dart';
...
class BusinessScalarWhereWithAggregatesInput extends Equatable {
  final List<BusinessScalarWhereWithAggregatesInput>? AND;
  final List<BusinessScalarWhereWithAggregatesInput>? OR;
  final List<BusinessScalarWhereWithAggregatesInput>? NOT;
  final StringWithAggregatesFilter? id;
  final StringWithAggregatesFilter? ownerId;
  final EnumBusinessModeWithAggregatesFilter? mode;
  final StringNullableWithAggregatesFilter? coverId;
  final StringWithAggregatesFilter? about;
  final StringWithAggregatesFilter? businessName;
  final JsonNullableWithAggregatesFilter? metadata;
  final EnumBusinessStatusWithAggregatesFilter? status;
  ...
  static BusinessScalarWhereWithAggregatesInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessScalarWhereWithAggregatesInput(
      AND: json['AND'] != null
          ? List.generate(
              json['AND'].length,
              (index) => BusinessScalarWhereWithAggregatesInput.fromJson(
                  json['AND'][index]))
          : null,
      OR: json['OR'] != null
          ? List.generate(
      ...
      ownerId: json['ownerId'] != null
          ? StringWithAggregatesFilter.fromJson(json['ownerId'])
          : null,
      mode: json['mode'] != null
          ? EnumBusinessModeWithAggregatesFilter.fromJson(json['mode'])
          : null,
      coverId: json['coverId'] != null
          ? StringNullableWithAggregatesFilter.fromJson(json['coverId'])
          : null,
      about: json['about'] != null
          ? StringWithAggregatesFilter.fromJson(json['about'])
          : null,
      businessName: json['businessName'] != null
          ? StringWithAggregatesFilter.fromJson(json['businessName'])
          : null,
      metadata: json['metadata'] != null
          ? JsonNullableWithAggregatesFilter.fromJson(json['metadata'])
          : null,
      status: json['status'] != null
          ? EnumBusinessStatusWithAggregatesFilter.fromJson(json['status'])
          : null,
  ...
  BusinessScalarWhereWithAggregatesInput copyWith(
      {List<BusinessScalarWhereWithAggregatesInput>? AND,
      List<BusinessScalarWhereWithAggregatesInput>? OR,
      List<BusinessScalarWhereWithAggregatesInput>? NOT,
      StringWithAggregatesFilter? id,
      StringWithAggregatesFilter? ownerId,
      EnumBusinessModeWithAggregatesFilter? mode,
      StringNullableWithAggregatesFilter? coverId,
      StringWithAggregatesFilter? about,
      StringWithAggregatesFilter? businessName,
      JsonNullableWithAggregatesFilter? metadata,
      EnumBusinessStatusWithAggregatesFilter? status,
