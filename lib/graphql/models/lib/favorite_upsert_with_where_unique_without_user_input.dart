...
class FavoriteUpsertWithWhereUniqueWithoutUserInput extends Equatable {
  final FavoriteWhereUniqueInput where;
  final FavoriteUpdateWithoutUserInput update;
  ...
  static FavoriteUpsertWithWhereUniqueWithoutUserInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUpsertWithWhereUniqueWithoutUserInput(
      where: FavoriteWhereUniqueInput.fromJson(json['where']),
      update: FavoriteUpdateWithoutUserInput.fromJson(json['update']),
  ...
  FavoriteUpsertWithWhereUniqueWithoutUserInput copyWith(
      {FavoriteWhereUniqueInput? where,
      FavoriteUpdateWithoutUserInput? update,
