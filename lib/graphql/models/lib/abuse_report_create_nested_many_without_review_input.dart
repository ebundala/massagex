...
class AbuseReportCreateNestedManyWithoutReviewInput extends Equatable {
  ...
  AbuseReportCreateNestedManyWithoutReviewInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static AbuseReportCreateNestedManyWithoutReviewInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportCreateNestedManyWithoutReviewInput(
  ...
  AbuseReportCreateNestedManyWithoutReviewInput copyWith(
