...
class BusinessUncheckedCreateNestedManyWithoutCoverInput extends Equatable {
  ...
  BusinessUncheckedCreateNestedManyWithoutCoverInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static BusinessUncheckedCreateNestedManyWithoutCoverInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUncheckedCreateNestedManyWithoutCoverInput(
  ...
  BusinessUncheckedCreateNestedManyWithoutCoverInput copyWith(
