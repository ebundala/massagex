import 'business_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class BusinessListRelationFilter extends Equatable {
  ...
  BusinessListRelationFilter({this.every, this.some, this.none});

  static BusinessListRelationFilter fromJson(Map<dynamic, dynamic> json) {
    return BusinessListRelationFilter(
      every: json['every'] != null
          ? BusinessWhereInput.fromJson(json['every'])
          : null,
      some: json['some'] != null
          ? BusinessWhereInput.fromJson(json['some'])
          : null,
      none: json['none'] != null
          ? BusinessWhereInput.fromJson(json['none'])
          : null,
    );
  }
  ...
  BusinessListRelationFilter copyWith(
      {BusinessWhereInput? every,
      BusinessWhereInput? some,
      BusinessWhereInput? none}) {
    return BusinessListRelationFilter(
