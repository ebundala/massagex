...
class AttachmentUncheckedCreateNestedManyWithoutCommentInput extends Equatable {
  ...
  AttachmentUncheckedCreateNestedManyWithoutCommentInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static AttachmentUncheckedCreateNestedManyWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedCreateNestedManyWithoutCommentInput(
  ...
  AttachmentUncheckedCreateNestedManyWithoutCommentInput copyWith(
