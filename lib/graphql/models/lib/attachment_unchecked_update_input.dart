...
class AttachmentUncheckedUpdateInput extends Equatable {
  ...
  static AttachmentUncheckedUpdateInput fromJson(Map<dynamic, dynamic> json) {
    return AttachmentUncheckedUpdateInput(
      id: json['id'] != null
  ...
  AttachmentUncheckedUpdateInput copyWith(
