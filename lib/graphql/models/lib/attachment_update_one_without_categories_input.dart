import 'attachment_create_without_categories_input.dart';
import 'attachment_create_or_connect_without_categories_input.dart';
import 'attachment_upsert_without_categories_input.dart';
import 'attachment_where_unique_input.dart';
import 'attachment_update_without_categories_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class AttachmentUpdateOneWithoutCategoriesInput extends Equatable {
  final AttachmentCreateWithoutCategoriesInput? create;
  final AttachmentCreateOrConnectWithoutCategoriesInput? connectOrCreate;
  final AttachmentUpsertWithoutCategoriesInput? upsert;
  final AttachmentWhereUniqueInput? connect;
  final bool? disconnect;
  final bool? delete;
  final AttachmentUpdateWithoutCategoriesInput? update;
  ...
  AttachmentUpdateOneWithoutCategoriesInput(
      {this.create,
  ...
  static AttachmentUpdateOneWithoutCategoriesInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUpdateOneWithoutCategoriesInput(
      create: json['create'] != null
          ? AttachmentCreateWithoutCategoriesInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? AttachmentCreateOrConnectWithoutCategoriesInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? AttachmentUpsertWithoutCategoriesInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? AttachmentUpdateWithoutCategoriesInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  AttachmentUpdateOneWithoutCategoriesInput copyWith(
      {AttachmentCreateWithoutCategoriesInput? create,
      AttachmentCreateOrConnectWithoutCategoriesInput? connectOrCreate,
      AttachmentUpsertWithoutCategoriesInput? upsert,
      AttachmentWhereUniqueInput? connect,
      bool? disconnect,
      bool? delete,
      AttachmentUpdateWithoutCategoriesInput? update}) {
    return AttachmentUpdateOneWithoutCategoriesInput(
