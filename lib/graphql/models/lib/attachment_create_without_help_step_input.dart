...
class AttachmentCreateWithoutHelpStepInput extends Equatable {
  ...
  AttachmentCreateWithoutHelpStepInput(
      {required this.path,
      this.id,
      this.filename,
      this.mimetype,
  ...
  static AttachmentCreateWithoutHelpStepInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateWithoutHelpStepInput(
      path: json['path'],
      id: json['id'],
  ...
  AttachmentCreateWithoutHelpStepInput copyWith(
      {MultipartFile? path,
      String? id,
      String? filename,
      String? mimetype,
