...
class TransactionCreateWithoutMpesaPaymentInput extends Equatable {
  final String? id;
  ...
  TransactionCreateWithoutMpesaPaymentInput(
      {this.id,
      required this.type,
      this.status,
      this.recordStatus,
  ...
  static TransactionCreateWithoutMpesaPaymentInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionCreateWithoutMpesaPaymentInput(
      id: json['id'],
  ...
  TransactionCreateWithoutMpesaPaymentInput copyWith(
      {String? id,
