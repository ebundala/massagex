...
class ServiceUpdateWithWhereUniqueWithoutImageInput extends Equatable {
  final ServiceWhereUniqueInput where;
  final ServiceUpdateWithoutImageInput data;
  ...
  ServiceUpdateWithWhereUniqueWithoutImageInput(
      {required this.where, required this.data});

  static ServiceUpdateWithWhereUniqueWithoutImageInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUpdateWithWhereUniqueWithoutImageInput(
      where: ServiceWhereUniqueInput.fromJson(json['where']),
      data: ServiceUpdateWithoutImageInput.fromJson(json['data']),
    );
  }
  ...
  ServiceUpdateWithWhereUniqueWithoutImageInput copyWith(
      {ServiceWhereUniqueInput? where, ServiceUpdateWithoutImageInput? data}) {
    return ServiceUpdateWithWhereUniqueWithoutImageInput(
