...
class BusinessUncheckedCreateNestedManyWithoutLocationInput extends Equatable {
  ...
  BusinessUncheckedCreateNestedManyWithoutLocationInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static BusinessUncheckedCreateNestedManyWithoutLocationInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUncheckedCreateNestedManyWithoutLocationInput(
  ...
  BusinessUncheckedCreateNestedManyWithoutLocationInput copyWith(
