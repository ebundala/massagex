...
class HelpStepCreateNestedManyWithoutHelpInput extends Equatable {
  ...
  HelpStepCreateNestedManyWithoutHelpInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static HelpStepCreateNestedManyWithoutHelpInput fromJson(
      Map<dynamic, dynamic> json) {
    return HelpStepCreateNestedManyWithoutHelpInput(
  ...
  HelpStepCreateNestedManyWithoutHelpInput copyWith(
