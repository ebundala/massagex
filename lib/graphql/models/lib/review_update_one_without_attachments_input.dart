...
import 'review_create_or_connect_without_attachments_input.dart';
import 'review_upsert_without_attachments_input.dart';
import 'review_where_unique_input.dart';
import 'review_update_without_attachments_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class ReviewUpdateOneWithoutAttachmentsInput extends Equatable {
  final ReviewCreateWithoutAttachmentsInput? create;
  final ReviewCreateOrConnectWithoutAttachmentsInput? connectOrCreate;
  final ReviewUpsertWithoutAttachmentsInput? upsert;
  final ReviewWhereUniqueInput? connect;
  final bool? disconnect;
  final bool? delete;
  final ReviewUpdateWithoutAttachmentsInput? update;
  ...
  ReviewUpdateOneWithoutAttachmentsInput(
      {this.create,
  ...
  static ReviewUpdateOneWithoutAttachmentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewUpdateOneWithoutAttachmentsInput(
      create: json['create'] != null
          ? ReviewCreateWithoutAttachmentsInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? ReviewCreateOrConnectWithoutAttachmentsInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? ReviewUpsertWithoutAttachmentsInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? ReviewUpdateWithoutAttachmentsInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  ReviewUpdateOneWithoutAttachmentsInput copyWith(
      {ReviewCreateWithoutAttachmentsInput? create,
      ReviewCreateOrConnectWithoutAttachmentsInput? connectOrCreate,
      ReviewUpsertWithoutAttachmentsInput? upsert,
      ReviewWhereUniqueInput? connect,
      bool? disconnect,
      bool? delete,
      ReviewUpdateWithoutAttachmentsInput? update}) {
    return ReviewUpdateOneWithoutAttachmentsInput(
