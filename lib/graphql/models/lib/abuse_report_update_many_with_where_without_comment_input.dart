...
class AbuseReportUpdateManyWithWhereWithoutCommentInput extends Equatable {
  ...
  AbuseReportUpdateManyWithWhereWithoutCommentInput(
      {required this.where, required this.data});

  static AbuseReportUpdateManyWithWhereWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpdateManyWithWhereWithoutCommentInput(
  ...
  AbuseReportUpdateManyWithWhereWithoutCommentInput copyWith(
