...
class UserCreateWithoutAbuseReportedInput extends Equatable {
  final String? id;
  final String? email;
  ...
  UserCreateWithoutAbuseReportedInput(
      {this.id,
      this.email,
      this.displayName,
      this.phoneNumber,
  ...
  static UserCreateWithoutAbuseReportedInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserCreateWithoutAbuseReportedInput(
      id: json['id'],
      email: json['email'],
  ...
  UserCreateWithoutAbuseReportedInput copyWith(
      {String? id,
      String? email,
      String? displayName,
      String? phoneNumber,
