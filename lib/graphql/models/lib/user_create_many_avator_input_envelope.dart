import 'user_create_many_avator_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class UserCreateManyAvatorInputEnvelope extends Equatable {
  final List<UserCreateManyAvatorInput>? data;
  ...
  UserCreateManyAvatorInputEnvelope({this.data, this.skipDuplicates});

  static UserCreateManyAvatorInputEnvelope fromJson(
      Map<dynamic, dynamic> json) {
    return UserCreateManyAvatorInputEnvelope(
      data: json['data'] != null
          ? List.generate(
              json['data'].length,
              (index) =>
                  UserCreateManyAvatorInput.fromJson(json['data'][index]))
          : null,
  ...
  UserCreateManyAvatorInputEnvelope copyWith(
      {List<UserCreateManyAvatorInput>? data, bool? skipDuplicates}) {
    return UserCreateManyAvatorInputEnvelope(
        data: data ?? this.data,
