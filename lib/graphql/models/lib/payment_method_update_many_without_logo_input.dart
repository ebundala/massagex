...
class PaymentMethodUpdateManyWithoutLogoInput extends Equatable {
  ...
  PaymentMethodUpdateManyWithoutLogoInput(
      {this.create,
  ...
  static PaymentMethodUpdateManyWithoutLogoInput fromJson(
      Map<dynamic, dynamic> json) {
    return PaymentMethodUpdateManyWithoutLogoInput(
  ...
  PaymentMethodUpdateManyWithoutLogoInput copyWith(
