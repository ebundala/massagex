...
class EnumGenderFilter extends Equatable {
  final Gender? equals;
  ...
  EnumGenderFilter({this.equals, this.in$, this.notIn, this.not});

  static EnumGenderFilter fromJson(Map<dynamic, dynamic> json) {
    return EnumGenderFilter(
      equals:
