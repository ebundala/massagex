...
class BusinessUpdateWithoutAttachmentsInput extends Equatable {
  ...
  BusinessUpdateWithoutAttachmentsInput(
      {this.id,
      this.mode,
      this.about,
      this.businessName,
  ...
  static BusinessUpdateWithoutAttachmentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUpdateWithoutAttachmentsInput(
      id: json['id'] != null
  ...
  BusinessUpdateWithoutAttachmentsInput copyWith(
