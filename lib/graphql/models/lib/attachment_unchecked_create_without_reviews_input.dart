...
class AttachmentUncheckedCreateWithoutReviewsInput extends Equatable {
  ...
  AttachmentUncheckedCreateWithoutReviewsInput(
      {required this.path,
      this.id,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUncheckedCreateWithoutReviewsInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedCreateWithoutReviewsInput(
      path: json['path'],
      id: json['id'],
  ...
  AttachmentUncheckedCreateWithoutReviewsInput copyWith(
      {MultipartFile? path,
      String? id,
      String? filename,
      String? mimetype,
