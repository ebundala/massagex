...
class AbuseReportUpdateManyWithoutOrderInput extends Equatable {
  ...
  AbuseReportUpdateManyWithoutOrderInput(
      {this.create,
  ...
  static AbuseReportUpdateManyWithoutOrderInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpdateManyWithoutOrderInput(
  ...
  AbuseReportUpdateManyWithoutOrderInput copyWith(
