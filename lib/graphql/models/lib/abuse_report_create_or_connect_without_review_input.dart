...
class AbuseReportCreateOrConnectWithoutReviewInput extends Equatable {
  ...
  AbuseReportCreateOrConnectWithoutReviewInput(
      {required this.where, required this.create});

  static AbuseReportCreateOrConnectWithoutReviewInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportCreateOrConnectWithoutReviewInput(
  ...
  AbuseReportCreateOrConnectWithoutReviewInput copyWith(
