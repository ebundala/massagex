...
class AttachmentUpdateManyWithWhereWithoutCommentInput extends Equatable {
  ...
  static AttachmentUpdateManyWithWhereWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUpdateManyWithWhereWithoutCommentInput(
  ...
  AttachmentUpdateManyWithWhereWithoutCommentInput copyWith(
