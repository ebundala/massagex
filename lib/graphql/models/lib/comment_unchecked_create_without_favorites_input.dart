...
class CommentUncheckedCreateWithoutFavoritesInput extends Equatable {
  final String? id;
  ...
  CommentUncheckedCreateWithoutFavoritesInput(
      {this.id,
  ...
  static CommentUncheckedCreateWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUncheckedCreateWithoutFavoritesInput(
      id: json['id'],
  ...
  CommentUncheckedCreateWithoutFavoritesInput copyWith(
      {String? id,
      String? authorId,
      String? reviewId,
