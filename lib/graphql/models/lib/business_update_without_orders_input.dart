...
class BusinessUpdateWithoutOrdersInput extends Equatable {
  ...
  static BusinessUpdateWithoutOrdersInput fromJson(Map<dynamic, dynamic> json) {
    return BusinessUpdateWithoutOrdersInput(
      id: json['id'] != null
  ...
  BusinessUpdateWithoutOrdersInput copyWith(
