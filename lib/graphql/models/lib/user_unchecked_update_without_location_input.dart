...
class UserUncheckedUpdateWithoutLocationInput extends Equatable {
  ...
  static UserUncheckedUpdateWithoutLocationInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUncheckedUpdateWithoutLocationInput(
      id: json['id'] != null
  ...
  UserUncheckedUpdateWithoutLocationInput copyWith(
