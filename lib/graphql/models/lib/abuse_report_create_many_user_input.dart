...
class AbuseReportCreateManyUserInput extends Equatable {
  final String? id;
  final int? number;
  final String? report;
  ...
  AbuseReportCreateManyUserInput(
      {this.id,
      this.number,
      this.report,
  ...
  static AbuseReportCreateManyUserInput fromJson(Map<dynamic, dynamic> json) {
    return AbuseReportCreateManyUserInput(
      id: json['id'],
      number: json['number'],
      report: json['report'],
  ...
  AbuseReportCreateManyUserInput copyWith(
      {String? id,
      int? number,
      String? report,
      String? authorId,
