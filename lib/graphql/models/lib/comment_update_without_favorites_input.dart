...
class CommentUpdateWithoutFavoritesInput extends Equatable {
  ...
  CommentUpdateWithoutFavoritesInput(
      {this.id,
  ...
  static CommentUpdateWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUpdateWithoutFavoritesInput(
      id: json['id'] != null
  ...
  CommentUpdateWithoutFavoritesInput copyWith(
