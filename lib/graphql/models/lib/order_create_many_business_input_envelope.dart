import 'order_create_many_business_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class OrderCreateManyBusinessInputEnvelope extends Equatable {
  final List<OrderCreateManyBusinessInput>? data;
  ...
  OrderCreateManyBusinessInputEnvelope({this.data, this.skipDuplicates});

  static OrderCreateManyBusinessInputEnvelope fromJson(
      Map<dynamic, dynamic> json) {
    return OrderCreateManyBusinessInputEnvelope(
      data: json['data'] != null
          ? List.generate(
              json['data'].length,
              (index) =>
                  OrderCreateManyBusinessInput.fromJson(json['data'][index]))
          : null,
  ...
  OrderCreateManyBusinessInputEnvelope copyWith(
      {List<OrderCreateManyBusinessInput>? data, bool? skipDuplicates}) {
    return OrderCreateManyBusinessInputEnvelope(
        data: data ?? this.data,
