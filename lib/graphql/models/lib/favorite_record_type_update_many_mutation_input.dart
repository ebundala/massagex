...
class FavoriteRecordTypeUpdateManyMutationInput extends Equatable {
  ...
  FavoriteRecordTypeUpdateManyMutationInput({this.id, this.name});

  static FavoriteRecordTypeUpdateManyMutationInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteRecordTypeUpdateManyMutationInput(
      id: json['id'] != null
  ...
  FavoriteRecordTypeUpdateManyMutationInput copyWith(
