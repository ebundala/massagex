...
class UserUpdateManyMutationInput extends Equatable {
  ...
  static UserUpdateManyMutationInput fromJson(Map<dynamic, dynamic> json) {
    return UserUpdateManyMutationInput(
      id: json['id'] != null
  ...
  UserUpdateManyMutationInput copyWith(
