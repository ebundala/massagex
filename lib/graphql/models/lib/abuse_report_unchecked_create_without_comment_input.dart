...
class AbuseReportUncheckedCreateWithoutCommentInput extends Equatable {
  final String? id;
  final int? number;
  final String? report;
  ...
  AbuseReportUncheckedCreateWithoutCommentInput(
      {this.id,
      this.number,
      this.report,
  ...
  static AbuseReportUncheckedCreateWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedCreateWithoutCommentInput(
      id: json['id'],
      number: json['number'],
      report: json['report'],
  ...
  AbuseReportUncheckedCreateWithoutCommentInput copyWith(
      {String? id,
      int? number,
      String? report,
      String? authorId,
