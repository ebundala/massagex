...
class ReviewUpsertWithoutAttachmentsInput extends Equatable {
  ...
  ReviewUpsertWithoutAttachmentsInput(
      {required this.update, required this.create});

  static ReviewUpsertWithoutAttachmentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewUpsertWithoutAttachmentsInput(
      update: ReviewUpdateWithoutAttachmentsInput.fromJson(json['update']),
  ...
  ReviewUpsertWithoutAttachmentsInput copyWith(
