...
class FavoriteUncheckedCreateWithoutOrderInput extends Equatable {
  final String? id;
  final String favId;
  ...
  FavoriteUncheckedCreateWithoutOrderInput(
      {this.id,
      required this.favId,
  ...
  static FavoriteUncheckedCreateWithoutOrderInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedCreateWithoutOrderInput(
      id: json['id'],
      favId: json['favId'],
  ...
  FavoriteUncheckedCreateWithoutOrderInput copyWith(
      {String? id,
      String? favId,
      String? authorId,
      String? typeId,
