...
class UserUncheckedCreateNestedManyWithoutAvatorInput extends Equatable {
  ...
  UserUncheckedCreateNestedManyWithoutAvatorInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static UserUncheckedCreateNestedManyWithoutAvatorInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUncheckedCreateNestedManyWithoutAvatorInput(
  ...
  UserUncheckedCreateNestedManyWithoutAvatorInput copyWith(
