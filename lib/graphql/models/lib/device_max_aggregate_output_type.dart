...
class DeviceMaxAggregateOutputType extends Equatable {
  final String? id;
  final String? fcm$id;
  final String? type;
  final String? userId;
  ...
  static DeviceMaxAggregateOutputType fromJson(Map<dynamic, dynamic> json) {
    return DeviceMaxAggregateOutputType(
      id: json['id'],
      fcm$id: json['fcm_id'],
      type: json['type'],
      userId: json['userId'],
  ...
  DeviceMaxAggregateOutputType copyWith(
      {String? id,
      String? fcm$id,
      String? type,
      String? userId,
...
extension DeviceMaxAggregateOutputTypeExt on DeviceMaxAggregateOutputType {
...
class DeviceMaxAggregateOutputTypeController
    extends ValueNotifier<DeviceMaxAggregateOutputType> {
  ...
  final DeviceMaxAggregateOutputType initialValue;
  final SelectionSetNode selectionSet;
  final Map<String, SelectionNodeData> selections = {};
  DeviceMaxAggregateOutputTypeController({
