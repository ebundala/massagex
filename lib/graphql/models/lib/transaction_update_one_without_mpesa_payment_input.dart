...
class TransactionUpdateOneWithoutMpesaPaymentInput extends Equatable {
  ...
  TransactionUpdateOneWithoutMpesaPaymentInput(
      {this.create,
  ...
  static TransactionUpdateOneWithoutMpesaPaymentInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUpdateOneWithoutMpesaPaymentInput(
  ...
  TransactionUpdateOneWithoutMpesaPaymentInput copyWith(
