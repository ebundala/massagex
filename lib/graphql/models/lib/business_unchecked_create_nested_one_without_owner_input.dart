...
class BusinessUncheckedCreateNestedOneWithoutOwnerInput extends Equatable {
  ...
  BusinessUncheckedCreateNestedOneWithoutOwnerInput(
      {this.create, this.connectOrCreate, this.connect});

  static BusinessUncheckedCreateNestedOneWithoutOwnerInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUncheckedCreateNestedOneWithoutOwnerInput(
  ...
  BusinessUncheckedCreateNestedOneWithoutOwnerInput copyWith(
