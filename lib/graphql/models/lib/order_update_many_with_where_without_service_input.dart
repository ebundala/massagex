...
class OrderUpdateManyWithWhereWithoutServiceInput extends Equatable {
  ...
  static OrderUpdateManyWithWhereWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUpdateManyWithWhereWithoutServiceInput(
  ...
  OrderUpdateManyWithWhereWithoutServiceInput copyWith(
