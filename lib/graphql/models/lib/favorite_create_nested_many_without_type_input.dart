...
class FavoriteCreateNestedManyWithoutTypeInput extends Equatable {
  ...
  FavoriteCreateNestedManyWithoutTypeInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static FavoriteCreateNestedManyWithoutTypeInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteCreateNestedManyWithoutTypeInput(
  ...
  FavoriteCreateNestedManyWithoutTypeInput copyWith(
