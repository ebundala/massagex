...
class UserRelationFilter extends Equatable {
  ...
  UserRelationFilter({this.is$, this.isNot});

  static UserRelationFilter fromJson(Map<dynamic, dynamic> json) {
    return UserRelationFilter(
      is$: json['is'] != null ? UserWhereInput.fromJson(json['is']) : null,
      isNot:
          json['isNot'] != null ? UserWhereInput.fromJson(json['isNot']) : null,
    );
  }
  ...
  UserRelationFilter copyWith({UserWhereInput? is$, UserWhereInput? isNot}) {
    return UserRelationFilter(is$: is$ ?? this.is$, isNot: isNot ?? this.isNot);
  }
