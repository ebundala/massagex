...
class AbuseReportUncheckedUpdateWithoutCommentInput extends Equatable {
  ...
  AbuseReportUncheckedUpdateWithoutCommentInput(
      {this.id,
      this.number,
      this.report,
      this.authorId,
  ...
  static AbuseReportUncheckedUpdateWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedUpdateWithoutCommentInput(
      id: json['id'] != null
  ...
  AbuseReportUncheckedUpdateWithoutCommentInput copyWith(
