import 'nested_float_with_aggregates_filter.dart';
...
class FloatWithAggregatesFilter extends Equatable {
  final double? equals;
  ...
  static FloatWithAggregatesFilter fromJson(Map<dynamic, dynamic> json) {
  ...
  FloatWithAggregatesFilter copyWith(
      {double? equals,
      List<double>? in$,
      List<double>? notIn,
      double? lt,
