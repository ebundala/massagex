...
class UserCreateOrConnectWithoutLocationInput extends Equatable {
  ...
  UserCreateOrConnectWithoutLocationInput(
      {required this.where, required this.create});

  static UserCreateOrConnectWithoutLocationInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserCreateOrConnectWithoutLocationInput(
  ...
  UserCreateOrConnectWithoutLocationInput copyWith(
      {UserWhereUniqueInput? where, UserCreateWithoutLocationInput? create}) {
    return UserCreateOrConnectWithoutLocationInput(
