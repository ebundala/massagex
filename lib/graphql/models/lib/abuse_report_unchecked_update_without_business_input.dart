...
class AbuseReportUncheckedUpdateWithoutBusinessInput extends Equatable {
  ...
  AbuseReportUncheckedUpdateWithoutBusinessInput(
      {this.id,
      this.number,
      this.report,
      this.authorId,
  ...
  static AbuseReportUncheckedUpdateWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedUpdateWithoutBusinessInput(
      id: json['id'] != null
  ...
  AbuseReportUncheckedUpdateWithoutBusinessInput copyWith(
