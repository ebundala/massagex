...
class CategoryUpdateManyMutationInput extends Equatable {
  ...
  static CategoryUpdateManyMutationInput fromJson(Map<dynamic, dynamic> json) {
    return CategoryUpdateManyMutationInput(
      id: json['id'] != null
  ...
  CategoryUpdateManyMutationInput copyWith(
