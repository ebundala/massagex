...
class PaymentMethodUncheckedCreateNestedManyWithoutLogoInput extends Equatable {
  ...
  PaymentMethodUncheckedCreateNestedManyWithoutLogoInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static PaymentMethodUncheckedCreateNestedManyWithoutLogoInput fromJson(
      Map<dynamic, dynamic> json) {
    return PaymentMethodUncheckedCreateNestedManyWithoutLogoInput(
  ...
  PaymentMethodUncheckedCreateNestedManyWithoutLogoInput copyWith(
