...
class ReviewUpdateManyWithoutRevieweeInput extends Equatable {
  ...
  ReviewUpdateManyWithoutRevieweeInput(
      {this.create,
  ...
  static ReviewUpdateManyWithoutRevieweeInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewUpdateManyWithoutRevieweeInput(
  ...
  ReviewUpdateManyWithoutRevieweeInput copyWith(
