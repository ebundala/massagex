...
class ReviewUncheckedUpdateInput extends Equatable {
  ...
  static ReviewUncheckedUpdateInput fromJson(Map<dynamic, dynamic> json) {
    return ReviewUncheckedUpdateInput(
      id: json['id'] != null
  ...
  ReviewUncheckedUpdateInput copyWith(
