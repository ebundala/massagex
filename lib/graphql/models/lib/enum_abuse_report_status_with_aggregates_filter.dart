...
import 'nested_enum_abuse_report_status_with_aggregates_filter.dart';
...
class EnumAbuseReportStatusWithAggregatesFilter extends Equatable {
  ...
  EnumAbuseReportStatusWithAggregatesFilter(
      {this.equals,
      this.in$,
      this.notIn,
      this.not,
  ...
  static EnumAbuseReportStatusWithAggregatesFilter fromJson(
      Map<dynamic, dynamic> json) {
    return EnumAbuseReportStatusWithAggregatesFilter(
  ...
  EnumAbuseReportStatusWithAggregatesFilter copyWith(
