...
class PaymentMethodUpdateWithoutTransactionsInput extends Equatable {
  ...
  PaymentMethodUpdateWithoutTransactionsInput(
      {this.id,
      this.name,
      this.description,
      this.code,
  ...
  static PaymentMethodUpdateWithoutTransactionsInput fromJson(
      Map<dynamic, dynamic> json) {
    return PaymentMethodUpdateWithoutTransactionsInput(
      id: json['id'] != null
  ...
  PaymentMethodUpdateWithoutTransactionsInput copyWith(
