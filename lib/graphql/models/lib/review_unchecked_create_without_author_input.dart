...
class ReviewUncheckedCreateWithoutAuthorInput extends Equatable {
  final String? id;
  ...
  static ReviewUncheckedCreateWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewUncheckedCreateWithoutAuthorInput(
      id: json['id'],
  ...
  ReviewUncheckedCreateWithoutAuthorInput copyWith(
      {String? id,
      String? revieweeId,
      int? value,
      String? content,
