...
import 'payment_method_upsert_with_where_unique_without_logo_input.dart';
import 'payment_method_create_many_logo_input_envelope.dart';
import 'payment_method_where_unique_input.dart';
import 'payment_method_update_with_where_unique_without_logo_input.dart';
import 'payment_method_update_many_with_where_without_logo_input.dart';
import 'payment_method_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class PaymentMethodUncheckedUpdateManyWithoutLogoInput extends Equatable {
  ...
  final List<PaymentMethodUpsertWithWhereUniqueWithoutLogoInput>? upsert;
  final PaymentMethodCreateManyLogoInputEnvelope? createMany;
  final List<PaymentMethodWhereUniqueInput>? connect;
  final List<PaymentMethodWhereUniqueInput>? set$;
  final List<PaymentMethodWhereUniqueInput>? disconnect;
  final List<PaymentMethodWhereUniqueInput>? delete;
  final List<PaymentMethodUpdateWithWhereUniqueWithoutLogoInput>? update;
  final List<PaymentMethodUpdateManyWithWhereWithoutLogoInput>? updateMany;
  final List<PaymentMethodScalarWhereInput>? deleteMany;
  ...
  PaymentMethodUncheckedUpdateManyWithoutLogoInput(
      {this.create,
  ...
  static PaymentMethodUncheckedUpdateManyWithoutLogoInput fromJson(
      Map<dynamic, dynamic> json) {
    return PaymentMethodUncheckedUpdateManyWithoutLogoInput(
      ...
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) =>
                  PaymentMethodUpsertWithWhereUniqueWithoutLogoInput.fromJson(
                      json['upsert'][index]))
          : null,
      ...
      set$: json['set'] != null
          ? List.generate(
              json['set'].length,
              (index) =>
                  PaymentMethodWhereUniqueInput.fromJson(json['set'][index]))
          : null,
      ...
      delete: json['delete'] != null
          ? List.generate(
              json['delete'].length,
              (index) =>
                  PaymentMethodWhereUniqueInput.fromJson(json['delete'][index]))
          : null,
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) =>
                  PaymentMethodUpdateWithWhereUniqueWithoutLogoInput.fromJson(
                      json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              ...
              (index) =>
                  PaymentMethodUpdateManyWithWhereWithoutLogoInput.fromJson(
                      json['updateMany'][index]))
          : null,
      deleteMany: json['deleteMany'] != null
          ? List.generate(
              json['deleteMany'].length,
              (index) => PaymentMethodScalarWhereInput.fromJson(
  ...
  PaymentMethodUncheckedUpdateManyWithoutLogoInput copyWith(
      {List<PaymentMethodCreateWithoutLogoInput>? create,
      List<PaymentMethodCreateOrConnectWithoutLogoInput>? connectOrCreate,
      List<PaymentMethodUpsertWithWhereUniqueWithoutLogoInput>? upsert,
      PaymentMethodCreateManyLogoInputEnvelope? createMany,
      List<PaymentMethodWhereUniqueInput>? connect,
      List<PaymentMethodWhereUniqueInput>? set$,
      List<PaymentMethodWhereUniqueInput>? disconnect,
      List<PaymentMethodWhereUniqueInput>? delete,
      List<PaymentMethodUpdateWithWhereUniqueWithoutLogoInput>? update,
      List<PaymentMethodUpdateManyWithWhereWithoutLogoInput>? updateMany,
      List<PaymentMethodScalarWhereInput>? deleteMany}) {
    return PaymentMethodUncheckedUpdateManyWithoutLogoInput(
