...
class UserUpsertWithoutOrderedInput extends Equatable {
  ...
  UserUpsertWithoutOrderedInput({required this.update, required this.create});

  static UserUpsertWithoutOrderedInput fromJson(Map<dynamic, dynamic> json) {
    return UserUpsertWithoutOrderedInput(
      update: UserUpdateWithoutOrderedInput.fromJson(json['update']),
      create: UserCreateWithoutOrderedInput.fromJson(json['create']),
    );
  }
  ...
  UserUpsertWithoutOrderedInput copyWith(
