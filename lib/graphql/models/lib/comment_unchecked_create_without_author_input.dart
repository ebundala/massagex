...
class CommentUncheckedCreateWithoutAuthorInput extends Equatable {
  final String? id;
  ...
  static CommentUncheckedCreateWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUncheckedCreateWithoutAuthorInput(
      id: json['id'],
  ...
  CommentUncheckedCreateWithoutAuthorInput copyWith(
      {String? id,
      String? reviewId,
