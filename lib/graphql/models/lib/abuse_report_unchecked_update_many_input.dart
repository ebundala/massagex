...
class AbuseReportUncheckedUpdateManyInput extends Equatable {
  ...
  AbuseReportUncheckedUpdateManyInput(
      {this.id,
      this.number,
      this.report,
      this.authorId,
  ...
  static AbuseReportUncheckedUpdateManyInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedUpdateManyInput(
      id: json['id'] != null
  ...
  AbuseReportUncheckedUpdateManyInput copyWith(
