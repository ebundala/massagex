...
class AttachmentUpdateManyWithWhereWithoutHelpStepInput extends Equatable {
  ...
  AttachmentUpdateManyWithWhereWithoutHelpStepInput(
      {required this.where, required this.data});

  static AttachmentUpdateManyWithWhereWithoutHelpStepInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUpdateManyWithWhereWithoutHelpStepInput(
  ...
  AttachmentUpdateManyWithWhereWithoutHelpStepInput copyWith(
