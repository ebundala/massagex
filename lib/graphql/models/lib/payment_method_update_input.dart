...
import 'attachment_update_one_required_without_payment_methods_input.dart';
import 'transaction_update_many_without_payment_method_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class PaymentMethodUpdateInput extends Equatable {
  ...
  final AttachmentUpdateOneRequiredWithoutPaymentMethodsInput? logo;
  final TransactionUpdateManyWithoutPaymentMethodInput? transactions;
  ...
  static PaymentMethodUpdateInput fromJson(Map<dynamic, dynamic> json) {
    return PaymentMethodUpdateInput(
      ...
      updatedAt: json['updatedAt'] != null
          ...
          : null,
      logo: json['logo'] != null
          ? AttachmentUpdateOneRequiredWithoutPaymentMethodsInput.fromJson(
              json['logo'])
          : null,
      transactions: json['transactions'] != null
          ? TransactionUpdateManyWithoutPaymentMethodInput.fromJson(
              json['transactions'])
          : null,
    );
  }
  ...
  PaymentMethodUpdateInput copyWith(
      ...
      AttachmentUpdateOneRequiredWithoutPaymentMethodsInput? logo,
      TransactionUpdateManyWithoutPaymentMethodInput? transactions}) {
    return PaymentMethodUpdateInput(
        id: id ?? this.id,
        name: name ?? this.name,
