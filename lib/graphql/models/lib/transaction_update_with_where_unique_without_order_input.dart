...
class TransactionUpdateWithWhereUniqueWithoutOrderInput extends Equatable {
  final TransactionWhereUniqueInput where;
  final TransactionUpdateWithoutOrderInput data;
  ...
  static TransactionUpdateWithWhereUniqueWithoutOrderInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUpdateWithWhereUniqueWithoutOrderInput(
      where: TransactionWhereUniqueInput.fromJson(json['where']),
      data: TransactionUpdateWithoutOrderInput.fromJson(json['data']),
    );
  }
  ...
  TransactionUpdateWithWhereUniqueWithoutOrderInput copyWith(
      {TransactionWhereUniqueInput? where,
      TransactionUpdateWithoutOrderInput? data}) {
    return TransactionUpdateWithWhereUniqueWithoutOrderInput(
