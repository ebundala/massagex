...
class ServiceUpdateWithoutImageInput extends Equatable {
  ...
  ServiceUpdateWithoutImageInput(
      {this.id,
      this.name,
      this.description,
      this.price,
  ...
  static ServiceUpdateWithoutImageInput fromJson(Map<dynamic, dynamic> json) {
    return ServiceUpdateWithoutImageInput(
      id: json['id'] != null
  ...
  ServiceUpdateWithoutImageInput copyWith(
