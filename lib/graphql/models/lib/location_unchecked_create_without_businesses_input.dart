...
class LocationUncheckedCreateWithoutBusinessesInput extends Equatable {
  final String? id;
  final String? name;
  final double lat;
  final double lon;
  ...
  LocationUncheckedCreateWithoutBusinessesInput(
      {this.id,
      this.name,
      required this.lat,
      required this.lon,
  ...
  static LocationUncheckedCreateWithoutBusinessesInput fromJson(
      Map<dynamic, dynamic> json) {
    return LocationUncheckedCreateWithoutBusinessesInput(
      id: json['id'],
      name: json['name'],
  ...
  LocationUncheckedCreateWithoutBusinessesInput copyWith(
      {String? id,
      String? name,
      double? lat,
      double? lon,
