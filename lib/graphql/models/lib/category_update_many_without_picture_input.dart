...
class CategoryUpdateManyWithoutPictureInput extends Equatable {
  ...
  CategoryUpdateManyWithoutPictureInput(
      {this.create,
  ...
  static CategoryUpdateManyWithoutPictureInput fromJson(
      Map<dynamic, dynamic> json) {
    return CategoryUpdateManyWithoutPictureInput(
  ...
  CategoryUpdateManyWithoutPictureInput copyWith(
