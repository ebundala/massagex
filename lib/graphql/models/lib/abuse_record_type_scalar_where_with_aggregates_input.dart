...
class AbuseRecordTypeScalarWhereWithAggregatesInput extends Equatable {
  final List<AbuseRecordTypeScalarWhereWithAggregatesInput>? AND;
  final List<AbuseRecordTypeScalarWhereWithAggregatesInput>? OR;
  final List<AbuseRecordTypeScalarWhereWithAggregatesInput>? NOT;
  ...
  AbuseRecordTypeScalarWhereWithAggregatesInput(
      {this.AND, this.OR, this.NOT, this.id, this.name});

  static AbuseRecordTypeScalarWhereWithAggregatesInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseRecordTypeScalarWhereWithAggregatesInput(
      AND: json['AND'] != null
          ? List.generate(
              json['AND'].length,
              (index) => AbuseRecordTypeScalarWhereWithAggregatesInput.fromJson(
                  json['AND'][index]))
          : null,
      OR: json['OR'] != null
          ? List.generate(
  ...
  AbuseRecordTypeScalarWhereWithAggregatesInput copyWith(
      {List<AbuseRecordTypeScalarWhereWithAggregatesInput>? AND,
      List<AbuseRecordTypeScalarWhereWithAggregatesInput>? OR,
      List<AbuseRecordTypeScalarWhereWithAggregatesInput>? NOT,
