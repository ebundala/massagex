...
class UserUncheckedUpdateWithoutBusinessProfileInput extends Equatable {
  ...
  UserUncheckedUpdateWithoutBusinessProfileInput(
      {this.id,
      this.email,
      this.displayName,
      this.phoneNumber,
  ...
  static UserUncheckedUpdateWithoutBusinessProfileInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUncheckedUpdateWithoutBusinessProfileInput(
      id: json['id'] != null
  ...
  UserUncheckedUpdateWithoutBusinessProfileInput copyWith(
