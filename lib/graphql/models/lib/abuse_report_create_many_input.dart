...
class AbuseReportCreateManyInput extends Equatable {
  final String? id;
  final int? number;
  final String? report;
  ...
  static AbuseReportCreateManyInput fromJson(Map<dynamic, dynamic> json) {
    return AbuseReportCreateManyInput(
      id: json['id'],
      number: json['number'],
      report: json['report'],
  ...
  AbuseReportCreateManyInput copyWith(
      {String? id,
      int? number,
      String? report,
      String? authorId,
