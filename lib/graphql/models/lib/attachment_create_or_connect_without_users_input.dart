...
class AttachmentCreateOrConnectWithoutUsersInput extends Equatable {
  ...
  AttachmentCreateOrConnectWithoutUsersInput(
      {required this.where, required this.create});

  static AttachmentCreateOrConnectWithoutUsersInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateOrConnectWithoutUsersInput(
  ...
  AttachmentCreateOrConnectWithoutUsersInput copyWith(
