...
class AttachmentUncheckedUpdateWithoutUsersInput extends Equatable {
  ...
  AttachmentUncheckedUpdateWithoutUsersInput(
      {this.id,
      this.path,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUncheckedUpdateWithoutUsersInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedUpdateWithoutUsersInput(
      id: json['id'] != null
  ...
  AttachmentUncheckedUpdateWithoutUsersInput copyWith(
