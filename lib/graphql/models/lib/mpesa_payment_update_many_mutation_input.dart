...
class MpesaPaymentUpdateManyMutationInput extends Equatable {
  ...
  static MpesaPaymentUpdateManyMutationInput fromJson(
      Map<dynamic, dynamic> json) {
    return MpesaPaymentUpdateManyMutationInput(
      id: json['id'] != null
  ...
  MpesaPaymentUpdateManyMutationInput copyWith(
