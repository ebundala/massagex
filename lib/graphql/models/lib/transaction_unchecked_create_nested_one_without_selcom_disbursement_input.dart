...
class TransactionUncheckedCreateNestedOneWithoutSelcomDisbursementInput
    extends Equatable {
  ...
  TransactionUncheckedCreateNestedOneWithoutSelcomDisbursementInput(
      {this.create, this.connectOrCreate, this.connect});

  static TransactionUncheckedCreateNestedOneWithoutSelcomDisbursementInput
      fromJson(Map<dynamic, dynamic> json) {
    return TransactionUncheckedCreateNestedOneWithoutSelcomDisbursementInput(
  ...
  TransactionUncheckedCreateNestedOneWithoutSelcomDisbursementInput copyWith(
