...
class SelcomDisbursementCreateWithoutTransactionInput extends Equatable {
  final String? id;
  final int amount;
  ...
  SelcomDisbursementCreateWithoutTransactionInput(
      {this.id,
  ...
  static SelcomDisbursementCreateWithoutTransactionInput fromJson(
      Map<dynamic, dynamic> json) {
    return SelcomDisbursementCreateWithoutTransactionInput(
      id: json['id'],
      amount: json['amount'],
  ...
  SelcomDisbursementCreateWithoutTransactionInput copyWith(
      {String? id,
      int? amount,
      String? reference,
      String? resultCode,
