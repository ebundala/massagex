...
import 'comment_create_or_connect_without_review_input.dart';
import 'comment_upsert_with_where_unique_without_review_input.dart';
import 'comment_create_many_review_input_envelope.dart';
import 'comment_where_unique_input.dart';
import 'comment_update_with_where_unique_without_review_input.dart';
import 'comment_update_many_with_where_without_review_input.dart';
import 'comment_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class CommentUncheckedUpdateManyWithoutReviewInput extends Equatable {
  final List<CommentCreateWithoutReviewInput>? create;
  final List<CommentCreateOrConnectWithoutReviewInput>? connectOrCreate;
  final List<CommentUpsertWithWhereUniqueWithoutReviewInput>? upsert;
  final CommentCreateManyReviewInputEnvelope? createMany;
  ...
  final List<CommentUpdateWithWhereUniqueWithoutReviewInput>? update;
  final List<CommentUpdateManyWithWhereWithoutReviewInput>? updateMany;
  ...
  CommentUncheckedUpdateManyWithoutReviewInput(
      {this.create,
  ...
  static CommentUncheckedUpdateManyWithoutReviewInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUncheckedUpdateManyWithoutReviewInput(
      create: json['create'] != null
          ? List.generate(
              json['create'].length,
              (index) => CommentCreateWithoutReviewInput.fromJson(
                  json['create'][index]))
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? List.generate(
              json['connectOrCreate'].length,
              (index) => CommentCreateOrConnectWithoutReviewInput.fromJson(
      ...
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) =>
                  CommentUpsertWithWhereUniqueWithoutReviewInput.fromJson(
                      json['upsert'][index]))
          : null,
      createMany: json['createMany'] != null
          ? CommentCreateManyReviewInputEnvelope.fromJson(json['createMany'])
          : null,
      ...
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) =>
                  CommentUpdateWithWhereUniqueWithoutReviewInput.fromJson(
                      json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              json['updateMany'].length,
              (index) => CommentUpdateManyWithWhereWithoutReviewInput.fromJson(
  ...
  CommentUncheckedUpdateManyWithoutReviewInput copyWith(
      {List<CommentCreateWithoutReviewInput>? create,
      List<CommentCreateOrConnectWithoutReviewInput>? connectOrCreate,
      List<CommentUpsertWithWhereUniqueWithoutReviewInput>? upsert,
      CommentCreateManyReviewInputEnvelope? createMany,
      ...
      List<CommentUpdateWithWhereUniqueWithoutReviewInput>? update,
      List<CommentUpdateManyWithWhereWithoutReviewInput>? updateMany,
