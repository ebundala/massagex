...
class AttachmentCreateNestedOneWithoutCategoriesInput extends Equatable {
  ...
  AttachmentCreateNestedOneWithoutCategoriesInput(
      {this.create, this.connectOrCreate, this.connect});

  static AttachmentCreateNestedOneWithoutCategoriesInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateNestedOneWithoutCategoriesInput(
  ...
  AttachmentCreateNestedOneWithoutCategoriesInput copyWith(
