...
class AttachmentUncheckedUpdateWithoutCategoryInput extends Equatable {
  ...
  AttachmentUncheckedUpdateWithoutCategoryInput(
      {this.id,
      this.path,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUncheckedUpdateWithoutCategoryInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedUpdateWithoutCategoryInput(
      id: json['id'] != null
  ...
  AttachmentUncheckedUpdateWithoutCategoryInput copyWith(
