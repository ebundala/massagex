...
class UserUpsertWithoutFavoritedInput extends Equatable {
  ...
  UserUpsertWithoutFavoritedInput({required this.update, required this.create});

  static UserUpsertWithoutFavoritedInput fromJson(Map<dynamic, dynamic> json) {
    return UserUpsertWithoutFavoritedInput(
      update: UserUpdateWithoutFavoritedInput.fromJson(json['update']),
      create: UserCreateWithoutFavoritedInput.fromJson(json['create']),
    );
  }
  ...
  UserUpsertWithoutFavoritedInput copyWith(
