...
class UserUncheckedCreateWithoutReviewedInput extends Equatable {
  final String? id;
  final String? email;
  ...
  UserUncheckedCreateWithoutReviewedInput(
      {this.id,
      this.email,
      this.displayName,
      this.phoneNumber,
  ...
  static UserUncheckedCreateWithoutReviewedInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUncheckedCreateWithoutReviewedInput(
      id: json['id'],
      email: json['email'],
  ...
  UserUncheckedCreateWithoutReviewedInput copyWith(
      {String? id,
      String? email,
      String? displayName,
      String? phoneNumber,
