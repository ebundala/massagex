...
class FavoriteUncheckedCreateWithoutCommentInput extends Equatable {
  final String? id;
  final String favId;
  ...
  FavoriteUncheckedCreateWithoutCommentInput(
      {this.id,
      required this.favId,
  ...
  static FavoriteUncheckedCreateWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedCreateWithoutCommentInput(
      id: json['id'],
      favId: json['favId'],
  ...
  FavoriteUncheckedCreateWithoutCommentInput copyWith(
      {String? id,
      String? favId,
      String? authorId,
      String? typeId,
