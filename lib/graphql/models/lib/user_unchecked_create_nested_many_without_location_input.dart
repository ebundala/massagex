...
class UserUncheckedCreateNestedManyWithoutLocationInput extends Equatable {
  ...
  UserUncheckedCreateNestedManyWithoutLocationInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static UserUncheckedCreateNestedManyWithoutLocationInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUncheckedCreateNestedManyWithoutLocationInput(
  ...
  UserUncheckedCreateNestedManyWithoutLocationInput copyWith(
