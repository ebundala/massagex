...
class CommentUpsertWithoutFavoritesInput extends Equatable {
  ...
  CommentUpsertWithoutFavoritesInput(
      {required this.update, required this.create});

  static CommentUpsertWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUpsertWithoutFavoritesInput(
      update: CommentUpdateWithoutFavoritesInput.fromJson(json['update']),
  ...
  CommentUpsertWithoutFavoritesInput copyWith(
