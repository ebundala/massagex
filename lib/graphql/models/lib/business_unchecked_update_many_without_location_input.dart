import 'business_create_without_location_input.dart';
import 'business_create_or_connect_without_location_input.dart';
import 'business_upsert_with_where_unique_without_location_input.dart';
import 'business_create_many_location_input_envelope.dart';
import 'business_where_unique_input.dart';
import 'business_update_with_where_unique_without_location_input.dart';
import 'business_update_many_with_where_without_location_input.dart';
import 'business_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class BusinessUncheckedUpdateManyWithoutLocationInput extends Equatable {
  final List<BusinessCreateWithoutLocationInput>? create;
  final List<BusinessCreateOrConnectWithoutLocationInput>? connectOrCreate;
  final List<BusinessUpsertWithWhereUniqueWithoutLocationInput>? upsert;
  final BusinessCreateManyLocationInputEnvelope? createMany;
  final List<BusinessWhereUniqueInput>? connect;
  final List<BusinessWhereUniqueInput>? set$;
  final List<BusinessWhereUniqueInput>? disconnect;
  final List<BusinessWhereUniqueInput>? delete;
  final List<BusinessUpdateWithWhereUniqueWithoutLocationInput>? update;
  final List<BusinessUpdateManyWithWhereWithoutLocationInput>? updateMany;
  final List<BusinessScalarWhereInput>? deleteMany;
  ...
  BusinessUncheckedUpdateManyWithoutLocationInput(
      {this.create,
  ...
  static BusinessUncheckedUpdateManyWithoutLocationInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUncheckedUpdateManyWithoutLocationInput(
      create: json['create'] != null
          ? List.generate(
              json['create'].length,
              (index) => BusinessCreateWithoutLocationInput.fromJson(
                  json['create'][index]))
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? List.generate(
              json['connectOrCreate'].length,
              (index) => BusinessCreateOrConnectWithoutLocationInput.fromJson(
      ...
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) =>
                  BusinessUpsertWithWhereUniqueWithoutLocationInput.fromJson(
                      json['upsert'][index]))
          : null,
      createMany: json['createMany'] != null
          ? BusinessCreateManyLocationInputEnvelope.fromJson(json['createMany'])
          : null,
      connect: json['connect'] != null
          ? List.generate(
              json['connect'].length,
              (index) =>
                  BusinessWhereUniqueInput.fromJson(json['connect'][index]))
          : null,
      set$: json['set'] != null
          ? List.generate(json['set'].length,
              (index) => BusinessWhereUniqueInput.fromJson(json['set'][index]))
          : null,
      disconnect: json['disconnect'] != null
          ? List.generate(
              json['disconnect'].length,
              (index) =>
                  BusinessWhereUniqueInput.fromJson(json['disconnect'][index]))
          : null,
      delete: json['delete'] != null
          ? List.generate(
              json['delete'].length,
              (index) =>
                  BusinessWhereUniqueInput.fromJson(json['delete'][index]))
          : null,
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) =>
                  BusinessUpdateWithWhereUniqueWithoutLocationInput.fromJson(
                      json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              ...
              (index) =>
                  BusinessUpdateManyWithWhereWithoutLocationInput.fromJson(
      ...
      deleteMany: json['deleteMany'] != null
          ? List.generate(
              ...
              (index) =>
                  BusinessScalarWhereInput.fromJson(json['deleteMany'][index]))
          : null,
    );
  }
  ...
  BusinessUncheckedUpdateManyWithoutLocationInput copyWith(
      {List<BusinessCreateWithoutLocationInput>? create,
      List<BusinessCreateOrConnectWithoutLocationInput>? connectOrCreate,
      List<BusinessUpsertWithWhereUniqueWithoutLocationInput>? upsert,
      BusinessCreateManyLocationInputEnvelope? createMany,
      List<BusinessWhereUniqueInput>? connect,
      List<BusinessWhereUniqueInput>? set$,
      List<BusinessWhereUniqueInput>? disconnect,
      List<BusinessWhereUniqueInput>? delete,
      List<BusinessUpdateWithWhereUniqueWithoutLocationInput>? update,
      List<BusinessUpdateManyWithWhereWithoutLocationInput>? updateMany,
      List<BusinessScalarWhereInput>? deleteMany}) {
    return BusinessUncheckedUpdateManyWithoutLocationInput(
