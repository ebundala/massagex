...
class BusinessCreateOrConnectWithoutOrdersInput extends Equatable {
  ...
  BusinessCreateOrConnectWithoutOrdersInput(
      {required this.where, required this.create});

  static BusinessCreateOrConnectWithoutOrdersInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessCreateOrConnectWithoutOrdersInput(
  ...
  BusinessCreateOrConnectWithoutOrdersInput copyWith(
