...
class FavoriteUncheckedCreateWithoutTypeInput extends Equatable {
  final String? id;
  final String favId;
  ...
  FavoriteUncheckedCreateWithoutTypeInput(
      {this.id,
      required this.favId,
  ...
  static FavoriteUncheckedCreateWithoutTypeInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedCreateWithoutTypeInput(
      id: json['id'],
      favId: json['favId'],
  ...
  FavoriteUncheckedCreateWithoutTypeInput copyWith(
      {String? id,
      String? favId,
      String? authorId,
