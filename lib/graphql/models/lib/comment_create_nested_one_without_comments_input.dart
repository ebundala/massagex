...
class CommentCreateNestedOneWithoutCommentsInput extends Equatable {
  ...
  static CommentCreateNestedOneWithoutCommentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentCreateNestedOneWithoutCommentsInput(
  ...
  CommentCreateNestedOneWithoutCommentsInput copyWith(
