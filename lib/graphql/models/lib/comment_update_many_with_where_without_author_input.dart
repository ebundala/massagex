...
class CommentUpdateManyWithWhereWithoutAuthorInput extends Equatable {
  ...
  static CommentUpdateManyWithWhereWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUpdateManyWithWhereWithoutAuthorInput(
  ...
  CommentUpdateManyWithWhereWithoutAuthorInput copyWith(
