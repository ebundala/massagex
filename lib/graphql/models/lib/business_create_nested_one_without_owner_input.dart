...
class BusinessCreateNestedOneWithoutOwnerInput extends Equatable {
  ...
  BusinessCreateNestedOneWithoutOwnerInput(
      {this.create, this.connectOrCreate, this.connect});

  static BusinessCreateNestedOneWithoutOwnerInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessCreateNestedOneWithoutOwnerInput(
  ...
  BusinessCreateNestedOneWithoutOwnerInput copyWith(
