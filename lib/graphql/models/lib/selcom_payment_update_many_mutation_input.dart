...
class SelcomPaymentUpdateManyMutationInput extends Equatable {
  ...
  static SelcomPaymentUpdateManyMutationInput fromJson(
      Map<dynamic, dynamic> json) {
    return SelcomPaymentUpdateManyMutationInput(
      id: json['id'] != null
  ...
  SelcomPaymentUpdateManyMutationInput copyWith(
