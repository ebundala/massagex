...
class AbuseReportCreateOrConnectWithoutAuthorInput extends Equatable {
  ...
  AbuseReportCreateOrConnectWithoutAuthorInput(
      {required this.where, required this.create});

  static AbuseReportCreateOrConnectWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportCreateOrConnectWithoutAuthorInput(
  ...
  AbuseReportCreateOrConnectWithoutAuthorInput copyWith(
