...
class FavoriteUncheckedCreateNestedManyWithoutUserInput extends Equatable {
  ...
  FavoriteUncheckedCreateNestedManyWithoutUserInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static FavoriteUncheckedCreateNestedManyWithoutUserInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedCreateNestedManyWithoutUserInput(
  ...
  FavoriteUncheckedCreateNestedManyWithoutUserInput copyWith(
