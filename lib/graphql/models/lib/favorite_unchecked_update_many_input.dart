...
class FavoriteUncheckedUpdateManyInput extends Equatable {
  ...
  static FavoriteUncheckedUpdateManyInput fromJson(Map<dynamic, dynamic> json) {
    return FavoriteUncheckedUpdateManyInput(
      id: json['id'] != null
  ...
  FavoriteUncheckedUpdateManyInput copyWith(
