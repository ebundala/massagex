...
class EnumRoleFilter extends Equatable {
  final Role? equals;
  final List<Role>? in$;
  final List<Role>? notIn;
  final NestedEnumRoleFilter? not;
  ...
  EnumRoleFilter({this.equals, this.in$, this.notIn, this.not});

  static EnumRoleFilter fromJson(Map<dynamic, dynamic> json) {
    return EnumRoleFilter(
      ...
      notIn: json['notIn'] != null
          ...
          : null,
      not: json['not'] != null
          ? NestedEnumRoleFilter.fromJson(json['not'])
          : null,
    );
  }
  ...
  EnumRoleFilter copyWith(
      {Role? equals,
      List<Role>? in$,
      List<Role>? notIn,
      NestedEnumRoleFilter? not}) {
    return EnumRoleFilter(
