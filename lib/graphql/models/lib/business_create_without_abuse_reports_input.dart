...
class BusinessCreateWithoutAbuseReportsInput extends Equatable {
  final String? id;
  ...
  BusinessCreateWithoutAbuseReportsInput(
      {this.id,
      this.mode,
      required this.about,
  ...
  static BusinessCreateWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessCreateWithoutAbuseReportsInput(
      id: json['id'],
      mode:
  ...
  BusinessCreateWithoutAbuseReportsInput copyWith(
      {String? id,
      BusinessMode? mode,
      String? about,
      String? businessName,
