...
class FavoriteUpdateManyWithoutCommentInput extends Equatable {
  ...
  FavoriteUpdateManyWithoutCommentInput(
      {this.create,
  ...
  static FavoriteUpdateManyWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUpdateManyWithoutCommentInput(
  ...
  FavoriteUpdateManyWithoutCommentInput copyWith(
