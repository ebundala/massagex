...
class LocationCreateInput extends Equatable {
  final String? id;
  final String? name;
  final double lat;
  final double lon;
  ...
  static LocationCreateInput fromJson(Map<dynamic, dynamic> json) {
    return LocationCreateInput(
      id: json['id'],
      name: json['name'],
