...
class BusinessCreateWithoutCoverInput extends Equatable {
  final String? id;
  ...
  BusinessCreateWithoutCoverInput(
      {this.id,
      this.mode,
      required this.about,
  ...
  static BusinessCreateWithoutCoverInput fromJson(Map<dynamic, dynamic> json) {
    return BusinessCreateWithoutCoverInput(
      id: json['id'],
      mode:
  ...
  BusinessCreateWithoutCoverInput copyWith(
      {String? id,
      BusinessMode? mode,
      String? about,
      String? businessName,
