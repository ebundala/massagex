...
class AbuseReportCreateWithoutServiceInput extends Equatable {
  final String? id;
  final int? number;
  final String? report;
  ...
  AbuseReportCreateWithoutServiceInput(
      {this.id,
      this.number,
      this.report,
      this.recordStatus,
  ...
  static AbuseReportCreateWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportCreateWithoutServiceInput(
      id: json['id'],
      number: json['number'],
      report: json['report'],
  ...
  AbuseReportCreateWithoutServiceInput copyWith(
      {String? id,
      int? number,
      String? report,
