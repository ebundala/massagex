...
class LocationUpdateWithoutBusinessesInput extends Equatable {
  ...
  LocationUpdateWithoutBusinessesInput(
      {this.id,
      this.name,
      this.lat,
      this.lon,
  ...
  static LocationUpdateWithoutBusinessesInput fromJson(
      Map<dynamic, dynamic> json) {
    return LocationUpdateWithoutBusinessesInput(
      id: json['id'] != null
  ...
  LocationUpdateWithoutBusinessesInput copyWith(
