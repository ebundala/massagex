...
class BusinessCreateNestedOneWithoutOrdersInput extends Equatable {
  ...
  BusinessCreateNestedOneWithoutOrdersInput(
      {this.create, this.connectOrCreate, this.connect});

  static BusinessCreateNestedOneWithoutOrdersInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessCreateNestedOneWithoutOrdersInput(
  ...
  BusinessCreateNestedOneWithoutOrdersInput copyWith(
