...
import 'attachment_create_or_connect_without_help_step_input.dart';
import 'attachment_upsert_with_where_unique_without_help_step_input.dart';
import 'attachment_create_many_help_step_input_envelope.dart';
import 'attachment_where_unique_input.dart';
import 'attachment_update_with_where_unique_without_help_step_input.dart';
import 'attachment_update_many_with_where_without_help_step_input.dart';
import 'attachment_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class AttachmentUncheckedUpdateManyWithoutHelpStepInput extends Equatable {
  final List<AttachmentCreateWithoutHelpStepInput>? create;
  final List<AttachmentCreateOrConnectWithoutHelpStepInput>? connectOrCreate;
  final List<AttachmentUpsertWithWhereUniqueWithoutHelpStepInput>? upsert;
  final AttachmentCreateManyHelpStepInputEnvelope? createMany;
  ...
  final List<AttachmentUpdateWithWhereUniqueWithoutHelpStepInput>? update;
  final List<AttachmentUpdateManyWithWhereWithoutHelpStepInput>? updateMany;
  ...
  AttachmentUncheckedUpdateManyWithoutHelpStepInput(
      {this.create,
  ...
  static AttachmentUncheckedUpdateManyWithoutHelpStepInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedUpdateManyWithoutHelpStepInput(
      create: json['create'] != null
          ? List.generate(
              json['create'].length,
              (index) => AttachmentCreateWithoutHelpStepInput.fromJson(
                  json['create'][index]))
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? List.generate(
              json['connectOrCreate'].length,
              (index) => AttachmentCreateOrConnectWithoutHelpStepInput.fromJson(
      ...
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) =>
                  AttachmentUpsertWithWhereUniqueWithoutHelpStepInput.fromJson(
                      json['upsert'][index]))
          : null,
      createMany: json['createMany'] != null
          ? AttachmentCreateManyHelpStepInputEnvelope.fromJson(
              json['createMany'])
          : null,
      ...
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) =>
                  AttachmentUpdateWithWhereUniqueWithoutHelpStepInput.fromJson(
                      json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              ...
              (index) =>
                  AttachmentUpdateManyWithWhereWithoutHelpStepInput.fromJson(
  ...
  AttachmentUncheckedUpdateManyWithoutHelpStepInput copyWith(
      {List<AttachmentCreateWithoutHelpStepInput>? create,
      List<AttachmentCreateOrConnectWithoutHelpStepInput>? connectOrCreate,
      List<AttachmentUpsertWithWhereUniqueWithoutHelpStepInput>? upsert,
      AttachmentCreateManyHelpStepInputEnvelope? createMany,
      ...
      List<AttachmentUpdateWithWhereUniqueWithoutHelpStepInput>? update,
      List<AttachmentUpdateManyWithWhereWithoutHelpStepInput>? updateMany,
