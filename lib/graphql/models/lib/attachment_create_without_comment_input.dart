...
class AttachmentCreateWithoutCommentInput extends Equatable {
  ...
  static AttachmentCreateWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateWithoutCommentInput(
      path: json['path'],
      id: json['id'],
  ...
  AttachmentCreateWithoutCommentInput copyWith(
      {MultipartFile? path,
      String? id,
      String? filename,
      String? mimetype,
