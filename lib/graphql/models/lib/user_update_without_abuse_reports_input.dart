...
class UserUpdateWithoutAbuseReportsInput extends Equatable {
  ...
  UserUpdateWithoutAbuseReportsInput(
      {this.id,
      this.email,
      this.displayName,
      this.phoneNumber,
  ...
  static UserUpdateWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUpdateWithoutAbuseReportsInput(
      id: json['id'] != null
  ...
  UserUpdateWithoutAbuseReportsInput copyWith(
