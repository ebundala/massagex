...
class AbuseReportCreateOrConnectWithoutTypeInput extends Equatable {
  ...
  AbuseReportCreateOrConnectWithoutTypeInput(
      {required this.where, required this.create});

  static AbuseReportCreateOrConnectWithoutTypeInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportCreateOrConnectWithoutTypeInput(
  ...
  AbuseReportCreateOrConnectWithoutTypeInput copyWith(
