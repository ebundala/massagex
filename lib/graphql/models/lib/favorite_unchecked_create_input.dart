...
class FavoriteUncheckedCreateInput extends Equatable {
  final String? id;
  final String favId;
  ...
  static FavoriteUncheckedCreateInput fromJson(Map<dynamic, dynamic> json) {
    return FavoriteUncheckedCreateInput(
      id: json['id'],
      favId: json['favId'],
  ...
  FavoriteUncheckedCreateInput copyWith(
      {String? id,
      String? favId,
      String? authorId,
      String? typeId,
