...
class AttachmentUpdateWithoutUsersInput extends Equatable {
  ...
  AttachmentUpdateWithoutUsersInput(
      {this.id,
      this.path,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUpdateWithoutUsersInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUpdateWithoutUsersInput(
      id: json['id'] != null
  ...
  AttachmentUpdateWithoutUsersInput copyWith(
