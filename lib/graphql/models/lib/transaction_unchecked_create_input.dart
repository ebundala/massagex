...
class TransactionUncheckedCreateInput extends Equatable {
  final String? id;
  ...
  static TransactionUncheckedCreateInput fromJson(Map<dynamic, dynamic> json) {
    return TransactionUncheckedCreateInput(
      id: json['id'],
  ...
  TransactionUncheckedCreateInput copyWith(
      {String? id,
