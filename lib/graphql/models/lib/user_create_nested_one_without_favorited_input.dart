...
class UserCreateNestedOneWithoutFavoritedInput extends Equatable {
  ...
  UserCreateNestedOneWithoutFavoritedInput(
      {this.create, this.connectOrCreate, this.connect});

  static UserCreateNestedOneWithoutFavoritedInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserCreateNestedOneWithoutFavoritedInput(
  ...
  UserCreateNestedOneWithoutFavoritedInput copyWith(
