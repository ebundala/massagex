...
import 'business_create_or_connect_without_cover_input.dart';
import 'business_upsert_with_where_unique_without_cover_input.dart';
import 'business_create_many_cover_input_envelope.dart';
import 'business_where_unique_input.dart';
import 'business_update_with_where_unique_without_cover_input.dart';
import 'business_update_many_with_where_without_cover_input.dart';
import 'business_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class BusinessUncheckedUpdateManyWithoutCoverInput extends Equatable {
  final List<BusinessCreateWithoutCoverInput>? create;
  final List<BusinessCreateOrConnectWithoutCoverInput>? connectOrCreate;
  final List<BusinessUpsertWithWhereUniqueWithoutCoverInput>? upsert;
  final BusinessCreateManyCoverInputEnvelope? createMany;
  ...
  final List<BusinessUpdateWithWhereUniqueWithoutCoverInput>? update;
  final List<BusinessUpdateManyWithWhereWithoutCoverInput>? updateMany;
  ...
  BusinessUncheckedUpdateManyWithoutCoverInput(
      {this.create,
  ...
  static BusinessUncheckedUpdateManyWithoutCoverInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUncheckedUpdateManyWithoutCoverInput(
      create: json['create'] != null
          ? List.generate(
              json['create'].length,
              (index) => BusinessCreateWithoutCoverInput.fromJson(
                  json['create'][index]))
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? List.generate(
              json['connectOrCreate'].length,
              (index) => BusinessCreateOrConnectWithoutCoverInput.fromJson(
      ...
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) =>
                  BusinessUpsertWithWhereUniqueWithoutCoverInput.fromJson(
                      json['upsert'][index]))
          : null,
      createMany: json['createMany'] != null
          ? BusinessCreateManyCoverInputEnvelope.fromJson(json['createMany'])
          : null,
      ...
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) =>
                  BusinessUpdateWithWhereUniqueWithoutCoverInput.fromJson(
                      json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              json['updateMany'].length,
              (index) => BusinessUpdateManyWithWhereWithoutCoverInput.fromJson(
  ...
  BusinessUncheckedUpdateManyWithoutCoverInput copyWith(
      {List<BusinessCreateWithoutCoverInput>? create,
      List<BusinessCreateOrConnectWithoutCoverInput>? connectOrCreate,
      List<BusinessUpsertWithWhereUniqueWithoutCoverInput>? upsert,
      BusinessCreateManyCoverInputEnvelope? createMany,
      ...
      List<BusinessUpdateWithWhereUniqueWithoutCoverInput>? update,
      List<BusinessUpdateManyWithWhereWithoutCoverInput>? updateMany,
