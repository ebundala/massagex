...
import 'user_create_or_connect_without_abuse_reports_input.dart';
import 'user_upsert_without_abuse_reports_input.dart';
import 'user_where_unique_input.dart';
import 'user_update_without_abuse_reports_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class UserUpdateOneWithoutAbuseReportsInput extends Equatable {
  final UserCreateWithoutAbuseReportsInput? create;
  final UserCreateOrConnectWithoutAbuseReportsInput? connectOrCreate;
  final UserUpsertWithoutAbuseReportsInput? upsert;
  final UserWhereUniqueInput? connect;
  final bool? disconnect;
  final bool? delete;
  final UserUpdateWithoutAbuseReportsInput? update;
  ...
  UserUpdateOneWithoutAbuseReportsInput(
      {this.create,
  ...
  static UserUpdateOneWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUpdateOneWithoutAbuseReportsInput(
      create: json['create'] != null
          ? UserCreateWithoutAbuseReportsInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? UserCreateOrConnectWithoutAbuseReportsInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? UserUpsertWithoutAbuseReportsInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? UserUpdateWithoutAbuseReportsInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  UserUpdateOneWithoutAbuseReportsInput copyWith(
      {UserCreateWithoutAbuseReportsInput? create,
      UserCreateOrConnectWithoutAbuseReportsInput? connectOrCreate,
      UserUpsertWithoutAbuseReportsInput? upsert,
      UserWhereUniqueInput? connect,
      bool? disconnect,
      bool? delete,
      UserUpdateWithoutAbuseReportsInput? update}) {
    return UserUpdateOneWithoutAbuseReportsInput(
