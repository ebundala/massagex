import 'attachment_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class AttachmentListRelationFilter extends Equatable {
  final AttachmentWhereInput? every;
  final AttachmentWhereInput? some;
  final AttachmentWhereInput? none;
  ...
  AttachmentListRelationFilter({this.every, this.some, this.none});

  static AttachmentListRelationFilter fromJson(Map<dynamic, dynamic> json) {
    return AttachmentListRelationFilter(
      every: json['every'] != null
          ? AttachmentWhereInput.fromJson(json['every'])
          : null,
      some: json['some'] != null
          ? AttachmentWhereInput.fromJson(json['some'])
          : null,
      none: json['none'] != null
          ? AttachmentWhereInput.fromJson(json['none'])
          : null,
    );
  }
  ...
  AttachmentListRelationFilter copyWith(
      {AttachmentWhereInput? every,
      AttachmentWhereInput? some,
      AttachmentWhereInput? none}) {
    return AttachmentListRelationFilter(
