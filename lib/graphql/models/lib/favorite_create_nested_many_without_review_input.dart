...
class FavoriteCreateNestedManyWithoutReviewInput extends Equatable {
  ...
  FavoriteCreateNestedManyWithoutReviewInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static FavoriteCreateNestedManyWithoutReviewInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteCreateNestedManyWithoutReviewInput(
  ...
  FavoriteCreateNestedManyWithoutReviewInput copyWith(
