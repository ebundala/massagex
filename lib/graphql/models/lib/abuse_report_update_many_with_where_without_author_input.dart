...
class AbuseReportUpdateManyWithWhereWithoutAuthorInput extends Equatable {
  ...
  AbuseReportUpdateManyWithWhereWithoutAuthorInput(
      {required this.where, required this.data});

  static AbuseReportUpdateManyWithWhereWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpdateManyWithWhereWithoutAuthorInput(
  ...
  AbuseReportUpdateManyWithWhereWithoutAuthorInput copyWith(
