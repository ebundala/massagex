...
class FavoriteRecordTypeCreateOrConnectWithoutFavoritesInput extends Equatable {
  final FavoriteRecordTypeWhereUniqueInput where;
  ...
  FavoriteRecordTypeCreateOrConnectWithoutFavoritesInput(
      {required this.where, required this.create});

  static FavoriteRecordTypeCreateOrConnectWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteRecordTypeCreateOrConnectWithoutFavoritesInput(
      where: FavoriteRecordTypeWhereUniqueInput.fromJson(json['where']),
      create: FavoriteRecordTypeCreateWithoutFavoritesInput.fromJson(
          json['create']),
    );
  }
  ...
  FavoriteRecordTypeCreateOrConnectWithoutFavoritesInput copyWith(
      {FavoriteRecordTypeWhereUniqueInput? where,
