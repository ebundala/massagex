...
import 'comment_create_or_connect_without_favorites_input.dart';
import 'comment_upsert_without_favorites_input.dart';
import 'comment_where_unique_input.dart';
import 'comment_update_without_favorites_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class CommentUpdateOneWithoutFavoritesInput extends Equatable {
  final CommentCreateWithoutFavoritesInput? create;
  final CommentCreateOrConnectWithoutFavoritesInput? connectOrCreate;
  final CommentUpsertWithoutFavoritesInput? upsert;
  final CommentWhereUniqueInput? connect;
  final bool? disconnect;
  final bool? delete;
  final CommentUpdateWithoutFavoritesInput? update;
  ...
  CommentUpdateOneWithoutFavoritesInput(
      {this.create,
  ...
  static CommentUpdateOneWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUpdateOneWithoutFavoritesInput(
      create: json['create'] != null
          ? CommentCreateWithoutFavoritesInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? CommentCreateOrConnectWithoutFavoritesInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? CommentUpsertWithoutFavoritesInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? CommentUpdateWithoutFavoritesInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  CommentUpdateOneWithoutFavoritesInput copyWith(
      {CommentCreateWithoutFavoritesInput? create,
      CommentCreateOrConnectWithoutFavoritesInput? connectOrCreate,
      CommentUpsertWithoutFavoritesInput? upsert,
      CommentWhereUniqueInput? connect,
      bool? disconnect,
      bool? delete,
      CommentUpdateWithoutFavoritesInput? update}) {
    return CommentUpdateOneWithoutFavoritesInput(
