...
class FavoriteUpdateWithWhereUniqueWithoutServiceInput extends Equatable {
  final FavoriteWhereUniqueInput where;
  final FavoriteUpdateWithoutServiceInput data;
  ...
  FavoriteUpdateWithWhereUniqueWithoutServiceInput(
      {required this.where, required this.data});

  static FavoriteUpdateWithWhereUniqueWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUpdateWithWhereUniqueWithoutServiceInput(
      where: FavoriteWhereUniqueInput.fromJson(json['where']),
      data: FavoriteUpdateWithoutServiceInput.fromJson(json['data']),
    );
  }
  ...
  FavoriteUpdateWithWhereUniqueWithoutServiceInput copyWith(
      {FavoriteWhereUniqueInput? where,
      FavoriteUpdateWithoutServiceInput? data}) {
    return FavoriteUpdateWithWhereUniqueWithoutServiceInput(
