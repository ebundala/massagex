...
class TransactionCreateManyInput extends Equatable {
  final String? id;
  ...
  static TransactionCreateManyInput fromJson(Map<dynamic, dynamic> json) {
    return TransactionCreateManyInput(
      id: json['id'],
  ...
  TransactionCreateManyInput copyWith(
      {String? id,
