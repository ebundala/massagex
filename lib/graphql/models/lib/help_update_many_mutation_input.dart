...
class HelpUpdateManyMutationInput extends Equatable {
  ...
  static HelpUpdateManyMutationInput fromJson(Map<dynamic, dynamic> json) {
    return HelpUpdateManyMutationInput(
      id: json['id'] != null
  ...
  HelpUpdateManyMutationInput copyWith(
