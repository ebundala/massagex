...
class OrderCreateNestedManyWithoutReceiptInput extends Equatable {
  ...
  OrderCreateNestedManyWithoutReceiptInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static OrderCreateNestedManyWithoutReceiptInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderCreateNestedManyWithoutReceiptInput(
  ...
  OrderCreateNestedManyWithoutReceiptInput copyWith(
