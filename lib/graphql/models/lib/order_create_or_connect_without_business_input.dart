...
class OrderCreateOrConnectWithoutBusinessInput extends Equatable {
  ...
  static OrderCreateOrConnectWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderCreateOrConnectWithoutBusinessInput(
  ...
  OrderCreateOrConnectWithoutBusinessInput copyWith(
      {OrderWhereUniqueInput? where, OrderCreateWithoutBusinessInput? create}) {
    return OrderCreateOrConnectWithoutBusinessInput(
