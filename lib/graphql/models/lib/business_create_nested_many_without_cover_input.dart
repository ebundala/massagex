...
class BusinessCreateNestedManyWithoutCoverInput extends Equatable {
  ...
  BusinessCreateNestedManyWithoutCoverInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static BusinessCreateNestedManyWithoutCoverInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessCreateNestedManyWithoutCoverInput(
  ...
  BusinessCreateNestedManyWithoutCoverInput copyWith(
