...
class SelcomPaymentUpdateWithoutTransactionInput extends Equatable {
  ...
  SelcomPaymentUpdateWithoutTransactionInput(
      {this.id,
      this.transId,
      this.amount,
      this.msisdn,
  ...
  static SelcomPaymentUpdateWithoutTransactionInput fromJson(
      Map<dynamic, dynamic> json) {
    return SelcomPaymentUpdateWithoutTransactionInput(
      id: json['id'] != null
  ...
  SelcomPaymentUpdateWithoutTransactionInput copyWith(
