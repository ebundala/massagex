...
class OrderBatchResponse extends Equatable {
  final bool? status;
  final BatchPayload? data;
  final String? message;
  OrderBatchResponse({this.status, this.data, this.message});

  static OrderBatchResponse fromJson(Map<dynamic, dynamic> json) {
