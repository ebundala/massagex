...
class CommentCreateNestedOneWithoutFavoritesInput extends Equatable {
  ...
  CommentCreateNestedOneWithoutFavoritesInput(
      {this.create, this.connectOrCreate, this.connect});

  static CommentCreateNestedOneWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentCreateNestedOneWithoutFavoritesInput(
  ...
  CommentCreateNestedOneWithoutFavoritesInput copyWith(
