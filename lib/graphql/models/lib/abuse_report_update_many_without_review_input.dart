...
class AbuseReportUpdateManyWithoutReviewInput extends Equatable {
  ...
  AbuseReportUpdateManyWithoutReviewInput(
      {this.create,
  ...
  static AbuseReportUpdateManyWithoutReviewInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpdateManyWithoutReviewInput(
  ...
  AbuseReportUpdateManyWithoutReviewInput copyWith(
