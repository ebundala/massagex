...
class NestedBoolFilter extends Equatable {
  final bool? equals;
  ...
  NestedBoolFilter({this.equals, this.not});

  static NestedBoolFilter fromJson(Map<dynamic, dynamic> json) {
  ...
  NestedBoolFilter copyWith({bool? equals, NestedBoolFilter? not}) {
    return NestedBoolFilter(
