...
import 'abuse_report_create_or_connect_without_order_input.dart';
import 'abuse_report_upsert_with_where_unique_without_order_input.dart';
import 'abuse_report_create_many_order_input_envelope.dart';
import 'abuse_report_where_unique_input.dart';
import 'abuse_report_update_with_where_unique_without_order_input.dart';
import 'abuse_report_update_many_with_where_without_order_input.dart';
import 'abuse_report_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class AbuseReportUncheckedUpdateManyWithoutOrderInput extends Equatable {
  final List<AbuseReportCreateWithoutOrderInput>? create;
  final List<AbuseReportCreateOrConnectWithoutOrderInput>? connectOrCreate;
  final List<AbuseReportUpsertWithWhereUniqueWithoutOrderInput>? upsert;
  final AbuseReportCreateManyOrderInputEnvelope? createMany;
  ...
  final List<AbuseReportUpdateWithWhereUniqueWithoutOrderInput>? update;
  final List<AbuseReportUpdateManyWithWhereWithoutOrderInput>? updateMany;
  ...
  AbuseReportUncheckedUpdateManyWithoutOrderInput(
      {this.create,
  ...
  static AbuseReportUncheckedUpdateManyWithoutOrderInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedUpdateManyWithoutOrderInput(
      create: json['create'] != null
          ? List.generate(
              json['create'].length,
              (index) => AbuseReportCreateWithoutOrderInput.fromJson(
                  json['create'][index]))
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? List.generate(
              json['connectOrCreate'].length,
              (index) => AbuseReportCreateOrConnectWithoutOrderInput.fromJson(
      ...
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) =>
                  AbuseReportUpsertWithWhereUniqueWithoutOrderInput.fromJson(
                      json['upsert'][index]))
          : null,
      createMany: json['createMany'] != null
          ? AbuseReportCreateManyOrderInputEnvelope.fromJson(json['createMany'])
          : null,
      ...
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) =>
                  AbuseReportUpdateWithWhereUniqueWithoutOrderInput.fromJson(
                      json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              ...
              (index) =>
                  AbuseReportUpdateManyWithWhereWithoutOrderInput.fromJson(
  ...
  AbuseReportUncheckedUpdateManyWithoutOrderInput copyWith(
      {List<AbuseReportCreateWithoutOrderInput>? create,
      List<AbuseReportCreateOrConnectWithoutOrderInput>? connectOrCreate,
      List<AbuseReportUpsertWithWhereUniqueWithoutOrderInput>? upsert,
      AbuseReportCreateManyOrderInputEnvelope? createMany,
      ...
      List<AbuseReportUpdateWithWhereUniqueWithoutOrderInput>? update,
      List<AbuseReportUpdateManyWithWhereWithoutOrderInput>? updateMany,
