...
class HelpMinAggregateOutputType extends Equatable {
  final String? id;
  final String? topic;
  ...
  static HelpMinAggregateOutputType fromJson(Map<dynamic, dynamic> json) {
    return HelpMinAggregateOutputType(
      id: json['id'],
      topic: json['topic'],
  ...
  HelpMinAggregateOutputType copyWith(
      {String? id,
      String? topic,
      String? description,
...
extension HelpMinAggregateOutputTypeExt on HelpMinAggregateOutputType {
...
class HelpMinAggregateOutputTypeController
    extends ValueNotifier<HelpMinAggregateOutputType> {
  ...
  final HelpMinAggregateOutputType initialValue;
  final SelectionSetNode selectionSet;
  final Map<String, SelectionNodeData> selections = {};
  HelpMinAggregateOutputTypeController({
