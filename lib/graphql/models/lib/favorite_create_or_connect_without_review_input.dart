...
class FavoriteCreateOrConnectWithoutReviewInput extends Equatable {
  ...
  FavoriteCreateOrConnectWithoutReviewInput(
      {required this.where, required this.create});

  static FavoriteCreateOrConnectWithoutReviewInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteCreateOrConnectWithoutReviewInput(
  ...
  FavoriteCreateOrConnectWithoutReviewInput copyWith(
