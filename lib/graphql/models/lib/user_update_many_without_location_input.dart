...
class UserUpdateManyWithoutLocationInput extends Equatable {
  ...
  UserUpdateManyWithoutLocationInput(
      {this.create,
  ...
  static UserUpdateManyWithoutLocationInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUpdateManyWithoutLocationInput(
  ...
  UserUpdateManyWithoutLocationInput copyWith(
