...
class SelcomPaymentCreateNestedOneWithoutTransactionInput extends Equatable {
  ...
  SelcomPaymentCreateNestedOneWithoutTransactionInput(
      {this.create, this.connectOrCreate, this.connect});

  static SelcomPaymentCreateNestedOneWithoutTransactionInput fromJson(
      Map<dynamic, dynamic> json) {
    return SelcomPaymentCreateNestedOneWithoutTransactionInput(
  ...
  SelcomPaymentCreateNestedOneWithoutTransactionInput copyWith(
