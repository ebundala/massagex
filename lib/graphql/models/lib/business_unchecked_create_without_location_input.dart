...
class BusinessUncheckedCreateWithoutLocationInput extends Equatable {
  final String? id;
  ...
  BusinessUncheckedCreateWithoutLocationInput(
      {this.id,
  ...
  static BusinessUncheckedCreateWithoutLocationInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUncheckedCreateWithoutLocationInput(
      id: json['id'],
  ...
  BusinessUncheckedCreateWithoutLocationInput copyWith(
      {String? id,
      String? ownerId,
      BusinessMode? mode,
      String? coverId,
