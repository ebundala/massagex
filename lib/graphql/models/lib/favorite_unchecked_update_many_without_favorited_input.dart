...
class FavoriteUncheckedUpdateManyWithoutFavoritedInput extends Equatable {
  ...
  FavoriteUncheckedUpdateManyWithoutFavoritedInput(
      {this.id,
      this.favId,
      this.typeId,
      this.recordStatus,
  ...
  static FavoriteUncheckedUpdateManyWithoutFavoritedInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedUpdateManyWithoutFavoritedInput(
      id: json['id'] != null
  ...
  FavoriteUncheckedUpdateManyWithoutFavoritedInput copyWith(
