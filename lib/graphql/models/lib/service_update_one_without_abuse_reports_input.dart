import 'service_create_without_abuse_reports_input.dart';
import 'service_create_or_connect_without_abuse_reports_input.dart';
import 'service_upsert_without_abuse_reports_input.dart';
import 'service_where_unique_input.dart';
import 'service_update_without_abuse_reports_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class ServiceUpdateOneWithoutAbuseReportsInput extends Equatable {
  final ServiceCreateWithoutAbuseReportsInput? create;
  final ServiceCreateOrConnectWithoutAbuseReportsInput? connectOrCreate;
  final ServiceUpsertWithoutAbuseReportsInput? upsert;
  final ServiceWhereUniqueInput? connect;
  final bool? disconnect;
  final bool? delete;
  final ServiceUpdateWithoutAbuseReportsInput? update;
  ...
  ServiceUpdateOneWithoutAbuseReportsInput(
      {this.create,
  ...
  static ServiceUpdateOneWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUpdateOneWithoutAbuseReportsInput(
      create: json['create'] != null
          ? ServiceCreateWithoutAbuseReportsInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? ServiceCreateOrConnectWithoutAbuseReportsInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? ServiceUpsertWithoutAbuseReportsInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? ServiceUpdateWithoutAbuseReportsInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  ServiceUpdateOneWithoutAbuseReportsInput copyWith(
      {ServiceCreateWithoutAbuseReportsInput? create,
      ServiceCreateOrConnectWithoutAbuseReportsInput? connectOrCreate,
      ServiceUpsertWithoutAbuseReportsInput? upsert,
      ServiceWhereUniqueInput? connect,
      bool? disconnect,
      bool? delete,
      ServiceUpdateWithoutAbuseReportsInput? update}) {
    return ServiceUpdateOneWithoutAbuseReportsInput(
