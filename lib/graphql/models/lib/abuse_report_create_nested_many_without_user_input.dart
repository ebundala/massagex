...
class AbuseReportCreateNestedManyWithoutUserInput extends Equatable {
  ...
  AbuseReportCreateNestedManyWithoutUserInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static AbuseReportCreateNestedManyWithoutUserInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportCreateNestedManyWithoutUserInput(
  ...
  AbuseReportCreateNestedManyWithoutUserInput copyWith(
