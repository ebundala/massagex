...
class AbuseReportUncheckedCreateNestedManyWithoutServiceInput
    extends Equatable {
  ...
  AbuseReportUncheckedCreateNestedManyWithoutServiceInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static AbuseReportUncheckedCreateNestedManyWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedCreateNestedManyWithoutServiceInput(
  ...
  AbuseReportUncheckedCreateNestedManyWithoutServiceInput copyWith(
