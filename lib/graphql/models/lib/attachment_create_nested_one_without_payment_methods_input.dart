...
class AttachmentCreateNestedOneWithoutPaymentMethodsInput extends Equatable {
  ...
  AttachmentCreateNestedOneWithoutPaymentMethodsInput(
      {this.create, this.connectOrCreate, this.connect});

  static AttachmentCreateNestedOneWithoutPaymentMethodsInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateNestedOneWithoutPaymentMethodsInput(
  ...
  AttachmentCreateNestedOneWithoutPaymentMethodsInput copyWith(
