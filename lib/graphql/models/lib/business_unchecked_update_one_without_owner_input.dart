...
import 'business_create_or_connect_without_owner_input.dart';
import 'business_upsert_without_owner_input.dart';
import 'business_where_unique_input.dart';
import 'business_update_without_owner_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class BusinessUncheckedUpdateOneWithoutOwnerInput extends Equatable {
  final BusinessCreateWithoutOwnerInput? create;
  final BusinessCreateOrConnectWithoutOwnerInput? connectOrCreate;
  final BusinessUpsertWithoutOwnerInput? upsert;
  ...
  BusinessUncheckedUpdateOneWithoutOwnerInput(
      {this.create,
  ...
  static BusinessUncheckedUpdateOneWithoutOwnerInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUncheckedUpdateOneWithoutOwnerInput(
      create: json['create'] != null
          ? BusinessCreateWithoutOwnerInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? BusinessCreateOrConnectWithoutOwnerInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? BusinessUpsertWithoutOwnerInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? BusinessUpdateWithoutOwnerInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  BusinessUncheckedUpdateOneWithoutOwnerInput copyWith(
      {BusinessCreateWithoutOwnerInput? create,
      BusinessCreateOrConnectWithoutOwnerInput? connectOrCreate,
      BusinessUpsertWithoutOwnerInput? upsert,
      BusinessWhereUniqueInput? connect,
      bool? disconnect,
      bool? delete,
      BusinessUpdateWithoutOwnerInput? update}) {
    return BusinessUncheckedUpdateOneWithoutOwnerInput(
