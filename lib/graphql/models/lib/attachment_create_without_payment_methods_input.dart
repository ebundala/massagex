...
import 'category_create_nested_many_without_picture_input.dart';

import "package:http/http.dart" show MultipartFile;
import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class AttachmentCreateWithoutPaymentMethodsInput extends Equatable {
  ...
  final CategoryCreateNestedManyWithoutPictureInput? categories;
  ...
  AttachmentCreateWithoutPaymentMethodsInput(
      {required this.path,
      this.id,
      this.filename,
      this.mimetype,
  ...
  static AttachmentCreateWithoutPaymentMethodsInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateWithoutPaymentMethodsInput(
      path: json['path'],
      id: json['id'],
      ...
      categories: json['categories'] != null
          ? CategoryCreateNestedManyWithoutPictureInput.fromJson(
              json['categories'])
          : null,
    );
  }
  ...
  AttachmentCreateWithoutPaymentMethodsInput copyWith(
      {MultipartFile? path,
      String? id,
      String? filename,
      String? mimetype,
      ...
      CategoryCreateNestedManyWithoutPictureInput? categories}) {
    return AttachmentCreateWithoutPaymentMethodsInput(
        path: path ?? this.path,
        id: id ?? this.id,
