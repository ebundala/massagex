...
class SelcomDisbursementCreateManyInput extends Equatable {
  final String? id;
  final int amount;
  ...
  SelcomDisbursementCreateManyInput(
      {this.id,
  ...
  static SelcomDisbursementCreateManyInput fromJson(
      Map<dynamic, dynamic> json) {
    return SelcomDisbursementCreateManyInput(
      id: json['id'],
      amount: json['amount'],
  ...
  SelcomDisbursementCreateManyInput copyWith(
      {String? id,
      int? amount,
      String? reference,
      String? resultCode,
