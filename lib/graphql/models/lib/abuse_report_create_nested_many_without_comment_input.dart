...
class AbuseReportCreateNestedManyWithoutCommentInput extends Equatable {
  ...
  AbuseReportCreateNestedManyWithoutCommentInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static AbuseReportCreateNestedManyWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportCreateNestedManyWithoutCommentInput(
  ...
  AbuseReportCreateNestedManyWithoutCommentInput copyWith(
