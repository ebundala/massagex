...
class CommentUpdateWithoutReviewInput extends Equatable {
  ...
  CommentUpdateWithoutReviewInput(
      {this.id,
  ...
  static CommentUpdateWithoutReviewInput fromJson(Map<dynamic, dynamic> json) {
    return CommentUpdateWithoutReviewInput(
      id: json['id'] != null
  ...
  CommentUpdateWithoutReviewInput copyWith(
