...
class AttachmentCreateNestedManyWithoutReviewsInput extends Equatable {
  ...
  AttachmentCreateNestedManyWithoutReviewsInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static AttachmentCreateNestedManyWithoutReviewsInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateNestedManyWithoutReviewsInput(
  ...
  AttachmentCreateNestedManyWithoutReviewsInput copyWith(
