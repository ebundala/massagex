...
class ReviewCreateNestedOneWithoutAbuseReportsInput extends Equatable {
  ...
  ReviewCreateNestedOneWithoutAbuseReportsInput(
      {this.create, this.connectOrCreate, this.connect});

  static ReviewCreateNestedOneWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewCreateNestedOneWithoutAbuseReportsInput(
  ...
  ReviewCreateNestedOneWithoutAbuseReportsInput copyWith(
