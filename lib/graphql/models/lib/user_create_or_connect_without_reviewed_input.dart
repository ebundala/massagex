...
class UserCreateOrConnectWithoutReviewedInput extends Equatable {
  ...
  UserCreateOrConnectWithoutReviewedInput(
      {required this.where, required this.create});

  static UserCreateOrConnectWithoutReviewedInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserCreateOrConnectWithoutReviewedInput(
  ...
  UserCreateOrConnectWithoutReviewedInput copyWith(
      {UserWhereUniqueInput? where, UserCreateWithoutReviewedInput? create}) {
    return UserCreateOrConnectWithoutReviewedInput(
