...
import 'role.dart';
import 'help_step_unchecked_create_nested_many_without_help_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class HelpUncheckedCreateInput extends Equatable {
  final String? id;
  final String topic;
  ...
  final HelpStepUncheckedCreateNestedManyWithoutHelpInput? steps;
  ...
  static HelpUncheckedCreateInput fromJson(Map<dynamic, dynamic> json) {
    return HelpUncheckedCreateInput(
      id: json['id'],
      topic: json['topic'],
      ...
      steps: json['steps'] != null
          ? HelpStepUncheckedCreateNestedManyWithoutHelpInput.fromJson(
              json['steps'])
          : null,
    );
  }
  ...
  HelpUncheckedCreateInput copyWith(
      {String? id,
      String? topic,
      String? description,
      ...
      DateTime? createdAt,
      DateTime? updatedAt,
      HelpStepUncheckedCreateNestedManyWithoutHelpInput? steps}) {
    return HelpUncheckedCreateInput(
        id: id ?? this.id,
