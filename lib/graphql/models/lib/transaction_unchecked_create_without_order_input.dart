...
class TransactionUncheckedCreateWithoutOrderInput extends Equatable {
  final String? id;
  ...
  static TransactionUncheckedCreateWithoutOrderInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUncheckedCreateWithoutOrderInput(
      id: json['id'],
  ...
  TransactionUncheckedCreateWithoutOrderInput copyWith(
      {String? id,
