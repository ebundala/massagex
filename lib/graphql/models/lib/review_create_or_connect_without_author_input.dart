...
class ReviewCreateOrConnectWithoutAuthorInput extends Equatable {
  ...
  static ReviewCreateOrConnectWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewCreateOrConnectWithoutAuthorInput(
  ...
  ReviewCreateOrConnectWithoutAuthorInput copyWith(
      {ReviewWhereUniqueInput? where, ReviewCreateWithoutAuthorInput? create}) {
    return ReviewCreateOrConnectWithoutAuthorInput(
