...
class AttachmentUpdateWithoutServicesInput extends Equatable {
  ...
  AttachmentUpdateWithoutServicesInput(
      {this.id,
      this.path,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUpdateWithoutServicesInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUpdateWithoutServicesInput(
      id: json['id'] != null
  ...
  AttachmentUpdateWithoutServicesInput copyWith(
