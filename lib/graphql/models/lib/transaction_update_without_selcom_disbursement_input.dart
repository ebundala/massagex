...
class TransactionUpdateWithoutSelcomDisbursementInput extends Equatable {
  ...
  TransactionUpdateWithoutSelcomDisbursementInput(
      {this.id,
      this.type,
      this.status,
      this.recordStatus,
  ...
  static TransactionUpdateWithoutSelcomDisbursementInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUpdateWithoutSelcomDisbursementInput(
      id: json['id'] != null
  ...
  TransactionUpdateWithoutSelcomDisbursementInput copyWith(
