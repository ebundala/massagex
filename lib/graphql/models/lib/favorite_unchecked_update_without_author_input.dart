...
class FavoriteUncheckedUpdateWithoutAuthorInput extends Equatable {
  ...
  FavoriteUncheckedUpdateWithoutAuthorInput(
      {this.id,
      this.favId,
      this.typeId,
      this.recordStatus,
  ...
  static FavoriteUncheckedUpdateWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedUpdateWithoutAuthorInput(
      id: json['id'] != null
  ...
  FavoriteUncheckedUpdateWithoutAuthorInput copyWith(
