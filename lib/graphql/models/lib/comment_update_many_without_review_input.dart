...
class CommentUpdateManyWithoutReviewInput extends Equatable {
  ...
  CommentUpdateManyWithoutReviewInput(
      {this.create,
  ...
  static CommentUpdateManyWithoutReviewInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUpdateManyWithoutReviewInput(
  ...
  CommentUpdateManyWithoutReviewInput copyWith(
