...
import 'transaction_update_without_order_input.dart';
import 'transaction_create_without_order_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class TransactionUpsertWithWhereUniqueWithoutOrderInput extends Equatable {
  final TransactionWhereUniqueInput where;
  final TransactionUpdateWithoutOrderInput update;
  ...
  static TransactionUpsertWithWhereUniqueWithoutOrderInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUpsertWithWhereUniqueWithoutOrderInput(
      where: TransactionWhereUniqueInput.fromJson(json['where']),
      update: TransactionUpdateWithoutOrderInput.fromJson(json['update']),
  ...
  TransactionUpsertWithWhereUniqueWithoutOrderInput copyWith(
      {TransactionWhereUniqueInput? where,
      TransactionUpdateWithoutOrderInput? update,
