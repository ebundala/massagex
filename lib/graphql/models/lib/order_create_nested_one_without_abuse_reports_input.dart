...
class OrderCreateNestedOneWithoutAbuseReportsInput extends Equatable {
  ...
  OrderCreateNestedOneWithoutAbuseReportsInput(
      {this.create, this.connectOrCreate, this.connect});

  static OrderCreateNestedOneWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderCreateNestedOneWithoutAbuseReportsInput(
  ...
  OrderCreateNestedOneWithoutAbuseReportsInput copyWith(
