...
class FavoriteCreateManyServiceInput extends Equatable {
  final String? id;
  final String favId;
  ...
  FavoriteCreateManyServiceInput(
      {this.id,
      required this.favId,
  ...
  static FavoriteCreateManyServiceInput fromJson(Map<dynamic, dynamic> json) {
    return FavoriteCreateManyServiceInput(
      id: json['id'],
      favId: json['favId'],
  ...
  FavoriteCreateManyServiceInput copyWith(
      {String? id,
      String? favId,
      String? authorId,
      String? typeId,
