...
class AbuseReportCreateNestedManyWithoutServiceInput extends Equatable {
  ...
  AbuseReportCreateNestedManyWithoutServiceInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static AbuseReportCreateNestedManyWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportCreateNestedManyWithoutServiceInput(
  ...
  AbuseReportCreateNestedManyWithoutServiceInput copyWith(
