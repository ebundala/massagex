...
class FavoriteUpdateWithWhereUniqueWithoutOrderInput extends Equatable {
  final FavoriteWhereUniqueInput where;
  final FavoriteUpdateWithoutOrderInput data;
  ...
  FavoriteUpdateWithWhereUniqueWithoutOrderInput(
      {required this.where, required this.data});

  static FavoriteUpdateWithWhereUniqueWithoutOrderInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUpdateWithWhereUniqueWithoutOrderInput(
      where: FavoriteWhereUniqueInput.fromJson(json['where']),
      data: FavoriteUpdateWithoutOrderInput.fromJson(json['data']),
    );
  }
  ...
  FavoriteUpdateWithWhereUniqueWithoutOrderInput copyWith(
      {FavoriteWhereUniqueInput? where,
      FavoriteUpdateWithoutOrderInput? data}) {
    return FavoriteUpdateWithWhereUniqueWithoutOrderInput(
