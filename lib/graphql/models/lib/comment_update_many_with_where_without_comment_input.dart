...
class CommentUpdateManyWithWhereWithoutCommentInput extends Equatable {
  ...
  static CommentUpdateManyWithWhereWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUpdateManyWithWhereWithoutCommentInput(
  ...
  CommentUpdateManyWithWhereWithoutCommentInput copyWith(
