...
class JsonNullableFilter extends Equatable {
  ...
  JsonNullableFilter({this.equals, this.not});

  static JsonNullableFilter fromJson(Map<dynamic, dynamic> json) {
    return JsonNullableFilter(
      equals:
  ...
  JsonNullableFilter copyWith({JSONObject? equals, JSONObject? not}) {
    return JsonNullableFilter(
