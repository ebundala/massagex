...
class OrderUncheckedCreateInput extends Equatable {
  final String? id;
  final int quantity;
  ...
  static OrderUncheckedCreateInput fromJson(Map<dynamic, dynamic> json) {
    return OrderUncheckedCreateInput(
      id: json['id'],
  ...
  OrderUncheckedCreateInput copyWith(
      {String? id,
      int? quantity,
