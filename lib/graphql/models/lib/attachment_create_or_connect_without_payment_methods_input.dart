...
class AttachmentCreateOrConnectWithoutPaymentMethodsInput extends Equatable {
  ...
  AttachmentCreateOrConnectWithoutPaymentMethodsInput(
      {required this.where, required this.create});

  static AttachmentCreateOrConnectWithoutPaymentMethodsInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateOrConnectWithoutPaymentMethodsInput(
  ...
  AttachmentCreateOrConnectWithoutPaymentMethodsInput copyWith(
