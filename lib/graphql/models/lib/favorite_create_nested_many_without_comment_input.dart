...
class FavoriteCreateNestedManyWithoutCommentInput extends Equatable {
  ...
  FavoriteCreateNestedManyWithoutCommentInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static FavoriteCreateNestedManyWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteCreateNestedManyWithoutCommentInput(
  ...
  FavoriteCreateNestedManyWithoutCommentInput copyWith(
