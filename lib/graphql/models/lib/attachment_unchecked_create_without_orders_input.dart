...
class AttachmentUncheckedCreateWithoutOrdersInput extends Equatable {
  ...
  AttachmentUncheckedCreateWithoutOrdersInput(
      {required this.path,
      this.id,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUncheckedCreateWithoutOrdersInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedCreateWithoutOrdersInput(
      path: json['path'],
      id: json['id'],
  ...
  AttachmentUncheckedCreateWithoutOrdersInput copyWith(
      {MultipartFile? path,
      String? id,
      String? filename,
      String? mimetype,
