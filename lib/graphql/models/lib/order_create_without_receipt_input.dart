...
import 'favorite_create_nested_many_without_order_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class OrderCreateWithoutReceiptInput extends Equatable {
  final String? id;
  final int quantity;
  ...
  final FavoriteCreateNestedManyWithoutOrderInput? favorites;
  ...
  OrderCreateWithoutReceiptInput(
      {this.id,
  ...
  static OrderCreateWithoutReceiptInput fromJson(Map<dynamic, dynamic> json) {
    return OrderCreateWithoutReceiptInput(
      id: json['id'],
      ...
      favorites: json['favorites'] != null
          ? FavoriteCreateNestedManyWithoutOrderInput.fromJson(
              json['favorites'])
          : null,
    );
  }
  ...
  OrderCreateWithoutReceiptInput copyWith(
      {String? id,
      int? quantity,
      ...
      FavoriteCreateNestedManyWithoutOrderInput? favorites}) {
    return OrderCreateWithoutReceiptInput(
        id: id ?? this.id,
