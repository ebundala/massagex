...
import 'user_update_without_location_input.dart';
import 'user_create_without_location_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class UserUpsertWithWhereUniqueWithoutLocationInput extends Equatable {
  final UserWhereUniqueInput where;
  final UserUpdateWithoutLocationInput update;
  final UserCreateWithoutLocationInput create;
  ...
  UserUpsertWithWhereUniqueWithoutLocationInput(
      {required this.where, required this.update, required this.create});

  static UserUpsertWithWhereUniqueWithoutLocationInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUpsertWithWhereUniqueWithoutLocationInput(
      where: UserWhereUniqueInput.fromJson(json['where']),
      update: UserUpdateWithoutLocationInput.fromJson(json['update']),
      create: UserCreateWithoutLocationInput.fromJson(json['create']),
    );
  }
  ...
  UserUpsertWithWhereUniqueWithoutLocationInput copyWith(
      {UserWhereUniqueInput? where,
      UserUpdateWithoutLocationInput? update,
      UserCreateWithoutLocationInput? create}) {
    return UserUpsertWithWhereUniqueWithoutLocationInput(
