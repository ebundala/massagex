...
class LocationUpsertWithoutBusinessesInput extends Equatable {
  ...
  LocationUpsertWithoutBusinessesInput(
      {required this.update, required this.create});

  static LocationUpsertWithoutBusinessesInput fromJson(
      Map<dynamic, dynamic> json) {
    return LocationUpsertWithoutBusinessesInput(
      update: LocationUpdateWithoutBusinessesInput.fromJson(json['update']),
  ...
  LocationUpsertWithoutBusinessesInput copyWith(
