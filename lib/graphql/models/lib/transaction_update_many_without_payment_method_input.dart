...
class TransactionUpdateManyWithoutPaymentMethodInput extends Equatable {
  ...
  TransactionUpdateManyWithoutPaymentMethodInput(
      {this.create,
  ...
  static TransactionUpdateManyWithoutPaymentMethodInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUpdateManyWithoutPaymentMethodInput(
  ...
  TransactionUpdateManyWithoutPaymentMethodInput copyWith(
