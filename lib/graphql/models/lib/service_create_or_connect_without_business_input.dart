...
class ServiceCreateOrConnectWithoutBusinessInput extends Equatable {
  ...
  ServiceCreateOrConnectWithoutBusinessInput(
      {required this.where, required this.create});

  static ServiceCreateOrConnectWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceCreateOrConnectWithoutBusinessInput(
  ...
  ServiceCreateOrConnectWithoutBusinessInput copyWith(
