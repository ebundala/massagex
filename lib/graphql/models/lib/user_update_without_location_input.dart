...
class UserUpdateWithoutLocationInput extends Equatable {
  ...
  UserUpdateWithoutLocationInput(
      {this.id,
      this.email,
      this.displayName,
      this.phoneNumber,
  ...
  static UserUpdateWithoutLocationInput fromJson(Map<dynamic, dynamic> json) {
    return UserUpdateWithoutLocationInput(
      id: json['id'] != null
  ...
  UserUpdateWithoutLocationInput copyWith(
