...
class TransactionUncheckedUpdateManyWithoutTransactionsInput extends Equatable {
  ...
  TransactionUncheckedUpdateManyWithoutTransactionsInput(
      {this.id,
  ...
  static TransactionUncheckedUpdateManyWithoutTransactionsInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUncheckedUpdateManyWithoutTransactionsInput(
      id: json['id'] != null
  ...
  TransactionUncheckedUpdateManyWithoutTransactionsInput copyWith(
