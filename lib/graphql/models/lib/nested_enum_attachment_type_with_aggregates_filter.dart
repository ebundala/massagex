...
class NestedEnumAttachmentTypeWithAggregatesFilter extends Equatable {
  ...
  static NestedEnumAttachmentTypeWithAggregatesFilter fromJson(
      Map<dynamic, dynamic> json) {
    return NestedEnumAttachmentTypeWithAggregatesFilter(
  ...
  NestedEnumAttachmentTypeWithAggregatesFilter copyWith(
