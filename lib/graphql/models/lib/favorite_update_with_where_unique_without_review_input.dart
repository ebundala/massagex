...
class FavoriteUpdateWithWhereUniqueWithoutReviewInput extends Equatable {
  final FavoriteWhereUniqueInput where;
  final FavoriteUpdateWithoutReviewInput data;
  ...
  FavoriteUpdateWithWhereUniqueWithoutReviewInput(
      {required this.where, required this.data});

  static FavoriteUpdateWithWhereUniqueWithoutReviewInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUpdateWithWhereUniqueWithoutReviewInput(
      where: FavoriteWhereUniqueInput.fromJson(json['where']),
      data: FavoriteUpdateWithoutReviewInput.fromJson(json['data']),
    );
  }
  ...
  FavoriteUpdateWithWhereUniqueWithoutReviewInput copyWith(
      {FavoriteWhereUniqueInput? where,
      FavoriteUpdateWithoutReviewInput? data}) {
    return FavoriteUpdateWithWhereUniqueWithoutReviewInput(
