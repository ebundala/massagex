...
class TransactionUpdateManyWithWhereWithoutOrderInput extends Equatable {
  ...
  static TransactionUpdateManyWithWhereWithoutOrderInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUpdateManyWithWhereWithoutOrderInput(
  ...
  TransactionUpdateManyWithWhereWithoutOrderInput copyWith(
