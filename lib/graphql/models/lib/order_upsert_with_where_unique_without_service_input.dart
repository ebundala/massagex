...
class OrderUpsertWithWhereUniqueWithoutServiceInput extends Equatable {
  final OrderWhereUniqueInput where;
  final OrderUpdateWithoutServiceInput update;
  final OrderCreateWithoutServiceInput create;
  ...
  static OrderUpsertWithWhereUniqueWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUpsertWithWhereUniqueWithoutServiceInput(
      where: OrderWhereUniqueInput.fromJson(json['where']),
      update: OrderUpdateWithoutServiceInput.fromJson(json['update']),
      create: OrderCreateWithoutServiceInput.fromJson(json['create']),
    );
  }
  ...
  OrderUpsertWithWhereUniqueWithoutServiceInput copyWith(
      {OrderWhereUniqueInput? where,
      OrderUpdateWithoutServiceInput? update,
      OrderCreateWithoutServiceInput? create}) {
    return OrderUpsertWithWhereUniqueWithoutServiceInput(
