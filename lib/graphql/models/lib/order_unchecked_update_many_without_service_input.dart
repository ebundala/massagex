import 'order_create_without_service_input.dart';
import 'order_create_or_connect_without_service_input.dart';
import 'order_upsert_with_where_unique_without_service_input.dart';
import 'order_create_many_service_input_envelope.dart';
import 'order_where_unique_input.dart';
import 'order_update_with_where_unique_without_service_input.dart';
import 'order_update_many_with_where_without_service_input.dart';
import 'order_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class OrderUncheckedUpdateManyWithoutServiceInput extends Equatable {
  final List<OrderCreateWithoutServiceInput>? create;
  final List<OrderCreateOrConnectWithoutServiceInput>? connectOrCreate;
  final List<OrderUpsertWithWhereUniqueWithoutServiceInput>? upsert;
  final OrderCreateManyServiceInputEnvelope? createMany;
  ...
  final List<OrderUpdateWithWhereUniqueWithoutServiceInput>? update;
  final List<OrderUpdateManyWithWhereWithoutServiceInput>? updateMany;
  ...
  OrderUncheckedUpdateManyWithoutServiceInput(
      {this.create,
  ...
  static OrderUncheckedUpdateManyWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUncheckedUpdateManyWithoutServiceInput(
      create: json['create'] != null
          ? List.generate(
              json['create'].length,
              (index) => OrderCreateWithoutServiceInput.fromJson(
                  json['create'][index]))
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? List.generate(
              json['connectOrCreate'].length,
              (index) => OrderCreateOrConnectWithoutServiceInput.fromJson(
                  json['connectOrCreate'][index]))
          : null,
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) => OrderUpsertWithWhereUniqueWithoutServiceInput.fromJson(
                  json['upsert'][index]))
          : null,
      createMany: json['createMany'] != null
          ? OrderCreateManyServiceInputEnvelope.fromJson(json['createMany'])
          : null,
      ...
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) => OrderUpdateWithWhereUniqueWithoutServiceInput.fromJson(
                  json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              json['updateMany'].length,
              (index) => OrderUpdateManyWithWhereWithoutServiceInput.fromJson(
  ...
  OrderUncheckedUpdateManyWithoutServiceInput copyWith(
      {List<OrderCreateWithoutServiceInput>? create,
      List<OrderCreateOrConnectWithoutServiceInput>? connectOrCreate,
      List<OrderUpsertWithWhereUniqueWithoutServiceInput>? upsert,
      OrderCreateManyServiceInputEnvelope? createMany,
      ...
      List<OrderUpdateWithWhereUniqueWithoutServiceInput>? update,
      List<OrderUpdateManyWithWhereWithoutServiceInput>? updateMany,
