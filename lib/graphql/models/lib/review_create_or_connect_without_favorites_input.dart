...
class ReviewCreateOrConnectWithoutFavoritesInput extends Equatable {
  ...
  ReviewCreateOrConnectWithoutFavoritesInput(
      {required this.where, required this.create});

  static ReviewCreateOrConnectWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewCreateOrConnectWithoutFavoritesInput(
  ...
  ReviewCreateOrConnectWithoutFavoritesInput copyWith(
