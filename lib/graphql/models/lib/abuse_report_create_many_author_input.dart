...
class AbuseReportCreateManyAuthorInput extends Equatable {
  final String? id;
  final int? number;
  final String? report;
  final String typeId;
  ...
  AbuseReportCreateManyAuthorInput(
      {this.id,
      this.number,
      this.report,
  ...
  static AbuseReportCreateManyAuthorInput fromJson(Map<dynamic, dynamic> json) {
    return AbuseReportCreateManyAuthorInput(
      id: json['id'],
      number: json['number'],
      report: json['report'],
      typeId: json['typeId'],
  ...
  AbuseReportCreateManyAuthorInput copyWith(
      {String? id,
      int? number,
      String? report,
      String? typeId,
