...
class UserUpdateManyWithoutAvatorInput extends Equatable {
  ...
  UserUpdateManyWithoutAvatorInput(
      {this.create,
  ...
  static UserUpdateManyWithoutAvatorInput fromJson(Map<dynamic, dynamic> json) {
    return UserUpdateManyWithoutAvatorInput(
  ...
  UserUpdateManyWithoutAvatorInput copyWith(
