...
class HelpStepUpsertWithoutAttachmentsInput extends Equatable {
  ...
  HelpStepUpsertWithoutAttachmentsInput(
      {required this.update, required this.create});

  static HelpStepUpsertWithoutAttachmentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return HelpStepUpsertWithoutAttachmentsInput(
      update: HelpStepUpdateWithoutAttachmentsInput.fromJson(json['update']),
  ...
  HelpStepUpsertWithoutAttachmentsInput copyWith(
