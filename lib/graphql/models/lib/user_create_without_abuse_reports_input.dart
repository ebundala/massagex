...
class UserCreateWithoutAbuseReportsInput extends Equatable {
  final String? id;
  final String? email;
  ...
  UserCreateWithoutAbuseReportsInput(
      {this.id,
      this.email,
      this.displayName,
      this.phoneNumber,
  ...
  static UserCreateWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserCreateWithoutAbuseReportsInput(
      id: json['id'],
      email: json['email'],
  ...
  UserCreateWithoutAbuseReportsInput copyWith(
      {String? id,
      String? email,
      String? displayName,
      String? phoneNumber,
