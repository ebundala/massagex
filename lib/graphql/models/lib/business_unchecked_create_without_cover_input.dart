...
class BusinessUncheckedCreateWithoutCoverInput extends Equatable {
  final String? id;
  ...
  BusinessUncheckedCreateWithoutCoverInput(
      {this.id,
  ...
  static BusinessUncheckedCreateWithoutCoverInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUncheckedCreateWithoutCoverInput(
      id: json['id'],
  ...
  BusinessUncheckedCreateWithoutCoverInput copyWith(
      {String? id,
      String? ownerId,
      BusinessMode? mode,
      String? about,
