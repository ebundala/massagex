...
import 'nested_enum_record_status_with_aggregates_filter.dart';
...
class EnumRecordStatusWithAggregatesFilter extends Equatable {
  ...
  EnumRecordStatusWithAggregatesFilter(
      {this.equals,
      this.in$,
      this.notIn,
      this.not,
  ...
  static EnumRecordStatusWithAggregatesFilter fromJson(
      Map<dynamic, dynamic> json) {
    return EnumRecordStatusWithAggregatesFilter(
  ...
  EnumRecordStatusWithAggregatesFilter copyWith(
      {RecordStatus? equals,
