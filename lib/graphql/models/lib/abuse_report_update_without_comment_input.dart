...
class AbuseReportUpdateWithoutCommentInput extends Equatable {
  ...
  AbuseReportUpdateWithoutCommentInput(
      {this.id,
      this.number,
      this.report,
      this.recordStatus,
  ...
  static AbuseReportUpdateWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpdateWithoutCommentInput(
      id: json['id'] != null
  ...
  AbuseReportUpdateWithoutCommentInput copyWith(
