import 'order_create_many_receipt_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class OrderCreateManyReceiptInputEnvelope extends Equatable {
  final List<OrderCreateManyReceiptInput>? data;
  ...
  OrderCreateManyReceiptInputEnvelope({this.data, this.skipDuplicates});

  static OrderCreateManyReceiptInputEnvelope fromJson(
      Map<dynamic, dynamic> json) {
    return OrderCreateManyReceiptInputEnvelope(
      data: json['data'] != null
          ? List.generate(
              json['data'].length,
              (index) =>
                  OrderCreateManyReceiptInput.fromJson(json['data'][index]))
          : null,
  ...
  OrderCreateManyReceiptInputEnvelope copyWith(
      {List<OrderCreateManyReceiptInput>? data, bool? skipDuplicates}) {
    return OrderCreateManyReceiptInputEnvelope(
        data: data ?? this.data,
