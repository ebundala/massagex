...
class SelcomDisbursementUncheckedCreateWithoutTransactionInput
    extends Equatable {
  final String? id;
  final int amount;
  ...
  SelcomDisbursementUncheckedCreateWithoutTransactionInput(
      {this.id,
  ...
  static SelcomDisbursementUncheckedCreateWithoutTransactionInput fromJson(
      Map<dynamic, dynamic> json) {
    return SelcomDisbursementUncheckedCreateWithoutTransactionInput(
      id: json['id'],
      amount: json['amount'],
  ...
  SelcomDisbursementUncheckedCreateWithoutTransactionInput copyWith(
      {String? id,
      int? amount,
      String? reference,
      String? resultCode,
