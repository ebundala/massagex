...
class CommentCreateWithoutAttachmentsInput extends Equatable {
  final String? id;
  ...
  static CommentCreateWithoutAttachmentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentCreateWithoutAttachmentsInput(
      id: json['id'],
  ...
  CommentCreateWithoutAttachmentsInput copyWith(
      {String? id,
