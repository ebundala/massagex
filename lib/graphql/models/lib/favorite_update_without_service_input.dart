...
class FavoriteUpdateWithoutServiceInput extends Equatable {
  ...
  FavoriteUpdateWithoutServiceInput(
      {this.id,
      this.favId,
      this.recordStatus,
      this.createdAt,
  ...
  static FavoriteUpdateWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUpdateWithoutServiceInput(
      id: json['id'] != null
  ...
  FavoriteUpdateWithoutServiceInput copyWith(
