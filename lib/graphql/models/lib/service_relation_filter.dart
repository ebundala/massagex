...
class ServiceRelationFilter extends Equatable {
  final ServiceWhereInput? is$;
  final ServiceWhereInput? isNot;
  ...
  ServiceRelationFilter({this.is$, this.isNot});

  static ServiceRelationFilter fromJson(Map<dynamic, dynamic> json) {
    return ServiceRelationFilter(
      is$: json['is'] != null ? ServiceWhereInput.fromJson(json['is']) : null,
      isNot: json['isNot'] != null
          ? ServiceWhereInput.fromJson(json['isNot'])
          : null,
    );
  }
  ...
  ServiceRelationFilter copyWith(
      {ServiceWhereInput? is$, ServiceWhereInput? isNot}) {
    return ServiceRelationFilter(
