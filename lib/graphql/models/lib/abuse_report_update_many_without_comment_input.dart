...
class AbuseReportUpdateManyWithoutCommentInput extends Equatable {
  ...
  AbuseReportUpdateManyWithoutCommentInput(
      {this.create,
  ...
  static AbuseReportUpdateManyWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpdateManyWithoutCommentInput(
  ...
  AbuseReportUpdateManyWithoutCommentInput copyWith(
