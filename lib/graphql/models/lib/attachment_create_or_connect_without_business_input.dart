...
class AttachmentCreateOrConnectWithoutBusinessInput extends Equatable {
  ...
  AttachmentCreateOrConnectWithoutBusinessInput(
      {required this.where, required this.create});

  static AttachmentCreateOrConnectWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateOrConnectWithoutBusinessInput(
  ...
  AttachmentCreateOrConnectWithoutBusinessInput copyWith(
