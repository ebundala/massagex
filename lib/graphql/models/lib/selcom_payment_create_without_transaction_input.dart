...
class SelcomPaymentCreateWithoutTransactionInput extends Equatable {
  final String? id;
  ...
  SelcomPaymentCreateWithoutTransactionInput(
      {this.id,
  ...
  static SelcomPaymentCreateWithoutTransactionInput fromJson(
      Map<dynamic, dynamic> json) {
    return SelcomPaymentCreateWithoutTransactionInput(
      id: json['id'],
  ...
  SelcomPaymentCreateWithoutTransactionInput copyWith(
      {String? id,
      String? transId,
      int? amount,
      String? msisdn,
