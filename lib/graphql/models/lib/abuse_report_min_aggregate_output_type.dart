...
class AbuseReportMinAggregateOutputType extends Equatable {
  final String? id;
  final int? number;
  final String? report;
  ...
  AbuseReportMinAggregateOutputType(
      {this.id,
      this.number,
      this.report,
      this.authorId,
  ...
  static AbuseReportMinAggregateOutputType fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportMinAggregateOutputType(
      id: json['id'],
      number: json['number'],
      report: json['report'],
  ...
  AbuseReportMinAggregateOutputType copyWith(
      {String? id,
      int? number,
      String? report,
      String? authorId,
...
extension AbuseReportMinAggregateOutputTypeExt
    on AbuseReportMinAggregateOutputType {
...
class AbuseReportMinAggregateOutputTypeController
    extends ValueNotifier<AbuseReportMinAggregateOutputType> {
  ...
  final AbuseReportMinAggregateOutputType initialValue;
  final SelectionSetNode selectionSet;
  final Map<String, SelectionNodeData> selections = {};
  AbuseReportMinAggregateOutputTypeController({
