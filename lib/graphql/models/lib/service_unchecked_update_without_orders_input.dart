...
class ServiceUncheckedUpdateWithoutOrdersInput extends Equatable {
  ...
  static ServiceUncheckedUpdateWithoutOrdersInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUncheckedUpdateWithoutOrdersInput(
      id: json['id'] != null
  ...
  ServiceUncheckedUpdateWithoutOrdersInput copyWith(
