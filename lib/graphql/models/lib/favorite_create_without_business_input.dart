...
class FavoriteCreateWithoutBusinessInput extends Equatable {
  final String? id;
  final String favId;
  ...
  FavoriteCreateWithoutBusinessInput(
      {this.id,
      required this.favId,
      this.recordStatus,
      this.createdAt,
  ...
  static FavoriteCreateWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteCreateWithoutBusinessInput(
      id: json['id'],
      favId: json['favId'],
  ...
  FavoriteCreateWithoutBusinessInput copyWith(
      {String? id,
      String? favId,
