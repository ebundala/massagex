...
import 'nested_enum_attachment_type_with_aggregates_filter.dart';
import 'nested_int_filter.dart';
import 'nested_enum_attachment_type_filter.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class EnumAttachmentTypeWithAggregatesFilter extends Equatable {
  final AttachmentType? equals;
  final List<AttachmentType>? in$;
  final List<AttachmentType>? notIn;
  final NestedEnumAttachmentTypeWithAggregatesFilter? not;
  final NestedIntFilter? $count;
  final NestedIntFilter? count;
  final NestedEnumAttachmentTypeFilter? $min;
  final NestedEnumAttachmentTypeFilter? min;
  final NestedEnumAttachmentTypeFilter? $max;
  final NestedEnumAttachmentTypeFilter? max;
  ...
  EnumAttachmentTypeWithAggregatesFilter(
      {this.equals,
      this.in$,
      this.notIn,
      this.not,
  ...
  static EnumAttachmentTypeWithAggregatesFilter fromJson(
      Map<dynamic, dynamic> json) {
    return EnumAttachmentTypeWithAggregatesFilter(
      equals: json['equals'] != null
          ? AttachmentTypeExt.fromJson(json['equals'])
          : null,
      in$: json['in'] != null
          ? List.generate(json['in'].length,
              (index) => AttachmentTypeExt.fromJson(json['in'][index]))
          : null,
      notIn: json['notIn'] != null
          ? List.generate(json['notIn'].length,
              (index) => AttachmentTypeExt.fromJson(json['notIn'][index]))
          : null,
      not: json['not'] != null
          ? NestedEnumAttachmentTypeWithAggregatesFilter.fromJson(json['not'])
          : null,
      ...
      count: json['count'] != null
          ...
          : null,
      $min: json['_min'] != null
          ? NestedEnumAttachmentTypeFilter.fromJson(json['_min'])
          : null,
      min: json['min'] != null
          ? NestedEnumAttachmentTypeFilter.fromJson(json['min'])
          : null,
      $max: json['_max'] != null
          ? NestedEnumAttachmentTypeFilter.fromJson(json['_max'])
          : null,
      max: json['max'] != null
          ? NestedEnumAttachmentTypeFilter.fromJson(json['max'])
          : null,
    );
  }
  ...
  EnumAttachmentTypeWithAggregatesFilter copyWith(
      {AttachmentType? equals,
      List<AttachmentType>? in$,
      List<AttachmentType>? notIn,
      NestedEnumAttachmentTypeWithAggregatesFilter? not,
      NestedIntFilter? $count,
      NestedIntFilter? count,
      NestedEnumAttachmentTypeFilter? $min,
      NestedEnumAttachmentTypeFilter? min,
      NestedEnumAttachmentTypeFilter? $max,
      NestedEnumAttachmentTypeFilter? max}) {
    return EnumAttachmentTypeWithAggregatesFilter(
