...
class ReviewUncheckedCreateWithoutAbuseReportsInput extends Equatable {
  final String? id;
  ...
  ReviewUncheckedCreateWithoutAbuseReportsInput(
      {this.id,
  ...
  static ReviewUncheckedCreateWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewUncheckedCreateWithoutAbuseReportsInput(
      id: json['id'],
  ...
  ReviewUncheckedCreateWithoutAbuseReportsInput copyWith(
      {String? id,
      String? authorId,
      String? revieweeId,
      int? value,
