...
class UserCreateNestedOneWithoutReviewsInput extends Equatable {
  ...
  static UserCreateNestedOneWithoutReviewsInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserCreateNestedOneWithoutReviewsInput(
  ...
  UserCreateNestedOneWithoutReviewsInput copyWith(
