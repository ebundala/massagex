...
class BusinessUpdateOneWithoutOwnerInput extends Equatable {
  ...
  BusinessUpdateOneWithoutOwnerInput(
      {this.create,
  ...
  static BusinessUpdateOneWithoutOwnerInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUpdateOneWithoutOwnerInput(
  ...
  BusinessUpdateOneWithoutOwnerInput copyWith(
