...
class CommentUncheckedUpdateManyInput extends Equatable {
  ...
  static CommentUncheckedUpdateManyInput fromJson(Map<dynamic, dynamic> json) {
    return CommentUncheckedUpdateManyInput(
      id: json['id'] != null
  ...
  CommentUncheckedUpdateManyInput copyWith(
