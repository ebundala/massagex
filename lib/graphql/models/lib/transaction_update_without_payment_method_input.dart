...
class TransactionUpdateWithoutPaymentMethodInput extends Equatable {
  ...
  TransactionUpdateWithoutPaymentMethodInput(
      {this.id,
      this.type,
      this.status,
      this.recordStatus,
  ...
  static TransactionUpdateWithoutPaymentMethodInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUpdateWithoutPaymentMethodInput(
      id: json['id'] != null
  ...
  TransactionUpdateWithoutPaymentMethodInput copyWith(
