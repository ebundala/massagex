...
class CommentUpsertWithWhereUniqueWithoutReviewInput extends Equatable {
  final CommentWhereUniqueInput where;
  final CommentUpdateWithoutReviewInput update;
  ...
  static CommentUpsertWithWhereUniqueWithoutReviewInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUpsertWithWhereUniqueWithoutReviewInput(
      where: CommentWhereUniqueInput.fromJson(json['where']),
      update: CommentUpdateWithoutReviewInput.fromJson(json['update']),
  ...
  CommentUpsertWithWhereUniqueWithoutReviewInput copyWith(
      {CommentWhereUniqueInput? where,
      CommentUpdateWithoutReviewInput? update,
