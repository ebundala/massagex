...
class TransactionUncheckedCreateWithoutPaymentMethodInput extends Equatable {
  final String? id;
  ...
  TransactionUncheckedCreateWithoutPaymentMethodInput(
      {this.id,
      required this.type,
  ...
  static TransactionUncheckedCreateWithoutPaymentMethodInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUncheckedCreateWithoutPaymentMethodInput(
      id: json['id'],
  ...
  TransactionUncheckedCreateWithoutPaymentMethodInput copyWith(
      {String? id,
