...
class FavoriteUncheckedCreateNestedManyWithoutCommentInput extends Equatable {
  ...
  FavoriteUncheckedCreateNestedManyWithoutCommentInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static FavoriteUncheckedCreateNestedManyWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedCreateNestedManyWithoutCommentInput(
  ...
  FavoriteUncheckedCreateNestedManyWithoutCommentInput copyWith(
