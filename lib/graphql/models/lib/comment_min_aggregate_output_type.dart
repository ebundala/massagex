...
class CommentMinAggregateOutputType extends Equatable {
  final String? id;
  ...
  static CommentMinAggregateOutputType fromJson(Map<dynamic, dynamic> json) {
    return CommentMinAggregateOutputType(
      id: json['id'],
  ...
  CommentMinAggregateOutputType copyWith(
      {String? id,
      String? authorId,
      String? reviewId,
...
extension CommentMinAggregateOutputTypeExt on CommentMinAggregateOutputType {
...
class CommentMinAggregateOutputTypeController
    extends ValueNotifier<CommentMinAggregateOutputType> {
  ...
  final CommentMinAggregateOutputType initialValue;
  final SelectionSetNode selectionSet;
  final Map<String, SelectionNodeData> selections = {};
  CommentMinAggregateOutputTypeController({
