...
import 'comment_update_without_comment_input.dart';
import 'comment_create_without_comment_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class CommentUpsertWithWhereUniqueWithoutCommentInput extends Equatable {
  final CommentWhereUniqueInput where;
  final CommentUpdateWithoutCommentInput update;
  ...
  static CommentUpsertWithWhereUniqueWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUpsertWithWhereUniqueWithoutCommentInput(
      where: CommentWhereUniqueInput.fromJson(json['where']),
      update: CommentUpdateWithoutCommentInput.fromJson(json['update']),
  ...
  CommentUpsertWithWhereUniqueWithoutCommentInput copyWith(
      {CommentWhereUniqueInput? where,
      CommentUpdateWithoutCommentInput? update,
