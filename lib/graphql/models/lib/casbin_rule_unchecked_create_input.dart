...
class CasbinRuleUncheckedCreateInput extends Equatable {
  final int? id;
  final String ptype;
  final String? v0;
  final String? v1;
  ...
  CasbinRuleUncheckedCreateInput(
      {this.id,
      required this.ptype,
      this.v0,
      this.v1,
  ...
  static CasbinRuleUncheckedCreateInput fromJson(Map<dynamic, dynamic> json) {
    return CasbinRuleUncheckedCreateInput(
      id: json['id'],
      ptype: json['ptype'],
      v0: json['v0'],
      v1: json['v1'],
  ...
  CasbinRuleUncheckedCreateInput copyWith(
      {int? id,
      String? ptype,
      String? v0,
      String? v1,
