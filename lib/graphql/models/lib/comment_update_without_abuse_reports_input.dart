...
class CommentUpdateWithoutAbuseReportsInput extends Equatable {
  ...
  CommentUpdateWithoutAbuseReportsInput(
      {this.id,
  ...
  static CommentUpdateWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUpdateWithoutAbuseReportsInput(
      id: json['id'] != null
  ...
  CommentUpdateWithoutAbuseReportsInput copyWith(
