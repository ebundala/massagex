...
class HelpUncheckedUpdateWithoutStepsInput extends Equatable {
  ...
  HelpUncheckedUpdateWithoutStepsInput(
      {this.id,
      this.topic,
      this.description,
      this.recordStatus,
  ...
  static HelpUncheckedUpdateWithoutStepsInput fromJson(
      Map<dynamic, dynamic> json) {
    return HelpUncheckedUpdateWithoutStepsInput(
      id: json['id'] != null
  ...
  HelpUncheckedUpdateWithoutStepsInput copyWith(
