...
class ReviewUncheckedCreateWithoutRevieweeInput extends Equatable {
  final String? id;
  ...
  ReviewUncheckedCreateWithoutRevieweeInput(
      {this.id,
  ...
  static ReviewUncheckedCreateWithoutRevieweeInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewUncheckedCreateWithoutRevieweeInput(
      id: json['id'],
  ...
  ReviewUncheckedCreateWithoutRevieweeInput copyWith(
      {String? id,
      String? authorId,
      int? value,
      String? content,
