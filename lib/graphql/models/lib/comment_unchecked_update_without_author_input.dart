...
class CommentUncheckedUpdateWithoutAuthorInput extends Equatable {
  ...
  static CommentUncheckedUpdateWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUncheckedUpdateWithoutAuthorInput(
      id: json['id'] != null
  ...
  CommentUncheckedUpdateWithoutAuthorInput copyWith(
