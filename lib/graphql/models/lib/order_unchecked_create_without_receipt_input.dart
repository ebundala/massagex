...
class OrderUncheckedCreateWithoutReceiptInput extends Equatable {
  final String? id;
  final int quantity;
  ...
  OrderUncheckedCreateWithoutReceiptInput(
      {this.id,
  ...
  static OrderUncheckedCreateWithoutReceiptInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUncheckedCreateWithoutReceiptInput(
      id: json['id'],
  ...
  OrderUncheckedCreateWithoutReceiptInput copyWith(
      {String? id,
      int? quantity,
