...
class AttachmentUncheckedCreateWithoutCommentInput extends Equatable {
  ...
  static AttachmentUncheckedCreateWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedCreateWithoutCommentInput(
      path: json['path'],
      id: json['id'],
  ...
  AttachmentUncheckedCreateWithoutCommentInput copyWith(
      {MultipartFile? path,
      String? id,
      String? filename,
      String? mimetype,
