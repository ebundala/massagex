...
class HelpStepUncheckedCreateNestedManyWithoutHelpInput extends Equatable {
  ...
  HelpStepUncheckedCreateNestedManyWithoutHelpInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static HelpStepUncheckedCreateNestedManyWithoutHelpInput fromJson(
      Map<dynamic, dynamic> json) {
    return HelpStepUncheckedCreateNestedManyWithoutHelpInput(
  ...
  HelpStepUncheckedCreateNestedManyWithoutHelpInput copyWith(
