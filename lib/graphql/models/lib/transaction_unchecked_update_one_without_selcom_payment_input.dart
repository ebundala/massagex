...
import 'transaction_upsert_without_selcom_payment_input.dart';
import 'transaction_where_unique_input.dart';
import 'transaction_update_without_selcom_payment_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class TransactionUncheckedUpdateOneWithoutSelcomPaymentInput extends Equatable {
  ...
  final TransactionUpsertWithoutSelcomPaymentInput? upsert;
  final TransactionWhereUniqueInput? connect;
  final bool? disconnect;
  final bool? delete;
  final TransactionUpdateWithoutSelcomPaymentInput? update;
  ...
  TransactionUncheckedUpdateOneWithoutSelcomPaymentInput(
      {this.create,
  ...
  static TransactionUncheckedUpdateOneWithoutSelcomPaymentInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUncheckedUpdateOneWithoutSelcomPaymentInput(
      ...
      upsert: json['upsert'] != null
          ? TransactionUpsertWithoutSelcomPaymentInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? TransactionUpdateWithoutSelcomPaymentInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  TransactionUncheckedUpdateOneWithoutSelcomPaymentInput copyWith(
      {TransactionCreateWithoutSelcomPaymentInput? create,
      TransactionCreateOrConnectWithoutSelcomPaymentInput? connectOrCreate,
      TransactionUpsertWithoutSelcomPaymentInput? upsert,
      TransactionWhereUniqueInput? connect,
      bool? disconnect,
      bool? delete,
      TransactionUpdateWithoutSelcomPaymentInput? update}) {
    return TransactionUncheckedUpdateOneWithoutSelcomPaymentInput(
