...
class CommentUpsertWithoutAttachmentsInput extends Equatable {
  ...
  CommentUpsertWithoutAttachmentsInput(
      {required this.update, required this.create});

  static CommentUpsertWithoutAttachmentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUpsertWithoutAttachmentsInput(
      update: CommentUpdateWithoutAttachmentsInput.fromJson(json['update']),
  ...
  CommentUpsertWithoutAttachmentsInput copyWith(
