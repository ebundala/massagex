...
class AttachmentCreateManyBusinessInput extends Equatable {
  ...
  AttachmentCreateManyBusinessInput(
      {required this.path,
      this.id,
      this.filename,
      this.mimetype,
  ...
  static AttachmentCreateManyBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateManyBusinessInput(
      path: json['path'],
      id: json['id'],
  ...
  AttachmentCreateManyBusinessInput copyWith(
      {MultipartFile? path,
      String? id,
      String? filename,
      String? mimetype,
