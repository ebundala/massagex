...
class HelpStepListRelationFilter extends Equatable {
  final HelpStepWhereInput? every;
  final HelpStepWhereInput? some;
  final HelpStepWhereInput? none;
  ...
  HelpStepListRelationFilter({this.every, this.some, this.none});

  static HelpStepListRelationFilter fromJson(Map<dynamic, dynamic> json) {
    return HelpStepListRelationFilter(
      every: json['every'] != null
          ? HelpStepWhereInput.fromJson(json['every'])
          : null,
      some: json['some'] != null
          ? HelpStepWhereInput.fromJson(json['some'])
          : null,
      none: json['none'] != null
          ? HelpStepWhereInput.fromJson(json['none'])
          : null,
    );
  }
  ...
  HelpStepListRelationFilter copyWith(
      {HelpStepWhereInput? every,
      HelpStepWhereInput? some,
      HelpStepWhereInput? none}) {
    return HelpStepListRelationFilter(
