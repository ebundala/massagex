...
class BusinessCreateOrConnectWithoutFavoritesInput extends Equatable {
  ...
  BusinessCreateOrConnectWithoutFavoritesInput(
      {required this.where, required this.create});

  static BusinessCreateOrConnectWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessCreateOrConnectWithoutFavoritesInput(
  ...
  BusinessCreateOrConnectWithoutFavoritesInput copyWith(
