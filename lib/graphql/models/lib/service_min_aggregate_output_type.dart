...
class ServiceMinAggregateOutputType extends Equatable {
  final String? id;
  final String? name;
  ...
  static ServiceMinAggregateOutputType fromJson(Map<dynamic, dynamic> json) {
    return ServiceMinAggregateOutputType(
      id: json['id'],
      name: json['name'],
  ...
  ServiceMinAggregateOutputType copyWith(
      {String? id,
      String? name,
      String? description,
      double? price,
...
extension ServiceMinAggregateOutputTypeExt on ServiceMinAggregateOutputType {
...
class ServiceMinAggregateOutputTypeController
    extends ValueNotifier<ServiceMinAggregateOutputType> {
  ...
  final ServiceMinAggregateOutputType initialValue;
  final SelectionSetNode selectionSet;
  final Map<String, SelectionNodeData> selections = {};
  ServiceMinAggregateOutputTypeController({
