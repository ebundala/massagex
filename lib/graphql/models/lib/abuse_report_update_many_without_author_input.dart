...
class AbuseReportUpdateManyWithoutAuthorInput extends Equatable {
  ...
  AbuseReportUpdateManyWithoutAuthorInput(
      {this.create,
  ...
  static AbuseReportUpdateManyWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpdateManyWithoutAuthorInput(
  ...
  AbuseReportUpdateManyWithoutAuthorInput copyWith(
