...
class AttachmentUpdateInput extends Equatable {
  ...
  static AttachmentUpdateInput fromJson(Map<dynamic, dynamic> json) {
    return AttachmentUpdateInput(
      id: json['id'] != null
  ...
  AttachmentUpdateInput copyWith(
