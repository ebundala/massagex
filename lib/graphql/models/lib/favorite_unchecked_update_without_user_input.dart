...
class FavoriteUncheckedUpdateWithoutUserInput extends Equatable {
  ...
  static FavoriteUncheckedUpdateWithoutUserInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedUpdateWithoutUserInput(
      id: json['id'] != null
  ...
  FavoriteUncheckedUpdateWithoutUserInput copyWith(
