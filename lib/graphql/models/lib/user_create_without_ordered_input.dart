...
class UserCreateWithoutOrderedInput extends Equatable {
  final String? id;
  final String? email;
  ...
  static UserCreateWithoutOrderedInput fromJson(Map<dynamic, dynamic> json) {
    return UserCreateWithoutOrderedInput(
      id: json['id'],
      email: json['email'],
  ...
  UserCreateWithoutOrderedInput copyWith(
      {String? id,
      String? email,
      String? displayName,
      String? phoneNumber,
