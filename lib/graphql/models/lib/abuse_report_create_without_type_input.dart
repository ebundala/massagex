...
class AbuseReportCreateWithoutTypeInput extends Equatable {
  final String? id;
  final int? number;
  final String? report;
  ...
  AbuseReportCreateWithoutTypeInput(
      {this.id,
      this.number,
      this.report,
      this.recordStatus,
  ...
  static AbuseReportCreateWithoutTypeInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportCreateWithoutTypeInput(
      id: json['id'],
      number: json['number'],
      report: json['report'],
  ...
  AbuseReportCreateWithoutTypeInput copyWith(
      {String? id,
      int? number,
      String? report,
