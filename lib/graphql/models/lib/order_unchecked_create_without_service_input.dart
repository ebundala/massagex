...
class OrderUncheckedCreateWithoutServiceInput extends Equatable {
  final String? id;
  final int quantity;
  ...
  static OrderUncheckedCreateWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUncheckedCreateWithoutServiceInput(
      id: json['id'],
  ...
  OrderUncheckedCreateWithoutServiceInput copyWith(
      {String? id,
      int? quantity,
