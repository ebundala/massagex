...
class SelcomPaymentUncheckedUpdateWithoutTransactionInput extends Equatable {
  ...
  SelcomPaymentUncheckedUpdateWithoutTransactionInput(
      {this.id,
      this.transId,
      this.amount,
      this.msisdn,
  ...
  static SelcomPaymentUncheckedUpdateWithoutTransactionInput fromJson(
      Map<dynamic, dynamic> json) {
    return SelcomPaymentUncheckedUpdateWithoutTransactionInput(
      id: json['id'] != null
  ...
  SelcomPaymentUncheckedUpdateWithoutTransactionInput copyWith(
