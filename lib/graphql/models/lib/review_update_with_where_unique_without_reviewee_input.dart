...
class ReviewUpdateWithWhereUniqueWithoutRevieweeInput extends Equatable {
  final ReviewWhereUniqueInput where;
  final ReviewUpdateWithoutRevieweeInput data;
  ...
  ReviewUpdateWithWhereUniqueWithoutRevieweeInput(
      {required this.where, required this.data});

  static ReviewUpdateWithWhereUniqueWithoutRevieweeInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewUpdateWithWhereUniqueWithoutRevieweeInput(
      where: ReviewWhereUniqueInput.fromJson(json['where']),
      data: ReviewUpdateWithoutRevieweeInput.fromJson(json['data']),
    );
  }
  ...
  ReviewUpdateWithWhereUniqueWithoutRevieweeInput copyWith(
      {ReviewWhereUniqueInput? where, ReviewUpdateWithoutRevieweeInput? data}) {
    return ReviewUpdateWithWhereUniqueWithoutRevieweeInput(
