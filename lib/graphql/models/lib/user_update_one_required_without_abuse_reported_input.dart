...
import 'user_create_or_connect_without_abuse_reported_input.dart';
import 'user_upsert_without_abuse_reported_input.dart';
...
class UserUpdateOneRequiredWithoutAbuseReportedInput extends Equatable {
  final UserCreateWithoutAbuseReportedInput? create;
  final UserCreateOrConnectWithoutAbuseReportedInput? connectOrCreate;
  final UserUpsertWithoutAbuseReportedInput? upsert;
  ...
  UserUpdateOneRequiredWithoutAbuseReportedInput(
      {this.create,
  ...
  static UserUpdateOneRequiredWithoutAbuseReportedInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUpdateOneRequiredWithoutAbuseReportedInput(
      create: json['create'] != null
          ? UserCreateWithoutAbuseReportedInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? UserCreateOrConnectWithoutAbuseReportedInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? UserUpsertWithoutAbuseReportedInput.fromJson(json['upsert'])
          : null,
      connect: json['connect'] != null
          ? UserWhereUniqueInput.fromJson(json['connect'])
          : null,
      update: json['update'] != null
          ? UserUpdateWithoutAbuseReportedInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  UserUpdateOneRequiredWithoutAbuseReportedInput copyWith(
      {UserCreateWithoutAbuseReportedInput? create,
      UserCreateOrConnectWithoutAbuseReportedInput? connectOrCreate,
      UserUpsertWithoutAbuseReportedInput? upsert,
