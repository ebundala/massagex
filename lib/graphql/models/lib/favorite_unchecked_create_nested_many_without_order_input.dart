...
class FavoriteUncheckedCreateNestedManyWithoutOrderInput extends Equatable {
  ...
  FavoriteUncheckedCreateNestedManyWithoutOrderInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static FavoriteUncheckedCreateNestedManyWithoutOrderInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedCreateNestedManyWithoutOrderInput(
  ...
  FavoriteUncheckedCreateNestedManyWithoutOrderInput copyWith(
