import 'service_create_without_image_input.dart';
import 'service_create_or_connect_without_image_input.dart';
import 'service_upsert_with_where_unique_without_image_input.dart';
import 'service_create_many_image_input_envelope.dart';
import 'service_where_unique_input.dart';
import 'service_update_with_where_unique_without_image_input.dart';
import 'service_update_many_with_where_without_image_input.dart';
import 'service_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class ServiceUncheckedUpdateManyWithoutImageInput extends Equatable {
  final List<ServiceCreateWithoutImageInput>? create;
  final List<ServiceCreateOrConnectWithoutImageInput>? connectOrCreate;
  final List<ServiceUpsertWithWhereUniqueWithoutImageInput>? upsert;
  final ServiceCreateManyImageInputEnvelope? createMany;
  ...
  final List<ServiceUpdateWithWhereUniqueWithoutImageInput>? update;
  final List<ServiceUpdateManyWithWhereWithoutImageInput>? updateMany;
  ...
  ServiceUncheckedUpdateManyWithoutImageInput(
      {this.create,
  ...
  static ServiceUncheckedUpdateManyWithoutImageInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUncheckedUpdateManyWithoutImageInput(
      create: json['create'] != null
          ? List.generate(
              json['create'].length,
              (index) => ServiceCreateWithoutImageInput.fromJson(
                  json['create'][index]))
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? List.generate(
              json['connectOrCreate'].length,
              (index) => ServiceCreateOrConnectWithoutImageInput.fromJson(
                  json['connectOrCreate'][index]))
          : null,
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) => ServiceUpsertWithWhereUniqueWithoutImageInput.fromJson(
                  json['upsert'][index]))
          : null,
      createMany: json['createMany'] != null
          ? ServiceCreateManyImageInputEnvelope.fromJson(json['createMany'])
          : null,
      ...
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) => ServiceUpdateWithWhereUniqueWithoutImageInput.fromJson(
                  json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              json['updateMany'].length,
              (index) => ServiceUpdateManyWithWhereWithoutImageInput.fromJson(
  ...
  ServiceUncheckedUpdateManyWithoutImageInput copyWith(
      {List<ServiceCreateWithoutImageInput>? create,
      List<ServiceCreateOrConnectWithoutImageInput>? connectOrCreate,
      List<ServiceUpsertWithWhereUniqueWithoutImageInput>? upsert,
      ServiceCreateManyImageInputEnvelope? createMany,
      ...
      List<ServiceUpdateWithWhereUniqueWithoutImageInput>? update,
      List<ServiceUpdateManyWithWhereWithoutImageInput>? updateMany,
