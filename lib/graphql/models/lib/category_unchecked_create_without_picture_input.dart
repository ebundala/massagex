...
class CategoryUncheckedCreateWithoutPictureInput extends Equatable {
  final String? id;
  final String name;
  ...
  CategoryUncheckedCreateWithoutPictureInput(
      {this.id,
      required this.name,
      this.description,
      this.metadata,
  ...
  static CategoryUncheckedCreateWithoutPictureInput fromJson(
      Map<dynamic, dynamic> json) {
    return CategoryUncheckedCreateWithoutPictureInput(
      id: json['id'],
      name: json['name'],
  ...
  CategoryUncheckedCreateWithoutPictureInput copyWith(
      {String? id,
      String? name,
      String? description,
      JSONObject? metadata,
