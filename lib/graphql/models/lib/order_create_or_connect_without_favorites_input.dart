...
class OrderCreateOrConnectWithoutFavoritesInput extends Equatable {
  ...
  OrderCreateOrConnectWithoutFavoritesInput(
      {required this.where, required this.create});

  static OrderCreateOrConnectWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderCreateOrConnectWithoutFavoritesInput(
  ...
  OrderCreateOrConnectWithoutFavoritesInput copyWith(
