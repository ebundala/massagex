...
class ServiceUncheckedUpdateManyInput extends Equatable {
  ...
  static ServiceUncheckedUpdateManyInput fromJson(Map<dynamic, dynamic> json) {
    return ServiceUncheckedUpdateManyInput(
      id: json['id'] != null
  ...
  ServiceUncheckedUpdateManyInput copyWith(
