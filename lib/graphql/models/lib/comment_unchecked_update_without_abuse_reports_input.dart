...
class CommentUncheckedUpdateWithoutAbuseReportsInput extends Equatable {
  ...
  CommentUncheckedUpdateWithoutAbuseReportsInput(
      {this.id,
      this.authorId,
      this.reviewId,
  ...
  static CommentUncheckedUpdateWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUncheckedUpdateWithoutAbuseReportsInput(
      id: json['id'] != null
  ...
  CommentUncheckedUpdateWithoutAbuseReportsInput copyWith(
