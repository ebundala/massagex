...
class OrderUpdateManyWithoutBusinessInput extends Equatable {
  ...
  OrderUpdateManyWithoutBusinessInput(
      {this.create,
  ...
  static OrderUpdateManyWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUpdateManyWithoutBusinessInput(
  ...
  OrderUpdateManyWithoutBusinessInput copyWith(
