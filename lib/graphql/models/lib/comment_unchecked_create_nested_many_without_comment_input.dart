...
class CommentUncheckedCreateNestedManyWithoutCommentInput extends Equatable {
  ...
  CommentUncheckedCreateNestedManyWithoutCommentInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static CommentUncheckedCreateNestedManyWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUncheckedCreateNestedManyWithoutCommentInput(
  ...
  CommentUncheckedCreateNestedManyWithoutCommentInput copyWith(
