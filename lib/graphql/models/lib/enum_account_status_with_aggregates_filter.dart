...
import 'nested_enum_account_status_with_aggregates_filter.dart';
...
class EnumAccountStatusWithAggregatesFilter extends Equatable {
  final AccountStatus? equals;
  final List<AccountStatus>? in$;
  final List<AccountStatus>? notIn;
  final NestedEnumAccountStatusWithAggregatesFilter? not;
  final NestedIntFilter? $count;
  final NestedIntFilter? count;
  final NestedEnumAccountStatusFilter? $min;
  final NestedEnumAccountStatusFilter? min;
  final NestedEnumAccountStatusFilter? $max;
  final NestedEnumAccountStatusFilter? max;
  ...
  static EnumAccountStatusWithAggregatesFilter fromJson(
      Map<dynamic, dynamic> json) {
    return EnumAccountStatusWithAggregatesFilter(
      ...
      notIn: json['notIn'] != null
          ...
          : null,
      not: json['not'] != null
          ? NestedEnumAccountStatusWithAggregatesFilter.fromJson(json['not'])
          : null,
      ...
      count: json['count'] != null
          ...
          : null,
      $min: json['_min'] != null
          ? NestedEnumAccountStatusFilter.fromJson(json['_min'])
          : null,
      min: json['min'] != null
          ? NestedEnumAccountStatusFilter.fromJson(json['min'])
          : null,
      $max: json['_max'] != null
          ? NestedEnumAccountStatusFilter.fromJson(json['_max'])
          : null,
      max: json['max'] != null
          ? NestedEnumAccountStatusFilter.fromJson(json['max'])
          : null,
    );
  }
  ...
  EnumAccountStatusWithAggregatesFilter copyWith(
      {AccountStatus? equals,
      List<AccountStatus>? in$,
      List<AccountStatus>? notIn,
      NestedEnumAccountStatusWithAggregatesFilter? not,
      NestedIntFilter? $count,
      NestedIntFilter? count,
      NestedEnumAccountStatusFilter? $min,
      NestedEnumAccountStatusFilter? min,
      NestedEnumAccountStatusFilter? $max,
      NestedEnumAccountStatusFilter? max}) {
    return EnumAccountStatusWithAggregatesFilter(
