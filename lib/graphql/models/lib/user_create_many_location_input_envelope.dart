import 'user_create_many_location_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class UserCreateManyLocationInputEnvelope extends Equatable {
  final List<UserCreateManyLocationInput>? data;
  ...
  UserCreateManyLocationInputEnvelope({this.data, this.skipDuplicates});

  static UserCreateManyLocationInputEnvelope fromJson(
      Map<dynamic, dynamic> json) {
    return UserCreateManyLocationInputEnvelope(
      data: json['data'] != null
          ? List.generate(
              json['data'].length,
              (index) =>
                  UserCreateManyLocationInput.fromJson(json['data'][index]))
          : null,
  ...
  UserCreateManyLocationInputEnvelope copyWith(
      {List<UserCreateManyLocationInput>? data, bool? skipDuplicates}) {
    return UserCreateManyLocationInputEnvelope(
        data: data ?? this.data,
