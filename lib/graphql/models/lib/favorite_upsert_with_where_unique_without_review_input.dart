...
import 'favorite_update_without_review_input.dart';
import 'favorite_create_without_review_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class FavoriteUpsertWithWhereUniqueWithoutReviewInput extends Equatable {
  final FavoriteWhereUniqueInput where;
  final FavoriteUpdateWithoutReviewInput update;
  final FavoriteCreateWithoutReviewInput create;
  ...
  FavoriteUpsertWithWhereUniqueWithoutReviewInput(
      {required this.where, required this.update, required this.create});

  static FavoriteUpsertWithWhereUniqueWithoutReviewInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUpsertWithWhereUniqueWithoutReviewInput(
      where: FavoriteWhereUniqueInput.fromJson(json['where']),
      update: FavoriteUpdateWithoutReviewInput.fromJson(json['update']),
      create: FavoriteCreateWithoutReviewInput.fromJson(json['create']),
    );
  }
  ...
  FavoriteUpsertWithWhereUniqueWithoutReviewInput copyWith(
      {FavoriteWhereUniqueInput? where,
      FavoriteUpdateWithoutReviewInput? update,
      FavoriteCreateWithoutReviewInput? create}) {
    return FavoriteUpsertWithWhereUniqueWithoutReviewInput(
