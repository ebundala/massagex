...
import 'comment_upsert_with_where_unique_without_author_input.dart';
import 'comment_create_many_author_input_envelope.dart';
import 'comment_where_unique_input.dart';
import 'comment_update_with_where_unique_without_author_input.dart';
import 'comment_update_many_with_where_without_author_input.dart';
import 'comment_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class CommentUncheckedUpdateManyWithoutAuthorInput extends Equatable {
  final List<CommentCreateWithoutAuthorInput>? create;
  final List<CommentCreateOrConnectWithoutAuthorInput>? connectOrCreate;
  final List<CommentUpsertWithWhereUniqueWithoutAuthorInput>? upsert;
  ...
  final List<CommentUpdateWithWhereUniqueWithoutAuthorInput>? update;
  final List<CommentUpdateManyWithWhereWithoutAuthorInput>? updateMany;
  ...
  static CommentUncheckedUpdateManyWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUncheckedUpdateManyWithoutAuthorInput(
      ...
      updateMany: json['updateMany'] != null
          ? List.generate(
              ...
              (index) => CommentUpdateManyWithWhereWithoutAuthorInput.fromJson(
  ...
  CommentUncheckedUpdateManyWithoutAuthorInput copyWith(
      {List<CommentCreateWithoutAuthorInput>? create,
      List<CommentCreateOrConnectWithoutAuthorInput>? connectOrCreate,
      List<CommentUpsertWithWhereUniqueWithoutAuthorInput>? upsert,
      ...
      List<CommentUpdateWithWhereUniqueWithoutAuthorInput>? update,
      List<CommentUpdateManyWithWhereWithoutAuthorInput>? updateMany,
