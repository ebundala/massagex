...
import 'business_upsert_without_favorites_input.dart';
import 'business_where_unique_input.dart';
import 'business_update_without_favorites_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class BusinessUpdateOneWithoutFavoritesInput extends Equatable {
  final BusinessCreateWithoutFavoritesInput? create;
  final BusinessCreateOrConnectWithoutFavoritesInput? connectOrCreate;
  final BusinessUpsertWithoutFavoritesInput? upsert;
  final BusinessWhereUniqueInput? connect;
  final bool? disconnect;
  final bool? delete;
  final BusinessUpdateWithoutFavoritesInput? update;
  ...
  BusinessUpdateOneWithoutFavoritesInput(
      {this.create,
  ...
  static BusinessUpdateOneWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUpdateOneWithoutFavoritesInput(
      ...
      upsert: json['upsert'] != null
          ? BusinessUpsertWithoutFavoritesInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? BusinessUpdateWithoutFavoritesInput.fromJson(json['update'])
          : null,
    );
  }
