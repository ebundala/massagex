...
class UserCreateWithoutFavoritedInput extends Equatable {
  final String? id;
  final String email;
  ...
  UserCreateWithoutFavoritedInput(
      {this.id,
      required this.email,
  ...
  static UserCreateWithoutFavoritedInput fromJson(Map<dynamic, dynamic> json) {
    return UserCreateWithoutFavoritedInput(
      id: json['id'],
      email: json['email'],
  ...
  UserCreateWithoutFavoritedInput copyWith(
      {String? id,
      String? email,
      String? displayName,
      String? phoneNumber,
