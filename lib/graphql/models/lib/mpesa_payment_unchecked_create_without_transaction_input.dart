...
class MpesaPaymentUncheckedCreateWithoutTransactionInput extends Equatable {
  final String? id;
  ...
  MpesaPaymentUncheckedCreateWithoutTransactionInput(
      {this.id,
  ...
  static MpesaPaymentUncheckedCreateWithoutTransactionInput fromJson(
      Map<dynamic, dynamic> json) {
    return MpesaPaymentUncheckedCreateWithoutTransactionInput(
      id: json['id'],
  ...
  MpesaPaymentUncheckedCreateWithoutTransactionInput copyWith(
      {String? id,
      String? input$Amount,
