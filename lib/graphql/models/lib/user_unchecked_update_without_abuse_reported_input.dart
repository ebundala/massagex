...
class UserUncheckedUpdateWithoutAbuseReportedInput extends Equatable {
  ...
  UserUncheckedUpdateWithoutAbuseReportedInput(
      {this.id,
      this.email,
      this.displayName,
      this.phoneNumber,
  ...
  static UserUncheckedUpdateWithoutAbuseReportedInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUncheckedUpdateWithoutAbuseReportedInput(
      id: json['id'] != null
  ...
  UserUncheckedUpdateWithoutAbuseReportedInput copyWith(
