import 'nested_date_time_with_aggregates_filter.dart';
import 'nested_int_filter.dart';
import 'nested_date_time_filter.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class DateTimeWithAggregatesFilter extends Equatable {
  ...
  static DateTimeWithAggregatesFilter fromJson(Map<dynamic, dynamic> json) {
    return DateTimeWithAggregatesFilter(
      ...
      not: json['not'] != null
          ? NestedDateTimeWithAggregatesFilter.fromJson(json['not'])
          : null,
      ...
      count: json['count'] != null
          ...
          : null,
      $min: json['_min'] != null
          ? NestedDateTimeFilter.fromJson(json['_min'])
          : null,
      min: json['min'] != null
          ? NestedDateTimeFilter.fromJson(json['min'])
          : null,
      $max: json['_max'] != null
          ? NestedDateTimeFilter.fromJson(json['_max'])
          : null,
      max: json['max'] != null
          ? NestedDateTimeFilter.fromJson(json['max'])
          : null,
    );
  }
  ...
  DateTimeWithAggregatesFilter copyWith(
      {DateTime? equals,
      List<DateTime>? in$,
      List<DateTime>? notIn,
      DateTime? lt,
      ...
      DateTime? gt,
      DateTime? gte,
      NestedDateTimeWithAggregatesFilter? not,
      NestedIntFilter? $count,
      NestedIntFilter? count,
      NestedDateTimeFilter? $min,
      NestedDateTimeFilter? min,
      NestedDateTimeFilter? $max,
      NestedDateTimeFilter? max}) {
    return DateTimeWithAggregatesFilter(
