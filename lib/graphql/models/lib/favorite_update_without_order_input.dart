...
class FavoriteUpdateWithoutOrderInput extends Equatable {
  ...
  FavoriteUpdateWithoutOrderInput(
      {this.id,
      this.favId,
      this.recordStatus,
      this.createdAt,
  ...
  static FavoriteUpdateWithoutOrderInput fromJson(Map<dynamic, dynamic> json) {
    return FavoriteUpdateWithoutOrderInput(
      id: json['id'] != null
  ...
  FavoriteUpdateWithoutOrderInput copyWith(
