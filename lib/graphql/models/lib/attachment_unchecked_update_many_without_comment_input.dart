...
class AttachmentUncheckedUpdateManyWithoutCommentInput extends Equatable {
  ...
  static AttachmentUncheckedUpdateManyWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedUpdateManyWithoutCommentInput(
  ...
  AttachmentUncheckedUpdateManyWithoutCommentInput copyWith(
