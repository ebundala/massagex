...
class AttachmentUncheckedCreateNestedManyWithoutHelpStepInput
    extends Equatable {
  ...
  AttachmentUncheckedCreateNestedManyWithoutHelpStepInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static AttachmentUncheckedCreateNestedManyWithoutHelpStepInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedCreateNestedManyWithoutHelpStepInput(
  ...
  AttachmentUncheckedCreateNestedManyWithoutHelpStepInput copyWith(
