...
class UserUncheckedCreateWithoutLocationInput extends Equatable {
  final String? id;
  final String email;
  ...
  UserUncheckedCreateWithoutLocationInput(
      {this.id,
      required this.email,
  ...
  static UserUncheckedCreateWithoutLocationInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUncheckedCreateWithoutLocationInput(
      id: json['id'],
      email: json['email'],
  ...
  UserUncheckedCreateWithoutLocationInput copyWith(
      {String? id,
      String? email,
      String? displayName,
      String? phoneNumber,
