...
class ReviewUncheckedUpdateWithoutAttachmentsInput extends Equatable {
  ...
  ReviewUncheckedUpdateWithoutAttachmentsInput(
      {this.id,
      this.authorId,
      this.revieweeId,
      this.value,
  ...
  static ReviewUncheckedUpdateWithoutAttachmentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewUncheckedUpdateWithoutAttachmentsInput(
      id: json['id'] != null
  ...
  ReviewUncheckedUpdateWithoutAttachmentsInput copyWith(
