import 'comment_create_without_abuse_reports_input.dart';
import 'comment_create_or_connect_without_abuse_reports_input.dart';
import 'comment_upsert_without_abuse_reports_input.dart';
import 'comment_where_unique_input.dart';
import 'comment_update_without_abuse_reports_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class CommentUpdateOneWithoutAbuseReportsInput extends Equatable {
  final CommentCreateWithoutAbuseReportsInput? create;
  final CommentCreateOrConnectWithoutAbuseReportsInput? connectOrCreate;
  final CommentUpsertWithoutAbuseReportsInput? upsert;
  final CommentWhereUniqueInput? connect;
  final bool? disconnect;
  final bool? delete;
  final CommentUpdateWithoutAbuseReportsInput? update;
  ...
  CommentUpdateOneWithoutAbuseReportsInput(
      {this.create,
  ...
  static CommentUpdateOneWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUpdateOneWithoutAbuseReportsInput(
      create: json['create'] != null
          ? CommentCreateWithoutAbuseReportsInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? CommentCreateOrConnectWithoutAbuseReportsInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? CommentUpsertWithoutAbuseReportsInput.fromJson(json['upsert'])
          : null,
      connect: json['connect'] != null
          ? CommentWhereUniqueInput.fromJson(json['connect'])
          : null,
      disconnect: json['disconnect'],
      delete: json['delete'],
      update: json['update'] != null
          ? CommentUpdateWithoutAbuseReportsInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  CommentUpdateOneWithoutAbuseReportsInput copyWith(
      {CommentCreateWithoutAbuseReportsInput? create,
      CommentCreateOrConnectWithoutAbuseReportsInput? connectOrCreate,
      CommentUpsertWithoutAbuseReportsInput? upsert,
      CommentWhereUniqueInput? connect,
      bool? disconnect,
      bool? delete,
      CommentUpdateWithoutAbuseReportsInput? update}) {
    return CommentUpdateOneWithoutAbuseReportsInput(
