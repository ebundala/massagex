...
class LocationBatchResponse extends Equatable {
  final bool? status;
  final BatchPayload? data;
  final String? message;
  LocationBatchResponse({this.status, this.data, this.message});

  static LocationBatchResponse fromJson(Map<dynamic, dynamic> json) {
  ...
  LocationBatchResponse copyWith(
