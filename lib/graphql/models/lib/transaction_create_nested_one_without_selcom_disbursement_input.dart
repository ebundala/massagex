...
class TransactionCreateNestedOneWithoutSelcomDisbursementInput
    extends Equatable {
  ...
  TransactionCreateNestedOneWithoutSelcomDisbursementInput(
      {this.create, this.connectOrCreate, this.connect});

  static TransactionCreateNestedOneWithoutSelcomDisbursementInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionCreateNestedOneWithoutSelcomDisbursementInput(
  ...
  TransactionCreateNestedOneWithoutSelcomDisbursementInput copyWith(
