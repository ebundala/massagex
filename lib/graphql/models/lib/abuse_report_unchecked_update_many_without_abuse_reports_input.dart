...
class AbuseReportUncheckedUpdateManyWithoutAbuseReportsInput extends Equatable {
  ...
  AbuseReportUncheckedUpdateManyWithoutAbuseReportsInput(
      {this.id,
      this.number,
      this.report,
      this.authorId,
  ...
  static AbuseReportUncheckedUpdateManyWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedUpdateManyWithoutAbuseReportsInput(
      id: json['id'] != null
  ...
  AbuseReportUncheckedUpdateManyWithoutAbuseReportsInput copyWith(
