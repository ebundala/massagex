...
class FavoriteUncheckedCreateNestedManyWithoutBusinessInput extends Equatable {
  ...
  FavoriteUncheckedCreateNestedManyWithoutBusinessInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static FavoriteUncheckedCreateNestedManyWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedCreateNestedManyWithoutBusinessInput(
  ...
  FavoriteUncheckedCreateNestedManyWithoutBusinessInput copyWith(
