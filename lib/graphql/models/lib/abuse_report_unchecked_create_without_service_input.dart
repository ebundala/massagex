...
class AbuseReportUncheckedCreateWithoutServiceInput extends Equatable {
  final String? id;
  final int? number;
  final String? report;
  ...
  AbuseReportUncheckedCreateWithoutServiceInput(
      {this.id,
      this.number,
      this.report,
  ...
  static AbuseReportUncheckedCreateWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedCreateWithoutServiceInput(
      id: json['id'],
      number: json['number'],
      report: json['report'],
  ...
  AbuseReportUncheckedCreateWithoutServiceInput copyWith(
      {String? id,
      int? number,
      String? report,
      String? authorId,
