...
class NestedEnumRecordStatusFilter extends Equatable {
  final RecordStatus? equals;
  final List<RecordStatus>? in$;
  final List<RecordStatus>? notIn;
  final NestedEnumRecordStatusFilter? not;
  ...
  NestedEnumRecordStatusFilter({this.equals, this.in$, this.notIn, this.not});

  static NestedEnumRecordStatusFilter fromJson(Map<dynamic, dynamic> json) {
    return NestedEnumRecordStatusFilter(
      ...
      notIn: json['notIn'] != null
          ...
          : null,
      not: json['not'] != null
          ? NestedEnumRecordStatusFilter.fromJson(json['not'])
          : null,
    );
  }
  ...
  NestedEnumRecordStatusFilter copyWith(
      {RecordStatus? equals,
      List<RecordStatus>? in$,
      List<RecordStatus>? notIn,
      NestedEnumRecordStatusFilter? not}) {
    return NestedEnumRecordStatusFilter(
