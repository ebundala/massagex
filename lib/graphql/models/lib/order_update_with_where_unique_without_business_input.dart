...
class OrderUpdateWithWhereUniqueWithoutBusinessInput extends Equatable {
  final OrderWhereUniqueInput where;
  final OrderUpdateWithoutBusinessInput data;
  ...
  static OrderUpdateWithWhereUniqueWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUpdateWithWhereUniqueWithoutBusinessInput(
      where: OrderWhereUniqueInput.fromJson(json['where']),
      data: OrderUpdateWithoutBusinessInput.fromJson(json['data']),
    );
  }
  ...
  OrderUpdateWithWhereUniqueWithoutBusinessInput copyWith(
      {OrderWhereUniqueInput? where, OrderUpdateWithoutBusinessInput? data}) {
    return OrderUpdateWithWhereUniqueWithoutBusinessInput(
