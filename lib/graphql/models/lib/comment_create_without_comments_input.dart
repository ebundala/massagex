...
class CommentCreateWithoutCommentsInput extends Equatable {
  final String? id;
  ...
  static CommentCreateWithoutCommentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentCreateWithoutCommentsInput(
      id: json['id'],
  ...
  CommentCreateWithoutCommentsInput copyWith(
      {String? id,
