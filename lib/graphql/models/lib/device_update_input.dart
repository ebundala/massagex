...
import 'user_update_one_without_device_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class DeviceUpdateInput extends Equatable {
  ...
  final UserUpdateOneWithoutDeviceInput? user;
  ...
  DeviceUpdateInput(
      {this.id, this.fcm$id, this.type, this.recordStatus, this.user});

  static DeviceUpdateInput fromJson(Map<dynamic, dynamic> json) {
    return DeviceUpdateInput(
      ...
      recordStatus: json['recordStatus'] != null
          ...
          : null,
      user: json['user'] != null
          ? UserUpdateOneWithoutDeviceInput.fromJson(json['user'])
          : null,
    );
  }
  ...
  DeviceUpdateInput copyWith(
      ...
      UserUpdateOneWithoutDeviceInput? user}) {
    return DeviceUpdateInput(
        id: id ?? this.id,
