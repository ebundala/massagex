...
class AbuseReportCreateManyReviewInput extends Equatable {
  final String? id;
  final int? number;
  final String? report;
  ...
  AbuseReportCreateManyReviewInput(
      {this.id,
      this.number,
      this.report,
  ...
  static AbuseReportCreateManyReviewInput fromJson(Map<dynamic, dynamic> json) {
    return AbuseReportCreateManyReviewInput(
      id: json['id'],
      number: json['number'],
      report: json['report'],
  ...
  AbuseReportCreateManyReviewInput copyWith(
      {String? id,
      int? number,
      String? report,
      String? authorId,
