...
class UserUncheckedUpdateManyWithoutUsersInput extends Equatable {
  ...
  static UserUncheckedUpdateManyWithoutUsersInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUncheckedUpdateManyWithoutUsersInput(
      id: json['id'] != null
  ...
  UserUncheckedUpdateManyWithoutUsersInput copyWith(
