...
class AbuseReportUncheckedUpdateWithoutReviewInput extends Equatable {
  ...
  AbuseReportUncheckedUpdateWithoutReviewInput(
      {this.id,
      this.number,
      this.report,
      this.authorId,
  ...
  static AbuseReportUncheckedUpdateWithoutReviewInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedUpdateWithoutReviewInput(
      id: json['id'] != null
  ...
  AbuseReportUncheckedUpdateWithoutReviewInput copyWith(
