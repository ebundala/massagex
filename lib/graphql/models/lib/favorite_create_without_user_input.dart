...
class FavoriteCreateWithoutUserInput extends Equatable {
  final String? id;
  final String favId;
  ...
  static FavoriteCreateWithoutUserInput fromJson(Map<dynamic, dynamic> json) {
    return FavoriteCreateWithoutUserInput(
      id: json['id'],
      favId: json['favId'],
  ...
  FavoriteCreateWithoutUserInput copyWith(
      {String? id,
      String? favId,
