...
class CategoryUncheckedCreateNestedManyWithoutPictureInput extends Equatable {
  ...
  CategoryUncheckedCreateNestedManyWithoutPictureInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static CategoryUncheckedCreateNestedManyWithoutPictureInput fromJson(
      Map<dynamic, dynamic> json) {
    return CategoryUncheckedCreateNestedManyWithoutPictureInput(
  ...
  CategoryUncheckedCreateNestedManyWithoutPictureInput copyWith(
