...
class ReviewUncheckedUpdateWithoutAuthorInput extends Equatable {
  ...
  static ReviewUncheckedUpdateWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewUncheckedUpdateWithoutAuthorInput(
      id: json['id'] != null
  ...
  ReviewUncheckedUpdateWithoutAuthorInput copyWith(
