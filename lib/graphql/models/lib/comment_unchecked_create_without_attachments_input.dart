...
class CommentUncheckedCreateWithoutAttachmentsInput extends Equatable {
  final String? id;
  ...
  static CommentUncheckedCreateWithoutAttachmentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUncheckedCreateWithoutAttachmentsInput(
      id: json['id'],
  ...
  CommentUncheckedCreateWithoutAttachmentsInput copyWith(
      {String? id,
      String? authorId,
      String? reviewId,
