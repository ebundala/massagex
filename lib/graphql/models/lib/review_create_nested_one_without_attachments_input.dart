...
class ReviewCreateNestedOneWithoutAttachmentsInput extends Equatable {
  ...
  ReviewCreateNestedOneWithoutAttachmentsInput(
      {this.create, this.connectOrCreate, this.connect});

  static ReviewCreateNestedOneWithoutAttachmentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewCreateNestedOneWithoutAttachmentsInput(
  ...
  ReviewCreateNestedOneWithoutAttachmentsInput copyWith(
