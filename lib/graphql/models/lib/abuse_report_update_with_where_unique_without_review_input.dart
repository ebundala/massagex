...
class AbuseReportUpdateWithWhereUniqueWithoutReviewInput extends Equatable {
  final AbuseReportWhereUniqueInput where;
  final AbuseReportUpdateWithoutReviewInput data;
  ...
  AbuseReportUpdateWithWhereUniqueWithoutReviewInput(
      {required this.where, required this.data});

  static AbuseReportUpdateWithWhereUniqueWithoutReviewInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpdateWithWhereUniqueWithoutReviewInput(
      where: AbuseReportWhereUniqueInput.fromJson(json['where']),
      data: AbuseReportUpdateWithoutReviewInput.fromJson(json['data']),
    );
  }
  ...
  AbuseReportUpdateWithWhereUniqueWithoutReviewInput copyWith(
      {AbuseReportWhereUniqueInput? where,
      AbuseReportUpdateWithoutReviewInput? data}) {
    return AbuseReportUpdateWithWhereUniqueWithoutReviewInput(
