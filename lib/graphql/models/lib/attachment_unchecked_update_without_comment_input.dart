...
class AttachmentUncheckedUpdateWithoutCommentInput extends Equatable {
  ...
  static AttachmentUncheckedUpdateWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedUpdateWithoutCommentInput(
      id: json['id'] != null
  ...
  AttachmentUncheckedUpdateWithoutCommentInput copyWith(
