...
class TransactionUpdateWithWhereUniqueWithoutPaymentMethodInput
    extends Equatable {
  final TransactionWhereUniqueInput where;
  final TransactionUpdateWithoutPaymentMethodInput data;
  ...
  static TransactionUpdateWithWhereUniqueWithoutPaymentMethodInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUpdateWithWhereUniqueWithoutPaymentMethodInput(
      where: TransactionWhereUniqueInput.fromJson(json['where']),
      data: TransactionUpdateWithoutPaymentMethodInput.fromJson(json['data']),
    );
  }
  ...
  TransactionUpdateWithWhereUniqueWithoutPaymentMethodInput copyWith(
      {TransactionWhereUniqueInput? where,
      TransactionUpdateWithoutPaymentMethodInput? data}) {
    return TransactionUpdateWithWhereUniqueWithoutPaymentMethodInput(
