...
import 'service_upsert_without_favorites_input.dart';
import 'service_where_unique_input.dart';
import 'service_update_without_favorites_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class ServiceUpdateOneWithoutFavoritesInput extends Equatable {
  final ServiceCreateWithoutFavoritesInput? create;
  final ServiceCreateOrConnectWithoutFavoritesInput? connectOrCreate;
  final ServiceUpsertWithoutFavoritesInput? upsert;
  final ServiceWhereUniqueInput? connect;
  final bool? disconnect;
  final bool? delete;
  final ServiceUpdateWithoutFavoritesInput? update;
  ...
  ServiceUpdateOneWithoutFavoritesInput(
      {this.create,
  ...
  static ServiceUpdateOneWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUpdateOneWithoutFavoritesInput(
      ...
      upsert: json['upsert'] != null
          ? ServiceUpsertWithoutFavoritesInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? ServiceUpdateWithoutFavoritesInput.fromJson(json['update'])
          : null,
    );
  }
