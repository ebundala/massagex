import 'order_create_without_owner_input.dart';
import 'order_create_or_connect_without_owner_input.dart';
import 'order_upsert_with_where_unique_without_owner_input.dart';
import 'order_create_many_owner_input_envelope.dart';
import 'order_where_unique_input.dart';
import 'order_update_with_where_unique_without_owner_input.dart';
import 'order_update_many_with_where_without_owner_input.dart';
import 'order_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class OrderUncheckedUpdateManyWithoutOwnerInput extends Equatable {
  final List<OrderCreateWithoutOwnerInput>? create;
  final List<OrderCreateOrConnectWithoutOwnerInput>? connectOrCreate;
  final List<OrderUpsertWithWhereUniqueWithoutOwnerInput>? upsert;
  final OrderCreateManyOwnerInputEnvelope? createMany;
  ...
  final List<OrderUpdateWithWhereUniqueWithoutOwnerInput>? update;
  final List<OrderUpdateManyWithWhereWithoutOwnerInput>? updateMany;
  ...
  OrderUncheckedUpdateManyWithoutOwnerInput(
      {this.create,
  ...
  static OrderUncheckedUpdateManyWithoutOwnerInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUncheckedUpdateManyWithoutOwnerInput(
      create: json['create'] != null
          ? List.generate(
              json['create'].length,
              (index) =>
                  OrderCreateWithoutOwnerInput.fromJson(json['create'][index]))
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? List.generate(
              json['connectOrCreate'].length,
              (index) => OrderCreateOrConnectWithoutOwnerInput.fromJson(
                  json['connectOrCreate'][index]))
          : null,
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) => OrderUpsertWithWhereUniqueWithoutOwnerInput.fromJson(
                  json['upsert'][index]))
          : null,
      createMany: json['createMany'] != null
          ? OrderCreateManyOwnerInputEnvelope.fromJson(json['createMany'])
          : null,
      ...
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) => OrderUpdateWithWhereUniqueWithoutOwnerInput.fromJson(
                  json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              json['updateMany'].length,
              (index) => OrderUpdateManyWithWhereWithoutOwnerInput.fromJson(
  ...
  OrderUncheckedUpdateManyWithoutOwnerInput copyWith(
      {List<OrderCreateWithoutOwnerInput>? create,
      List<OrderCreateOrConnectWithoutOwnerInput>? connectOrCreate,
      List<OrderUpsertWithWhereUniqueWithoutOwnerInput>? upsert,
      OrderCreateManyOwnerInputEnvelope? createMany,
      ...
      List<OrderUpdateWithWhereUniqueWithoutOwnerInput>? update,
      List<OrderUpdateManyWithWhereWithoutOwnerInput>? updateMany,
