...
class CasbinRuleUpdateInput extends Equatable {
  ...
  static CasbinRuleUpdateInput fromJson(Map<dynamic, dynamic> json) {
    return CasbinRuleUpdateInput(
  ...
  CasbinRuleUpdateInput copyWith(
