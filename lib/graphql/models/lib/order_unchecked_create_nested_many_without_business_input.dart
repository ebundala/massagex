...
class OrderUncheckedCreateNestedManyWithoutBusinessInput extends Equatable {
  ...
  OrderUncheckedCreateNestedManyWithoutBusinessInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static OrderUncheckedCreateNestedManyWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUncheckedCreateNestedManyWithoutBusinessInput(
  ...
  OrderUncheckedCreateNestedManyWithoutBusinessInput copyWith(
