...
class FavoriteUpdateWithoutUserInput extends Equatable {
  ...
  static FavoriteUpdateWithoutUserInput fromJson(Map<dynamic, dynamic> json) {
    return FavoriteUpdateWithoutUserInput(
      id: json['id'] != null
  ...
  FavoriteUpdateWithoutUserInput copyWith(
