...
class SelcomPaymentMinAggregateOutputType extends Equatable {
  final String? id;
  ...
  SelcomPaymentMinAggregateOutputType(
      {this.id,
      this.transId,
      this.amount,
      this.msisdn,
  ...
  static SelcomPaymentMinAggregateOutputType fromJson(
      Map<dynamic, dynamic> json) {
    return SelcomPaymentMinAggregateOutputType(
      id: json['id'],
  ...
  SelcomPaymentMinAggregateOutputType copyWith(
      {String? id,
      String? transId,
      int? amount,
      String? msisdn,
...
extension SelcomPaymentMinAggregateOutputTypeExt
    on SelcomPaymentMinAggregateOutputType {
...
class SelcomPaymentMinAggregateOutputTypeController
    extends ValueNotifier<SelcomPaymentMinAggregateOutputType> {
  ...
  final SelcomPaymentMinAggregateOutputType initialValue;
  final SelectionSetNode selectionSet;
  final Map<String, SelectionNodeData> selections = {};
  SelcomPaymentMinAggregateOutputTypeController({
