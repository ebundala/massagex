...
class NestedDateTimeFilter extends Equatable {
  ...
  static NestedDateTimeFilter fromJson(Map<dynamic, dynamic> json) {
    return NestedDateTimeFilter(
      ...
      not: json['not'] != null
          ? NestedDateTimeFilter.fromJson(json['not'])
          : null,
    );
  }
