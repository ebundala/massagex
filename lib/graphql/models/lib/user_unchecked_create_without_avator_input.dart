...
class UserUncheckedCreateWithoutAvatorInput extends Equatable {
  final String? id;
  final String email;
  ...
  UserUncheckedCreateWithoutAvatorInput(
      {this.id,
      required this.email,
  ...
  static UserUncheckedCreateWithoutAvatorInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUncheckedCreateWithoutAvatorInput(
      id: json['id'],
      email: json['email'],
  ...
  UserUncheckedCreateWithoutAvatorInput copyWith(
      {String? id,
      String? email,
      String? displayName,
      String? phoneNumber,
