...
class CasbinRuleScalarWhereWithAggregatesInput extends Equatable {
  final List<CasbinRuleScalarWhereWithAggregatesInput>? AND;
  final List<CasbinRuleScalarWhereWithAggregatesInput>? OR;
  final List<CasbinRuleScalarWhereWithAggregatesInput>? NOT;
  final IntWithAggregatesFilter? id;
  final StringWithAggregatesFilter? ptype;
  final StringNullableWithAggregatesFilter? v0;
  final StringNullableWithAggregatesFilter? v1;
  final StringNullableWithAggregatesFilter? v2;
  final StringNullableWithAggregatesFilter? v3;
  final StringNullableWithAggregatesFilter? v4;
  final StringNullableWithAggregatesFilter? v5;
  ...
  CasbinRuleScalarWhereWithAggregatesInput(
      {this.AND,
      this.OR,
      this.NOT,
      this.id,
  ...
  static CasbinRuleScalarWhereWithAggregatesInput fromJson(
      Map<dynamic, dynamic> json) {
    return CasbinRuleScalarWhereWithAggregatesInput(
      AND: json['AND'] != null
          ? List.generate(
              json['AND'].length,
              (index) => CasbinRuleScalarWhereWithAggregatesInput.fromJson(
                  json['AND'][index]))
          : null,
      OR: json['OR'] != null
          ? List.generate(
      ...
      NOT: json['NOT'] != null
          ...
          : null,
      id: json['id'] != null
          ? IntWithAggregatesFilter.fromJson(json['id'])
          : null,
      ptype: json['ptype'] != null
          ? StringWithAggregatesFilter.fromJson(json['ptype'])
          : null,
      v0: json['v0'] != null
          ? StringNullableWithAggregatesFilter.fromJson(json['v0'])
          : null,
      v1: json['v1'] != null
          ? StringNullableWithAggregatesFilter.fromJson(json['v1'])
          : null,
      v2: json['v2'] != null
          ? StringNullableWithAggregatesFilter.fromJson(json['v2'])
          : null,
      v3: json['v3'] != null
          ? StringNullableWithAggregatesFilter.fromJson(json['v3'])
          : null,
      v4: json['v4'] != null
          ? StringNullableWithAggregatesFilter.fromJson(json['v4'])
          : null,
      v5: json['v5'] != null
          ? StringNullableWithAggregatesFilter.fromJson(json['v5'])
          : null,
  ...
  CasbinRuleScalarWhereWithAggregatesInput copyWith(
      {List<CasbinRuleScalarWhereWithAggregatesInput>? AND,
      List<CasbinRuleScalarWhereWithAggregatesInput>? OR,
      List<CasbinRuleScalarWhereWithAggregatesInput>? NOT,
      IntWithAggregatesFilter? id,
      StringWithAggregatesFilter? ptype,
      StringNullableWithAggregatesFilter? v0,
      StringNullableWithAggregatesFilter? v1,
      StringNullableWithAggregatesFilter? v2,
      StringNullableWithAggregatesFilter? v3,
      StringNullableWithAggregatesFilter? v4,
      StringNullableWithAggregatesFilter? v5,
