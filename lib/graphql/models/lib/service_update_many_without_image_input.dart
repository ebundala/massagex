...
class ServiceUpdateManyWithoutImageInput extends Equatable {
  ...
  ServiceUpdateManyWithoutImageInput(
      {this.create,
  ...
  static ServiceUpdateManyWithoutImageInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUpdateManyWithoutImageInput(
  ...
  ServiceUpdateManyWithoutImageInput copyWith(
