...
class AttachmentUncheckedCreateWithoutServicesInput extends Equatable {
  ...
  AttachmentUncheckedCreateWithoutServicesInput(
      {required this.path,
      this.id,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUncheckedCreateWithoutServicesInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedCreateWithoutServicesInput(
      path: json['path'],
      id: json['id'],
  ...
  AttachmentUncheckedCreateWithoutServicesInput copyWith(
      {MultipartFile? path,
      String? id,
      String? filename,
      String? mimetype,
