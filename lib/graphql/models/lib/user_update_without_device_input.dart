...
class UserUpdateWithoutDeviceInput extends Equatable {
  ...
  static UserUpdateWithoutDeviceInput fromJson(Map<dynamic, dynamic> json) {
    return UserUpdateWithoutDeviceInput(
      id: json['id'] != null
  ...
  UserUpdateWithoutDeviceInput copyWith(
