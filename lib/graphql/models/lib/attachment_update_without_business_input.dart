...
class AttachmentUpdateWithoutBusinessInput extends Equatable {
  ...
  AttachmentUpdateWithoutBusinessInput(
      {this.id,
      this.path,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUpdateWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUpdateWithoutBusinessInput(
      id: json['id'] != null
  ...
  AttachmentUpdateWithoutBusinessInput copyWith(
