...
class ServiceUncheckedCreateWithoutFavoritesInput extends Equatable {
  final String? id;
  final String name;
  ...
  ServiceUncheckedCreateWithoutFavoritesInput(
      {this.id,
      required this.name,
      this.description,
      required this.price,
  ...
  static ServiceUncheckedCreateWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUncheckedCreateWithoutFavoritesInput(
      id: json['id'],
      name: json['name'],
  ...
  ServiceUncheckedCreateWithoutFavoritesInput copyWith(
      {String? id,
      String? name,
      String? description,
      double? price,
