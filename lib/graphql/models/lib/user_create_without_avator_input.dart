...
class UserCreateWithoutAvatorInput extends Equatable {
  final String? id;
  final String? email;
  ...
  static UserCreateWithoutAvatorInput fromJson(Map<dynamic, dynamic> json) {
    return UserCreateWithoutAvatorInput(
      id: json['id'],
      email: json['email'],
  ...
  UserCreateWithoutAvatorInput copyWith(
      {String? id,
      String? email,
      String? displayName,
      String? phoneNumber,
