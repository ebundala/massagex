...
class PaymentMethodUncheckedUpdateWithoutTransactionsInput extends Equatable {
  ...
  PaymentMethodUncheckedUpdateWithoutTransactionsInput(
      {this.id,
      this.name,
      this.description,
      this.attachmentId,
  ...
  static PaymentMethodUncheckedUpdateWithoutTransactionsInput fromJson(
      Map<dynamic, dynamic> json) {
    return PaymentMethodUncheckedUpdateWithoutTransactionsInput(
      id: json['id'] != null
  ...
  PaymentMethodUncheckedUpdateWithoutTransactionsInput copyWith(
