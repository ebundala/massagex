...
class AbuseReportCreateWithoutOrderInput extends Equatable {
  final String? id;
  final int? number;
  final String? report;
  ...
  AbuseReportCreateWithoutOrderInput(
      {this.id,
      this.number,
      this.report,
      this.recordStatus,
  ...
  static AbuseReportCreateWithoutOrderInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportCreateWithoutOrderInput(
      id: json['id'],
      number: json['number'],
      report: json['report'],
  ...
  AbuseReportCreateWithoutOrderInput copyWith(
      {String? id,
      int? number,
      String? report,
