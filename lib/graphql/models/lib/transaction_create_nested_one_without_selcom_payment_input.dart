...
class TransactionCreateNestedOneWithoutSelcomPaymentInput extends Equatable {
  ...
  TransactionCreateNestedOneWithoutSelcomPaymentInput(
      {this.create, this.connectOrCreate, this.connect});

  static TransactionCreateNestedOneWithoutSelcomPaymentInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionCreateNestedOneWithoutSelcomPaymentInput(
  ...
  TransactionCreateNestedOneWithoutSelcomPaymentInput copyWith(
