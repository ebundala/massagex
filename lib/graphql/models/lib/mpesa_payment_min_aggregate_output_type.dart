...
class MpesaPaymentMinAggregateOutputType extends Equatable {
  final String? id;
  ...
  MpesaPaymentMinAggregateOutputType(
      {this.id,
      this.input$Amount,
      this.input$Country,
      this.input$Currency,
  ...
  static MpesaPaymentMinAggregateOutputType fromJson(
      Map<dynamic, dynamic> json) {
    return MpesaPaymentMinAggregateOutputType(
      id: json['id'],
  ...
  MpesaPaymentMinAggregateOutputType copyWith(
      {String? id,
      String? input$Amount,
...
extension MpesaPaymentMinAggregateOutputTypeExt
    on MpesaPaymentMinAggregateOutputType {
...
class MpesaPaymentMinAggregateOutputTypeController
    extends ValueNotifier<MpesaPaymentMinAggregateOutputType> {
  ...
  final MpesaPaymentMinAggregateOutputType initialValue;
  final SelectionSetNode selectionSet;
  final Map<String, SelectionNodeData> selections = {};
  MpesaPaymentMinAggregateOutputTypeController({
