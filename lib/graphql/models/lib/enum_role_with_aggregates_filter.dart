import 'role.dart';
import 'nested_enum_role_with_aggregates_filter.dart';
import 'nested_int_filter.dart';
import 'nested_enum_role_filter.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class EnumRoleWithAggregatesFilter extends Equatable {
  final Role? equals;
  final List<Role>? in$;
  final List<Role>? notIn;
  final NestedEnumRoleWithAggregatesFilter? not;
  ...
  static EnumRoleWithAggregatesFilter fromJson(Map<dynamic, dynamic> json) {
    return EnumRoleWithAggregatesFilter(
      equals: json['equals'] != null ? RoleExt.fromJson(json['equals']) : null,
      in$: json['in'] != null
          ? List.generate(
              json['in'].length, (index) => RoleExt.fromJson(json['in'][index]))
          : null,
      notIn: json['notIn'] != null
          ? List.generate(json['notIn'].length,
              (index) => RoleExt.fromJson(json['notIn'][index]))
          : null,
      not: json['not'] != null
          ? NestedEnumRoleWithAggregatesFilter.fromJson(json['not'])
          : null,
      ...
      count: json['count'] != null
          ...
          : null,
      $min: json['_min'] != null
          ? NestedEnumRoleFilter.fromJson(json['_min'])
          : null,
      min: json['min'] != null
          ? NestedEnumRoleFilter.fromJson(json['min'])
          : null,
      $max: json['_max'] != null
          ? NestedEnumRoleFilter.fromJson(json['_max'])
          : null,
      max: json['max'] != null
          ? NestedEnumRoleFilter.fromJson(json['max'])
          : null,
    );
  }
  ...
  EnumRoleWithAggregatesFilter copyWith(
      {Role? equals,
      List<Role>? in$,
      List<Role>? notIn,
      NestedEnumRoleWithAggregatesFilter? not,
      NestedIntFilter? $count,
      NestedIntFilter? count,
      NestedEnumRoleFilter? $min,
      NestedEnumRoleFilter? min,
      NestedEnumRoleFilter? $max,
      NestedEnumRoleFilter? max}) {
    return EnumRoleWithAggregatesFilter(
