...
class DeviceUncheckedUpdateManyInput extends Equatable {
  ...
  static DeviceUncheckedUpdateManyInput fromJson(Map<dynamic, dynamic> json) {
    return DeviceUncheckedUpdateManyInput(
      id: json['id'] != null
  ...
  DeviceUncheckedUpdateManyInput copyWith(
