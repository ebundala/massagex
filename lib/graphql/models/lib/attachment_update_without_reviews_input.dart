...
class AttachmentUpdateWithoutReviewsInput extends Equatable {
  ...
  AttachmentUpdateWithoutReviewsInput(
      {this.id,
      this.path,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUpdateWithoutReviewsInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUpdateWithoutReviewsInput(
      id: json['id'] != null
  ...
  AttachmentUpdateWithoutReviewsInput copyWith(
