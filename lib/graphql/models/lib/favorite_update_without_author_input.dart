...
class FavoriteUpdateWithoutAuthorInput extends Equatable {
  ...
  FavoriteUpdateWithoutAuthorInput(
      {this.id,
      this.favId,
      this.recordStatus,
      this.createdAt,
  ...
  static FavoriteUpdateWithoutAuthorInput fromJson(Map<dynamic, dynamic> json) {
    return FavoriteUpdateWithoutAuthorInput(
      id: json['id'] != null
  ...
  FavoriteUpdateWithoutAuthorInput copyWith(
