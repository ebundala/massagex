...
import 'mpesa_payment_upsert_without_transaction_input.dart';
import 'mpesa_payment_where_unique_input.dart';
import 'mpesa_payment_update_without_transaction_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class MpesaPaymentUpdateOneWithoutTransactionInput extends Equatable {
  ...
  final MpesaPaymentUpsertWithoutTransactionInput? upsert;
  final MpesaPaymentWhereUniqueInput? connect;
  final bool? disconnect;
  final bool? delete;
  final MpesaPaymentUpdateWithoutTransactionInput? update;
  ...
  MpesaPaymentUpdateOneWithoutTransactionInput(
      {this.create,
  ...
  static MpesaPaymentUpdateOneWithoutTransactionInput fromJson(
      Map<dynamic, dynamic> json) {
    return MpesaPaymentUpdateOneWithoutTransactionInput(
      ...
      upsert: json['upsert'] != null
          ? MpesaPaymentUpsertWithoutTransactionInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? MpesaPaymentUpdateWithoutTransactionInput.fromJson(json['update'])
          : null,
    );
  }
