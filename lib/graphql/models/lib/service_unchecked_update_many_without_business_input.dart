...
import 'service_create_or_connect_without_business_input.dart';
import 'service_upsert_with_where_unique_without_business_input.dart';
import 'service_create_many_business_input_envelope.dart';
import 'service_where_unique_input.dart';
import 'service_update_with_where_unique_without_business_input.dart';
import 'service_update_many_with_where_without_business_input.dart';
import 'service_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class ServiceUncheckedUpdateManyWithoutBusinessInput extends Equatable {
  final List<ServiceCreateWithoutBusinessInput>? create;
  final List<ServiceCreateOrConnectWithoutBusinessInput>? connectOrCreate;
  final List<ServiceUpsertWithWhereUniqueWithoutBusinessInput>? upsert;
  final ServiceCreateManyBusinessInputEnvelope? createMany;
  ...
  final List<ServiceUpdateWithWhereUniqueWithoutBusinessInput>? update;
  final List<ServiceUpdateManyWithWhereWithoutBusinessInput>? updateMany;
  ...
  ServiceUncheckedUpdateManyWithoutBusinessInput(
      {this.create,
  ...
  static ServiceUncheckedUpdateManyWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUncheckedUpdateManyWithoutBusinessInput(
      create: json['create'] != null
          ? List.generate(
              json['create'].length,
              (index) => ServiceCreateWithoutBusinessInput.fromJson(
                  json['create'][index]))
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? List.generate(
              json['connectOrCreate'].length,
              (index) => ServiceCreateOrConnectWithoutBusinessInput.fromJson(
      ...
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) =>
                  ServiceUpsertWithWhereUniqueWithoutBusinessInput.fromJson(
                      json['upsert'][index]))
          : null,
      createMany: json['createMany'] != null
          ? ServiceCreateManyBusinessInputEnvelope.fromJson(json['createMany'])
          : null,
      ...
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) =>
                  ServiceUpdateWithWhereUniqueWithoutBusinessInput.fromJson(
                      json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              ...
              (index) =>
                  ServiceUpdateManyWithWhereWithoutBusinessInput.fromJson(
  ...
  ServiceUncheckedUpdateManyWithoutBusinessInput copyWith(
      {List<ServiceCreateWithoutBusinessInput>? create,
      List<ServiceCreateOrConnectWithoutBusinessInput>? connectOrCreate,
      List<ServiceUpsertWithWhereUniqueWithoutBusinessInput>? upsert,
      ServiceCreateManyBusinessInputEnvelope? createMany,
      ...
      List<ServiceUpdateWithWhereUniqueWithoutBusinessInput>? update,
      List<ServiceUpdateManyWithWhereWithoutBusinessInput>? updateMany,
