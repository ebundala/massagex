...
import 'review_update_many_without_reviewee_input.dart';
...
class UserUpdateWithoutBusinessProfileInput extends Equatable {
  ...
  final ReviewUpdateManyWithoutRevieweeInput? reviews;
  ...
  UserUpdateWithoutBusinessProfileInput(
      {this.id,
      this.email,
      this.displayName,
      this.phoneNumber,
  ...
  static UserUpdateWithoutBusinessProfileInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUpdateWithoutBusinessProfileInput(
      id: json['id'] != null
      ...
      reviews: json['reviews'] != null
          ? ReviewUpdateManyWithoutRevieweeInput.fromJson(json['reviews'])
          : null,
  ...
  UserUpdateWithoutBusinessProfileInput copyWith(
      ...
      ReviewUpdateManyWithoutRevieweeInput? reviews,
