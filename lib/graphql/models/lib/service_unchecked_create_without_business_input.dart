...
class ServiceUncheckedCreateWithoutBusinessInput extends Equatable {
  final String? id;
  final String name;
  ...
  ServiceUncheckedCreateWithoutBusinessInput(
      {this.id,
      required this.name,
      this.description,
      required this.price,
  ...
  static ServiceUncheckedCreateWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUncheckedCreateWithoutBusinessInput(
      id: json['id'],
      name: json['name'],
  ...
  ServiceUncheckedCreateWithoutBusinessInput copyWith(
      {String? id,
      String? name,
      String? description,
      double? price,
