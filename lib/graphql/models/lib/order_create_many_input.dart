...
class OrderCreateManyInput extends Equatable {
  final String? id;
  final int quantity;
  ...
  static OrderCreateManyInput fromJson(Map<dynamic, dynamic> json) {
    return OrderCreateManyInput(
      id: json['id'],
