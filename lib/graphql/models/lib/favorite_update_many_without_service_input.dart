...
class FavoriteUpdateManyWithoutServiceInput extends Equatable {
  ...
  FavoriteUpdateManyWithoutServiceInput(
      {this.create,
  ...
  static FavoriteUpdateManyWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUpdateManyWithoutServiceInput(
  ...
  FavoriteUpdateManyWithoutServiceInput copyWith(
