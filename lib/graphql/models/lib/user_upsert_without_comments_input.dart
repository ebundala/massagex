...
class UserUpsertWithoutCommentsInput extends Equatable {
  ...
  UserUpsertWithoutCommentsInput({required this.update, required this.create});

  static UserUpsertWithoutCommentsInput fromJson(Map<dynamic, dynamic> json) {
    return UserUpsertWithoutCommentsInput(
      update: UserUpdateWithoutCommentsInput.fromJson(json['update']),
  ...
  UserUpsertWithoutCommentsInput copyWith(
