...
class UserCreateNestedOneWithoutOrderedInput extends Equatable {
  ...
  UserCreateNestedOneWithoutOrderedInput(
      {this.create, this.connectOrCreate, this.connect});

  static UserCreateNestedOneWithoutOrderedInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserCreateNestedOneWithoutOrderedInput(
  ...
  UserCreateNestedOneWithoutOrderedInput copyWith(
