...
class UserUncheckedCreateWithoutFavoritedInput extends Equatable {
  final String? id;
  final String? email;
  ...
  UserUncheckedCreateWithoutFavoritedInput(
      {this.id,
      this.email,
      this.displayName,
      this.phoneNumber,
  ...
  static UserUncheckedCreateWithoutFavoritedInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUncheckedCreateWithoutFavoritedInput(
      id: json['id'],
      email: json['email'],
  ...
  UserUncheckedCreateWithoutFavoritedInput copyWith(
      {String? id,
      String? email,
      String? displayName,
      String? phoneNumber,
