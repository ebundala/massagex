...
class AbuseReportUpdateManyWithWhereWithoutServiceInput extends Equatable {
  ...
  AbuseReportUpdateManyWithWhereWithoutServiceInput(
      {required this.where, required this.data});

  static AbuseReportUpdateManyWithWhereWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpdateManyWithWhereWithoutServiceInput(
  ...
  AbuseReportUpdateManyWithWhereWithoutServiceInput copyWith(
