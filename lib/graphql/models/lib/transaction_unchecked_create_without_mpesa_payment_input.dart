...
class TransactionUncheckedCreateWithoutMpesaPaymentInput extends Equatable {
  final String? id;
  ...
  TransactionUncheckedCreateWithoutMpesaPaymentInput(
      {this.id,
  ...
  static TransactionUncheckedCreateWithoutMpesaPaymentInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUncheckedCreateWithoutMpesaPaymentInput(
      id: json['id'],
  ...
  TransactionUncheckedCreateWithoutMpesaPaymentInput copyWith(
      {String? id,
