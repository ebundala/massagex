...
import 'service_unchecked_update_many_without_image_input.dart';
...
class AttachmentUncheckedUpdateWithoutPaymentMethodsInput extends Equatable {
  ...
  final ServiceUncheckedUpdateManyWithoutImageInput? services;
  ...
  AttachmentUncheckedUpdateWithoutPaymentMethodsInput(
      {this.id,
      this.path,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUncheckedUpdateWithoutPaymentMethodsInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedUpdateWithoutPaymentMethodsInput(
      id: json['id'] != null
      ...
      services: json['services'] != null
          ? ServiceUncheckedUpdateManyWithoutImageInput.fromJson(
              json['services'])
          : null,
  ...
  AttachmentUncheckedUpdateWithoutPaymentMethodsInput copyWith(
      ...
      ServiceUncheckedUpdateManyWithoutImageInput? services,
