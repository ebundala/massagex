...
import 'category_unchecked_create_nested_many_without_picture_input.dart';

import "package:http/http.dart" show MultipartFile;
import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class AttachmentUncheckedCreateWithoutPaymentMethodsInput extends Equatable {
  ...
  final CategoryUncheckedCreateNestedManyWithoutPictureInput? categories;
  ...
  AttachmentUncheckedCreateWithoutPaymentMethodsInput(
      {required this.path,
      this.id,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUncheckedCreateWithoutPaymentMethodsInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedCreateWithoutPaymentMethodsInput(
      path: json['path'],
      id: json['id'],
      ...
      categories: json['categories'] != null
          ? CategoryUncheckedCreateNestedManyWithoutPictureInput.fromJson(
              json['categories'])
          : null,
    );
  }
  ...
  AttachmentUncheckedCreateWithoutPaymentMethodsInput copyWith(
      {MultipartFile? path,
      String? id,
      String? filename,
      String? mimetype,
      ...
      CategoryUncheckedCreateNestedManyWithoutPictureInput? categories}) {
    return AttachmentUncheckedCreateWithoutPaymentMethodsInput(
        path: path ?? this.path,
        id: id ?? this.id,
