...
class UserUncheckedUpdateWithoutReviewedInput extends Equatable {
  ...
  UserUncheckedUpdateWithoutReviewedInput(
      {this.id,
      this.email,
      this.displayName,
      this.phoneNumber,
  ...
  static UserUncheckedUpdateWithoutReviewedInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUncheckedUpdateWithoutReviewedInput(
      id: json['id'] != null
  ...
  UserUncheckedUpdateWithoutReviewedInput copyWith(
