...
class BusinessUncheckedUpdateWithoutFavoritesInput extends Equatable {
  ...
  BusinessUncheckedUpdateWithoutFavoritesInput(
      {this.id,
      this.ownerId,
      this.mode,
      this.coverId,
  ...
  static BusinessUncheckedUpdateWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUncheckedUpdateWithoutFavoritesInput(
      id: json['id'] != null
  ...
  BusinessUncheckedUpdateWithoutFavoritesInput copyWith(
