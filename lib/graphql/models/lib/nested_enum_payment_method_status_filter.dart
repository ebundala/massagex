...
class NestedEnumPaymentMethodStatusFilter extends Equatable {
  ...
  NestedEnumPaymentMethodStatusFilter(
      {this.equals, this.in$, this.notIn, this.not});

  static NestedEnumPaymentMethodStatusFilter fromJson(
      Map<dynamic, dynamic> json) {
    return NestedEnumPaymentMethodStatusFilter(
  ...
  NestedEnumPaymentMethodStatusFilter copyWith(
