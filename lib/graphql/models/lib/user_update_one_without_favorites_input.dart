...
import 'user_create_or_connect_without_favorites_input.dart';
import 'user_upsert_without_favorites_input.dart';
...
class UserUpdateOneWithoutFavoritesInput extends Equatable {
  final UserCreateWithoutFavoritesInput? create;
  final UserCreateOrConnectWithoutFavoritesInput? connectOrCreate;
  final UserUpsertWithoutFavoritesInput? upsert;
  ...
  UserUpdateOneWithoutFavoritesInput(
      {this.create,
  ...
  static UserUpdateOneWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUpdateOneWithoutFavoritesInput(
      create: json['create'] != null
          ? UserCreateWithoutFavoritesInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? UserCreateOrConnectWithoutFavoritesInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? UserUpsertWithoutFavoritesInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? UserUpdateWithoutFavoritesInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  UserUpdateOneWithoutFavoritesInput copyWith(
      {UserCreateWithoutFavoritesInput? create,
      UserCreateOrConnectWithoutFavoritesInput? connectOrCreate,
      UserUpsertWithoutFavoritesInput? upsert,
