...
class SelcomPaymentUpsertWithoutTransactionInput extends Equatable {
  ...
  SelcomPaymentUpsertWithoutTransactionInput(
      {required this.update, required this.create});

  static SelcomPaymentUpsertWithoutTransactionInput fromJson(
      Map<dynamic, dynamic> json) {
    return SelcomPaymentUpsertWithoutTransactionInput(
      update:
  ...
  SelcomPaymentUpsertWithoutTransactionInput copyWith(
