import 'review_create_many_author_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class ReviewCreateManyAuthorInputEnvelope extends Equatable {
  final List<ReviewCreateManyAuthorInput>? data;
  ...
  ReviewCreateManyAuthorInputEnvelope({this.data, this.skipDuplicates});

  static ReviewCreateManyAuthorInputEnvelope fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewCreateManyAuthorInputEnvelope(
      data: json['data'] != null
          ? List.generate(
              json['data'].length,
              (index) =>
                  ReviewCreateManyAuthorInput.fromJson(json['data'][index]))
          : null,
  ...
  ReviewCreateManyAuthorInputEnvelope copyWith(
      {List<ReviewCreateManyAuthorInput>? data, bool? skipDuplicates}) {
    return ReviewCreateManyAuthorInputEnvelope(
        data: data ?? this.data,
