...
class AttachmentUpdateManyWithoutBusinessInput extends Equatable {
  ...
  AttachmentUpdateManyWithoutBusinessInput(
      {this.create,
  ...
  static AttachmentUpdateManyWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUpdateManyWithoutBusinessInput(
  ...
  AttachmentUpdateManyWithoutBusinessInput copyWith(
