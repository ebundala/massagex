...
import 'nested_enum_transaction_status_with_aggregates_filter.dart';
import 'nested_int_filter.dart';
import 'nested_enum_transaction_status_filter.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class EnumTransactionStatusWithAggregatesFilter extends Equatable {
  final TransactionStatus? equals;
  final List<TransactionStatus>? in$;
  final List<TransactionStatus>? notIn;
  final NestedEnumTransactionStatusWithAggregatesFilter? not;
  final NestedIntFilter? $count;
  final NestedIntFilter? count;
  final NestedEnumTransactionStatusFilter? $min;
  final NestedEnumTransactionStatusFilter? min;
  final NestedEnumTransactionStatusFilter? $max;
  final NestedEnumTransactionStatusFilter? max;
  ...
  EnumTransactionStatusWithAggregatesFilter(
      {this.equals,
      this.in$,
      this.notIn,
      this.not,
  ...
  static EnumTransactionStatusWithAggregatesFilter fromJson(
      Map<dynamic, dynamic> json) {
    return EnumTransactionStatusWithAggregatesFilter(
      ...
      notIn: json['notIn'] != null
          ...
          : null,
      not: json['not'] != null
          ? NestedEnumTransactionStatusWithAggregatesFilter.fromJson(
              json['not'])
          : null,
      ...
      count: json['count'] != null
          ...
          : null,
      $min: json['_min'] != null
          ? NestedEnumTransactionStatusFilter.fromJson(json['_min'])
          : null,
      min: json['min'] != null
          ? NestedEnumTransactionStatusFilter.fromJson(json['min'])
          : null,
      $max: json['_max'] != null
          ? NestedEnumTransactionStatusFilter.fromJson(json['_max'])
          : null,
      max: json['max'] != null
          ? NestedEnumTransactionStatusFilter.fromJson(json['max'])
          : null,
    );
  }
  ...
  EnumTransactionStatusWithAggregatesFilter copyWith(
      {TransactionStatus? equals,
      List<TransactionStatus>? in$,
      List<TransactionStatus>? notIn,
      NestedEnumTransactionStatusWithAggregatesFilter? not,
      NestedIntFilter? $count,
      NestedIntFilter? count,
      NestedEnumTransactionStatusFilter? $min,
      NestedEnumTransactionStatusFilter? min,
      NestedEnumTransactionStatusFilter? $max,
      NestedEnumTransactionStatusFilter? max}) {
    return EnumTransactionStatusWithAggregatesFilter(
