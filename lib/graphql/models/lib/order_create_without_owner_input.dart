...
class OrderCreateWithoutOwnerInput extends Equatable {
  final String? id;
  final int quantity;
  ...
  static OrderCreateWithoutOwnerInput fromJson(Map<dynamic, dynamic> json) {
    return OrderCreateWithoutOwnerInput(
      id: json['id'],
  ...
  OrderCreateWithoutOwnerInput copyWith(
      {String? id,
      int? quantity,
