...
class BusinessCreateWithoutLocationInput extends Equatable {
  final String? id;
  ...
  BusinessCreateWithoutLocationInput(
      {this.id,
      this.mode,
      required this.about,
  ...
  static BusinessCreateWithoutLocationInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessCreateWithoutLocationInput(
      id: json['id'],
      mode:
  ...
  BusinessCreateWithoutLocationInput copyWith(
      {String? id,
      BusinessMode? mode,
      String? about,
      String? businessName,
