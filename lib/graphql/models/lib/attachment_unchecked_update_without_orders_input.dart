...
class AttachmentUncheckedUpdateWithoutOrdersInput extends Equatable {
  ...
  AttachmentUncheckedUpdateWithoutOrdersInput(
      {this.id,
      this.path,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUncheckedUpdateWithoutOrdersInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedUpdateWithoutOrdersInput(
      id: json['id'] != null
  ...
  AttachmentUncheckedUpdateWithoutOrdersInput copyWith(
