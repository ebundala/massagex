...
class AbuseReportUpdateWithWhereUniqueWithoutServiceInput extends Equatable {
  final AbuseReportWhereUniqueInput where;
  final AbuseReportUpdateWithoutServiceInput data;
  ...
  AbuseReportUpdateWithWhereUniqueWithoutServiceInput(
      {required this.where, required this.data});

  static AbuseReportUpdateWithWhereUniqueWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpdateWithWhereUniqueWithoutServiceInput(
      where: AbuseReportWhereUniqueInput.fromJson(json['where']),
      data: AbuseReportUpdateWithoutServiceInput.fromJson(json['data']),
    );
  }
  ...
  AbuseReportUpdateWithWhereUniqueWithoutServiceInput copyWith(
      {AbuseReportWhereUniqueInput? where,
      AbuseReportUpdateWithoutServiceInput? data}) {
    return AbuseReportUpdateWithWhereUniqueWithoutServiceInput(
