...
class FavoriteUncheckedUpdateInput extends Equatable {
  ...
  static FavoriteUncheckedUpdateInput fromJson(Map<dynamic, dynamic> json) {
    return FavoriteUncheckedUpdateInput(
      id: json['id'] != null
  ...
  FavoriteUncheckedUpdateInput copyWith(
