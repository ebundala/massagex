...
class ReviewUncheckedUpdateWithoutFavoritesInput extends Equatable {
  ...
  ReviewUncheckedUpdateWithoutFavoritesInput(
      {this.id,
      this.authorId,
      this.revieweeId,
      this.value,
  ...
  static ReviewUncheckedUpdateWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewUncheckedUpdateWithoutFavoritesInput(
      id: json['id'] != null
  ...
  ReviewUncheckedUpdateWithoutFavoritesInput copyWith(
