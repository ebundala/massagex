...
class CommentCreateOrConnectWithoutCommentsInput extends Equatable {
  ...
  static CommentCreateOrConnectWithoutCommentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentCreateOrConnectWithoutCommentsInput(
  ...
  CommentCreateOrConnectWithoutCommentsInput copyWith(
