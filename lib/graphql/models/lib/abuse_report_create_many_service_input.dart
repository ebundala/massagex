...
class AbuseReportCreateManyServiceInput extends Equatable {
  final String? id;
  final int? number;
  final String? report;
  ...
  AbuseReportCreateManyServiceInput(
      {this.id,
      this.number,
      this.report,
  ...
  static AbuseReportCreateManyServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportCreateManyServiceInput(
      id: json['id'],
      number: json['number'],
      report: json['report'],
  ...
  AbuseReportCreateManyServiceInput copyWith(
      {String? id,
      int? number,
      String? report,
      String? authorId,
