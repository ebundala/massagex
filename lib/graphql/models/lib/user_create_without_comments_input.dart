...
class UserCreateWithoutCommentsInput extends Equatable {
  final String? id;
  final String email;
  ...
  static UserCreateWithoutCommentsInput fromJson(Map<dynamic, dynamic> json) {
    return UserCreateWithoutCommentsInput(
      id: json['id'],
      email: json['email'],
  ...
  UserCreateWithoutCommentsInput copyWith(
      {String? id,
      String? email,
      String? displayName,
      String? phoneNumber,
