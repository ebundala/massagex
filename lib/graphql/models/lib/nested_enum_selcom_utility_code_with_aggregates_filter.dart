...
class NestedEnumSelcomUtilityCodeWithAggregatesFilter extends Equatable {
  ...
  NestedEnumSelcomUtilityCodeWithAggregatesFilter(
      {this.equals,
      this.in$,
      this.notIn,
      this.not,
  ...
  static NestedEnumSelcomUtilityCodeWithAggregatesFilter fromJson(
      Map<dynamic, dynamic> json) {
    return NestedEnumSelcomUtilityCodeWithAggregatesFilter(
  ...
  NestedEnumSelcomUtilityCodeWithAggregatesFilter copyWith(
