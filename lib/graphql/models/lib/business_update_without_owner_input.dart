...
class BusinessUpdateWithoutOwnerInput extends Equatable {
  ...
  static BusinessUpdateWithoutOwnerInput fromJson(Map<dynamic, dynamic> json) {
    return BusinessUpdateWithoutOwnerInput(
      id: json['id'] != null
  ...
  BusinessUpdateWithoutOwnerInput copyWith(
