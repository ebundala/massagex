...
import 'nested_enum_payment_status_with_aggregates_filter.dart';
import 'nested_int_filter.dart';
import 'nested_enum_payment_status_filter.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class EnumPaymentStatusWithAggregatesFilter extends Equatable {
  final PaymentStatus? equals;
  final List<PaymentStatus>? in$;
  final List<PaymentStatus>? notIn;
  final NestedEnumPaymentStatusWithAggregatesFilter? not;
  final NestedIntFilter? $count;
  final NestedIntFilter? count;
  final NestedEnumPaymentStatusFilter? $min;
  final NestedEnumPaymentStatusFilter? min;
  final NestedEnumPaymentStatusFilter? $max;
  final NestedEnumPaymentStatusFilter? max;
  ...
  static EnumPaymentStatusWithAggregatesFilter fromJson(
      Map<dynamic, dynamic> json) {
    return EnumPaymentStatusWithAggregatesFilter(
      ...
      notIn: json['notIn'] != null
          ...
          : null,
      not: json['not'] != null
          ? NestedEnumPaymentStatusWithAggregatesFilter.fromJson(json['not'])
          : null,
      ...
      count: json['count'] != null
          ...
          : null,
      $min: json['_min'] != null
          ? NestedEnumPaymentStatusFilter.fromJson(json['_min'])
          : null,
      min: json['min'] != null
          ? NestedEnumPaymentStatusFilter.fromJson(json['min'])
          : null,
      $max: json['_max'] != null
          ? NestedEnumPaymentStatusFilter.fromJson(json['_max'])
          : null,
      max: json['max'] != null
          ? NestedEnumPaymentStatusFilter.fromJson(json['max'])
          : null,
    );
  }
  ...
  EnumPaymentStatusWithAggregatesFilter copyWith(
      {PaymentStatus? equals,
      List<PaymentStatus>? in$,
      List<PaymentStatus>? notIn,
      NestedEnumPaymentStatusWithAggregatesFilter? not,
      NestedIntFilter? $count,
      NestedIntFilter? count,
      NestedEnumPaymentStatusFilter? $min,
      NestedEnumPaymentStatusFilter? min,
      NestedEnumPaymentStatusFilter? $max,
      NestedEnumPaymentStatusFilter? max}) {
    return EnumPaymentStatusWithAggregatesFilter(
