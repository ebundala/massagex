...
class AbuseReportCreateOrConnectWithoutBusinessInput extends Equatable {
  ...
  AbuseReportCreateOrConnectWithoutBusinessInput(
      {required this.where, required this.create});

  static AbuseReportCreateOrConnectWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportCreateOrConnectWithoutBusinessInput(
  ...
  AbuseReportCreateOrConnectWithoutBusinessInput copyWith(
