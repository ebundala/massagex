...
import 'category_create_or_connect_without_picture_input.dart';
import 'category_upsert_with_where_unique_without_picture_input.dart';
import 'category_create_many_picture_input_envelope.dart';
import 'category_where_unique_input.dart';
import 'category_update_with_where_unique_without_picture_input.dart';
import 'category_update_many_with_where_without_picture_input.dart';
import 'category_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class CategoryUncheckedUpdateManyWithoutPictureInput extends Equatable {
  final List<CategoryCreateWithoutPictureInput>? create;
  final List<CategoryCreateOrConnectWithoutPictureInput>? connectOrCreate;
  final List<CategoryUpsertWithWhereUniqueWithoutPictureInput>? upsert;
  final CategoryCreateManyPictureInputEnvelope? createMany;
  final List<CategoryWhereUniqueInput>? connect;
  final List<CategoryWhereUniqueInput>? set$;
  final List<CategoryWhereUniqueInput>? disconnect;
  final List<CategoryWhereUniqueInput>? delete;
  final List<CategoryUpdateWithWhereUniqueWithoutPictureInput>? update;
  final List<CategoryUpdateManyWithWhereWithoutPictureInput>? updateMany;
  final List<CategoryScalarWhereInput>? deleteMany;
  ...
  CategoryUncheckedUpdateManyWithoutPictureInput(
      {this.create,
  ...
  static CategoryUncheckedUpdateManyWithoutPictureInput fromJson(
      Map<dynamic, dynamic> json) {
    return CategoryUncheckedUpdateManyWithoutPictureInput(
      create: json['create'] != null
          ? List.generate(
              json['create'].length,
              (index) => CategoryCreateWithoutPictureInput.fromJson(
                  json['create'][index]))
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? List.generate(
              json['connectOrCreate'].length,
              (index) => CategoryCreateOrConnectWithoutPictureInput.fromJson(
      ...
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) =>
                  CategoryUpsertWithWhereUniqueWithoutPictureInput.fromJson(
                      json['upsert'][index]))
          : null,
      createMany: json['createMany'] != null
          ? CategoryCreateManyPictureInputEnvelope.fromJson(json['createMany'])
          : null,
      connect: json['connect'] != null
          ? List.generate(
              json['connect'].length,
              (index) =>
                  CategoryWhereUniqueInput.fromJson(json['connect'][index]))
          : null,
      set$: json['set'] != null
          ? List.generate(json['set'].length,
              (index) => CategoryWhereUniqueInput.fromJson(json['set'][index]))
          : null,
      disconnect: json['disconnect'] != null
          ? List.generate(
              json['disconnect'].length,
              (index) =>
                  CategoryWhereUniqueInput.fromJson(json['disconnect'][index]))
          : null,
      delete: json['delete'] != null
          ? List.generate(
              json['delete'].length,
              (index) =>
                  CategoryWhereUniqueInput.fromJson(json['delete'][index]))
          : null,
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) =>
                  CategoryUpdateWithWhereUniqueWithoutPictureInput.fromJson(
                      json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              ...
              (index) =>
                  CategoryUpdateManyWithWhereWithoutPictureInput.fromJson(
      ...
      deleteMany: json['deleteMany'] != null
          ? List.generate(
              ...
              (index) =>
                  CategoryScalarWhereInput.fromJson(json['deleteMany'][index]))
          : null,
    );
  }
  ...
  CategoryUncheckedUpdateManyWithoutPictureInput copyWith(
      {List<CategoryCreateWithoutPictureInput>? create,
      List<CategoryCreateOrConnectWithoutPictureInput>? connectOrCreate,
      List<CategoryUpsertWithWhereUniqueWithoutPictureInput>? upsert,
      CategoryCreateManyPictureInputEnvelope? createMany,
      List<CategoryWhereUniqueInput>? connect,
      List<CategoryWhereUniqueInput>? set$,
      List<CategoryWhereUniqueInput>? disconnect,
      List<CategoryWhereUniqueInput>? delete,
      List<CategoryUpdateWithWhereUniqueWithoutPictureInput>? update,
      List<CategoryUpdateManyWithWhereWithoutPictureInput>? updateMany,
      List<CategoryScalarWhereInput>? deleteMany}) {
    return CategoryUncheckedUpdateManyWithoutPictureInput(
