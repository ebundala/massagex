...
class CommentCreateNestedManyWithoutCommentInput extends Equatable {
  ...
  static CommentCreateNestedManyWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentCreateNestedManyWithoutCommentInput(
  ...
  CommentCreateNestedManyWithoutCommentInput copyWith(
