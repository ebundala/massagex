...
class AttachmentUncheckedCreateNestedManyWithoutBusinessInput
    extends Equatable {
  ...
  AttachmentUncheckedCreateNestedManyWithoutBusinessInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static AttachmentUncheckedCreateNestedManyWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedCreateNestedManyWithoutBusinessInput(
  ...
  AttachmentUncheckedCreateNestedManyWithoutBusinessInput copyWith(
