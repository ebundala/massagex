...
class UserCreateManyLocationInput extends Equatable {
  final String? id;
  final String email;
  ...
  static UserCreateManyLocationInput fromJson(Map<dynamic, dynamic> json) {
    return UserCreateManyLocationInput(
      id: json['id'],
      email: json['email'],
  ...
  UserCreateManyLocationInput copyWith(
      {String? id,
      String? email,
      String? displayName,
      String? phoneNumber,
