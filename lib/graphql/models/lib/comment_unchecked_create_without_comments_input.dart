...
class CommentUncheckedCreateWithoutCommentsInput extends Equatable {
  final String? id;
  ...
  CommentUncheckedCreateWithoutCommentsInput(
      {this.id,
  ...
  static CommentUncheckedCreateWithoutCommentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUncheckedCreateWithoutCommentsInput(
      id: json['id'],
  ...
  CommentUncheckedCreateWithoutCommentsInput copyWith(
      {String? id,
      String? authorId,
      String? reviewId,
