...
class AbuseRecordTypeMinAggregateOutputType extends Equatable {
  final String? id;
  final String? name;
  AbuseRecordTypeMinAggregateOutputType({this.id, this.name});

  static AbuseRecordTypeMinAggregateOutputType fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseRecordTypeMinAggregateOutputType(
      id: json['id'],
      name: json['name'],
    );
  }
  ...
  AbuseRecordTypeMinAggregateOutputType copyWith({String? id, String? name}) {
    return AbuseRecordTypeMinAggregateOutputType(
...
extension AbuseRecordTypeMinAggregateOutputTypeExt
    on AbuseRecordTypeMinAggregateOutputType {
...
class AbuseRecordTypeMinAggregateOutputTypeController
    extends ValueNotifier<AbuseRecordTypeMinAggregateOutputType> {
  TextEditingController? idController;

  TextEditingController? nameController;

  final AbuseRecordTypeMinAggregateOutputType initialValue;
  final SelectionSetNode selectionSet;
  final Map<String, SelectionNodeData> selections = {};
  AbuseRecordTypeMinAggregateOutputTypeController({
