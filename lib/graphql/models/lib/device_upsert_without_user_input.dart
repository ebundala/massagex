...
class DeviceUpsertWithoutUserInput extends Equatable {
  ...
  DeviceUpsertWithoutUserInput({required this.update, required this.create});

  static DeviceUpsertWithoutUserInput fromJson(Map<dynamic, dynamic> json) {
    return DeviceUpsertWithoutUserInput(
      update: DeviceUpdateWithoutUserInput.fromJson(json['update']),
      create: DeviceCreateWithoutUserInput.fromJson(json['create']),
    );
  }
  ...
  DeviceUpsertWithoutUserInput copyWith(
