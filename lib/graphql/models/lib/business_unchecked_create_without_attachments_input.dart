...
class BusinessUncheckedCreateWithoutAttachmentsInput extends Equatable {
  final String? id;
  ...
  BusinessUncheckedCreateWithoutAttachmentsInput(
      {this.id,
  ...
  static BusinessUncheckedCreateWithoutAttachmentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUncheckedCreateWithoutAttachmentsInput(
      id: json['id'],
  ...
  BusinessUncheckedCreateWithoutAttachmentsInput copyWith(
      {String? id,
      String? ownerId,
      BusinessMode? mode,
      String? coverId,
