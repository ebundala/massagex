...
class UserCreateNestedOneWithoutAbuseReportsInput extends Equatable {
  ...
  UserCreateNestedOneWithoutAbuseReportsInput(
      {this.create, this.connectOrCreate, this.connect});

  static UserCreateNestedOneWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserCreateNestedOneWithoutAbuseReportsInput(
  ...
  UserCreateNestedOneWithoutAbuseReportsInput copyWith(
