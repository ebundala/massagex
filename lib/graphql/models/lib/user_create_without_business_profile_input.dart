...
import 'review_create_nested_many_without_reviewee_input.dart';
...
class UserCreateWithoutBusinessProfileInput extends Equatable {
  final String? id;
  final String email;
  ...
  final ReviewCreateNestedManyWithoutRevieweeInput? reviews;
  ...
  UserCreateWithoutBusinessProfileInput(
      {this.id,
      required this.email,
  ...
  static UserCreateWithoutBusinessProfileInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserCreateWithoutBusinessProfileInput(
      id: json['id'],
      email: json['email'],
      ...
      reviews: json['reviews'] != null
          ? ReviewCreateNestedManyWithoutRevieweeInput.fromJson(json['reviews'])
          : null,
  ...
  UserCreateWithoutBusinessProfileInput copyWith(
      {String? id,
      String? email,
      String? displayName,
      String? phoneNumber,
      ...
      ReviewCreateNestedManyWithoutRevieweeInput? reviews,
