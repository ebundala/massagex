...
class UserUpdateWithoutAvatorInput extends Equatable {
  ...
  static UserUpdateWithoutAvatorInput fromJson(Map<dynamic, dynamic> json) {
    return UserUpdateWithoutAvatorInput(
      id: json['id'] != null
  ...
  UserUpdateWithoutAvatorInput copyWith(
