...
class UserUpdateWithoutFavoritesInput extends Equatable {
  ...
  static UserUpdateWithoutFavoritesInput fromJson(Map<dynamic, dynamic> json) {
    return UserUpdateWithoutFavoritesInput(
      id: json['id'] != null
  ...
  UserUpdateWithoutFavoritesInput copyWith(
