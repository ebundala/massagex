...
import 'favorite_create_or_connect_without_author_input.dart';
import 'favorite_upsert_with_where_unique_without_author_input.dart';
import 'favorite_create_many_author_input_envelope.dart';
import 'favorite_where_unique_input.dart';
import 'favorite_update_with_where_unique_without_author_input.dart';
import 'favorite_update_many_with_where_without_author_input.dart';
import 'favorite_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class FavoriteUncheckedUpdateManyWithoutAuthorInput extends Equatable {
  final List<FavoriteCreateWithoutAuthorInput>? create;
  final List<FavoriteCreateOrConnectWithoutAuthorInput>? connectOrCreate;
  final List<FavoriteUpsertWithWhereUniqueWithoutAuthorInput>? upsert;
  final FavoriteCreateManyAuthorInputEnvelope? createMany;
  ...
  final List<FavoriteUpdateWithWhereUniqueWithoutAuthorInput>? update;
  final List<FavoriteUpdateManyWithWhereWithoutAuthorInput>? updateMany;
  ...
  FavoriteUncheckedUpdateManyWithoutAuthorInput(
      {this.create,
  ...
  static FavoriteUncheckedUpdateManyWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedUpdateManyWithoutAuthorInput(
      create: json['create'] != null
          ? List.generate(
              json['create'].length,
              (index) => FavoriteCreateWithoutAuthorInput.fromJson(
                  json['create'][index]))
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? List.generate(
              json['connectOrCreate'].length,
              (index) => FavoriteCreateOrConnectWithoutAuthorInput.fromJson(
      ...
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) =>
                  FavoriteUpsertWithWhereUniqueWithoutAuthorInput.fromJson(
                      json['upsert'][index]))
          : null,
      createMany: json['createMany'] != null
          ? FavoriteCreateManyAuthorInputEnvelope.fromJson(json['createMany'])
          : null,
      ...
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) =>
                  FavoriteUpdateWithWhereUniqueWithoutAuthorInput.fromJson(
                      json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              json['updateMany'].length,
              (index) => FavoriteUpdateManyWithWhereWithoutAuthorInput.fromJson(
  ...
  FavoriteUncheckedUpdateManyWithoutAuthorInput copyWith(
      {List<FavoriteCreateWithoutAuthorInput>? create,
      List<FavoriteCreateOrConnectWithoutAuthorInput>? connectOrCreate,
      List<FavoriteUpsertWithWhereUniqueWithoutAuthorInput>? upsert,
      FavoriteCreateManyAuthorInputEnvelope? createMany,
      ...
      List<FavoriteUpdateWithWhereUniqueWithoutAuthorInput>? update,
      List<FavoriteUpdateManyWithWhereWithoutAuthorInput>? updateMany,
