...
class AttachmentCreateNestedManyWithoutHelpStepInput extends Equatable {
  ...
  AttachmentCreateNestedManyWithoutHelpStepInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static AttachmentCreateNestedManyWithoutHelpStepInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateNestedManyWithoutHelpStepInput(
  ...
  AttachmentCreateNestedManyWithoutHelpStepInput copyWith(
