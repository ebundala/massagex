...
class AbuseReportCreateManyBusinessInput extends Equatable {
  final String? id;
  final int? number;
  final String? report;
  ...
  AbuseReportCreateManyBusinessInput(
      {this.id,
      this.number,
      this.report,
  ...
  static AbuseReportCreateManyBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportCreateManyBusinessInput(
      id: json['id'],
      number: json['number'],
      report: json['report'],
  ...
  AbuseReportCreateManyBusinessInput copyWith(
      {String? id,
      int? number,
      String? report,
      String? authorId,
