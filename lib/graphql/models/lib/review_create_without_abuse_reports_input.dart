...
class ReviewCreateWithoutAbuseReportsInput extends Equatable {
  final String? id;
  final int? value;
  ...
  ReviewCreateWithoutAbuseReportsInput(
      {this.id,
      this.value,
      this.content,
      this.recordStatus,
  ...
  static ReviewCreateWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewCreateWithoutAbuseReportsInput(
      id: json['id'],
      value: json['value'],
  ...
  ReviewCreateWithoutAbuseReportsInput copyWith(
      {String? id,
      int? value,
      String? content,
