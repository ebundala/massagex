...
class FavoriteUpdateWithWhereUniqueWithoutTypeInput extends Equatable {
  final FavoriteWhereUniqueInput where;
  final FavoriteUpdateWithoutTypeInput data;
  ...
  FavoriteUpdateWithWhereUniqueWithoutTypeInput(
      {required this.where, required this.data});

  static FavoriteUpdateWithWhereUniqueWithoutTypeInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUpdateWithWhereUniqueWithoutTypeInput(
      where: FavoriteWhereUniqueInput.fromJson(json['where']),
      data: FavoriteUpdateWithoutTypeInput.fromJson(json['data']),
    );
  }
  ...
  FavoriteUpdateWithWhereUniqueWithoutTypeInput copyWith(
      {FavoriteWhereUniqueInput? where, FavoriteUpdateWithoutTypeInput? data}) {
    return FavoriteUpdateWithWhereUniqueWithoutTypeInput(
