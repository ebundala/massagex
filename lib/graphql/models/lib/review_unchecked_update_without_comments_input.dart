...
class ReviewUncheckedUpdateWithoutCommentsInput extends Equatable {
  ...
  ReviewUncheckedUpdateWithoutCommentsInput(
      {this.id,
      this.authorId,
      this.revieweeId,
      this.value,
  ...
  static ReviewUncheckedUpdateWithoutCommentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewUncheckedUpdateWithoutCommentsInput(
      id: json['id'] != null
  ...
  ReviewUncheckedUpdateWithoutCommentsInput copyWith(
