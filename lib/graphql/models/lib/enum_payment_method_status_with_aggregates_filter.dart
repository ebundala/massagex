...
import 'nested_enum_payment_method_status_with_aggregates_filter.dart';
import 'nested_int_filter.dart';
import 'nested_enum_payment_method_status_filter.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class EnumPaymentMethodStatusWithAggregatesFilter extends Equatable {
  final PaymentMethodStatus? equals;
  final List<PaymentMethodStatus>? in$;
  final List<PaymentMethodStatus>? notIn;
  final NestedEnumPaymentMethodStatusWithAggregatesFilter? not;
  final NestedIntFilter? $count;
  final NestedIntFilter? count;
  final NestedEnumPaymentMethodStatusFilter? $min;
  final NestedEnumPaymentMethodStatusFilter? min;
  final NestedEnumPaymentMethodStatusFilter? $max;
  final NestedEnumPaymentMethodStatusFilter? max;
  ...
  EnumPaymentMethodStatusWithAggregatesFilter(
      {this.equals,
      this.in$,
      this.notIn,
      this.not,
  ...
  static EnumPaymentMethodStatusWithAggregatesFilter fromJson(
      Map<dynamic, dynamic> json) {
    return EnumPaymentMethodStatusWithAggregatesFilter(
      equals: json['equals'] != null
          ? PaymentMethodStatusExt.fromJson(json['equals'])
          : null,
      in$: json['in'] != null
          ? List.generate(json['in'].length,
              (index) => PaymentMethodStatusExt.fromJson(json['in'][index]))
          : null,
      notIn: json['notIn'] != null
          ? List.generate(json['notIn'].length,
              (index) => PaymentMethodStatusExt.fromJson(json['notIn'][index]))
          : null,
      not: json['not'] != null
          ? NestedEnumPaymentMethodStatusWithAggregatesFilter.fromJson(
              json['not'])
          : null,
      ...
      count: json['count'] != null
          ...
          : null,
      $min: json['_min'] != null
          ? NestedEnumPaymentMethodStatusFilter.fromJson(json['_min'])
          : null,
      min: json['min'] != null
          ? NestedEnumPaymentMethodStatusFilter.fromJson(json['min'])
          : null,
      $max: json['_max'] != null
          ? NestedEnumPaymentMethodStatusFilter.fromJson(json['_max'])
          : null,
      max: json['max'] != null
          ? NestedEnumPaymentMethodStatusFilter.fromJson(json['max'])
          : null,
    );
  }
  ...
  EnumPaymentMethodStatusWithAggregatesFilter copyWith(
      {PaymentMethodStatus? equals,
      List<PaymentMethodStatus>? in$,
      List<PaymentMethodStatus>? notIn,
      NestedEnumPaymentMethodStatusWithAggregatesFilter? not,
      NestedIntFilter? $count,
      NestedIntFilter? count,
      NestedEnumPaymentMethodStatusFilter? $min,
      NestedEnumPaymentMethodStatusFilter? min,
      NestedEnumPaymentMethodStatusFilter? $max,
      NestedEnumPaymentMethodStatusFilter? max}) {
    return EnumPaymentMethodStatusWithAggregatesFilter(
