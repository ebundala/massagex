...
class AbuseReportUncheckedCreateWithoutOrderInput extends Equatable {
  final String? id;
  final int? number;
  final String? report;
  ...
  AbuseReportUncheckedCreateWithoutOrderInput(
      {this.id,
      this.number,
      this.report,
  ...
  static AbuseReportUncheckedCreateWithoutOrderInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedCreateWithoutOrderInput(
      id: json['id'],
      number: json['number'],
      report: json['report'],
  ...
  AbuseReportUncheckedCreateWithoutOrderInput copyWith(
      {String? id,
      int? number,
      String? report,
      String? authorId,
