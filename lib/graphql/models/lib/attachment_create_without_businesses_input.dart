...
class AttachmentCreateWithoutBusinessesInput extends Equatable {
  ...
  static AttachmentCreateWithoutBusinessesInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateWithoutBusinessesInput(
      path: json['path'],
      id: json['id'],
  ...
  AttachmentCreateWithoutBusinessesInput copyWith(
      {MultipartFile? path,
      String? id,
      String? filename,
      String? mimetype,
