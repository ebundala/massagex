...
class FavoriteUpdateManyWithoutUserInput extends Equatable {
  ...
  FavoriteUpdateManyWithoutUserInput(
      {this.create,
  ...
  static FavoriteUpdateManyWithoutUserInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUpdateManyWithoutUserInput(
  ...
  FavoriteUpdateManyWithoutUserInput copyWith(
