...
class ServiceUncheckedCreateNestedManyWithoutBusinessInput extends Equatable {
  ...
  ServiceUncheckedCreateNestedManyWithoutBusinessInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static ServiceUncheckedCreateNestedManyWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUncheckedCreateNestedManyWithoutBusinessInput(
  ...
  ServiceUncheckedCreateNestedManyWithoutBusinessInput copyWith(
