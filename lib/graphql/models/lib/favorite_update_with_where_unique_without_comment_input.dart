...
class FavoriteUpdateWithWhereUniqueWithoutCommentInput extends Equatable {
  final FavoriteWhereUniqueInput where;
  final FavoriteUpdateWithoutCommentInput data;
  ...
  FavoriteUpdateWithWhereUniqueWithoutCommentInput(
      {required this.where, required this.data});

  static FavoriteUpdateWithWhereUniqueWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUpdateWithWhereUniqueWithoutCommentInput(
      where: FavoriteWhereUniqueInput.fromJson(json['where']),
      data: FavoriteUpdateWithoutCommentInput.fromJson(json['data']),
    );
  }
  ...
  FavoriteUpdateWithWhereUniqueWithoutCommentInput copyWith(
      {FavoriteWhereUniqueInput? where,
      FavoriteUpdateWithoutCommentInput? data}) {
    return FavoriteUpdateWithWhereUniqueWithoutCommentInput(
