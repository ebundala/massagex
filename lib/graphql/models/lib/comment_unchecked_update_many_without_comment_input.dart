...
class CommentUncheckedUpdateManyWithoutCommentInput extends Equatable {
  ...
  static CommentUncheckedUpdateManyWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUncheckedUpdateManyWithoutCommentInput(
  ...
  CommentUncheckedUpdateManyWithoutCommentInput copyWith(
