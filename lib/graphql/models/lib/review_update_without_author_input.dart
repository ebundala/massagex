...
class ReviewUpdateWithoutAuthorInput extends Equatable {
  ...
  static ReviewUpdateWithoutAuthorInput fromJson(Map<dynamic, dynamic> json) {
    return ReviewUpdateWithoutAuthorInput(
      id: json['id'] != null
  ...
  ReviewUpdateWithoutAuthorInput copyWith(
