...
class ServiceCreateWithoutFavoritesInput extends Equatable {
  final String? id;
  final String name;
  ...
  ServiceCreateWithoutFavoritesInput(
      {this.id,
      required this.name,
      this.description,
      required this.price,
  ...
  static ServiceCreateWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceCreateWithoutFavoritesInput(
      id: json['id'],
      name: json['name'],
  ...
  ServiceCreateWithoutFavoritesInput copyWith(
      {String? id,
      String? name,
      String? description,
      double? price,
