...
class BusinessCreateNestedOneWithoutAttachmentsInput extends Equatable {
  ...
  BusinessCreateNestedOneWithoutAttachmentsInput(
      {this.create, this.connectOrCreate, this.connect});

  static BusinessCreateNestedOneWithoutAttachmentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessCreateNestedOneWithoutAttachmentsInput(
  ...
  BusinessCreateNestedOneWithoutAttachmentsInput copyWith(
