...
class ServiceUpdateManyWithoutCategoryInput extends Equatable {
  ...
  ServiceUpdateManyWithoutCategoryInput(
      {this.create,
  ...
  static ServiceUpdateManyWithoutCategoryInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUpdateManyWithoutCategoryInput(
  ...
  ServiceUpdateManyWithoutCategoryInput copyWith(
