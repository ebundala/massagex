...
class CommentCreateManyReviewInput extends Equatable {
  final String? id;
  ...
  static CommentCreateManyReviewInput fromJson(Map<dynamic, dynamic> json) {
    return CommentCreateManyReviewInput(
      id: json['id'],
  ...
  CommentCreateManyReviewInput copyWith(
      {String? id,
      String? authorId,
