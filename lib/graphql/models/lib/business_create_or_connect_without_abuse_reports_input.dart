...
class BusinessCreateOrConnectWithoutAbuseReportsInput extends Equatable {
  ...
  BusinessCreateOrConnectWithoutAbuseReportsInput(
      {required this.where, required this.create});

  static BusinessCreateOrConnectWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessCreateOrConnectWithoutAbuseReportsInput(
  ...
  BusinessCreateOrConnectWithoutAbuseReportsInput copyWith(
