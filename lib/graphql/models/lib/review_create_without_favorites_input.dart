...
class ReviewCreateWithoutFavoritesInput extends Equatable {
  final String? id;
  final int? value;
  ...
  ReviewCreateWithoutFavoritesInput(
      {this.id,
      this.value,
      this.content,
      this.recordStatus,
  ...
  static ReviewCreateWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewCreateWithoutFavoritesInput(
      id: json['id'],
      value: json['value'],
  ...
  ReviewCreateWithoutFavoritesInput copyWith(
      {String? id,
      int? value,
      String? content,
