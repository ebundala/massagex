...
class BusinessUncheckedUpdateManyInput extends Equatable {
  ...
  static BusinessUncheckedUpdateManyInput fromJson(Map<dynamic, dynamic> json) {
    return BusinessUncheckedUpdateManyInput(
      id: json['id'] != null
  ...
  BusinessUncheckedUpdateManyInput copyWith(
