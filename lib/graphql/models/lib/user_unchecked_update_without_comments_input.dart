...
class UserUncheckedUpdateWithoutCommentsInput extends Equatable {
  ...
  static UserUncheckedUpdateWithoutCommentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUncheckedUpdateWithoutCommentsInput(
      id: json['id'] != null
  ...
  UserUncheckedUpdateWithoutCommentsInput copyWith(
