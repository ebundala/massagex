...
class AttachmentUncheckedUpdateWithoutHelpStepInput extends Equatable {
  ...
  AttachmentUncheckedUpdateWithoutHelpStepInput(
      {this.id,
      this.path,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUncheckedUpdateWithoutHelpStepInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedUpdateWithoutHelpStepInput(
      id: json['id'] != null
  ...
  AttachmentUncheckedUpdateWithoutHelpStepInput copyWith(
