...
class CommentCreateNestedManyWithoutReviewInput extends Equatable {
  ...
  CommentCreateNestedManyWithoutReviewInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static CommentCreateNestedManyWithoutReviewInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentCreateNestedManyWithoutReviewInput(
  ...
  CommentCreateNestedManyWithoutReviewInput copyWith(
