...
class CommentUncheckedUpdateWithoutAttachmentsInput extends Equatable {
  ...
  static CommentUncheckedUpdateWithoutAttachmentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUncheckedUpdateWithoutAttachmentsInput(
      id: json['id'] != null
  ...
  CommentUncheckedUpdateWithoutAttachmentsInput copyWith(
