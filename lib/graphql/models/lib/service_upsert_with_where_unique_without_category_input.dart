...
import 'service_update_without_category_input.dart';
import 'service_create_without_category_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class ServiceUpsertWithWhereUniqueWithoutCategoryInput extends Equatable {
  final ServiceWhereUniqueInput where;
  final ServiceUpdateWithoutCategoryInput update;
  ...
  static ServiceUpsertWithWhereUniqueWithoutCategoryInput fromJson(
      Map<dynamic, dynamic> json) {
    return ServiceUpsertWithWhereUniqueWithoutCategoryInput(
      where: ServiceWhereUniqueInput.fromJson(json['where']),
      update: ServiceUpdateWithoutCategoryInput.fromJson(json['update']),
  ...
  ServiceUpsertWithWhereUniqueWithoutCategoryInput copyWith(
      {ServiceWhereUniqueInput? where,
      ServiceUpdateWithoutCategoryInput? update,
