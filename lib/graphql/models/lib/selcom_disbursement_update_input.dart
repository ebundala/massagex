...
import 'transaction_update_one_without_selcom_disbursement_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class SelcomDisbursementUpdateInput extends Equatable {
  ...
  final TransactionUpdateOneWithoutSelcomDisbursementInput? transaction;
  ...
  static SelcomDisbursementUpdateInput fromJson(Map<dynamic, dynamic> json) {
    return SelcomDisbursementUpdateInput(
      id: json['id'] != null
      ...
      transaction: json['transaction'] != null
          ? TransactionUpdateOneWithoutSelcomDisbursementInput.fromJson(
              json['transaction'])
          : null,
    );
  }
  ...
  SelcomDisbursementUpdateInput copyWith(
      ...
      TransactionUpdateOneWithoutSelcomDisbursementInput? transaction}) {
    return SelcomDisbursementUpdateInput(
        id: id ?? this.id,
