...
class AttachmentUncheckedUpdateWithoutBusinessesInput extends Equatable {
  ...
  AttachmentUncheckedUpdateWithoutBusinessesInput(
      {this.id,
      this.path,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUncheckedUpdateWithoutBusinessesInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedUpdateWithoutBusinessesInput(
      id: json['id'] != null
  ...
  AttachmentUncheckedUpdateWithoutBusinessesInput copyWith(
