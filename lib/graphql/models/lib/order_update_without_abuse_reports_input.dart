...
class OrderUpdateWithoutAbuseReportsInput extends Equatable {
  ...
  OrderUpdateWithoutAbuseReportsInput(
      {this.id,
      this.quantity,
      this.recordStatus,
      this.orderStatus,
  ...
  static OrderUpdateWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUpdateWithoutAbuseReportsInput(
      id: json['id'] != null
  ...
  OrderUpdateWithoutAbuseReportsInput copyWith(
