...
class AttachmentUncheckedCreateNestedManyWithoutReviewsInput extends Equatable {
  ...
  AttachmentUncheckedCreateNestedManyWithoutReviewsInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static AttachmentUncheckedCreateNestedManyWithoutReviewsInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedCreateNestedManyWithoutReviewsInput(
  ...
  AttachmentUncheckedCreateNestedManyWithoutReviewsInput copyWith(
