import 'order_create_without_receipt_input.dart';
import 'order_create_or_connect_without_receipt_input.dart';
import 'order_upsert_with_where_unique_without_receipt_input.dart';
import 'order_create_many_receipt_input_envelope.dart';
import 'order_where_unique_input.dart';
import 'order_update_with_where_unique_without_receipt_input.dart';
import 'order_update_many_with_where_without_receipt_input.dart';
import 'order_scalar_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class OrderUncheckedUpdateManyWithoutReceiptInput extends Equatable {
  final List<OrderCreateWithoutReceiptInput>? create;
  final List<OrderCreateOrConnectWithoutReceiptInput>? connectOrCreate;
  final List<OrderUpsertWithWhereUniqueWithoutReceiptInput>? upsert;
  final OrderCreateManyReceiptInputEnvelope? createMany;
  final List<OrderWhereUniqueInput>? connect;
  final List<OrderWhereUniqueInput>? set$;
  final List<OrderWhereUniqueInput>? disconnect;
  final List<OrderWhereUniqueInput>? delete;
  final List<OrderUpdateWithWhereUniqueWithoutReceiptInput>? update;
  final List<OrderUpdateManyWithWhereWithoutReceiptInput>? updateMany;
  final List<OrderScalarWhereInput>? deleteMany;
  ...
  OrderUncheckedUpdateManyWithoutReceiptInput(
      {this.create,
  ...
  static OrderUncheckedUpdateManyWithoutReceiptInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUncheckedUpdateManyWithoutReceiptInput(
      create: json['create'] != null
          ? List.generate(
              json['create'].length,
              (index) => OrderCreateWithoutReceiptInput.fromJson(
                  json['create'][index]))
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? List.generate(
              json['connectOrCreate'].length,
              (index) => OrderCreateOrConnectWithoutReceiptInput.fromJson(
                  json['connectOrCreate'][index]))
          : null,
      upsert: json['upsert'] != null
          ? List.generate(
              json['upsert'].length,
              (index) => OrderUpsertWithWhereUniqueWithoutReceiptInput.fromJson(
                  json['upsert'][index]))
          : null,
      createMany: json['createMany'] != null
          ? OrderCreateManyReceiptInputEnvelope.fromJson(json['createMany'])
          : null,
      connect: json['connect'] != null
          ? List.generate(json['connect'].length,
              (index) => OrderWhereUniqueInput.fromJson(json['connect'][index]))
          : null,
      set$: json['set'] != null
          ? List.generate(json['set'].length,
              (index) => OrderWhereUniqueInput.fromJson(json['set'][index]))
          : null,
      disconnect: json['disconnect'] != null
          ? List.generate(
              json['disconnect'].length,
              (index) =>
                  OrderWhereUniqueInput.fromJson(json['disconnect'][index]))
          : null,
      delete: json['delete'] != null
          ? List.generate(json['delete'].length,
              (index) => OrderWhereUniqueInput.fromJson(json['delete'][index]))
          : null,
      update: json['update'] != null
          ? List.generate(
              json['update'].length,
              (index) => OrderUpdateWithWhereUniqueWithoutReceiptInput.fromJson(
                  json['update'][index]))
          : null,
      updateMany: json['updateMany'] != null
          ? List.generate(
              json['updateMany'].length,
              (index) => OrderUpdateManyWithWhereWithoutReceiptInput.fromJson(
      ...
      deleteMany: json['deleteMany'] != null
          ? List.generate(
              ...
              (index) =>
                  OrderScalarWhereInput.fromJson(json['deleteMany'][index]))
          : null,
    );
  }
  ...
  OrderUncheckedUpdateManyWithoutReceiptInput copyWith(
      {List<OrderCreateWithoutReceiptInput>? create,
      List<OrderCreateOrConnectWithoutReceiptInput>? connectOrCreate,
      List<OrderUpsertWithWhereUniqueWithoutReceiptInput>? upsert,
      OrderCreateManyReceiptInputEnvelope? createMany,
      List<OrderWhereUniqueInput>? connect,
      List<OrderWhereUniqueInput>? set$,
      List<OrderWhereUniqueInput>? disconnect,
      List<OrderWhereUniqueInput>? delete,
      List<OrderUpdateWithWhereUniqueWithoutReceiptInput>? update,
      List<OrderUpdateManyWithWhereWithoutReceiptInput>? updateMany,
      List<OrderScalarWhereInput>? deleteMany}) {
    return OrderUncheckedUpdateManyWithoutReceiptInput(
