...
import 'device_upsert_without_user_input.dart';
import 'device_where_unique_input.dart';
import 'device_update_without_user_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class DeviceUncheckedUpdateOneWithoutUserInput extends Equatable {
  final DeviceCreateWithoutUserInput? create;
  final DeviceCreateOrConnectWithoutUserInput? connectOrCreate;
  final DeviceUpsertWithoutUserInput? upsert;
  ...
  DeviceUncheckedUpdateOneWithoutUserInput(
      {this.create,
  ...
  static DeviceUncheckedUpdateOneWithoutUserInput fromJson(
      Map<dynamic, dynamic> json) {
    return DeviceUncheckedUpdateOneWithoutUserInput(
      ...
      upsert: json['upsert'] != null
          ? DeviceUpsertWithoutUserInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? DeviceUpdateWithoutUserInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  DeviceUncheckedUpdateOneWithoutUserInput copyWith(
      {DeviceCreateWithoutUserInput? create,
      DeviceCreateOrConnectWithoutUserInput? connectOrCreate,
      DeviceUpsertWithoutUserInput? upsert,
      DeviceWhereUniqueInput? connect,
      bool? disconnect,
      bool? delete,
      DeviceUpdateWithoutUserInput? update}) {
    return DeviceUncheckedUpdateOneWithoutUserInput(
