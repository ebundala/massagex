...
class FavoriteRecordTypeCreateNestedOneWithoutFavoritesInput extends Equatable {
  ...
  FavoriteRecordTypeCreateNestedOneWithoutFavoritesInput(
      {this.create, this.connectOrCreate, this.connect});

  static FavoriteRecordTypeCreateNestedOneWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteRecordTypeCreateNestedOneWithoutFavoritesInput(
  ...
  FavoriteRecordTypeCreateNestedOneWithoutFavoritesInput copyWith(
