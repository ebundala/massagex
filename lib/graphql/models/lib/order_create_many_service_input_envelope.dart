import 'order_create_many_service_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class OrderCreateManyServiceInputEnvelope extends Equatable {
  final List<OrderCreateManyServiceInput>? data;
  ...
  OrderCreateManyServiceInputEnvelope({this.data, this.skipDuplicates});

  static OrderCreateManyServiceInputEnvelope fromJson(
      Map<dynamic, dynamic> json) {
    return OrderCreateManyServiceInputEnvelope(
      data: json['data'] != null
          ? List.generate(
              json['data'].length,
              (index) =>
                  OrderCreateManyServiceInput.fromJson(json['data'][index]))
          : null,
  ...
  OrderCreateManyServiceInputEnvelope copyWith(
      {List<OrderCreateManyServiceInput>? data, bool? skipDuplicates}) {
    return OrderCreateManyServiceInputEnvelope(
        data: data ?? this.data,
