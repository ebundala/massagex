...
class AbuseReportUncheckedUpdateWithoutOrderInput extends Equatable {
  ...
  AbuseReportUncheckedUpdateWithoutOrderInput(
      {this.id,
      this.number,
      this.report,
      this.authorId,
  ...
  static AbuseReportUncheckedUpdateWithoutOrderInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUncheckedUpdateWithoutOrderInput(
      id: json['id'] != null
  ...
  AbuseReportUncheckedUpdateWithoutOrderInput copyWith(
