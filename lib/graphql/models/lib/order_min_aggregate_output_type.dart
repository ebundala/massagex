...
class OrderMinAggregateOutputType extends Equatable {
  final String? id;
  final int? quantity;
  ...
  static OrderMinAggregateOutputType fromJson(Map<dynamic, dynamic> json) {
    return OrderMinAggregateOutputType(
      id: json['id'],
  ...
  OrderMinAggregateOutputType copyWith(
      {String? id,
      int? quantity,
...
extension OrderMinAggregateOutputTypeExt on OrderMinAggregateOutputType {
...
class OrderMinAggregateOutputTypeController
    extends ValueNotifier<OrderMinAggregateOutputType> {
  ...
  final OrderMinAggregateOutputType initialValue;
  final SelectionSetNode selectionSet;
  final Map<String, SelectionNodeData> selections = {};
  OrderMinAggregateOutputTypeController({
