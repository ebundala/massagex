...
class ReviewUpdateWithoutAttachmentsInput extends Equatable {
  ...
  ReviewUpdateWithoutAttachmentsInput(
      {this.id,
      this.value,
      this.content,
      this.recordStatus,
  ...
  static ReviewUpdateWithoutAttachmentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewUpdateWithoutAttachmentsInput(
      id: json['id'] != null
  ...
  ReviewUpdateWithoutAttachmentsInput copyWith(
