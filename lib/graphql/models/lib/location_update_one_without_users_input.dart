import 'location_create_without_users_input.dart';
import 'location_create_or_connect_without_users_input.dart';
import 'location_upsert_without_users_input.dart';
import 'location_where_unique_input.dart';
import 'location_update_without_users_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class LocationUpdateOneWithoutUsersInput extends Equatable {
  final LocationCreateWithoutUsersInput? create;
  final LocationCreateOrConnectWithoutUsersInput? connectOrCreate;
  final LocationUpsertWithoutUsersInput? upsert;
  final LocationWhereUniqueInput? connect;
  final bool? disconnect;
  final bool? delete;
  final LocationUpdateWithoutUsersInput? update;
  ...
  LocationUpdateOneWithoutUsersInput(
      {this.create,
  ...
  static LocationUpdateOneWithoutUsersInput fromJson(
      Map<dynamic, dynamic> json) {
    return LocationUpdateOneWithoutUsersInput(
      create: json['create'] != null
          ? LocationCreateWithoutUsersInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? LocationCreateOrConnectWithoutUsersInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? LocationUpsertWithoutUsersInput.fromJson(json['upsert'])
          : null,
      connect: json['connect'] != null
          ? LocationWhereUniqueInput.fromJson(json['connect'])
          : null,
      disconnect: json['disconnect'],
      delete: json['delete'],
      update: json['update'] != null
          ? LocationUpdateWithoutUsersInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  LocationUpdateOneWithoutUsersInput copyWith(
      {LocationCreateWithoutUsersInput? create,
      LocationCreateOrConnectWithoutUsersInput? connectOrCreate,
      LocationUpsertWithoutUsersInput? upsert,
      LocationWhereUniqueInput? connect,
      bool? disconnect,
      bool? delete,
      LocationUpdateWithoutUsersInput? update}) {
    return LocationUpdateOneWithoutUsersInput(
