...
class OrderCreateManyOwnerInput extends Equatable {
  final String? id;
  final int quantity;
  ...
  static OrderCreateManyOwnerInput fromJson(Map<dynamic, dynamic> json) {
    return OrderCreateManyOwnerInput(
      id: json['id'],
  ...
  OrderCreateManyOwnerInput copyWith(
      {String? id,
      int? quantity,
