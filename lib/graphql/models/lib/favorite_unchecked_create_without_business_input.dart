...
class FavoriteUncheckedCreateWithoutBusinessInput extends Equatable {
  final String? id;
  final String favId;
  ...
  FavoriteUncheckedCreateWithoutBusinessInput(
      {this.id,
      required this.favId,
  ...
  static FavoriteUncheckedCreateWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedCreateWithoutBusinessInput(
      id: json['id'],
      favId: json['favId'],
  ...
  FavoriteUncheckedCreateWithoutBusinessInput copyWith(
      {String? id,
      String? favId,
      String? authorId,
      String? typeId,
