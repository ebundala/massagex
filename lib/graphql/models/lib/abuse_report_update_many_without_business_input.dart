...
class AbuseReportUpdateManyWithoutBusinessInput extends Equatable {
  ...
  AbuseReportUpdateManyWithoutBusinessInput(
      {this.create,
  ...
  static AbuseReportUpdateManyWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportUpdateManyWithoutBusinessInput(
  ...
  AbuseReportUpdateManyWithoutBusinessInput copyWith(
