import 'abuse_report_where_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class AbuseReportListRelationFilter extends Equatable {
  final AbuseReportWhereInput? every;
  final AbuseReportWhereInput? some;
  final AbuseReportWhereInput? none;
  ...
  AbuseReportListRelationFilter({this.every, this.some, this.none});

  static AbuseReportListRelationFilter fromJson(Map<dynamic, dynamic> json) {
    return AbuseReportListRelationFilter(
      every: json['every'] != null
          ? AbuseReportWhereInput.fromJson(json['every'])
          : null,
      some: json['some'] != null
          ? AbuseReportWhereInput.fromJson(json['some'])
          : null,
      none: json['none'] != null
          ? AbuseReportWhereInput.fromJson(json['none'])
          : null,
    );
  }
  ...
  AbuseReportListRelationFilter copyWith(
      {AbuseReportWhereInput? every,
      AbuseReportWhereInput? some,
      AbuseReportWhereInput? none}) {
    return AbuseReportListRelationFilter(
