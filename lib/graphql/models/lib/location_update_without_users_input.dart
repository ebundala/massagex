...
class LocationUpdateWithoutUsersInput extends Equatable {
  ...
  LocationUpdateWithoutUsersInput(
      {this.id,
      this.name,
      this.lat,
      this.lon,
  ...
  static LocationUpdateWithoutUsersInput fromJson(Map<dynamic, dynamic> json) {
    return LocationUpdateWithoutUsersInput(
      id: json['id'] != null
  ...
  LocationUpdateWithoutUsersInput copyWith(
