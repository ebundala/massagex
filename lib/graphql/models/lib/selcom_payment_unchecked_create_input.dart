...
import 'transaction_unchecked_create_nested_one_without_selcom_payment_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class SelcomPaymentUncheckedCreateInput extends Equatable {
  final String? id;
  ...
  final TransactionUncheckedCreateNestedOneWithoutSelcomPaymentInput?
      transaction;
  ...
  SelcomPaymentUncheckedCreateInput(
      {this.id,
  ...
  static SelcomPaymentUncheckedCreateInput fromJson(
      Map<dynamic, dynamic> json) {
    return SelcomPaymentUncheckedCreateInput(
      id: json['id'],
  ...
  SelcomPaymentUncheckedCreateInput copyWith(
      {String? id,
      String? transId,
      int? amount,
      String? msisdn,
