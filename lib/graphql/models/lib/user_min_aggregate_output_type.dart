...
class UserMinAggregateOutputType extends Equatable {
  final String? id;
  final String? email;
  ...
  static UserMinAggregateOutputType fromJson(Map<dynamic, dynamic> json) {
    return UserMinAggregateOutputType(
      id: json['id'],
      email: json['email'],
  ...
  UserMinAggregateOutputType copyWith(
      {String? id,
      String? email,
      String? displayName,
      String? phoneNumber,
...
extension UserMinAggregateOutputTypeExt on UserMinAggregateOutputType {
...
class UserMinAggregateOutputTypeController
    extends ValueNotifier<UserMinAggregateOutputType> {
  ...
  final UserMinAggregateOutputType initialValue;
  final SelectionSetNode selectionSet;
  final Map<String, SelectionNodeData> selections = {};
  UserMinAggregateOutputTypeController({
