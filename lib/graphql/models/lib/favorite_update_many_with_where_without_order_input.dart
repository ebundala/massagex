...
class FavoriteUpdateManyWithWhereWithoutOrderInput extends Equatable {
  ...
  FavoriteUpdateManyWithWhereWithoutOrderInput(
      {required this.where, required this.data});

  static FavoriteUpdateManyWithWhereWithoutOrderInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUpdateManyWithWhereWithoutOrderInput(
  ...
  FavoriteUpdateManyWithWhereWithoutOrderInput copyWith(
