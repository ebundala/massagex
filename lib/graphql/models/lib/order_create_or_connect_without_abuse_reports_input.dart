...
class OrderCreateOrConnectWithoutAbuseReportsInput extends Equatable {
  ...
  OrderCreateOrConnectWithoutAbuseReportsInput(
      {required this.where, required this.create});

  static OrderCreateOrConnectWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderCreateOrConnectWithoutAbuseReportsInput(
  ...
  OrderCreateOrConnectWithoutAbuseReportsInput copyWith(
