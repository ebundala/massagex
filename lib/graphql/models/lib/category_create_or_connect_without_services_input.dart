...
class CategoryCreateOrConnectWithoutServicesInput extends Equatable {
  ...
  CategoryCreateOrConnectWithoutServicesInput(
      {required this.where, required this.create});

  static CategoryCreateOrConnectWithoutServicesInput fromJson(
      Map<dynamic, dynamic> json) {
    return CategoryCreateOrConnectWithoutServicesInput(
  ...
  CategoryCreateOrConnectWithoutServicesInput copyWith(
