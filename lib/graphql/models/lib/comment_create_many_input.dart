...
class CommentCreateManyInput extends Equatable {
  final String? id;
  ...
  static CommentCreateManyInput fromJson(Map<dynamic, dynamic> json) {
    return CommentCreateManyInput(
      id: json['id'],
  ...
  CommentCreateManyInput copyWith(
      {String? id,
      String? authorId,
      String? reviewId,
