...
class CommentUncheckedUpdateWithoutFavoritesInput extends Equatable {
  ...
  CommentUncheckedUpdateWithoutFavoritesInput(
      {this.id,
      this.authorId,
      this.reviewId,
  ...
  static CommentUncheckedUpdateWithoutFavoritesInput fromJson(
      Map<dynamic, dynamic> json) {
    return CommentUncheckedUpdateWithoutFavoritesInput(
      id: json['id'] != null
  ...
  CommentUncheckedUpdateWithoutFavoritesInput copyWith(
