...
class MpesaPaymentUpdateWithoutTransactionInput extends Equatable {
  ...
  MpesaPaymentUpdateWithoutTransactionInput(
      {this.id,
      this.input$Amount,
      this.input$Country,
      this.input$Currency,
  ...
  static MpesaPaymentUpdateWithoutTransactionInput fromJson(
      Map<dynamic, dynamic> json) {
    return MpesaPaymentUpdateWithoutTransactionInput(
      id: json['id'] != null
  ...
  MpesaPaymentUpdateWithoutTransactionInput copyWith(
