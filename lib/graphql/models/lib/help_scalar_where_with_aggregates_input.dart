...
class HelpScalarWhereWithAggregatesInput extends Equatable {
  final List<HelpScalarWhereWithAggregatesInput>? AND;
  final List<HelpScalarWhereWithAggregatesInput>? OR;
  final List<HelpScalarWhereWithAggregatesInput>? NOT;
  final StringWithAggregatesFilter? id;
  final StringWithAggregatesFilter? topic;
  final StringNullableWithAggregatesFilter? description;
  final EnumRecordStatusWithAggregatesFilter? recordStatus;
  final EnumRoleWithAggregatesFilter? audience;
  ...
  HelpScalarWhereWithAggregatesInput(
      {this.AND,
      this.OR,
      this.NOT,
      this.id,
  ...
  static HelpScalarWhereWithAggregatesInput fromJson(
      Map<dynamic, dynamic> json) {
    return HelpScalarWhereWithAggregatesInput(
      AND: json['AND'] != null
          ? List.generate(
              json['AND'].length,
              (index) => HelpScalarWhereWithAggregatesInput.fromJson(
                  json['AND'][index]))
          : null,
      OR: json['OR'] != null
          ? List.generate(
      ...
      topic: json['topic'] != null
          ? StringWithAggregatesFilter.fromJson(json['topic'])
          : null,
      ...
      audience: json['audience'] != null
          ? EnumRoleWithAggregatesFilter.fromJson(json['audience'])
          : null,
  ...
  HelpScalarWhereWithAggregatesInput copyWith(
      {List<HelpScalarWhereWithAggregatesInput>? AND,
      List<HelpScalarWhereWithAggregatesInput>? OR,
      List<HelpScalarWhereWithAggregatesInput>? NOT,
      StringWithAggregatesFilter? id,
      StringWithAggregatesFilter? topic,
      StringNullableWithAggregatesFilter? description,
      EnumRecordStatusWithAggregatesFilter? recordStatus,
      EnumRoleWithAggregatesFilter? audience,
