...
class NestedEnumRoleFilter extends Equatable {
  final Role? equals;
  final List<Role>? in$;
  ...
  NestedEnumRoleFilter({this.equals, this.in$, this.notIn, this.not});

  static NestedEnumRoleFilter fromJson(Map<dynamic, dynamic> json) {
    return NestedEnumRoleFilter(
