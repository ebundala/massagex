...
class AttachmentUpdateWithWhereUniqueWithoutHelpStepInput extends Equatable {
  final AttachmentWhereUniqueInput where;
  final AttachmentUpdateWithoutHelpStepInput data;
  ...
  AttachmentUpdateWithWhereUniqueWithoutHelpStepInput(
      {required this.where, required this.data});

  static AttachmentUpdateWithWhereUniqueWithoutHelpStepInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUpdateWithWhereUniqueWithoutHelpStepInput(
      where: AttachmentWhereUniqueInput.fromJson(json['where']),
      data: AttachmentUpdateWithoutHelpStepInput.fromJson(json['data']),
    );
  }
  ...
  AttachmentUpdateWithWhereUniqueWithoutHelpStepInput copyWith(
      {AttachmentWhereUniqueInput? where,
      AttachmentUpdateWithoutHelpStepInput? data}) {
    return AttachmentUpdateWithWhereUniqueWithoutHelpStepInput(
