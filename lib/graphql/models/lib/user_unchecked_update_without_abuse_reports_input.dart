...
class UserUncheckedUpdateWithoutAbuseReportsInput extends Equatable {
  ...
  UserUncheckedUpdateWithoutAbuseReportsInput(
      {this.id,
      this.email,
      this.displayName,
      this.phoneNumber,
  ...
  static UserUncheckedUpdateWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUncheckedUpdateWithoutAbuseReportsInput(
      id: json['id'] != null
  ...
  UserUncheckedUpdateWithoutAbuseReportsInput copyWith(
