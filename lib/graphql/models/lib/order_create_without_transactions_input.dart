...
class OrderCreateWithoutTransactionsInput extends Equatable {
  final String? id;
  final int quantity;
  ...
  OrderCreateWithoutTransactionsInput(
      {this.id,
  ...
  static OrderCreateWithoutTransactionsInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderCreateWithoutTransactionsInput(
      id: json['id'],
  ...
  OrderCreateWithoutTransactionsInput copyWith(
      {String? id,
      int? quantity,
