...
class ReviewCreateNestedOneWithoutCommentsInput extends Equatable {
  ...
  ReviewCreateNestedOneWithoutCommentsInput(
      {this.create, this.connectOrCreate, this.connect});

  static ReviewCreateNestedOneWithoutCommentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewCreateNestedOneWithoutCommentsInput(
  ...
  ReviewCreateNestedOneWithoutCommentsInput copyWith(
