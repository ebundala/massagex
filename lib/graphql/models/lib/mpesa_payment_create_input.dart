...
import 'transaction_create_nested_one_without_mpesa_payment_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class MpesaPaymentCreateInput extends Equatable {
  final String? id;
  ...
  final TransactionCreateNestedOneWithoutMpesaPaymentInput? transaction;
  ...
  static MpesaPaymentCreateInput fromJson(Map<dynamic, dynamic> json) {
    return MpesaPaymentCreateInput(
      id: json['id'],
      ...
      transaction: json['transaction'] != null
          ? TransactionCreateNestedOneWithoutMpesaPaymentInput.fromJson(
              json['transaction'])
          : null,
    );
  }
  ...
  MpesaPaymentCreateInput copyWith(
      {String? id,
      String? input$Amount,
      ...
      DateTime? createdAt,
      DateTime? updatedAt,
      TransactionCreateNestedOneWithoutMpesaPaymentInput? transaction}) {
    return MpesaPaymentCreateInput(
        id: id ?? this.id,
