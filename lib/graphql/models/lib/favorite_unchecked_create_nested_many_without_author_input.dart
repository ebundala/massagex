...
class FavoriteUncheckedCreateNestedManyWithoutAuthorInput extends Equatable {
  ...
  FavoriteUncheckedCreateNestedManyWithoutAuthorInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static FavoriteUncheckedCreateNestedManyWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedCreateNestedManyWithoutAuthorInput(
  ...
  FavoriteUncheckedCreateNestedManyWithoutAuthorInput copyWith(
