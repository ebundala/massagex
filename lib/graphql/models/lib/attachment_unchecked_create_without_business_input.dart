...
class AttachmentUncheckedCreateWithoutBusinessInput extends Equatable {
  ...
  AttachmentUncheckedCreateWithoutBusinessInput(
      {required this.path,
      this.id,
      this.filename,
      this.mimetype,
  ...
  static AttachmentUncheckedCreateWithoutBusinessInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedCreateWithoutBusinessInput(
      path: json['path'],
      id: json['id'],
  ...
  AttachmentUncheckedCreateWithoutBusinessInput copyWith(
      {MultipartFile? path,
      String? id,
      String? filename,
      String? mimetype,
