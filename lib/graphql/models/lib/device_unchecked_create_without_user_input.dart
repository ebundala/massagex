...
class DeviceUncheckedCreateWithoutUserInput extends Equatable {
  final String id;
  final String? fcm$id;
  final String? type;
  ...
  static DeviceUncheckedCreateWithoutUserInput fromJson(
      Map<dynamic, dynamic> json) {
    return DeviceUncheckedCreateWithoutUserInput(
      id: json['id'],
      fcm$id: json['fcm_id'],
      type: json['type'],
  ...
  DeviceUncheckedCreateWithoutUserInput copyWith(
