...
class AttachmentCreateOrConnectWithoutCategoryInput extends Equatable {
  ...
  AttachmentCreateOrConnectWithoutCategoryInput(
      {required this.where, required this.create});

  static AttachmentCreateOrConnectWithoutCategoryInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentCreateOrConnectWithoutCategoryInput(
  ...
  AttachmentCreateOrConnectWithoutCategoryInput copyWith(
