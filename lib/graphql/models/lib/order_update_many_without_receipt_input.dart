...
class OrderUpdateManyWithoutReceiptInput extends Equatable {
  ...
  OrderUpdateManyWithoutReceiptInput(
      {this.create,
  ...
  static OrderUpdateManyWithoutReceiptInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderUpdateManyWithoutReceiptInput(
  ...
  OrderUpdateManyWithoutReceiptInput copyWith(
