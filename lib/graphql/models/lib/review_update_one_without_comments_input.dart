...
import 'review_create_or_connect_without_comments_input.dart';
import 'review_upsert_without_comments_input.dart';
...
class ReviewUpdateOneWithoutCommentsInput extends Equatable {
  final ReviewCreateWithoutCommentsInput? create;
  final ReviewCreateOrConnectWithoutCommentsInput? connectOrCreate;
  final ReviewUpsertWithoutCommentsInput? upsert;
  ...
  ReviewUpdateOneWithoutCommentsInput(
      {this.create,
  ...
  static ReviewUpdateOneWithoutCommentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewUpdateOneWithoutCommentsInput(
      create: json['create'] != null
          ? ReviewCreateWithoutCommentsInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? ReviewCreateOrConnectWithoutCommentsInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? ReviewUpsertWithoutCommentsInput.fromJson(json['upsert'])
          : null,
      ...
      update: json['update'] != null
          ? ReviewUpdateWithoutCommentsInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  ReviewUpdateOneWithoutCommentsInput copyWith(
      {ReviewCreateWithoutCommentsInput? create,
      ReviewCreateOrConnectWithoutCommentsInput? connectOrCreate,
      ReviewUpsertWithoutCommentsInput? upsert,
