...
class TransactionUncheckedUpdateWithoutSelcomPaymentInput extends Equatable {
  ...
  TransactionUncheckedUpdateWithoutSelcomPaymentInput(
      {this.id,
  ...
  static TransactionUncheckedUpdateWithoutSelcomPaymentInput fromJson(
      Map<dynamic, dynamic> json) {
    return TransactionUncheckedUpdateWithoutSelcomPaymentInput(
      id: json['id'] != null
  ...
  TransactionUncheckedUpdateWithoutSelcomPaymentInput copyWith(
