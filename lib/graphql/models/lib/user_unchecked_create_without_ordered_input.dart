...
class UserUncheckedCreateWithoutOrderedInput extends Equatable {
  final String? id;
  final String? email;
  ...
  UserUncheckedCreateWithoutOrderedInput(
      {this.id,
      this.email,
      this.displayName,
      this.phoneNumber,
  ...
  static UserUncheckedCreateWithoutOrderedInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUncheckedCreateWithoutOrderedInput(
      id: json['id'],
      email: json['email'],
  ...
  UserUncheckedCreateWithoutOrderedInput copyWith(
      {String? id,
      String? email,
      String? displayName,
      String? phoneNumber,
