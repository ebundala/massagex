...
class HelpStepUpsertWithWhereUniqueWithoutHelpInput extends Equatable {
  final HelpStepWhereUniqueInput where;
  final HelpStepUpdateWithoutHelpInput update;
  ...
  HelpStepUpsertWithWhereUniqueWithoutHelpInput(
      {required this.where, required this.update, required this.create});

  static HelpStepUpsertWithWhereUniqueWithoutHelpInput fromJson(
      Map<dynamic, dynamic> json) {
    return HelpStepUpsertWithWhereUniqueWithoutHelpInput(
      where: HelpStepWhereUniqueInput.fromJson(json['where']),
      update: HelpStepUpdateWithoutHelpInput.fromJson(json['update']),
  ...
  HelpStepUpsertWithWhereUniqueWithoutHelpInput copyWith(
      {HelpStepWhereUniqueInput? where,
      HelpStepUpdateWithoutHelpInput? update,
