...
import 'nested_enum_business_status_with_aggregates_filter.dart';
...
class EnumBusinessStatusWithAggregatesFilter extends Equatable {
  ...
  EnumBusinessStatusWithAggregatesFilter(
      {this.equals,
      this.in$,
      this.notIn,
      this.not,
  ...
  static EnumBusinessStatusWithAggregatesFilter fromJson(
      Map<dynamic, dynamic> json) {
    return EnumBusinessStatusWithAggregatesFilter(
  ...
  EnumBusinessStatusWithAggregatesFilter copyWith(
