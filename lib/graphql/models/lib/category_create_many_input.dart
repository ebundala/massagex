...
class CategoryCreateManyInput extends Equatable {
  final String? id;
  final String name;
  ...
  static CategoryCreateManyInput fromJson(Map<dynamic, dynamic> json) {
    return CategoryCreateManyInput(
      id: json['id'],
      name: json['name'],
  ...
  CategoryCreateManyInput copyWith(
      {String? id,
      String? name,
      String? description,
      String? pictureId,
