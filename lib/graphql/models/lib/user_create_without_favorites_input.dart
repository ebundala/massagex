...
class UserCreateWithoutFavoritesInput extends Equatable {
  final String? id;
  final String? email;
  ...
  static UserCreateWithoutFavoritesInput fromJson(Map<dynamic, dynamic> json) {
  ...
  UserCreateWithoutFavoritesInput copyWith(
      {String? id,
      String? email,
      String? displayName,
      String? phoneNumber,
