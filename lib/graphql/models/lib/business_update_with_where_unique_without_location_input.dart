...
class BusinessUpdateWithWhereUniqueWithoutLocationInput extends Equatable {
  final BusinessWhereUniqueInput where;
  final BusinessUpdateWithoutLocationInput data;
  ...
  BusinessUpdateWithWhereUniqueWithoutLocationInput(
      {required this.where, required this.data});

  static BusinessUpdateWithWhereUniqueWithoutLocationInput fromJson(
      Map<dynamic, dynamic> json) {
    return BusinessUpdateWithWhereUniqueWithoutLocationInput(
      where: BusinessWhereUniqueInput.fromJson(json['where']),
      data: BusinessUpdateWithoutLocationInput.fromJson(json['data']),
    );
  }
  ...
  BusinessUpdateWithWhereUniqueWithoutLocationInput copyWith(
      {BusinessWhereUniqueInput? where,
      BusinessUpdateWithoutLocationInput? data}) {
    return BusinessUpdateWithWhereUniqueWithoutLocationInput(
