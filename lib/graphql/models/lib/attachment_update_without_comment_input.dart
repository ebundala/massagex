...
class AttachmentUpdateWithoutCommentInput extends Equatable {
  ...
  static AttachmentUpdateWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUpdateWithoutCommentInput(
      id: json['id'] != null
  ...
  AttachmentUpdateWithoutCommentInput copyWith(
