...
class CategoryUpdateWithoutServicesInput extends Equatable {
  ...
  static CategoryUpdateWithoutServicesInput fromJson(
      Map<dynamic, dynamic> json) {
    return CategoryUpdateWithoutServicesInput(
      id: json['id'] != null
  ...
  CategoryUpdateWithoutServicesInput copyWith(
