import 'order_create_many_owner_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class OrderCreateManyOwnerInputEnvelope extends Equatable {
  final List<OrderCreateManyOwnerInput>? data;
  ...
  OrderCreateManyOwnerInputEnvelope({this.data, this.skipDuplicates});

  static OrderCreateManyOwnerInputEnvelope fromJson(
      Map<dynamic, dynamic> json) {
    return OrderCreateManyOwnerInputEnvelope(
      data: json['data'] != null
          ? List.generate(
              json['data'].length,
              (index) =>
                  OrderCreateManyOwnerInput.fromJson(json['data'][index]))
          : null,
  ...
  OrderCreateManyOwnerInputEnvelope copyWith(
      {List<OrderCreateManyOwnerInput>? data, bool? skipDuplicates}) {
    return OrderCreateManyOwnerInputEnvelope(
        data: data ?? this.data,
