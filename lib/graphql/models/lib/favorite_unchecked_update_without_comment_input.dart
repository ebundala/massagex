...
class FavoriteUncheckedUpdateWithoutCommentInput extends Equatable {
  ...
  FavoriteUncheckedUpdateWithoutCommentInput(
      {this.id,
      this.favId,
      this.authorId,
      this.typeId,
  ...
  static FavoriteUncheckedUpdateWithoutCommentInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUncheckedUpdateWithoutCommentInput(
      id: json['id'] != null
  ...
  FavoriteUncheckedUpdateWithoutCommentInput copyWith(
