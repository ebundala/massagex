...
class ReviewCreateOrConnectWithoutCommentsInput extends Equatable {
  ...
  ReviewCreateOrConnectWithoutCommentsInput(
      {required this.where, required this.create});

  static ReviewCreateOrConnectWithoutCommentsInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewCreateOrConnectWithoutCommentsInput(
  ...
  ReviewCreateOrConnectWithoutCommentsInput copyWith(
