...
class FavoriteUpdateManyWithWhereWithoutAuthorInput extends Equatable {
  ...
  FavoriteUpdateManyWithWhereWithoutAuthorInput(
      {required this.where, required this.data});

  static FavoriteUpdateManyWithWhereWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return FavoriteUpdateManyWithWhereWithoutAuthorInput(
  ...
  FavoriteUpdateManyWithWhereWithoutAuthorInput copyWith(
