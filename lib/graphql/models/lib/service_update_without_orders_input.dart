...
class ServiceUpdateWithoutOrdersInput extends Equatable {
  ...
  ServiceUpdateWithoutOrdersInput(
      {this.id,
      this.name,
      this.description,
      this.price,
  ...
  static ServiceUpdateWithoutOrdersInput fromJson(Map<dynamic, dynamic> json) {
    return ServiceUpdateWithoutOrdersInput(
      id: json['id'] != null
  ...
  ServiceUpdateWithoutOrdersInput copyWith(
