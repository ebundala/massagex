...
class UserUncheckedCreateWithoutAbuseReportsInput extends Equatable {
  final String? id;
  final String email;
  ...
  UserUncheckedCreateWithoutAbuseReportsInput(
      {this.id,
      required this.email,
  ...
  static UserUncheckedCreateWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUncheckedCreateWithoutAbuseReportsInput(
      id: json['id'],
      email: json['email'],
  ...
  UserUncheckedCreateWithoutAbuseReportsInput copyWith(
      {String? id,
      String? email,
      String? displayName,
      String? phoneNumber,
