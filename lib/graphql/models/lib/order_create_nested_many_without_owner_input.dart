...
class OrderCreateNestedManyWithoutOwnerInput extends Equatable {
  ...
  OrderCreateNestedManyWithoutOwnerInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static OrderCreateNestedManyWithoutOwnerInput fromJson(
      Map<dynamic, dynamic> json) {
    return OrderCreateNestedManyWithoutOwnerInput(
  ...
  OrderCreateNestedManyWithoutOwnerInput copyWith(
