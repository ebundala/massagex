...
class AbuseReportCreateNestedManyWithoutAuthorInput extends Equatable {
  ...
  AbuseReportCreateNestedManyWithoutAuthorInput(
      {this.create, this.connectOrCreate, this.createMany, this.connect});

  static AbuseReportCreateNestedManyWithoutAuthorInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportCreateNestedManyWithoutAuthorInput(
  ...
  AbuseReportCreateNestedManyWithoutAuthorInput copyWith(
