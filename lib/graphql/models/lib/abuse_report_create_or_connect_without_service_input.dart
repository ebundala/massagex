...
class AbuseReportCreateOrConnectWithoutServiceInput extends Equatable {
  ...
  AbuseReportCreateOrConnectWithoutServiceInput(
      {required this.where, required this.create});

  static AbuseReportCreateOrConnectWithoutServiceInput fromJson(
      Map<dynamic, dynamic> json) {
    return AbuseReportCreateOrConnectWithoutServiceInput(
  ...
  AbuseReportCreateOrConnectWithoutServiceInput copyWith(
