...
class UserUpsertWithoutAbuseReportsInput extends Equatable {
  ...
  UserUpsertWithoutAbuseReportsInput(
      {required this.update, required this.create});

  static UserUpsertWithoutAbuseReportsInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUpsertWithoutAbuseReportsInput(
      update: UserUpdateWithoutAbuseReportsInput.fromJson(json['update']),
  ...
  UserUpsertWithoutAbuseReportsInput copyWith(
