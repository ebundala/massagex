...
class AttachmentUncheckedUpdateManyInput extends Equatable {
  ...
  static AttachmentUncheckedUpdateManyInput fromJson(
      Map<dynamic, dynamic> json) {
    return AttachmentUncheckedUpdateManyInput(
      id: json['id'] != null
  ...
  AttachmentUncheckedUpdateManyInput copyWith(
