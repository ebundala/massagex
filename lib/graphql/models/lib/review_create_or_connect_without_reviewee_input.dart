...
class ReviewCreateOrConnectWithoutRevieweeInput extends Equatable {
  ...
  ReviewCreateOrConnectWithoutRevieweeInput(
      {required this.where, required this.create});

  static ReviewCreateOrConnectWithoutRevieweeInput fromJson(
      Map<dynamic, dynamic> json) {
    return ReviewCreateOrConnectWithoutRevieweeInput(
  ...
  ReviewCreateOrConnectWithoutRevieweeInput copyWith(
