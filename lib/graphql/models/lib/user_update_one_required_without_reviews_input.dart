import 'user_create_without_reviews_input.dart';
import 'user_create_or_connect_without_reviews_input.dart';
import 'user_upsert_without_reviews_input.dart';
import 'user_where_unique_input.dart';
import 'user_update_without_reviews_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class UserUpdateOneRequiredWithoutReviewsInput extends Equatable {
  final UserCreateWithoutReviewsInput? create;
  final UserCreateOrConnectWithoutReviewsInput? connectOrCreate;
  final UserUpsertWithoutReviewsInput? upsert;
  final UserWhereUniqueInput? connect;
  final UserUpdateWithoutReviewsInput? update;
  ...
  UserUpdateOneRequiredWithoutReviewsInput(
      {this.create,
  ...
  static UserUpdateOneRequiredWithoutReviewsInput fromJson(
      Map<dynamic, dynamic> json) {
    return UserUpdateOneRequiredWithoutReviewsInput(
      create: json['create'] != null
          ? UserCreateWithoutReviewsInput.fromJson(json['create'])
          : null,
      connectOrCreate: json['connectOrCreate'] != null
          ? UserCreateOrConnectWithoutReviewsInput.fromJson(
              json['connectOrCreate'])
          : null,
      upsert: json['upsert'] != null
          ? UserUpsertWithoutReviewsInput.fromJson(json['upsert'])
          : null,
      connect: json['connect'] != null
          ? UserWhereUniqueInput.fromJson(json['connect'])
          : null,
      update: json['update'] != null
          ? UserUpdateWithoutReviewsInput.fromJson(json['update'])
          : null,
    );
  }
  ...
  UserUpdateOneRequiredWithoutReviewsInput copyWith(
      {UserCreateWithoutReviewsInput? create,
      UserCreateOrConnectWithoutReviewsInput? connectOrCreate,
      UserUpsertWithoutReviewsInput? upsert,
      UserWhereUniqueInput? connect,
      UserUpdateWithoutReviewsInput? update}) {
    return UserUpdateOneRequiredWithoutReviewsInput(
