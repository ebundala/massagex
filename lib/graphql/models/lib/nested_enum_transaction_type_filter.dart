...
class NestedEnumTransactionTypeFilter extends Equatable {
  ...
  static NestedEnumTransactionTypeFilter fromJson(Map<dynamic, dynamic> json) {
    return NestedEnumTransactionTypeFilter(
  ...
  NestedEnumTransactionTypeFilter copyWith(
