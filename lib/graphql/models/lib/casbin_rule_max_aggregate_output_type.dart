...
class CasbinRuleMaxAggregateOutputType extends Equatable {
  final int? id;
  final String? ptype;
  final String? v0;
  final String? v1;
  ...
  static CasbinRuleMaxAggregateOutputType fromJson(Map<dynamic, dynamic> json) {
    return CasbinRuleMaxAggregateOutputType(
      id: json['id'],
      ptype: json['ptype'],
      v0: json['v0'],
      v1: json['v1'],
  ...
  CasbinRuleMaxAggregateOutputType copyWith(
      {int? id,
      String? ptype,
      String? v0,
      String? v1,
