...
import 'help_step_update_many_without_help_input.dart';

import "package:gql/ast.dart" as ast;
import "package:equatable/equatable.dart";

class HelpUpdateInput extends Equatable {
  ...
  final HelpStepUpdateManyWithoutHelpInput? steps;
  ...
  static HelpUpdateInput fromJson(Map<dynamic, dynamic> json) {
    return HelpUpdateInput(
      id: json['id'] != null
      ...
      steps: json['steps'] != null
          ? HelpStepUpdateManyWithoutHelpInput.fromJson(json['steps'])
          : null,
    );
  }
  ...
  HelpUpdateInput copyWith(
      ...
      HelpStepUpdateManyWithoutHelpInput? steps}) {
    return HelpUpdateInput(
        id: id ?? this.id,
