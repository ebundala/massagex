...
class CategoryUncheckedUpdateWithoutServicesInput extends Equatable {
  ...
  static CategoryUncheckedUpdateWithoutServicesInput fromJson(
      Map<dynamic, dynamic> json) {
    return CategoryUncheckedUpdateWithoutServicesInput(
      id: json['id'] != null
  ...
  CategoryUncheckedUpdateWithoutServicesInput copyWith(
