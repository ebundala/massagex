...
class NestedEnumTransactionStatusWithAggregatesFilter extends Equatable {
  ...
  NestedEnumTransactionStatusWithAggregatesFilter(
      {this.equals,
      this.in$,
      this.notIn,
      this.not,
  ...
  static NestedEnumTransactionStatusWithAggregatesFilter fromJson(
      Map<dynamic, dynamic> json) {
    return NestedEnumTransactionStatusWithAggregatesFilter(
  ...
  NestedEnumTransactionStatusWithAggregatesFilter copyWith(
