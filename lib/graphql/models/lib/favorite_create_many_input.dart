...
class FavoriteCreateManyInput extends Equatable {
  final String? id;
  final String favId;
  ...
  static FavoriteCreateManyInput fromJson(Map<dynamic, dynamic> json) {
    return FavoriteCreateManyInput(
      id: json['id'],
      favId: json['favId'],
  ...
  FavoriteCreateManyInput copyWith(
      {String? id,
      String? favId,
      String? authorId,
      String? typeId,
